...
module Router_13(
  ...
  wire        _egress_unit_3_to_28_io_credit_available_0;	// @[Router.scala:125:13]
  wire        _egress_unit_3_to_28_io_channel_status_0_occupied;	// @[Router.scala:125:13]
  wire        _egress_unit_3_to_28_io_out_valid;	// @[Router.scala:125:13]
  ...
  wire        _ingress_unit_2_from_40_io_vcalloc_req_bits_vc_sel_3_0;	// @[Router.scala:116:13]
  ...
  wire        _ingress_unit_2_from_40_io_salloc_req_0_bits_vc_sel_3_0;	// @[Router.scala:116:13]
  ...
  wire [4:0]  _ingress_unit_2_from_40_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_2_from_40_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [4:0]  _ingress_unit_2_from_40_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [1:0]  fires_count = {1'h0, _vc_allocator_io_req_0_ready & _input_unit_0_from_29_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_40_io_vcalloc_req_valid};	// @[Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :137:31]
  ...
  wire        _T_29 = auto_egress_nodes_out_0_flit_ready & _egress_unit_1_to_26_io_out_valid;	// @[Decoupled.scala:51:35, Router.scala:125:13]
  wire        _T_38 = auto_egress_nodes_out_1_flit_ready & _egress_unit_2_to_27_io_out_valid;	// @[Decoupled.scala:51:35, Router.scala:125:13]
  wire        _T_47 = auto_egress_nodes_out_2_flit_ready & _egress_unit_3_to_28_io_out_valid;	// @[Decoupled.scala:51:35, Router.scala:125:13]
  ...
  InputUnit_13 input_unit_0_from_29 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_out_credit_available_3_0             (_egress_unit_3_to_28_io_credit_available_0),	// @[Router.scala:125:13]
  ...
  IngressUnit_40 ingress_unit_2_from_40 (	// @[Router.scala:116:13]
    ...
    .io_vcalloc_req_bits_vc_sel_3_0          (_ingress_unit_2_from_40_io_vcalloc_req_bits_vc_sel_3_0),
    ...
    .io_salloc_req_0_bits_vc_sel_3_0         (_ingress_unit_2_from_40_io_salloc_req_0_bits_vc_sel_3_0),
  ...
  OutputUnit_13 output_unit_0_to_29 (	// @[Router.scala:122:13]
    .clock                                   (clock),
    .reset                                   (reset),
  ...
  EgressUnit_26 egress_unit_1_to_26 (	// @[Router.scala:125:13]
    .clock                             (clock),
    .reset                             (reset),
  ...
  EgressUnit_27 egress_unit_2_to_27 (	// @[Router.scala:125:13]
    .clock                        (clock),
    .reset                        (reset),
  ...
  EgressUnit_27 egress_unit_3_to_28 (	// @[Router.scala:125:13]
    .clock                        (clock),
    .reset                        (reset),
    ...
    .io_credit_available_0        (_egress_unit_3_to_28_io_credit_available_0),
    .io_channel_status_0_occupied (_egress_unit_3_to_28_io_channel_status_0_occupied),
    .io_out_valid                 (_egress_unit_3_to_28_io_out_valid),
  ...
  SwitchAllocator_13 switch_allocator (	// @[Router.scala:130:34]
    ...
    .io_req_2_0_bits_vc_sel_3_0 (_ingress_unit_2_from_40_io_salloc_req_0_bits_vc_sel_3_0),	// @[Router.scala:116:13]
  ...
  RotatingSingleVCAllocator_13 vc_allocator (	// @[Router.scala:131:30]
    ...
    .io_req_2_bits_vc_sel_3_0       (_ingress_unit_2_from_40_io_vcalloc_req_bits_vc_sel_3_0),	// @[Router.scala:116:13]
    ...
    .io_channel_status_3_0_occupied (_egress_unit_3_to_28_io_channel_status_0_occupied),	// @[Router.scala:125:13]
  ...
  assign auto_egress_nodes_out_2_flit_valid = _egress_unit_3_to_28_io_out_valid;	// @[Router.scala:125:13]
