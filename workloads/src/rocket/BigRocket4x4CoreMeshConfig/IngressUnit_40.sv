...
module IngressUnit_40(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_13 = io_in_bits_egress_id == 5'h15;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_14 = io_in_bits_egress_id == 5'h13;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_15 = io_in_bits_egress_id == 5'hF;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_16 = io_in_bits_egress_id == 5'h5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_17 = io_in_bits_egress_id == 5'h17;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_18 = io_in_bits_egress_id == 5'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_19 = io_in_bits_egress_id == 5'h3;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_20 = io_in_bits_egress_id == 5'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_21 = io_in_bits_egress_id == 5'h19;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 = io_in_bits_egress_id == 5'h7;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 = io_in_bits_egress_id == 5'h9;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 = io_in_bits_egress_id == 5'hD;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 = io_in_bits_egress_id == 5'h11;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_18 = _route_buffer_io_enq_bits_flow_egress_node_id_T_18 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T_13 ? 4'hA : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_14 ? 4'h9 : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_17 ? 4'hB : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_21 ? 4'hC : 4'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_25, _route_buffer_io_enq_bits_flow_egress_node_id_T_15 | _route_buffer_io_enq_bits_flow_egress_node_T_18[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_23 | _route_buffer_io_enq_bits_flow_egress_node_id_T_24, _route_buffer_io_enq_bits_flow_egress_node_id_T_15 | _route_buffer_io_enq_bits_flow_egress_node_id_T_16 | _route_buffer_io_enq_bits_flow_egress_node_id_T_22 | _route_buffer_io_enq_bits_flow_egress_node_id_T_24, _route_buffer_io_enq_bits_flow_egress_node_id_T_15 | _route_buffer_io_enq_bits_flow_egress_node_T_18[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_19 | _route_buffer_io_enq_bits_flow_egress_node_id_T_22};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 4'hD;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  assign _T_33 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN = _T_33 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      ...
      if (~reset & _GEN & ~_route_q_io_enq_ready) begin	// @[IngressUnit.scala:27:23, :62:24, :64:53, :65:26, :73:{9,36}]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (5'hD),
  ...
  Queue_253 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN),	// @[IngressUnit.scala:62:24, :64:53, :65:26]
    .io_enq_bits_vc_sel_3_0 (_T_33 & io_in_bits_egress_id == 5'h1C),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_2_0 (_T_33 & io_in_bits_egress_id == 5'h1B),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_33 & io_in_bits_egress_id == 5'h1A),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
