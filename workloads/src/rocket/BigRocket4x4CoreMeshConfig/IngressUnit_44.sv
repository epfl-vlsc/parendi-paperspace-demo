...
module IngressUnit_44(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_13 = io_in_bits_egress_id == 5'h17;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_14 = io_in_bits_egress_id == 5'h7;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_15 = io_in_bits_egress_id == 5'hD;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_16 = io_in_bits_egress_id == 5'h11;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_17 = io_in_bits_egress_id == 5'hF;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_18 = io_in_bits_egress_id == 5'h5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_19 = io_in_bits_egress_id == 5'h15;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_20 = io_in_bits_egress_id == 5'h9;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_21 = io_in_bits_egress_id == 5'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 = io_in_bits_egress_id == 5'h19;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 = io_in_bits_egress_id == 5'h3;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 = io_in_bits_egress_id == 5'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 = io_in_bits_egress_id == 5'h13;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_15 = _route_buffer_io_enq_bits_flow_egress_node_id_T_15 ? 3'h6 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_24 = _route_buffer_io_enq_bits_flow_egress_node_id_T_24 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [1:0]  _GEN = {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_14}} | _route_buffer_io_enq_bits_flow_egress_node_T_15[1:0] | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_17}};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T_13 ? 4'hB : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_19 ? 4'hA : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_22 ? 4'hC : 4'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_16, _route_buffer_io_enq_bits_flow_egress_node_T_15[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_17 | _route_buffer_io_enq_bits_flow_egress_node_id_T_20 | _route_buffer_io_enq_bits_flow_egress_node_T_24[2], _GEN[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_18, _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_23 | _route_buffer_io_enq_bits_flow_egress_node_T_24[0]} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 4'h9 : 4'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  assign _T_33 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & (&_route_buffer_io_enq_bits_flow_egress_node_WIRE);	// @[IngressUnit.scala:26:28, :55:59, :64:41, Mux.scala:27:73]
  wire        _GEN_0 = _T_33 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~(&_route_buffer_io_enq_bits_flow_egress_node_WIRE);	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26, Mux.scala:27:73]
