...
module Router(
  ...
  wire        _output_unit_0_to_16_io_credit_available_0;	// @[Router.scala:122:13]
  ...
  wire        _output_unit_0_to_16_io_channel_status_0_occupied;	// @[Router.scala:122:13]
  ...
  wire [4:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [4:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [4:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [4:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [4:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [4:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [2:0]  fires_count = {1'h0, {1'h0, _vc_allocator_io_req_0_ready & _input_unit_0_from_16_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_1_ready & _ingress_unit_1_from_0_io_vcalloc_req_valid}} + {1'h0, {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_1_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_3_ready & _ingress_unit_3_from_2_io_vcalloc_req_valid}};	// @[Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :137:31, :176:14]
  ...
  InputUnit input_unit_0_from_16 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_out_credit_available_0_0             (_output_unit_0_to_16_io_credit_available_0),	// @[Router.scala:122:13]
    ...
    .io_vcalloc_req_bits_vc_sel_1_0          (_input_unit_0_from_16_io_vcalloc_req_bits_vc_sel_1_0),
  ...
  OutputUnit output_unit_0_to_16 (	// @[Router.scala:122:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_credit_available_0                   (_output_unit_0_to_16_io_credit_available_0),
    ...
    .io_channel_status_0_occupied            (_output_unit_0_to_16_io_channel_status_0_occupied),
  ...
  RotatingSingleVCAllocator vc_allocator (	// @[Router.scala:131:30]
    ...
    .io_req_0_bits_vc_sel_1_0       (_input_unit_0_from_16_io_vcalloc_req_bits_vc_sel_1_0),	// @[Router.scala:112:13]
    ...
    .io_channel_status_0_0_occupied (_output_unit_0_to_16_io_channel_status_0_occupied),	// @[Router.scala:122:13]
