...
module TLROM(
  ...
  assign auto_in_d_bits_data = (|(auto_in_a_bits_address[16:15])) ? 64'h0 : _GEN[auto_in_a_bits_address[14:3]];	// @[BootROM.scala:46:22, :51:34, :52:64, :53:{47,53}]
endmodule
