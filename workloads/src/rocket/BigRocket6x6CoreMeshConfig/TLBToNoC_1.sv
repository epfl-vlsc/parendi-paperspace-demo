...
module TLBToNoC_1(
  ...
  Queue_1404 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id = {_q_io_deq_bits_source[7:2] == 6'h0, {_q_io_deq_bits_source[7:2] == 6'h10, {_q_io_deq_bits_source[7:2] == 6'h18, {_q_io_deq_bits_source[7:2] == 6'h1C, {_q_io_deq_bits_source[7:2] == 6'h1E, _q_io_deq_bits_source[7:2] == 6'h1F, 1'h0} | (_q_io_deq_bits_source[7:2] == 6'h1D ? 3'h6 : 3'h0)} | (_q_io_deq_bits_source[7:2] == 6'h1B ? 4'hA : 4'h0) | (_q_io_deq_bits_source[7:2] == 6'h1A ? 4'hC : 4'h0) | (_q_io_deq_bits_source[7:2] == 6'h19 ? 4'hE : 4'h0)} | (_q_io_deq_bits_source[7:2] == 6'h17 ? 5'h12 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h16 ? 5'h14 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h15 ? 5'h16 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h14 ? 5'h18 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h13 ? 5'h1A : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h12 ? 5'h1C : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h11 ? 5'h1E : 5'h0)} | (_q_io_deq_bits_source[7:2] == 6'hF ? 6'h22 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hE ? 6'h24 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hD ? 6'h26 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hC ? 6'h28 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hB ? 6'h2A : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hA ? 6'h2C : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h9 ? 6'h2E : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h8 ? 6'h30 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h7 ? 6'h32 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h6 ? 6'h34 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h5 ? 6'h36 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h4 ? 6'h38 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h3 ? 6'h3A : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h2 ? 6'h3C : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h1 ? 6'h3E : 6'h0)};	// @[Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17]
endmodule
