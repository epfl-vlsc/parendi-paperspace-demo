...
module IngressUnit_96(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 7'h42;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 7'h45;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 7'h48;	// @[IngressUnit.scala:30:72]
  wire [5:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 6'h21 : 6'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 6'h23 : 6'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 6'h22 : 6'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[5], _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 3'h4;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
  wire        _T_13 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN = _T_13 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T | _route_buffer_io_enq_bits_flow_egress_node_id_T_1 | _route_buffer_io_enq_bits_flow_egress_node_id_T_2)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_vnet_id         (3'h4),
    .io_enq_bits_flow_ingress_node    (7'h20),
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 7'h41),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 7'h40),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_0_0 (1'h0),
    .io_enq_bits_vc_sel_0_1 (1'h0),
    .io_enq_bits_vc_sel_0_2 (1'h0),
    .io_enq_bits_vc_sel_0_3 (1'h0),
    .io_enq_bits_vc_sel_0_4 (~_T_13),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
