...
module CoherenceManagerWrapper(
  ...
  input  [7:0]  auto_coherent_jbar_in_a_bits_source,
  ...
  input  [7:0]  auto_coherent_jbar_in_c_bits_source,
  ...
  output [7:0]  auto_coherent_jbar_in_b_bits_source,
  ...
  output [7:0]  auto_coherent_jbar_in_d_bits_source,
  ...
  wire [7:0]  _l2_auto_in_b_bits_source;	// @[Configs.scala:76:24]
  ...
  wire [7:0]  _l2_auto_in_d_bits_source;	// @[Configs.scala:76:24]
