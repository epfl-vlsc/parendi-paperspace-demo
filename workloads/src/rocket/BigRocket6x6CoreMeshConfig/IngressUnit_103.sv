...
module IngressUnit_103(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 7'h3C;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 7'h4;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 7'h14;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_3 = io_in_bits_egress_id == 7'h1A;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_4 = io_in_bits_egress_id == 7'hE;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_5 = io_in_bits_egress_id == 7'h34;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_6 = io_in_bits_egress_id == 7'h22;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_7 = io_in_bits_egress_id == 7'h18;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_9 = io_in_bits_egress_id == 7'h8;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_10 = io_in_bits_egress_id == 7'h12;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_11 = io_in_bits_egress_id == 7'h36;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_12 = io_in_bits_egress_id == 7'h3E;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_13 = io_in_bits_egress_id == 7'h38;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_14 = io_in_bits_egress_id == 7'h20;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_15 = io_in_bits_egress_id == 7'h16;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_16 = io_in_bits_egress_id == 7'h40;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_17 = io_in_bits_egress_id == 7'h2A;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_18 = io_in_bits_egress_id == 7'h2C;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_19 = io_in_bits_egress_id == 7'hA;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_20 = io_in_bits_egress_id == 7'h28;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_21 = io_in_bits_egress_id == 7'h26;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 = io_in_bits_egress_id == 7'h2;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 = io_in_bits_egress_id == 7'hC;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 = io_in_bits_egress_id == 7'h1C;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 = io_in_bits_egress_id == 7'h24;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_26 = io_in_bits_egress_id == 7'h1E;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_27 = io_in_bits_egress_id == 7'h2E;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_28 = io_in_bits_egress_id == 7'h30;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_29 = io_in_bits_egress_id == 7'h3A;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_30 = io_in_bits_egress_id == 7'h32;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_31 = io_in_bits_egress_id == 7'h10;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_32 = io_in_bits_egress_id == 7'h6;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _GEN = _route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_36 = _route_buffer_io_enq_bits_flow_egress_node_id_T_3 ? 4'hD : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_43 = _route_buffer_io_enq_bits_flow_egress_node_id_T_10 ? 4'h9 : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_48 = _route_buffer_io_enq_bits_flow_egress_node_id_T_15 ? 4'hB : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_53 = _route_buffer_io_enq_bits_flow_egress_node_id_T_20 ? 5'h14 : 5'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_54 = _route_buffer_io_enq_bits_flow_egress_node_id_T_21 ? 5'h13 : 5'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _GEN_0 = _route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 4'h9 : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_60 = _route_buffer_io_enq_bits_flow_egress_node_id_T_27 ? 5'h17 : 5'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_62 = _route_buffer_io_enq_bits_flow_egress_node_id_T_29 ? 5'h1D : 5'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_63 = _route_buffer_io_enq_bits_flow_egress_node_id_T_30 ? 5'h19 : 5'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [1:0]  _GEN_1 = _GEN[2:1] | _route_buffer_io_enq_bits_flow_egress_node_T_36[3:2];	// @[Mux.scala:27:73]
  wire [4:0]  _GEN_2 = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 5'h1E : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_5 ? 5'h1A : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_6 ? 5'h11 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_11 ? 5'h1B : 5'h0) | {5{_route_buffer_io_enq_bits_flow_egress_node_id_T_12}} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_13 ? 5'h1C : 5'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_14, _GEN_1[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_7 | _route_buffer_io_enq_bits_flow_egress_node_T_43[3] | _route_buffer_io_enq_bits_flow_egress_node_T_48[3], _GEN_1[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_id_T_7 | _route_buffer_io_enq_bits_flow_egress_node_id_T_9, _route_buffer_io_enq_bits_flow_egress_node_id_T_1 | _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_T_48[1], _route_buffer_io_enq_bits_flow_egress_node_T_36[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_T_43[0] | _route_buffer_io_enq_bits_flow_egress_node_T_48[0]} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_17 ? 5'h15 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_18 ? 5'h16 : 5'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [1:0]  _GEN_3 = _GEN_2[4:3] | _route_buffer_io_enq_bits_flow_egress_node_T_53[4:3] | _route_buffer_io_enq_bits_flow_egress_node_T_54[4:3];	// @[Mux.scala:27:73]
  wire [2:0]  _GEN_4 = _GEN_2[2:0] | (_route_buffer_io_enq_bits_flow_egress_node_id_T_19 ? 3'h5 : 3'h0) | _route_buffer_io_enq_bits_flow_egress_node_T_53[2:0] | _route_buffer_io_enq_bits_flow_egress_node_T_54[2:0];	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire        _GEN_5 = _GEN_3[1] | _GEN_0[3] | _route_buffer_io_enq_bits_flow_egress_node_T_60[4] | _route_buffer_io_enq_bits_flow_egress_node_id_T_28 | _route_buffer_io_enq_bits_flow_egress_node_T_62[4] | _route_buffer_io_enq_bits_flow_egress_node_T_63[4];	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [1:0]  _GEN_6 = _GEN_4[2:1] | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_23}} | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_24}} | _GEN_0[1:0] | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_26}} | _route_buffer_io_enq_bits_flow_egress_node_T_60[2:1] | _route_buffer_io_enq_bits_flow_egress_node_T_62[2:1];	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        _GEN_7 = _GEN_3[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_24 | _route_buffer_io_enq_bits_flow_egress_node_id_T_26 | _route_buffer_io_enq_bits_flow_egress_node_id_T_28 | _route_buffer_io_enq_bits_flow_egress_node_T_62[3] | _route_buffer_io_enq_bits_flow_egress_node_T_63[3] | _route_buffer_io_enq_bits_flow_egress_node_id_T_31;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        _GEN_8 = _GEN_6[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_32;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        _GEN_9 = _GEN_4[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_22 | _route_buffer_io_enq_bits_flow_egress_node_id_T_26 | _route_buffer_io_enq_bits_flow_egress_node_T_60[0] | _route_buffer_io_enq_bits_flow_egress_node_T_62[0] | _route_buffer_io_enq_bits_flow_egress_node_T_63[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_32;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_id_T_16, _GEN_5, _GEN_7, _GEN_6[1], _GEN_8, _GEN_9} == 6'h23;	// @[IngressUnit.scala:30:72, :41:50, :55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_egress_node     ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_16, _GEN_5, _GEN_7, _GEN_6[1], _GEN_8, _GEN_9}),	// @[IngressUnit.scala:30:72, :41:50, Mux.scala:27:73]
