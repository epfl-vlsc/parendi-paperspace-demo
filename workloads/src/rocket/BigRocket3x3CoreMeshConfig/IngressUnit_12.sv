...
module IngressUnit_12(
  ...
  wire [2:0]  _GEN = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 3'h6 : 3'h0) | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_2}};	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  ...
  wire        _GEN_0 = _T_13 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_egress_node     ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_1, _GEN}),	// @[IngressUnit.scala:30:72, :41:50, Mux.scala:27:73]
