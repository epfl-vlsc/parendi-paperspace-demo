...
module IngressUnit_19(
  ...
  input  [3:0]  io_in_bits_egress_id,
  ...
  wire        _T_19;	// @[IngressUnit.scala:64:41]
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_6 = io_in_bits_egress_id == 4'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_7 = io_in_bits_egress_id == 4'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_8 = io_in_bits_egress_id == 4'h5;	// @[IngressUnit.scala:30:72]
  ...
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T_7 ? 3'h5 : 3'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_10, _route_buffer_io_enq_bits_flow_egress_node_id_T_8 | _route_buffer_io_enq_bits_flow_egress_node_id_T_9, _route_buffer_io_enq_bits_flow_egress_node_id_T_9 | _route_buffer_io_enq_bits_flow_egress_node_id_T_11};	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 3'h6;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  assign _T_19 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN = _T_19 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (5'h6),
    .io_enq_bits_flow_ingress_node_id (2'h1),
    .io_enq_bits_flow_egress_node     ({2'h0, _route_buffer_io_enq_bits_flow_egress_node_WIRE}),	// @[IngressUnit.scala:41:50, Mux.scala:27:73]
    .io_enq_bits_flow_egress_node_id  ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | _route_buffer_io_enq_bits_flow_egress_node_id_T_7 | _route_buffer_io_enq_bits_flow_egress_node_id_T_8 | _route_buffer_io_enq_bits_flow_egress_node_id_T_9 | _route_buffer_io_enq_bits_flow_egress_node_id_T_10 | _route_buffer_io_enq_bits_flow_egress_node_id_T_11}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_120 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN),	// @[IngressUnit.scala:62:24, :64:53, :65:26]
    .io_enq_bits_vc_sel_3_0 (_T_19 & io_in_bits_egress_id == 4'hE),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_2_0 (_T_19 & io_in_bits_egress_id == 4'hD),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_19 & io_in_bits_egress_id == 4'hC),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_0_1 (~_T_19),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
    .io_enq_bits_vc_sel_0_2 (~_T_19),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
    .io_enq_bits_vc_sel_0_3 (~_T_19),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
    .io_enq_bits_vc_sel_0_4 (~_T_19),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
  ...
  Queue_122 vcalloc_q (	// @[IngressUnit.scala:76:25]
    .clock                  (clock),
    .reset                  (reset),
