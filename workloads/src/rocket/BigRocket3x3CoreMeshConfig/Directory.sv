...
module Directory(
  ...
  wire [12:0]  _WIRE_7;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_6;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_5;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_4;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_3;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_2;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_1;	// @[Directory.scala:99:44]
  wire [12:0]  _WIRE_0;	// @[Directory.scala:99:44]
  ...
  wire [5:0]   _write_io_deq_bits_data_clients;	// @[Decoupled.scala:375:21]
  wire [3:0]   _write_io_deq_bits_data_tag;	// @[Decoupled.scala:375:21]
  wire [103:0] _cc_dir_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  assign _WIRE_0 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_1 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_2 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_3 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_4 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_5 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_6 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_7 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 13'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  ...
  wire         _hits_T_6 = _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[11:10])) & (~setQuash | (|_write_io_deq_bits_way));	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_13 = _cc_dir_RW0_rdata[16:13] == tag & (|(_cc_dir_RW0_rdata[24:23])) & (~setQuash | _write_io_deq_bits_way != 3'h1);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_20 = _cc_dir_RW0_rdata[29:26] == tag & (|(_cc_dir_RW0_rdata[37:36])) & (~setQuash | _write_io_deq_bits_way != 3'h2);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_27 = _cc_dir_RW0_rdata[42:39] == tag & (|(_cc_dir_RW0_rdata[50:49])) & (~setQuash | _write_io_deq_bits_way != 3'h3);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_34 = _cc_dir_RW0_rdata[55:52] == tag & (|(_cc_dir_RW0_rdata[63:62])) & (~setQuash | _write_io_deq_bits_way != 3'h4);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_41 = _cc_dir_RW0_rdata[68:65] == tag & (|(_cc_dir_RW0_rdata[76:75])) & (~setQuash | _write_io_deq_bits_way != 3'h5);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_48 = _cc_dir_RW0_rdata[81:78] == tag & (|(_cc_dir_RW0_rdata[89:88])) & (~setQuash | _write_io_deq_bits_way != 3'h6);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_55 = _cc_dir_RW0_rdata[94:91] == tag & (|(_cc_dir_RW0_rdata[102:101])) & (~setQuash | _write_io_deq_bits_way != 3'h7);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[Directory.scala:86:10]
      ...
      if (~reset & ~(~ren1 | ({_victimLTE_T_7, _victimLTE_T_6, _victimLTE_T_5, _victimLFSR_prng_io_out_9, _victimLTE_T_3, |_GEN_0} & {~_victimLTE_T_6, ~_victimLTE_T_5, ~_victimLFSR_prng_io_out_9, ~_victimLTE_T_3, ~(|_GEN_0), ~(|_GEN)}) == 6'h0)) begin	// @[Cat.scala:33:92, Directory.scala:103:21, :117:43, :119:57, :121:11, :122:{10,17,39,54}, Mux.scala:27:73, PRNG.scala:91:22]
  ...
  Queue_376 write (	// @[Decoupled.scala:375:21]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty = (|hits) ? _hits_T_6 & _cc_dir_RW0_rdata[12] | _hits_T_13 & _cc_dir_RW0_rdata[25] | _hits_T_20 & _cc_dir_RW0_rdata[38] | _hits_T_27 & _cc_dir_RW0_rdata[51] | _hits_T_34 & _cc_dir_RW0_rdata[64] | _hits_T_41 & _cc_dir_RW0_rdata[77] | _hits_T_48 & _cc_dir_RW0_rdata[90] | _hits_T_55 & _cc_dir_RW0_rdata[103] : _view__T_69 ? _write_io_deq_bits_data_dirty : victimWayOH[0] & _cc_dir_RW0_rdata[12] | victimWayOH[1] & _cc_dir_RW0_rdata[25] | victimWayOH[2] & _cc_dir_RW0_rdata[38] | victimWayOH[3] & _cc_dir_RW0_rdata[51] | victimWayOH[4] & _cc_dir_RW0_rdata[64] | victimWayOH[5] & _cc_dir_RW0_rdata[77] | victimWayOH[6] & _cc_dir_RW0_rdata[90] | victimWayOH[7] & _cc_dir_RW0_rdata[103];	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_state = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[11:10] : 2'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[24:23] : 2'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[37:36] : 2'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[50:49] : 2'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[63:62] : 2'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[76:75] : 2'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[89:88] : 2'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[102:101] : 2'h0) : _view__T_69 ? _write_io_deq_bits_data_state : (victimWayOH[0] ? _cc_dir_RW0_rdata[11:10] : 2'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[24:23] : 2'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[37:36] : 2'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[50:49] : 2'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[63:62] : 2'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[76:75] : 2'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[89:88] : 2'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[102:101] : 2'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_clients = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[9:4] : 6'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[22:17] : 6'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[35:30] : 6'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[48:43] : 6'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[61:56] : 6'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[74:69] : 6'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[87:82] : 6'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[100:95] : 6'h0) : _view__T_69 ? _write_io_deq_bits_data_clients : (victimWayOH[0] ? _cc_dir_RW0_rdata[9:4] : 6'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[22:17] : 6'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[35:30] : 6'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[48:43] : 6'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[61:56] : 6'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[74:69] : 6'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[87:82] : 6'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[100:95] : 6'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_tag = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[16:13] : 4'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[29:26] : 4'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[42:39] : 4'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[55:52] : 4'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[68:65] : 4'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[81:78] : 4'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[94:91] : 4'h0) : _view__T_69 ? _write_io_deq_bits_data_tag : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[16:13] : 4'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[29:26] : 4'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[42:39] : 4'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[55:52] : 4'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[68:65] : 4'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[81:78] : 4'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[94:91] : 4'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
