...
module Router(
  ...
  wire [2:0]  fires_count = {1'h0, {1'h0, _vc_allocator_io_req_0_ready & _input_unit_0_from_9_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_1_ready & _ingress_unit_1_from_0_io_vcalloc_req_valid}} + {1'h0, {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_1_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_3_ready & _ingress_unit_3_from_2_io_vcalloc_req_valid}};	// @[Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :137:31, :176:14]
  ...
  InputUnit input_unit_0_from_9 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_out_credit_available_0_0             (_output_unit_0_to_9_io_credit_available_0),	// @[Router.scala:122:13]
  ...
  OutputUnit output_unit_0_to_9 (	// @[Router.scala:122:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_credit_available_0                   (_output_unit_0_to_9_io_credit_available_0),
    ...
    .io_channel_status_0_occupied            (_output_unit_0_to_9_io_channel_status_0_occupied),
  ...
  RotatingSingleVCAllocator vc_allocator (	// @[Router.scala:131:30]
    ...
    .io_channel_status_0_0_occupied (_output_unit_0_to_9_io_channel_status_0_occupied),	// @[Router.scala:122:13]
