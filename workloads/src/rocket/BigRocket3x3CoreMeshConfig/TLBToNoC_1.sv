...
module TLBToNoC_1(
  ...
  Queue_345 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_payload = is_body ? {_q_io_deq_bits_mask, _q_io_deq_bits_data, _q_io_deq_bits_corrupt} : {27'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_address};	// @[Cat.scala:33:92, Tilelink.scala:45:17, :59:24, :68:33]
  assign io_flit_bits_egress_id = {_q_io_deq_bits_source[4:2] == 3'h1, {_q_io_deq_bits_source[4:2] == 3'h3, _q_io_deq_bits_source[4:2] == 3'h4, 1'h0} | (_q_io_deq_bits_source[4:2] == 3'h2 ? 3'h6 : 3'h0)} | (_q_io_deq_bits_source[4:2] == 3'h0 ? 4'hA : 4'h0);	// @[Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17]
endmodule
