...
module TLSourceShrinker(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      allocated <= (allocated | (a_first & _alloc_T ? _GEN_2 : 16'h0)) & ~((d_last_counter == 3'h1 | (auto_out_d_bits_opcode[0] ? ~(_d_last_beats1_decode_T_1[5:3]) : 3'h0) == 3'h0) & _free_T ? 16'h1 << auto_out_d_bits_source : 16'h0);	// @[Bundles.scala:259:74, Decoupled.scala:51:35, Edges.scala:106:36, :221:14, :229:27, :231:25, :232:{25,33,43}, OneHot.scala:57:35, SourceShrinker.scala:54:32, :55:53, :76:29, :77:27, :78:27, :79:26, :80:{33,45,47}, package.scala:235:{46,71,76}]
    ...
    if (a_first)	// @[Edges.scala:231:25]
      x1_a_bits_source_r <= {1'h0, |(_GEN_2[15:8]), |(_GEN_3[6:3]), |(_GEN_4[2:1]), _nextFree_T_8};	// @[Cat.scala:33:92, OneHot.scala:30:18, :32:{14,28}, Reg.scala:19:16, SourceShrinker.scala:55:53, package.scala:245:48]
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  assign auto_out_a_bits_source = a_first ? {|(_GEN_2[15:8]), |(_GEN_3[6:3]), |(_GEN_4[2:1]), _nextFree_T_8} : x1_a_bits_source_r[3:0];	// @[Cat.scala:33:92, Edges.scala:231:25, OneHot.scala:30:18, :32:{14,28}, Reg.scala:19:16, SourceShrinker.scala:55:53, package.scala:80:42]
