...
module TLDToNoC(
  ...
  output [3:0]  io_flit_bits_egress_id
);
  ...
  Queue_346 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_payload = is_body ? {_q_io_deq_bits_data, _q_io_deq_bits_corrupt} : {47'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_sink, _q_io_deq_bits_denied};	// @[Cat.scala:33:92, Tilelink.scala:45:17, :59:24, :68:33]
  assign io_flit_bits_egress_id = {1'h0, {1'h0, {1'h0, _q_io_deq_bits_source[4:2] == 3'h5} | {2{_q_io_deq_bits_source[4:2] == 3'h4}}} | (_q_io_deq_bits_source[4:2] == 3'h3 ? 3'h5 : 3'h0) | {3{_q_io_deq_bits_source[4:2] == 3'h2}}} | (_q_io_deq_bits_source[4:2] == 3'h1 ? 4'h9 : 4'h0) | (_q_io_deq_bits_source[4:2] == 3'h0 ? 4'hB : 4'h0);	// @[Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17]
endmodule
