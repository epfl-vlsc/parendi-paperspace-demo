  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[12:11];	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_address = _RANDOM_0[27:13];	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_mask = {_RANDOM_0[31:28], _RANDOM_1[3:0]};	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_data = {_RANDOM_1[31:4], _RANDOM_2, _RANDOM_3[3:0]};	// AtomicAutomata.scala:79:24
        cam_a_0_bits_corrupt = _RANDOM_3[4];	// AtomicAutomata.scala:79:24
        cam_a_0_fifoId = _RANDOM_3[5];	// AtomicAutomata.scala:79:24
        cam_a_0_lut = _RANDOM_3[9:6];	// AtomicAutomata.scala:79:24
        cam_d_0_data = {_RANDOM_3[31:10], _RANDOM_4, _RANDOM_5[9:0]};	// AtomicAutomata.scala:79:24, :80:24
        cam_d_0_denied = _RANDOM_5[10];	// AtomicAutomata.scala:80:24
        cam_d_0_corrupt = _RANDOM_5[11];	// AtomicAutomata.scala:80:24
        beatsLeft = _RANDOM_5[14:12];	// Arbiter.scala:88:30, AtomicAutomata.scala:80:24
        state_0 = _RANDOM_5[15];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        state_1 = _RANDOM_5[16];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        d_first_counter = _RANDOM_5[19:17];	// AtomicAutomata.scala:80:24, Edges.scala:229:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
