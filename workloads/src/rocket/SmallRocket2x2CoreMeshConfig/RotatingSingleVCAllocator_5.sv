...
module RotatingSingleVCAllocator_5(
  ...
  wire [3:0]  in_arb_filter =
    _in_arb_filter_T_3[0]
      ? 4'h1
      : _in_arb_filter_T_3[1] ? 4'h2 : in_arb_vals_0 ? 4'h4 : {in_arb_vals_1, 3'h0};	// ISLIP.scala:23:21, Mux.scala:47:70, OneHot.scala:84:71, SingleVCAllocator.scala:19:84, :32:39
  ...
  wire [10:0] _GEN =
    {_in_vc_sel_WIRE_17,
     ...
     _in_vc_sel_WIRE_8,
     1'h0,
     _in_vc_sel_WIRE_5} & ~(in_alloc_mask[14:4]);	// ISLIP.scala:17:25, :18:{29,31}, :33:18, Mux.scala:27:73
  wire [29:0] _in_alloc_oh_T_55 =
    _GEN[0]
      ? 30'h10
      : _GEN[2]
          ? 30'h40
