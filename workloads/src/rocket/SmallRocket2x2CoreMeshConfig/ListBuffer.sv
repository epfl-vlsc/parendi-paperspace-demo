...
module ListBuffer(
  ...
  wire [40:0] freeOH =
    {~(_freeOH_T_15 | {_freeOH_T_15[7:0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// ListBuffer.scala:53:{16,25,32,38}, package.scala:245:{43,48,53}
  ...
  wire [5:0]  data_MPORT_addr =
    {|(freeOH[40:32]),
     ...
     |(_GEN_1[6:3]),
     |(_GEN_2[2:1]),
     _GEN_2[2] | _GEN_2[0]};	// Cat.scala:33:92, ListBuffer.scala:53:38, OneHot.scala:30:18, :31:18, :32:{14,28}
    ...
    if (reset) begin
      ...
      valid <=
        ...
        & ~(io_pop_valid & _head_ext_R0_data == _tail_ext_R0_data
              ? _valid_clr_T[39:0]
              : 40'h0) | (data_MPORT_en ? _valid_set_T[39:0] : 40'h0);	// Decoupled.scala:51:35, ListBuffer.scala:46:22, :47:18, :48:18, :56:30, :57:30, :65:23, :66:15, :87:22, :89:{20,48}, :90:17, :98:{21,23,35}, OneHot.scala:64:{12,27}
      used <=
        used & ~(io_pop_valid ? _used_clr_T[39:0] : 40'h0)
        | (data_MPORT_en ? freeOH[39:0] : 40'h0);	// Decoupled.scala:51:35, ListBuffer.scala:46:22, :49:22, :53:38, :58:30, :59:30, :65:23, :67:14, :87:22, :88:14, :97:{21,23,35}, OneHot.scala:64:{12,27}
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  data_combMem_1 data_ext (	// ListBuffer.scala:51:18
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_push_bits_data_corrupt, io_push_bits_data_mask, io_push_bits_data_data}),	// ListBuffer.scala:51:18
