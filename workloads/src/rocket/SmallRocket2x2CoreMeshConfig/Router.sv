...
module Router(
  ...
  wire [2:0]  fires_count =
    ...
    + {1'h0,
       {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_1_io_vcalloc_req_valid}
         + {1'h0,
            _vc_allocator_io_req_3_ready & _ingress_unit_3_from_2_io_vcalloc_req_valid}};	// Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :134:32, :137:31
  ...
  OutputUnit output_unit_0_to_4 (	// Router.scala:122:13
    ...
    .io_channel_status_0_occupied
      (_output_unit_0_to_4_io_channel_status_0_occupied),
