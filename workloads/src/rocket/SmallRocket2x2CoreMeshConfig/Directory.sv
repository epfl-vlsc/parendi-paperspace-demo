...
module Directory(
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 8'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire        _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[6:5]))
  ...
  wire        _hits_T_13 =
    _cc_dir_RW0_rdata[11:8] == tag & (|(_cc_dir_RW0_rdata[14:13]))
  ...
  wire        _hits_T_20 =
    _cc_dir_RW0_rdata[19:16] == tag & (|(_cc_dir_RW0_rdata[22:21]))
  ...
  wire        _hits_T_27 =
    _cc_dir_RW0_rdata[27:24] == tag & (|(_cc_dir_RW0_rdata[30:29]))
  ...
  wire        _hits_T_34 =
    _cc_dir_RW0_rdata[35:32] == tag & (|(_cc_dir_RW0_rdata[38:37]))
  ...
  wire        _hits_T_41 =
    _cc_dir_RW0_rdata[43:40] == tag & (|(_cc_dir_RW0_rdata[46:45]))
  ...
  wire        _hits_T_48 =
    _cc_dir_RW0_rdata[51:48] == tag & (|(_cc_dir_RW0_rdata[54:53]))
  ...
  wire        _hits_T_55 =
    _cc_dir_RW0_rdata[59:56] == tag & (|(_cc_dir_RW0_rdata[62:61]))
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[7] | _hits_T_13 & _cc_dir_RW0_rdata[15] | _hits_T_20
        & _cc_dir_RW0_rdata[23] | _hits_T_27 & _cc_dir_RW0_rdata[31] | _hits_T_34
        & _cc_dir_RW0_rdata[39] | _hits_T_41 & _cc_dir_RW0_rdata[47] | _hits_T_48
        & _cc_dir_RW0_rdata[55] | _hits_T_55 & _cc_dir_RW0_rdata[63]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[7] | victimWayOH[1] & _cc_dir_RW0_rdata[15]
            | victimWayOH[2] & _cc_dir_RW0_rdata[23] | victimWayOH[3]
            & _cc_dir_RW0_rdata[31] | victimWayOH[4] & _cc_dir_RW0_rdata[39]
            | victimWayOH[5] & _cc_dir_RW0_rdata[47] | victimWayOH[6]
            & _cc_dir_RW0_rdata[55] | victimWayOH[7] & _cc_dir_RW0_rdata[63];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[6:5] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[14:13] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[22:21] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[30:29] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[38:37] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[46:45] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[54:53] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[62:61] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[6:5] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[14:13] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[22:21] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[30:29] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[38:37] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[46:45] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[54:53] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[62:61] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[4] | _hits_T_13 & _cc_dir_RW0_rdata[12] | _hits_T_20
        & _cc_dir_RW0_rdata[20] | _hits_T_27 & _cc_dir_RW0_rdata[28] | _hits_T_34
        & _cc_dir_RW0_rdata[36] | _hits_T_41 & _cc_dir_RW0_rdata[44] | _hits_T_48
        & _cc_dir_RW0_rdata[52] | _hits_T_55 & _cc_dir_RW0_rdata[60]
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : victimWayOH[0] & _cc_dir_RW0_rdata[4] | victimWayOH[1] & _cc_dir_RW0_rdata[12]
            | victimWayOH[2] & _cc_dir_RW0_rdata[20] | victimWayOH[3]
            & _cc_dir_RW0_rdata[28] | victimWayOH[4] & _cc_dir_RW0_rdata[36]
            | victimWayOH[5] & _cc_dir_RW0_rdata[44] | victimWayOH[6]
            & _cc_dir_RW0_rdata[52] | victimWayOH[7] & _cc_dir_RW0_rdata[60];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[11:8] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[19:16] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[27:24] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[35:32] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[43:40] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[51:48] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[59:56] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[11:8] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[19:16] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[27:24] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[35:32] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[43:40] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[51:48] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[59:56] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
