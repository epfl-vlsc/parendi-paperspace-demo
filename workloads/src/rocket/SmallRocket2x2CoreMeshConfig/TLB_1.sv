...
module TLB_1(
  ...
  wire        legal_address =
    io_req_bits_vaddr[33:12] == 22'h3 | io_req_bits_vaddr[33:12] == 22'h2010
    | io_req_bits_vaddr[33:12] == 22'h4 | io_req_bits_vaddr[33:16] == 18'h1
    | io_req_bits_vaddr[33:17] == 17'h4000 | io_req_bits_vaddr[33:29] == 5'h3;	// Parameters.scala:137:{31,65}, TLB.scala:410:67
  ...
  assign io_resp_ae_inst =
    ~(legal_address
      & ({io_req_bits_vaddr[31:30],
          io_req_bits_vaddr[25],
          io_req_bits_vaddr[16],
          io_req_bits_vaddr[14]} == 5'h0
         | {io_req_bits_vaddr[31:30],
            io_req_bits_vaddr[25],
            ~(io_req_bits_vaddr[16])} == 4'h0 | io_req_bits_vaddr[31:30] == 2'h1
         | {_GEN, io_req_bits_vaddr[25]} == 3'h0) & _pmp_io_x);	// Parameters.scala:137:{31,45,65}, :616:89, TLB.scala:403:19, :410:67, :424:65, :632:23
