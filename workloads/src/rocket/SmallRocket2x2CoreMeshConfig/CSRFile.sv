...
module CSRFile(
  ...
  wire [14:0] _GEN_11 =
    ((&{io_rw_addr[2],
       ...
       ? {4'h0, io_interrupts_meip, 10'h0}
       : 15'h0) | _io_rw_rdata_T_14[15:1];	// CSR.scala:571:22, Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0,
       ...
       _GEN_11[14:2] | _io_rw_rdata_T_111[15:3] | _io_rw_rdata_T_112[15:3]
         | _io_rw_rdata_T_113[15:3] | _io_rw_rdata_T_114[15:3] | _io_rw_rdata_T_115[15:3]
         | _io_rw_rdata_T_116[15:3] | _io_rw_rdata_T_117[15:3] | _io_rw_rdata_T_118[15:3],
       _GEN_11[1:0] | _io_rw_rdata_T_17[2:1] | _io_rw_rdata_T_111[2:1]
         | _io_rw_rdata_T_112[2:1] | _io_rw_rdata_T_113[2:1] | _io_rw_rdata_T_114[2:1]
         | _io_rw_rdata_T_115[2:1] | _io_rw_rdata_T_116[2:1] | _io_rw_rdata_T_117[2:1]
         | _io_rw_rdata_T_118[2:1],
       (&{io_rw_addr[2],
          decoded_decoded_invInputs[3],
          io_rw_addr[4],
          decoded_decoded_invInputs[5],
         ...
         | _io_rw_rdata_T_111[0] | _io_rw_rdata_T_112[0] | _io_rw_rdata_T_113[0]
         | _io_rw_rdata_T_114[0] | _io_rw_rdata_T_115[0] | _io_rw_rdata_T_116[0]
         | _io_rw_rdata_T_117[0] | _io_rw_rdata_T_118[0]
         | (&{decoded_decoded_invInputs[0],
              io_rw_addr[1],
              decoded_decoded_invInputs[2],
              decoded_decoded_invInputs[3],
    ...
    | ((&{io_rw_addr[0],
          ...
          io_rw_addr[11]})
         ? 64'h20181004
         : 64'h0);	// Bitwise.scala:77:12, CSR.scala:369:47, :373:28, :455:26, :463:19, :464:20, :466:20, :477:27, :478:22, :480:25, :610:25, :611:32, :617:48, :753:43, :1408:67, :1583:26, Cat.scala:33:92, Mux.scala:27:73, :47:70, package.scala:124:38, :155:13, :166:35, pla.scala:78:21, :90:45, :91:29, :98:74
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (csr_wen & (&_decoded_decoded_T)) begin	// CSR.scala:1053:19, :1162:18, :1166:39, :1168:23, Cat.scala:33:92, package.scala:73:59, pla.scala:98:74
        ...
        reg_mstatus_mpie <=
          insn_ret & ~_T_375 | (_GEN_14 ? reg_mstatus_mpie : reg_mstatus_mie);	// CSR.scala:373:28, :835:83, :975:20, :976:24, :1053:19, :1055:48, :1072:{48,66}, :1077:65
