...
module TLXbar_4(
  ...
  assign auto_in_d_bits_source =
    (muxStateEarly_0 ? auto_out_0_d_bits_source : 2'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_source : 2'h0)
    | (muxStateEarly_2 ? auto_out_2_d_bits_source : 2'h0)
    | (muxStateEarly_3 ? auto_out_3_d_bits_source : 2'h0);	// Arbiter.scala:118:30, Mux.scala:27:73
