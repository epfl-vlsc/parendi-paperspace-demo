...
module Queue_119(
  ...
  wire [2:0] _ram_sink_ext_R0_data;	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_sink = maybe_full ? _ram_sink_ext_R0_data : io_enq_bits_sink;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
endmodule
