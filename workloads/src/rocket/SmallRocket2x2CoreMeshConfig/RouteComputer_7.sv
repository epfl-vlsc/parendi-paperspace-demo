...
module RouteComputer_7(
  ...
  wire [1:0] _decoded_T =
    {io_req_0_bits_flow_egress_node_id[0], io_req_0_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_2 =
  ...
  assign io_resp_1_vc_sel_0_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_44, &_decoded_T_47};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_0_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_44, &_decoded_T_47};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_0_4 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_44, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_1_3 =
    |{&_decoded_T, &_decoded_T_2, &_decoded_T_4, io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
