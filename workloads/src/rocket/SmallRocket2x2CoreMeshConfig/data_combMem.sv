...
module data_combMem(	// ListBuffer.scala:51:18
  ...
  reg [30:0] Memory[0:32];	// ListBuffer.scala:51:18
  ...
  `ifndef SYNTHESIS	// ListBuffer.scala:51:18
    `ifdef RANDOMIZE_MEM_INIT	// ListBuffer.scala:51:18
      ...
      reg [31:0] _RANDOM_MEM;	// ListBuffer.scala:51:18
    `endif // RANDOMIZE_MEM_INIT
    initial begin	// ListBuffer.scala:51:18
      ...
      `ifdef RANDOMIZE_MEM_INIT	// ListBuffer.scala:51:18
        for (initvar = 0; initvar < 33; initvar = initvar + 1) begin
          _RANDOM_MEM = {`RANDOM};
          Memory[initvar] = _RANDOM_MEM[30:0];
        end	// ListBuffer.scala:51:18
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 31'bx;	// ListBuffer.scala:51:18
endmodule
