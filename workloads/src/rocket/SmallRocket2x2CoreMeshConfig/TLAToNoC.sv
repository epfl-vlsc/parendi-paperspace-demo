...
module TLAToNoC(
  ...
  wire        _io_flit_bits_tail_output =
    (tail_counter == 9'h1
     | (_q_io_deq_bits_opcode[2] ? 9'h0 : ~(_tail_beats1_decode_T_1[11:3])) == 9'h0)
    & (is_body | ~has_body);	// Edges.scala:92:37, :221:14, :229:27, :232:{25,33,43}, Tilelink.scala:45:17, :59:24, :61:50, :64:{35,47}, :135:45, package.scala:235:{46,71,76}
  ...
  assign io_flit_bits_egress_id =
    {_q_io_deq_bits_address[31:30] == 2'h1,
     {1'h0, _q_io_deq_bits_address[31:30] == 2'h0, 1'h0}
       | (_q_io_deq_bits_address[31:30] == 2'h2 ? 3'h5 : 3'h0)};	// Edges.scala:92:28, Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17
endmodule
