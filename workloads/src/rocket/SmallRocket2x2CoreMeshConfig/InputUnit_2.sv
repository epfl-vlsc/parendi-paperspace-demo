...
module InputUnit_2(
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2
      ...
      if (io_in_flit_0_bits_flow_egress_node == 3'h2)	// InputUnit.scala:209:57, :210:26
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
      ...
      states_4_vc_sel_3_0 <=
        ...
        & (_T
             ? io_in_flit_0_bits_flow_egress_node_id == 2'h2 & _GEN_1 | ~_GEN_1
               & states_4_vc_sel_3_0
             : states_4_vc_sel_3_0);	// InputUnit.scala:192:19, :205:{32,60}, :209:57, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26
      states_4_vc_sel_2_0 <=
        ~_GEN_0
        & (_T
    ...
    if (_salloc_arb_io_chosen_oh_0[4]) begin	// InputUnit.scala:296:26, Mux.scala:29:36
      ...
      salloc_outs_0_flit_flow_ingress_node <= 3'h0;	// InputUnit.scala:208:27, :336:8
      salloc_outs_0_flit_flow_ingress_node_id <= 2'h0;	// Bitwise.scala:51:90, InputUnit.scala:336:8
      salloc_outs_0_flit_flow_egress_node <= 3'h0;	// InputUnit.scala:208:27, :336:8
  ...
  InputBuffer_1 input_buffer (	// InputUnit.scala:181:28
    .clock                         (clock),
    .reset                         (reset),
  ...
  Arbiter route_arbiter (	// InputUnit.scala:187:29
    ...
    .io_in_1_bits_flow_ingress_node    (3'h0),	// InputUnit.scala:208:27
    .io_in_1_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_1_bits_flow_egress_node     (3'h0),	// InputUnit.scala:208:27
    ...
    .io_in_2_bits_flow_ingress_node    (3'h0),	// InputUnit.scala:208:27
    .io_in_2_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_2_bits_flow_egress_node     (3'h0),	// InputUnit.scala:208:27
    ...
    .io_in_3_bits_flow_ingress_node    (3'h0),	// InputUnit.scala:208:27
    .io_in_3_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_3_bits_flow_egress_node     (3'h0),	// InputUnit.scala:208:27
