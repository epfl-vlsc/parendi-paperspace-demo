...
module TLMasterToNoC(
  ...
  input  [1:0]  io_tilelink_a_bits_source,
  ...
  input  [1:0]  io_tilelink_c_bits_source,
  ...
  output [1:0]  io_tilelink_b_bits_source,
  ...
  output [1:0]  io_tilelink_d_bits_source,
  ...
  output [3:0]  io_flits_a_bits_egress_id,
