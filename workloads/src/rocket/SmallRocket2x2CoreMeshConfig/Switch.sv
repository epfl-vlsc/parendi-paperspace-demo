...
module Switch(
  ...
  assign io_out_2_0_bits_flow_ingress_node =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 3'h0)
    | (io_sel_2_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 3'h0);	// Mux.scala:27:73
  ...
  assign io_out_0_0_bits_flow_ingress_node =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 3'h0)
    | (io_sel_0_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 3'h0);	// Mux.scala:27:73
  ...
  assign io_out_0_0_bits_flow_egress_node =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node : 3'h0)
    | (io_sel_0_0_3_0 ? io_in_3_0_bits_flit_flow_egress_node : 3'h0);	// Mux.scala:27:73
