...
module SourceD(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_offset = _RANDOM_0[29:24];	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = {_RANDOM_0[31:30], _RANDOM_1[3:0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_set = _RANDOM_1[10:4];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[13:11];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[16:14];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[17];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[18];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[19];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[20];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[21];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[22];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[23];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = _RANDOM_1[26:24];	// Reg.scala:19:16
        s2_bypass = _RANDOM_1[27];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_1[28];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_1[30];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[2:0];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[5:3];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[8:6];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[10:9];	// Reg.scala:19:16
        s2_req_put = _RANDOM_2[26:21];	// Reg.scala:19:16
        s2_req_set = {_RANDOM_2[31:27], _RANDOM_3[1:0]};	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[4:2];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[7:5];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[8];	// Reg.scala:19:16
        s2_last = _RANDOM_3[9];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[10];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[11];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[12];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[13];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:14], _RANDOM_4, _RANDOM_5[13:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = _RANDOM_5[21:14];	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_5[22];	// Reg.scala:19:16
        s3_full = _RANDOM_5[23];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_5[24];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_beat = _RANDOM_5[27:25];	// Reg.scala:19:16
        s3_bypass = _RANDOM_5[28];	// Reg.scala:19:16
        s3_req_prio_0 = _RANDOM_5[29];	// Reg.scala:19:16
        s3_req_prio_2 = _RANDOM_5[31];	// Reg.scala:19:16
        s3_req_opcode = _RANDOM_6[3:1];	// Reg.scala:19:16
        s3_req_param = _RANDOM_6[6:4];	// Reg.scala:19:16
        s3_req_size = _RANDOM_6[9:7];	// Reg.scala:19:16
        s3_req_source = _RANDOM_6[11:10];	// Reg.scala:19:16
        s3_req_set = {_RANDOM_6[31:28], _RANDOM_7[2:0]};	// Reg.scala:19:16
        s3_req_sink = _RANDOM_7[5:3];	// Reg.scala:19:16
        s3_req_way = _RANDOM_7[8:6];	// Reg.scala:19:16
        s3_req_bad = _RANDOM_7[9];	// Reg.scala:19:16
        s3_pdata_data = {_RANDOM_7[31:11], _RANDOM_8, _RANDOM_9[10:0]};	// Reg.scala:19:16
        s3_pdata_mask = _RANDOM_9[18:11];	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_9[19];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_9[20];	// Reg.scala:19:16
        s3_retires = _RANDOM_9[21];	// Reg.scala:19:16
        s3_need_r = _RANDOM_9[22];	// Reg.scala:19:16
        s4_full = _RANDOM_9[23];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_beat = _RANDOM_9[26:24];	// Reg.scala:19:16
        s4_need_bs = _RANDOM_9[28];	// Reg.scala:19:16
        s4_need_pb = _RANDOM_9[29];	// Reg.scala:19:16
        s4_req_prio_2 = _RANDOM_10[0];	// Reg.scala:19:16
        s4_req_param = _RANDOM_10[7:5];	// Reg.scala:19:16
        s4_req_set = {_RANDOM_10[31:29], _RANDOM_11[3:0]};	// Reg.scala:19:16
        s4_req_way = _RANDOM_11[9:7];	// Reg.scala:19:16
        s4_adjusted_opcode = _RANDOM_11[13:11];	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_11[31:14], _RANDOM_12, _RANDOM_13[13:0]};	// Reg.scala:19:16
        s4_pdata_mask = _RANDOM_13[21:14];	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_13[22];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_13[31:23], _RANDOM_14, _RANDOM_15[22:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_16[28:22];	// Reg.scala:19:16
        s5_req_way = _RANDOM_17[2:0];	// Reg.scala:19:16
        s5_beat = _RANDOM_17[6:4];	// Reg.scala:19:16
        s5_dat = {_RANDOM_17[31:7], _RANDOM_18, _RANDOM_19[6:0]};	// Reg.scala:19:16
        s6_req_set = _RANDOM_20[12:6];	// Reg.scala:19:16
        s6_req_way = _RANDOM_20[18:16];	// Reg.scala:19:16
        s6_beat = _RANDOM_20[22:20];	// Reg.scala:19:16
        s6_dat = {_RANDOM_20[31:23], _RANDOM_21, _RANDOM_22[22:0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_22[31:23], _RANDOM_23, _RANDOM_24[22:0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_24[23];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_24[31:24], _RANDOM_25, _RANDOM_26[23:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_144 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
