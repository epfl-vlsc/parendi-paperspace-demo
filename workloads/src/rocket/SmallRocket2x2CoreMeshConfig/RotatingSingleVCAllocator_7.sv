...
module RotatingSingleVCAllocator_7(
  ...
  assign in_arb_vals_1 =
    ...
    & (in_arb_reqs_1_0_0 | in_arb_reqs_1_0_1 | in_arb_reqs_1_0_2 | in_arb_reqs_1_0_3
       | in_arb_reqs_1_0_4);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  ...
  `ifndef SYNTHESIS
    ...
    wire  [3:0]  _T_29 =
      {1'h0, {1'h0, _GEN + _GEN_0} + {1'h0, _GEN_3 + _GEN_1 + _GEN_2}}
      + {1'h0, {1'h0, _GEN_4 + _GEN_5} + {1'h0, _GEN_8 + _GEN_6 + _GEN_7}};	// Bitwise.scala:51:90
    wire  [3:0]  _T_62 =
      {1'h0, {1'h0, _GEN + _GEN_0} + {1'h0, _GEN_3 + _GEN_1 + _GEN_2}}
      + {1'h0, {1'h0, _GEN_4 + _GEN_5} + {1'h0, _GEN_8 + _GEN_6 + _GEN_7}};	// Bitwise.scala:51:90
