...
module IngressUnit(
  ...
  wire [2:0]  _vcalloc_buffer_io_deq_bits_flow_ingress_node;	// IngressUnit.scala:75:30
  wire [1:0]  _vcalloc_buffer_io_deq_bits_flow_ingress_node_id;	// IngressUnit.scala:75:30
  wire [2:0]  _vcalloc_buffer_io_deq_bits_flow_egress_node;	// IngressUnit.scala:75:30
  ...
  wire [2:0]  _route_buffer_io_deq_bits_flow_ingress_node;	// IngressUnit.scala:26:28
  wire [1:0]  _route_buffer_io_deq_bits_flow_ingress_node_id;	// IngressUnit.scala:26:28
  wire [2:0]  _route_buffer_io_deq_bits_flow_egress_node;	// IngressUnit.scala:26:28
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 4'h2;	// IngressUnit.scala:30:72
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 =
    io_in_bits_egress_id == 4'h8;	// IngressUnit.scala:30:72
  wire [1:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_1}}
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_2,
       _route_buffer_io_enq_bits_flow_egress_node_id_T};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        _T_13 =
  ...
  reg  [2:0]  out_bundle_bits_flit_flow_ingress_node;	// IngressUnit.scala:116:8
  reg  [1:0]  out_bundle_bits_flit_flow_ingress_node_id;	// IngressUnit.scala:116:8
  reg  [2:0]  out_bundle_bits_flit_flow_egress_node;	// IngressUnit.scala:116:8
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bundle_bits_flit_flow_ingress_node = _RANDOM_2[17:15];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_ingress_node_id = _RANDOM_2[19:18];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node = _RANDOM_2[22:20];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node_id = _RANDOM_2[24:23];	// IngressUnit.scala:116:8
        out_bundle_bits_out_virt_channel = _RANDOM_2[30:28];	// IngressUnit.scala:116:8
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (3'h0),
  ...
  Queue_6 route_q (	// IngressUnit.scala:27:23
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 4'h1),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 4'h0),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
