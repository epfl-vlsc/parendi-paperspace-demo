...
module RouteComputer_4(
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_110, &_decoded_T_112, &_decoded_T_114, io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_2_vc_sel_0_4 =
    |{&_decoded_T_110, &_decoded_T_112, &_decoded_T_114, io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_0_1 =
    |{io_req_1_bits_src_virt_id[0],
      io_req_1_bits_src_virt_id[1],
      io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :114:39
  ...
  assign io_resp_0_vc_sel_2_4 =
    &{~(io_req_0_bits_flow_egress_node[0]), io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45, :98:74
  ...
  assign io_resp_0_vc_sel_1_4 =
    |{io_req_0_bits_flow_egress_node_id[1],
      &_decoded_T_1,
      &{io_req_0_bits_flow_egress_node[0], io_req_0_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
endmodule
