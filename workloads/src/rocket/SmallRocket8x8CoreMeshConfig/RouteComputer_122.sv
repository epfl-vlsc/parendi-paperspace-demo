...
module RouteComputer_122(
  ...
  wire [2:0] _decoded_T_146 =
    {io_req_2_bits_flow_egress_node[1], _GEN[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_148 =
    {io_req_2_bits_flow_egress_node[1], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_150 =
    {io_req_2_bits_flow_egress_node[1], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
