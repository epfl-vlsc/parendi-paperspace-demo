...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 7'h3D & _q_io_enq_bits_ingress_id_T_7
          ? 8'hB8
          : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 7'h3F & _q_io_enq_bits_ingress_id_T_7
            ? 8'hBA
            : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 7'h3E & _q_io_enq_bits_ingress_id_T_7
            ? 8'hBC
