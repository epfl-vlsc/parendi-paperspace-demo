...
module TLDToNoC(
  ...
  Queue_2481 q (	// Tilelink.scala:45:17
    .clock               (clock),
    .reset               (reset),
    ...
    {1'h0,
     {1'h0,
      {1'h0,
       {1'h0,
        {1'h0,
         {1'h0, _q_io_deq_bits_source[7:2] == 6'h3C}
           | {2{_q_io_deq_bits_source[7:2] == 6'h3B}}}
          | (_q_io_deq_bits_source[7:2] == 6'h3A ? 3'h5 : 3'h0)
          | {3{_q_io_deq_bits_source[7:2] == 6'h39}}}
         | (_q_io_deq_bits_source[7:2] == 6'h38 ? 4'h9 : 4'h0)
         | (_q_io_deq_bits_source[7:2] == 6'h37 ? 4'hB : 4'h0)
         | (_q_io_deq_bits_source[7:2] == 6'h36 ? 4'hD : 4'h0)
         | {4{_q_io_deq_bits_source[7:2] == 6'h35}}}
        | (_q_io_deq_bits_source[7:2] == 6'h34 ? 5'h11 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h33 ? 5'h13 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h32 ? 5'h15 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h31 ? 5'h17 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h30 ? 5'h19 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h2F ? 5'h1B : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h2E ? 5'h1D : 5'h0)
        | {5{_q_io_deq_bits_source[7:2] == 6'h2D}}}
       | (_q_io_deq_bits_source[7:2] == 6'h2C ? 6'h21 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h2B ? 6'h23 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h2A ? 6'h25 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h29 ? 6'h27 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h28 ? 6'h29 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h27 ? 6'h2B : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h26 ? 6'h2D : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h25 ? 6'h2F : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h24 ? 6'h31 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h23 ? 6'h33 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h22 ? 6'h35 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h21 ? 6'h37 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h20 ? 6'h39 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h1F ? 6'h3B : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h1E ? 6'h3D : 6'h0)
       | {6{_q_io_deq_bits_source[7:2] == 6'h1D}}}
    | (_q_io_deq_bits_source[7:2] == 6'h1C ? 7'h41 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h1B ? 7'h43 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h1A ? 7'h45 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h19 ? 7'h47 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h18 ? 7'h49 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h17 ? 7'h4B : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h16 ? 7'h4D : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h15 ? 7'h4F : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h14 ? 7'h51 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h13 ? 7'h53 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h12 ? 7'h55 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h11 ? 7'h57 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h10 ? 7'h59 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hF ? 7'h5B : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hE ? 7'h5D : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hD ? 7'h5F : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hC ? 7'h61 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hB ? 7'h63 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hA ? 7'h65 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h9 ? 7'h67 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h8 ? 7'h69 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h7 ? 7'h6B : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h6 ? 7'h6D : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h5 ? 7'h6F : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h4 ? 7'h71 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h3 ? 7'h73 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h2 ? 7'h75 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h1 ? 7'h77 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h0 ? 7'h79 : 7'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
