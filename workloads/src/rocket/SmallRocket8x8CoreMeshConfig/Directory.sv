...
module Directory(
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 68'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire         _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[66:65]))
  ...
  wire         _hits_T_13 =
    _cc_dir_RW0_rdata[71:68] == tag & (|(_cc_dir_RW0_rdata[134:133]))
  ...
  wire         _hits_T_20 =
    _cc_dir_RW0_rdata[139:136] == tag & (|(_cc_dir_RW0_rdata[202:201]))
  ...
  wire         _hits_T_27 =
    _cc_dir_RW0_rdata[207:204] == tag & (|(_cc_dir_RW0_rdata[270:269]))
  ...
  wire         _hits_T_34 =
    _cc_dir_RW0_rdata[275:272] == tag & (|(_cc_dir_RW0_rdata[338:337]))
  ...
  wire         _hits_T_41 =
    _cc_dir_RW0_rdata[343:340] == tag & (|(_cc_dir_RW0_rdata[406:405]))
  ...
  wire         _hits_T_48 =
    _cc_dir_RW0_rdata[411:408] == tag & (|(_cc_dir_RW0_rdata[474:473]))
  ...
  wire         _hits_T_55 =
    _cc_dir_RW0_rdata[479:476] == tag & (|(_cc_dir_RW0_rdata[542:541]))
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[67] | _hits_T_13 & _cc_dir_RW0_rdata[135]
        | _hits_T_20 & _cc_dir_RW0_rdata[203] | _hits_T_27 & _cc_dir_RW0_rdata[271]
        | _hits_T_34 & _cc_dir_RW0_rdata[339] | _hits_T_41 & _cc_dir_RW0_rdata[407]
        | _hits_T_48 & _cc_dir_RW0_rdata[475] | _hits_T_55 & _cc_dir_RW0_rdata[543]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[67] | victimWayOH[1]
            & _cc_dir_RW0_rdata[135] | victimWayOH[2] & _cc_dir_RW0_rdata[203]
            | victimWayOH[3] & _cc_dir_RW0_rdata[271] | victimWayOH[4]
            & _cc_dir_RW0_rdata[339] | victimWayOH[5] & _cc_dir_RW0_rdata[407]
            | victimWayOH[6] & _cc_dir_RW0_rdata[475] | victimWayOH[7]
            & _cc_dir_RW0_rdata[543];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[66:65] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[134:133] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[202:201] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[270:269] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[338:337] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[406:405] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[474:473] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[542:541] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[66:65] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[134:133] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[202:201] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[270:269] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[338:337] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[406:405] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[474:473] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[542:541] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[64:4] : 61'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[132:72] : 61'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[200:140] : 61'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[268:208] : 61'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[336:276] : 61'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[404:344] : 61'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[472:412] : 61'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[540:480] : 61'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[64:4] : 61'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[132:72] : 61'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[200:140] : 61'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[268:208] : 61'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[336:276] : 61'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[404:344] : 61'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[472:412] : 61'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[540:480] : 61'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[71:68] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[139:136] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[207:204] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[275:272] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[343:340] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[411:408] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[479:476] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[71:68] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[139:136] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[207:204] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[275:272] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[343:340] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[411:408] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[479:476] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
