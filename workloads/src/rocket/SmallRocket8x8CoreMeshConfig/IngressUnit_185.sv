...
module IngressUnit_185(
  ...
  wire        _vcalloc_buffer_io_deq_ready_T_1 =
    io_salloc_req_0_ready & _vcalloc_q_io_deq_valid
    & (|({_vcalloc_q_io_deq_bits_vc_sel_3_0,
         ...
         & {io_out_credit_available_3_0,
            ...
            io_out_credit_available_0_2,
            io_out_credit_available_0_1,
            1'h1}));	// IngressUnit.scala:76:25, :107:{41,48,74,82}, :110:83
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (7'h0),	// IngressUnit.scala:36:35
    .io_enq_bits_flow_ingress_node_id (2'h0),	// IngressUnit.scala:36:35
    .io_enq_bits_flow_egress_node     (7'h0),	// IngressUnit.scala:36:35
  ...
  Queue_1167 vcalloc_q (	// IngressUnit.scala:76:25
    ...
    .io_deq_ready
      (_vcalloc_buffer_io_deq_bits_tail & _vcalloc_buffer_io_deq_ready_T_1
       & _vcalloc_buffer_io_deq_valid),	// IngressUnit.scala:75:30, :110:83, :111:42
