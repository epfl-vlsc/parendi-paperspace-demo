...
module IngressUnit_105(
  ...
  wire [5:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 6'h3D : 6'h0)
    | {6{_route_buffer_io_enq_bits_flow_egress_node_id_T_1}}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 6'h3E : 6'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
