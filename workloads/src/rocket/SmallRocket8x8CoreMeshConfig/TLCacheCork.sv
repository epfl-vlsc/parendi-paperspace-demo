...
module TLCacheCork(
  ...
  assign bundleIn_0_d_valid =
    out_6_valid & (_pool_io_alloc_valid | (|d_first_counter) | ~d_grant);	// Arbiter.scala:126:29, CacheCork.scala:119:26, :125:54, :127:{34,70,73}, Edges.scala:229:27, :231:25
  wire        out_6_ready =
    auto_in_d_ready & (_pool_io_alloc_valid | (|d_first_counter) | ~d_grant);	// CacheCork.scala:119:26, :125:54, :127:73, :128:{34,70}, Edges.scala:229:27, :231:25
  ...
  wire [7:0]  _GEN =
    {{wSourceVec_0},
     ...
     {wSourceVec_2},
     {wSourceVec_1},
     {wSourceVec_0}};	// CacheCork.scala:139:29, :143:25
  ...
  wire [2:0]  out_3_bits_opcode =
    auto_out_d_bits_opcode == 3'h0 & ~(auto_out_d_bits_source[0])
      ? 3'h6
      : _T_18 ? 3'h5 : auto_out_d_bits_opcode;	// CacheCork.scala:69:37, :125:40, :134:13, :154:{51,71,76}, :155:27, :158:{33,47,50,73}, :159:27, Nodes.scala:1215:84
  ...
  wire        out_2_valid =
    idle
      ...
      : state_0 & winnerQual_0 | state_1 & out_1_earlyValid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:29, CacheCork.scala:73:33, :94:33, Mux.scala:27:73
  ...
  assign out_6_valid =
    idle_1
      ...
      : state_1_0 & auto_out_d_valid | state_1_1 & _q_io_deq_valid | state_1_2
        & _q_1_io_deq_valid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Decoupled.scala:375:21, Mux.scala:27:73
  wire [2:0]  out_6_bits_size =
    (muxStateEarly_1_0 ? auto_out_d_bits_size : 3'h0)
    | (muxStateEarly_1_1 ? _q_io_deq_bits_size : 3'h0)
    | (muxStateEarly_1_2 ? _q_1_io_deq_bits_size : 3'h0);	// Arbiter.scala:118:30, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84
  assign out_6_bits_opcode =
    (muxStateEarly_1_0 ? out_3_bits_opcode : 3'h0)
    | (muxStateEarly_1_1 ? _q_io_deq_bits_opcode : 3'h0)
    | (muxStateEarly_1_2 ? _q_1_io_deq_bits_opcode : 3'h0);	// Arbiter.scala:118:30, CacheCork.scala:154:76, :158:73, :159:27, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84
    ...
    if (reset) begin
      ...
      if (idle & auto_out_a_ready)	// Arbiter.scala:89:28, :90:24
        beatsLeft <=
          ...
          | (winnerQual_1 & ~(out_1_bits_opcode[2]) ? ~(_decode_T_5[5:3]) : 3'h0);	// Arbiter.scala:88:30, :99:79, :112:73, :113:44, CacheCork.scala:74:18, :78:86, :79:27, :94:33, Edges.scala:92:{28,37}, :221:14, Nodes.scala:1215:84, package.scala:235:{46,71,76}
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// CacheCork.scala:108:16
      if (~reset
          & ~(~auto_in_c_valid | _bundleIn_0_c_ready_T | (&auto_in_c_bits_opcode))) begin	// CacheCork.scala:94:53, :105:53, :108:{16,17,61}
      ...
      if (~reset
          & ~((~auto_out_d_valid | ~earlyWinner_1_1)
              & (~(auto_out_d_valid | earlyWinner_1_1) | ~earlyWinner_1_2))) begin	// Arbiter.scala:98:79, :105:53, :106:{13,61,64,67,82}
        if (`ASSERT_VERBOSE_COND_)	// Arbiter.scala:106:13
          $error("Assertion failed\n    at Arbiter.scala:106 assert((prefixOR zip earlyWinner) map { case (p,w) => !p || !w } reduce {_ && _})\n");	// Arbiter.scala:106:13
        if (`STOP_COND_)	// Arbiter.scala:106:13
          $fatal;	// Arbiter.scala:106:13
      ...
      if (~reset
          & ~(~(_sink_ACancel_earlyValid_T_5 | _q_1_io_deq_valid) | auto_out_d_valid
              | earlyWinner_1_1 | earlyWinner_1_2)) begin	// Arbiter.scala:98:79, :108:{14,15,36,41}, Decoupled.scala:375:21
        if (`ASSERT_VERBOSE_COND_)	// Arbiter.scala:108:14
          $error("Assertion failed\n    at Arbiter.scala:108 assert (!earlyValids.reduce(_||_) || earlyWinner.reduce(_||_))\n");	// Arbiter.scala:108:14
        if (`STOP_COND_)	// Arbiter.scala:108:14
          $fatal;	// Arbiter.scala:108:14
  ...
  IDPool pool (	// CacheCork.scala:119:26
    ...
    .io_alloc_ready
      (auto_in_d_ready & bundleIn_0_d_valid & ~(|d_first_counter) & d_grant),	// CacheCork.scala:125:54, :126:53, :127:34, Edges.scala:229:27, :231:25
    .io_alloc_valid (_pool_io_alloc_valid),
    .io_alloc_bits  (_pool_io_alloc_bits)
  );
  Queue_2509 q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_2509 q_1 (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_in_d_bits_param =
    (muxStateEarly_1_0
       ? (_T_18
            ? {1'h0, ~((|d_first_counter) ? dWHeld_r : _GEN_0)}
            : auto_out_d_bits_param)
       : 2'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_param : 2'h0)
    | (muxStateEarly_1_2 ? _q_1_io_deq_bits_param : 2'h0);	// Arbiter.scala:118:30, CacheCork.scala:134:13, :143:25, :154:{51,76}, :156:{26,32}, Decoupled.scala:375:21, Edges.scala:229:27, :231:25, Mux.scala:27:73, Nodes.scala:1215:84, Reg.scala:19:16, package.scala:80:42
  ...
  assign auto_in_d_bits_source =
    ...
    | (muxStateEarly_1_2 ? _q_1_io_deq_bits_source : 3'h0);	// Arbiter.scala:118:30, CacheCork.scala:135:46, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_in_d_bits_sink =
    (|d_first_counter) ? bundleIn_0_d_bits_sink_r : _pool_io_alloc_bits;	// CacheCork.scala:119:26, Edges.scala:229:27, :231:25, Reg.scala:19:16, package.scala:80:42
  assign auto_in_d_bits_denied =
    muxStateEarly_1_0 & auto_out_d_bits_denied | muxStateEarly_1_1 & _q_io_deq_bits_denied
    | muxStateEarly_1_2 & _q_1_io_deq_bits_denied;	// Arbiter.scala:118:30, Decoupled.scala:375:21, Mux.scala:27:73
  assign auto_in_d_bits_data =
    (muxStateEarly_1_0 ? auto_out_d_bits_data : 64'h0)
    | (muxStateEarly_1_1 ? _q_io_deq_bits_data : 64'h0)
    | (muxStateEarly_1_2 ? _q_1_io_deq_bits_data : 64'h0);	// Arbiter.scala:118:30, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_in_d_bits_corrupt =
    muxStateEarly_1_0 & auto_out_d_bits_corrupt | muxStateEarly_1_1
    & _q_io_deq_bits_corrupt | muxStateEarly_1_2 & _q_1_io_deq_bits_corrupt;	// Arbiter.scala:118:30, Decoupled.scala:375:21, Mux.scala:27:73
  ...
  assign auto_out_a_bits_size =
    ...
    | (muxStateEarly_1 ? auto_in_a_bits_size : 3'h0);	// Arbiter.scala:118:30, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_out_a_bits_source =
    (muxStateEarly_0 ? {auto_in_c_bits_source, 1'h0} : 4'h0)
    | (muxStateEarly_1
         ? {auto_in_a_bits_source,
            _T_2 | auto_in_a_bits_opcode == 3'h0 | auto_in_a_bits_opcode == 3'h1}
         : 4'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, CacheCork.scala:68:{38,74}, :75:25, :78:{49,86}, :81:27, :96:41, :146:40, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_out_a_bits_address =
    (muxStateEarly_0 ? auto_in_c_bits_address : 32'h0)
    | (muxStateEarly_1 ? auto_in_a_bits_address : 32'h0);	// Arbiter.scala:118:30, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_out_a_bits_mask =
    (muxStateEarly_0
       ? {c_a_bits_a_mask_acc_5 | c_a_bits_a_mask_eq_5 & auto_in_c_bits_address[0],
          ...
          c_a_bits_a_mask_acc_2 | c_a_bits_a_mask_eq_2 & ~(auto_in_c_bits_address[0])}
       : 8'h0) | (muxStateEarly_1 ? auto_in_a_bits_mask : 8'h0);	// Arbiter.scala:118:30, Cat.scala:33:92, Misc.scala:209:26, :210:20, :213:27, :214:29, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_out_a_bits_data =
    (muxStateEarly_0 ? auto_in_c_bits_data : 64'h0)
    | (muxStateEarly_1 ? auto_in_a_bits_data : 64'h0);	// Arbiter.scala:118:30, Mux.scala:27:73, Nodes.scala:1215:84
  assign auto_out_a_bits_corrupt =
    muxStateEarly_0 & auto_in_c_bits_corrupt | muxStateEarly_1 & auto_in_a_bits_corrupt;	// Arbiter.scala:118:30, Mux.scala:27:73
