...
module RouteComputer_124(
  ...
  wire [2:0] _decoded_T_146 =
    {io_req_2_bits_flow_egress_node[2], _GEN[1], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_148 =
    {io_req_2_bits_flow_egress_node[2], _GEN[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_150 =
    {io_req_2_bits_flow_egress_node[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112, &_decoded_T_122, &_decoded_T_132, &_decoded_T_142};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_120, &_decoded_T_130, &_decoded_T_140, &_decoded_T_158};	// Cat.scala:33:92, pla.scala:98:74, :114:39
