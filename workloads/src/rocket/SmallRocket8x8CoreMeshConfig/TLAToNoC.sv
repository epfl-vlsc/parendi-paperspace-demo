...
module TLAToNoC(
  ...
  Queue_2297 q (	// Tilelink.scala:45:17
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id =
    {_q_io_deq_bits_address[31:30] == 2'h1,
     (_q_io_deq_bits_address[31:30] == 2'h0 ? 7'h7A : 7'h0)
       | (_q_io_deq_bits_address[31:30] == 2'h2 ? 7'h7D : 7'h0)};	// Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17
endmodule
