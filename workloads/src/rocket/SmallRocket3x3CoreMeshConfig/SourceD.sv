...
module SourceD(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_offset = {_RANDOM_0[31:27], _RANDOM_1[0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = _RANDOM_1[6:1];	// Reg.scala:19:16
        s1_req_reg_set = _RANDOM_1[13:7];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[16:14];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[19:17];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[20];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[21];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[22];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[23];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[24];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[25];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[26];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = _RANDOM_1[29:27];	// Reg.scala:19:16
        s2_bypass = _RANDOM_1[30];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_1[31];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_2[1];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[5:3];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[8:6];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[11:9];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[16:12];	// Reg.scala:19:16
        s2_req_put = {_RANDOM_2[31:27], _RANDOM_3[0]};	// Reg.scala:19:16
        s2_req_set = _RANDOM_3[7:1];	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[10:8];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[13:11];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[14];	// Reg.scala:19:16
        s2_last = _RANDOM_3[15];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[16];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[17];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[18];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[19];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:20], _RANDOM_4, _RANDOM_5[19:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = _RANDOM_5[27:20];	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_5[28];	// Reg.scala:19:16
        s3_full = _RANDOM_5[29];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_5[30];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_beat = {_RANDOM_5[31], _RANDOM_6[1:0]};	// Reg.scala:19:16
        s3_bypass = _RANDOM_6[2];	// Reg.scala:19:16
        s3_req_prio_0 = _RANDOM_6[3];	// Reg.scala:19:16
        s3_req_prio_2 = _RANDOM_6[5];	// Reg.scala:19:16
        s3_req_opcode = _RANDOM_6[9:7];	// Reg.scala:19:16
        s3_req_param = _RANDOM_6[12:10];	// Reg.scala:19:16
        s3_req_size = _RANDOM_6[15:13];	// Reg.scala:19:16
        s3_req_source = _RANDOM_6[20:16];	// Reg.scala:19:16
        s3_req_set = _RANDOM_7[11:5];	// Reg.scala:19:16
        ...
        s3_pdata_data = {_RANDOM_7[31:20], _RANDOM_8, _RANDOM_9[19:0]};	// Reg.scala:19:16
        s3_pdata_mask = _RANDOM_9[27:20];	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_9[28];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_9[29];	// Reg.scala:19:16
        s3_retires = _RANDOM_9[30];	// Reg.scala:19:16
        s3_need_r = _RANDOM_9[31];	// Reg.scala:19:16
        s4_full = _RANDOM_10[0];	// SourceD.scala:248:24
        s4_beat = _RANDOM_10[3:1];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_need_bs = _RANDOM_10[5];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_need_pb = _RANDOM_10[6];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_req_prio_2 = _RANDOM_10[9];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_req_param = _RANDOM_10[16:14];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_req_set = _RANDOM_11[15:9];	// Reg.scala:19:16
        s4_req_way = _RANDOM_11[21:19];	// Reg.scala:19:16
        s4_adjusted_opcode = _RANDOM_11[25:23];	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_11[31:26], _RANDOM_12, _RANDOM_13[25:0]};	// Reg.scala:19:16
        s4_pdata_mask = {_RANDOM_13[31:26], _RANDOM_14[1:0]};	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_14[2];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_14[31:3], _RANDOM_15, _RANDOM_16[2:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_17[11:5];	// Reg.scala:19:16
        s5_req_way = _RANDOM_17[17:15];	// Reg.scala:19:16
        s5_beat = _RANDOM_17[21:19];	// Reg.scala:19:16
        s5_dat = {_RANDOM_17[31:22], _RANDOM_18, _RANDOM_19[21:0]};	// Reg.scala:19:16
        s6_req_set = _RANDOM_20[30:24];	// Reg.scala:19:16
        s6_req_way = _RANDOM_21[4:2];	// Reg.scala:19:16
        s6_beat = _RANDOM_21[8:6];	// Reg.scala:19:16
        s6_dat = {_RANDOM_21[31:9], _RANDOM_22, _RANDOM_23[8:0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_23[31:9], _RANDOM_24, _RANDOM_25[8:0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_25[9];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_25[31:10], _RANDOM_26, _RANDOM_27[9:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_369 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
