...
module EgressUnit_20(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ({1'h0,
        io_in_0_bits_flow_ingress_node == 5'h2 & _q_io_enq_bits_ingress_id_T_16,
        1'h0,
        io_in_0_bits_flow_ingress_node == 5'h0 & _q_io_enq_bits_ingress_id_T_16,
        1'h0}
       | (io_in_0_bits_flow_ingress_node == 5'h4 & _q_io_enq_bits_ingress_id_T_16
            ? 5'hE
            : 5'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h5 & _q_io_enq_bits_ingress_id_T_16
            ? 5'h11
            : 5'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h3 & _q_io_enq_bits_ingress_id_T_16
            ? 5'hB
            : 5'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h1 & _q_io_enq_bits_ingress_id_T_16
            ? 5'h5
            : 5'h0)),	// EgressUnit.scala:21:17, :31:{39,75}, :32:27, Mux.scala:27:73
    .io_deq_ready           (1'h1),
