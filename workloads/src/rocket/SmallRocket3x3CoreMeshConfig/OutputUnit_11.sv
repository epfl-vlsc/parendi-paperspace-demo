...
module OutputUnit_11(
  ...
  wire       _GEN = ~(io_out_vc_free[4]) & states_4_occupied;	// OutputUnit.scala:66:19, :74:{25,30}, :76:18
  always @(posedge clock) begin
    if (reset) begin
      ...
      states_4_occupied <= io_allocs_4_alloc | _GEN;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_4_c <=
  ...
  assign io_channel_status_4_occupied = _GEN;	// OutputUnit.scala:66:19, :74:30, :76:18
