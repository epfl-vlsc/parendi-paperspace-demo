...
module RouteComputer_17(
  ...
  wire [3:0] _decoded_T_16 =
    {_GEN[0], _GEN[1], io_req_0_bits_src_virt_id[0], io_req_0_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_28 =
    {io_req_0_bits_flow_egress_node[0], _GEN[2], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{io_req_2_bits_src_virt_id[0],
      ...
      io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :114:39
  ...
  assign io_resp_0_vc_sel_1_1 =
    |{&_decoded_T_4,
      ...
      &_decoded_T_14,
      &_decoded_T_34,
      &_decoded_T_38};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_0_vc_sel_1_3 =
    |{&_decoded_T_4,
      ...
      &_decoded_T_22,
      &_decoded_T_32,
      &_decoded_T_36};	// Cat.scala:33:92, pla.scala:98:74, :114:39
