...
module IngressUnit_22(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 4'hA;	// IngressUnit.scala:30:72
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_3 =
    io_in_bits_egress_id == 4'h4;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_5 =
    io_in_bits_egress_id == 4'h6;	// IngressUnit.scala:30:72
    ...
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T
              ...
              | io_in_bits_egress_id == 4'h0
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_5)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_egress_node
      ({2'h0,
        (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 3'h5 : 3'h0)
          | {_route_buffer_io_enq_bits_flow_egress_node_id_T_2,
             _route_buffer_io_enq_bits_flow_egress_node_id_T_3
               | _route_buffer_io_enq_bits_flow_egress_node_id_T_5,
             _route_buffer_io_enq_bits_flow_egress_node_id_T_1
               | _route_buffer_io_enq_bits_flow_egress_node_id_T_5}}),	// IngressUnit.scala:30:72, :41:50, :51:44, Mux.scala:27:73
