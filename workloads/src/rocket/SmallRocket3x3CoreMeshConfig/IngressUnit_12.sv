...
module IngressUnit_12(
  ...
  wire [2:0]  _GEN =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 3'h6 : 3'h0)
    | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_2}};	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_id_T_1, _GEN} == 4'h4;	// IngressUnit.scala:30:72, :41:50, :55:59, Mux.scala:27:73
  wire        _T_13 =
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_egress_node
      ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_1, _GEN}),	// IngressUnit.scala:30:72, :41:50, Mux.scala:27:73
  ...
  Queue_6 route_q (	// IngressUnit.scala:27:23
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 5'h9),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 5'h8),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
