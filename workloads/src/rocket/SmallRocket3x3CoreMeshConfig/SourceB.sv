...
module SourceB(
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      remain <=
        ...
        & ~(io_b_ready & b_valid ? _GEN_1 : 6'h0);	// Decoupled.scala:51:35, SourceB.scala:46:25, :47:30, :48:30, :49:{23,37,39}, :53:37, :62:{24,37}, :68:21, :69:{19,32}
  ...
  assign io_b_bits_source =
    (_GEN_1[0] ? 5'h14 : 5'h0)
    | {_GEN_1[1], _GEN_1[2] | _GEN_1[3], _GEN_1[2] | _GEN_1[4], 2'h0};	// Cat.scala:33:92, Mux.scala:27:73, :29:36, SourceB.scala:53:37
  assign io_b_bits_address =
    {15'h0,
     (|remain) ? tag_r : io_req_bits_tag,
     (|remain) ? set_r : io_req_bits_set,
     6'h0};	// Cat.scala:33:92, Reg.scala:19:16, SourceB.scala:46:25, :51:23, :72:18, :73:18
endmodule
