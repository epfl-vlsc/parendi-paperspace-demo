...
module TLDToNoC(
  ...
  assign io_flit_bits_egress_id =
    {1'h0,
     {1'h0,
      {1'h0, _q_io_deq_bits_source[4:2] == 3'h5}
        | {2{_q_io_deq_bits_source[4:2] == 3'h4}}}
       | (_q_io_deq_bits_source[4:2] == 3'h3 ? 3'h5 : 3'h0)
       | {3{_q_io_deq_bits_source[4:2] == 3'h2}}}
    | (_q_io_deq_bits_source[4:2] == 3'h1 ? 4'h9 : 4'h0)
    | (_q_io_deq_bits_source[4:2] == 3'h0 ? 4'hB : 4'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
