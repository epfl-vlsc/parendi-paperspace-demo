...
module SwitchAllocator_9(
  ...
  SwitchArbiter_42 arbs_0 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_42 arbs_1 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_42 arbs_2 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_credit_alloc_0_0_alloc =
    _arbs_0_io_out_0_valid & _arbs_0_io_out_0_bits_vc_sel_0_0;	// SwitchAllocator.scala:83:45, :120:33
