...
module CSRFile(
  ...
  wire [2:0]  _GEN_11 =
    ((&{io_rw_addr[2],
        ...
        io_rw_addr[11]})
       ? io_hartid
       : 3'h0) | _io_rw_rdata_T_14[2:0]
    | ((&_decoded_decoded_T_8) ? reg_mcountinhibit : 3'h0) | _io_rw_rdata_T_111[2:0]
    | _io_rw_rdata_T_112[2:0] | _io_rw_rdata_T_113[2:0] | _io_rw_rdata_T_114[2:0]
    | _io_rw_rdata_T_115[2:0] | _io_rw_rdata_T_116[2:0] | _io_rw_rdata_T_117[2:0]
    | _io_rw_rdata_T_118[2:0];	// CSR.scala:551:34, :611:32, Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0,
       ...
       ((&{io_rw_addr[2],
          ...
          ? {4'h0, io_interrupts_meip, 8'h0}
          : 13'h0) | _io_rw_rdata_T_14[15:3] | _io_rw_rdata_T_111[15:3]
         | _io_rw_rdata_T_112[15:3] | _io_rw_rdata_T_113[15:3] | _io_rw_rdata_T_114[15:3]
         | _io_rw_rdata_T_115[15:3] | _io_rw_rdata_T_116[15:3] | _io_rw_rdata_T_117[15:3]
         | _io_rw_rdata_T_118[15:3],
       _GEN_11[2:1],
       _GEN_11[0]
         | (&{decoded_decoded_invInputs[0],
              io_rw_addr[1],
