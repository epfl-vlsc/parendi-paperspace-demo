...
module InputUnit_33(
  ...
  wire        _salloc_arb_io_in_4_valid_T_2 =
    states_4_g == 3'h3 & states_4_vc_sel_0_4 & io_out_credit_available_0_4
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2
      ...
      if (io_in_flit_0_bits_flow_egress_node == 5'hF)	// InputUnit.scala:209:57
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
    ...
    if (_GEN)	// InputUnit.scala:287:29
      ...
      states_4_vc_sel_0_4 <= ~_GEN_0 & states_4_vc_sel_0_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
    ...
    if (_vc_sel_WIRE_5)	// Mux.scala:27:73
      salloc_outs_0_out_vid <= {_vc_sel_WIRE_5, 2'h0};	// Bitwise.scala:51:90, Cat.scala:33:92, InputUnit.scala:336:8, Mux.scala:27:73
