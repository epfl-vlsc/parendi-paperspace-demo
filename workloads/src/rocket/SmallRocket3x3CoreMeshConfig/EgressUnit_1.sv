...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 5'h6 & _q_io_enq_bits_ingress_id_T_7
          ? 5'h13
          : 5'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h8 & _q_io_enq_bits_ingress_id_T_7
            ? 5'h15
            : 5'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h7 & _q_io_enq_bits_ingress_id_T_7
            ? 5'h17
