...
module TLAToNoC(
  ...
  assign io_flit_bits_egress_id =
    {1'h0,
     (_q_io_deq_bits_address[31:30] == 2'h0 ? 4'hC : 4'h0)
       | {4{_q_io_deq_bits_address[31:30] == 2'h2}}}
    | (_q_io_deq_bits_address[31:30] == 2'h1 ? 5'h12 : 5'h0);	// Edges.scala:92:28, Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17
endmodule
