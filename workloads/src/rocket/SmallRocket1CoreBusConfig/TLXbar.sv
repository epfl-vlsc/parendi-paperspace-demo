...
module TLXbar(
  ...
  wire        requestAIO_0_0 = auto_in_a_bits_address[31:30] == 2'h0;	// @[Parameters.scala:137:{45,65}]
  wire        requestAIO_0_1 = auto_in_a_bits_address[31:30] == 2'h2;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_2 = auto_in_a_bits_address[31:30] == 2'h1;	// @[Parameters.scala:137:{31,45,65}]
  ...
  wire        out_15_valid = idle ? _sink_ACancel_earlyValid_T | auto_out_2_d_valid : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2 & auto_out_2_d_valid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0)};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Edges.scala:106:36, :221:14, Xbar.scala:310:24, package.scala:235:{46,71,76}]
  ...
  `ifndef SYNTHESIS
    wire         _T_27 = auto_out_0_d_valid | auto_out_1_d_valid;	// @[Arbiter.scala:109:36]
    always @(posedge clock) begin	// @[Arbiter.scala:106:13]
      ...
      if (~reset & ~(~(_T_27 | auto_out_2_d_valid) | _T_27 | auto_out_2_d_valid)) begin	// @[Arbiter.scala:109:{14,15,36,41}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[11:9];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[12];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[13];	// @[Arbiter.scala:88:30, :117:26]
        state_2 = _RANDOM_0[14];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:310:24]
  ...
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0) | (muxStateEarly_2 ? {1'h0, auto_out_2_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Mux.scala:27:73, Xbar.scala:310:24]
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 2'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_sink = (muxStateEarly_0 ? {2'h0, auto_out_0_d_bits_sink} : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_sink : 3'h0) | (muxStateEarly_2 ? {2'h0, auto_out_2_d_bits_sink} : 3'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:310:24, :326:28]
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_2_a_bits_address = auto_in_a_bits_address[30:0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_0_a_bits_address = auto_in_a_bits_address[25:0];	// @[BundleMap.scala:247:19]
