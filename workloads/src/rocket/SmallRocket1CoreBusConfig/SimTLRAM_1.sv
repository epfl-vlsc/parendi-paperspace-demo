...
module SimTLRAM_1(
  ...
  wire [63:0] _mem_rdata;	// @[HarnessExtMem.scala:150:52]
  ...
  reg  [7:0]  r_source;	// @[HarnessExtMem.scala:618:26]
  reg         r_read;	// @[HarnessExtMem.scala:619:26]
  reg         r_atomic;	// @[HarnessExtMem.scala:620:26]
  reg         r_sublane;	// @[HarnessExtMem.scala:621:26]
  reg  [30:0] r_address;	// @[HarnessExtMem.scala:622:26]
  reg  [7:0]  r_mask;	// @[HarnessExtMem.scala:623:26]
  reg  [63:0] r_rmw_data;	// @[HarnessExtMem.scala:624:26]
  wire [63:0] d_corrected = {d_raw_data_7, d_raw_data_6, d_raw_data_5, d_raw_data_4, d_raw_data_3, d_raw_data_2, d_raw_data_1, d_raw_data_0};	// @[Cat.scala:33:92, HarnessExtMem.scala:611:26]
  ...
  wire        in_a_ready = ~(d_full & d_wb) & (~r_full | r_ready) & (~r_full | ~(r_atomic | r_sublane));	// @[HarnessExtMem.scala:598:30, :614:30, :620:26, :621:26, :709:23, :722:62, :723:{19,28,41,49,61,73,76,87}]
  ...
  assign r_raw_data_0 = REG ? _mem_rdata[7:0] : r_0;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_1 = REG ? _mem_rdata[15:8] : r_1;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_2 = REG ? _mem_rdata[23:16] : r_2;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_3 = REG ? _mem_rdata[31:24] : r_3;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_4 = REG ? _mem_rdata[39:32] : r_4;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_5 = REG ? _mem_rdata[47:40] : r_5;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_6 = REG ? _mem_rdata[55:48] : r_6;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  assign r_raw_data_7 = REG ? _mem_rdata[63:56] : r_7;	// @[HarnessExtMem.scala:150:52, :805:68, :807:47, Reg.scala:19:16, package.scala:80:42]
  ...
  always @(posedge clock) begin
    ...
    if (_T_18) begin	// @[HarnessExtMem.scala:735:18]
      ...
      if (REG) begin	// @[HarnessExtMem.scala:807:47]
        d_raw_data_0 <= _mem_rdata[7:0];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_1 <= _mem_rdata[15:8];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_2 <= _mem_rdata[23:16];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_3 <= _mem_rdata[31:24];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_4 <= _mem_rdata[39:32];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_5 <= _mem_rdata[47:40];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_6 <= _mem_rdata[55:48];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
        d_raw_data_7 <= _mem_rdata[63:56];	// @[HarnessExtMem.scala:150:52, :611:26, :805:68]
      end
    ...
    if (REG) begin	// @[HarnessExtMem.scala:807:47]
      r_0 <= _mem_rdata[7:0];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_1 <= _mem_rdata[15:8];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_2 <= _mem_rdata[23:16];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_3 <= _mem_rdata[31:24];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_4 <= _mem_rdata[39:32];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_5 <= _mem_rdata[47:40];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_6 <= _mem_rdata[55:48];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
      r_7 <= _mem_rdata[63:56];	// @[HarnessExtMem.scala:150:52, :805:68, Reg.scala:19:16]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_source = _RANDOM_0[17:10];	// @[HarnessExtMem.scala:598:30, :603:26]
        d_read = _RANDOM_0[18];	// @[HarnessExtMem.scala:598:30, :604:26]
        d_atomic = _RANDOM_0[19];	// @[HarnessExtMem.scala:598:30, :605:26]
        d_sublane = _RANDOM_0[20];	// @[HarnessExtMem.scala:598:30, :606:26]
        d_address = {_RANDOM_0[31:21], _RANDOM_1[19:0]};	// @[HarnessExtMem.scala:598:30, :607:26]
        d_mask = _RANDOM_1[27:20];	// @[HarnessExtMem.scala:607:26, :608:26]
        d_rmw_data = {_RANDOM_1[31:28], _RANDOM_2, _RANDOM_3[27:0]};	// @[HarnessExtMem.scala:607:26, :609:26]
        d_raw_data_0 = {_RANDOM_3[31:29], _RANDOM_4[4:0]};	// @[HarnessExtMem.scala:609:26, :611:26]
        d_raw_data_1 = _RANDOM_4[12:5];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_2 = _RANDOM_4[20:13];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_3 = _RANDOM_4[28:21];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_4 = {_RANDOM_4[31:29], _RANDOM_5[4:0]};	// @[HarnessExtMem.scala:611:26]
        d_raw_data_5 = _RANDOM_5[12:5];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_6 = _RANDOM_5[20:13];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_7 = _RANDOM_5[28:21];	// @[HarnessExtMem.scala:611:26]
        r_full = _RANDOM_5[29];	// @[HarnessExtMem.scala:611:26, :614:30]
        r_opcode = {_RANDOM_5[31:30], _RANDOM_6[0]};	// @[HarnessExtMem.scala:611:26, :615:26]
        r_param = _RANDOM_6[3:1];	// @[HarnessExtMem.scala:615:26, :616:26]
        r_size = _RANDOM_6[5:4];	// @[HarnessExtMem.scala:615:26, :617:26]
        r_source = _RANDOM_6[13:6];	// @[HarnessExtMem.scala:615:26, :618:26]
        r_read = _RANDOM_6[14];	// @[HarnessExtMem.scala:615:26, :619:26]
        r_atomic = _RANDOM_6[15];	// @[HarnessExtMem.scala:615:26, :620:26]
        r_sublane = _RANDOM_6[16];	// @[HarnessExtMem.scala:615:26, :621:26]
        r_address = {_RANDOM_6[31:17], _RANDOM_7[15:0]};	// @[HarnessExtMem.scala:615:26, :622:26]
        r_mask = _RANDOM_7[23:16];	// @[HarnessExtMem.scala:622:26, :623:26]
        r_rmw_data = {_RANDOM_7[31:24], _RANDOM_8, _RANDOM_9[23:0]};	// @[HarnessExtMem.scala:622:26, :624:26]
        REG = _RANDOM_9[26];	// @[HarnessExtMem.scala:624:26, :807:47]
        r_0 = {_RANDOM_9[31:27], _RANDOM_10[2:0]};	// @[HarnessExtMem.scala:624:26, Reg.scala:19:16]
        r_1 = _RANDOM_10[10:3];	// @[Reg.scala:19:16]
        r_2 = _RANDOM_10[18:11];	// @[Reg.scala:19:16]
        r_3 = _RANDOM_10[26:19];	// @[Reg.scala:19:16]
        r_4 = {_RANDOM_10[31:27], _RANDOM_11[2:0]};	// @[Reg.scala:19:16]
        r_5 = _RANDOM_11[10:3];	// @[Reg.scala:19:16]
        r_6 = _RANDOM_11[18:11];	// @[Reg.scala:19:16]
        r_7 = _RANDOM_11[26:19];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SimMMIOToHostSnooper #(
    .OFFSET(0),
    .LANES(8),
    .BITS(8),
    .SIZE(128)
  ) mem (	// @[HarnessExtMem.scala:150:52]
    .addr  (d_wb ? d_address[9:3] : auto_in_a_bits_address[9:3]),	// @[HarnessExtMem.scala:607:26, :709:23, :792:21]
    .wdata ({d_wb ? _d_updated_alu_io_data_out[63:56] : auto_in_a_bits_data[63:56], d_wb ? _d_updated_alu_io_data_out[55:48] : auto_in_a_bits_data[55:48], d_wb ? _d_updated_alu_io_data_out[47:40] : auto_in_a_bits_data[47:40], d_wb ? _d_updated_alu_io_data_out[39:32] : auto_in_a_bits_data[39:32], d_wb ? _d_updated_alu_io_data_out[31:24] : auto_in_a_bits_data[31:24], d_wb ? _d_updated_alu_io_data_out[23:16] : auto_in_a_bits_data[23:16], d_wb ? _d_updated_alu_io_data_out[15:8] : auto_in_a_bits_data[15:8], d_wb ? _d_updated_alu_io_data_out[7:0] : auto_in_a_bits_data[7:0]}),	// @[HarnessExtMem.scala:664:23, :709:23, :771:67, :773:62, :794:21, :810:29]
  ...
  Atomics_2 d_updated_alu (	// @[HarnessExtMem.scala:664:23]
  ...
  assign auto_in_d_bits_data = d_mux ? d_corrected : {r_raw_data_7, r_raw_data_6, r_raw_data_5, r_raw_data_4, r_raw_data_3, r_raw_data_2, r_raw_data_1, r_raw_data_0};	// @[Cat.scala:33:92, HarnessExtMem.scala:686:24, :695:29, package.scala:80:42]
endmodule
