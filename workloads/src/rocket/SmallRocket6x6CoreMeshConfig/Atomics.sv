...
module Atomics(
  ...
  assign io_data_out =
    {_GEN_9[io_a_mask[7] ? select : 2'h0],
     _GEN_10[io_a_mask[6] ? select : 2'h0],
     _GEN_7[io_a_mask[5] ? select : 2'h0],
     _GEN_8[io_a_mask[4] ? select : 2'h0],
     _GEN_5[io_a_mask[3] ? select : 2'h0],
     _GEN_6[io_a_mask[2] ? select : 2'h0],
     _GEN_3[io_a_mask[1] ? select : 2'h0],
     _GEN_4[io_a_mask[0] ? select : 2'h0]};	// Atomics.scala:47:{19,42}, :59:47, Bitwise.scala:28:17, Cat.scala:33:92
endmodule
