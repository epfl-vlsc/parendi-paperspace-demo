...
module TLCToNoC(
  ...
  wire        _q_io_deq_ready_T_2 =
    io_flit_ready & (is_body | ~(_q_io_deq_bits_opcode[0]));	// Edges.scala:102:36, Tilelink.scala:45:17, :59:24, :61:{35,47,50}
  ...
  wire        _io_flit_bits_tail_output =
    ...
    & (is_body | ~(_q_io_deq_bits_opcode[0]));	// Edges.scala:102:36, :221:14, :229:27, :232:{25,33,43}, Tilelink.scala:45:17, :59:24, :61:50, :64:{35,47}, package.scala:235:{46,71,76}
  ...
  Queue_1306 q (	// Tilelink.scala:45:17
    .clock               (clock),
    .reset               (reset),
