...
module TLBuffer_14(
  ...
  Queue_1440 x1_a_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1441 bundleIn_0_d_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1442 bundleIn_0_b_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1443 x1_c_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1429 x1_e_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
