...
module InputBuffer(
  ...
  wire [4:0]      to_q_oh_enc =
    can_to_q_0
      ? 5'h1
      : can_to_q_1 ? 5'h2 : can_to_q_2 ? 5'h4 : can_to_q_3 ? 5'h8 : {can_to_q_4, 4'h0};	// InputUnit.scala:86:32, :117:70, Mux.scala:47:70
  wire            _T_11 = can_to_q_0 | can_to_q_1 | can_to_q_2 | can_to_q_3 | can_to_q_4;	// InputUnit.scala:117:70, package.scala:73:59
  wire [3:0]      head =
    (to_q_oh_enc[0] ? heads_0 : 4'h0) | (to_q_oh_enc[1] ? heads_1 : 4'h0)
    | (to_q_oh_enc[2] ? heads_2 : 4'h0) | (to_q_oh_enc[3] ? heads_3 : 4'h0)
    | (to_q_oh_enc[4] ? heads_4 : 4'h0);	// InputUnit.scala:86:{24,32}, Mux.scala:27:73, :47:70, OneHot.scala:82:30
  ...
  wire            _tails_T_14 =
    mem_MPORT_addr == ({1'h0, {1'h0, {2{_tails_T_16}}} | {3{_tails_T_17}}}
                       | (_tails_T_18 ? 4'hB : 4'h0) | {4{_tails_T_19}});	// InputUnit.scala:86:32, :104:14, Mux.scala:27:73, :29:36
  wire [3:0]      _tails_WIRE_2 =
    {_tails_T_18, _tails_T_17, 2'h0} | (_tails_T_19 ? 4'hC : 4'h0);	// InputUnit.scala:86:32, Mux.scala:27:73, :29:36
  ...
  wire            _heads_T_9 =
    head == ({1'h0, {1'h0, {2{to_q_oh_enc[1]}}} | {3{to_q_oh_enc[2]}}}
             | (to_q_oh_enc[3] ? 4'hB : 4'h0) | {4{to_q_oh_enc[4]}});	// InputUnit.scala:86:32, :123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30
  wire [3:0]      _heads_WIRE_2 =
    {to_q_oh_enc[3:2], 2'h0} | (to_q_oh_enc[4] ? 4'hC : 4'h0);	// InputUnit.scala:86:32, Mux.scala:27:73, :47:70, OneHot.scala:82:30
  ...
  Queue qs_4 (	// InputUnit.scala:90:49
    ...
    .reset               (reset),
    .io_enq_valid
      (_GEN_4 | ~mem_MPORT_en & _T_2 & io_enq_0_bits_virt_channel_id == 3'h4),	// InputUnit.scala:91:31, :100:{27,44}, :107:{34,50}, :109:46, :120:27, :127:29, :128:32, Mux.scala:27:73
