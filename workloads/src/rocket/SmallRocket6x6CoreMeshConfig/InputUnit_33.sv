...
module InputUnit_33(
  ...
  wire [9:0]  _vcalloc_filter_T_20 =
    vcalloc_vals_4 & ~(mask[4]) ? 10'h10 : {vcalloc_vals_4, 9'h0};	// InputUnit.scala:250:21, :253:{87,89}, :266:32, Mux.scala:47:70
  ...
  wire        _T_31 = io_vcalloc_req_ready & vcalloc_vals_4;	// Decoupled.scala:51:35, InputUnit.scala:266:32
  wire        _GEN = _T_31 & vcalloc_sel[4];	// Decoupled.scala:51:35, InputUnit.scala:254:58, :287:29, Mux.scala:29:36
  wire        _salloc_arb_io_in_4_valid_T_2 =
    states_4_g == 3'h3
    & (|({states_4_vc_sel_3_0, states_4_vc_sel_2_0, states_4_vc_sel_1_0}
         & {io_out_credit_available_3_0,
            io_out_credit_available_2_0,
            io_out_credit_available_1_0})) & _input_buffer_io_deq_4_valid;	// InputUnit.scala:181:28, :192:19, :210:20, :304:{40,47,73,81}, :305:{22,50}
  ...
  wire        _T_59 = io_salloc_req_0_ready & _salloc_arb_io_out_0_valid;	// Decoupled.scala:51:35, InputUnit.scala:296:26
  wire        _GEN_0 =
  ...
  wire        _GEN_1 = io_in_flit_0_bits_virt_channel_id == 3'h4;	// InputUnit.scala:210:20
  wire        _GEN_2 = _T & _GEN_1;	// InputUnit.scala:192:19, :205:{32,60}, :210:20
  always @(posedge clock) begin
    ...
    else if (_T_31 & vcalloc_sel[4] | vcalloc_vals_4 & vcalloc_sel[4]
    ...
    else if (_GEN_2) begin	// InputUnit.scala:192:19, :205:60, :210:20
      if (io_in_flit_0_bits_flow_egress_node == 7'h21)	// InputUnit.scala:209:57
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
    ...
    if (_GEN) begin	// InputUnit.scala:287:29
      ...
      states_4_vc_sel_3_0 <=
        ~_GEN_0
        & (_T
             ? io_in_flit_0_bits_flow_egress_node_id == 2'h2 & _GEN_1 | ~_GEN_1
               & states_4_vc_sel_3_0
             : states_4_vc_sel_3_0);	// InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26
      states_4_vc_sel_2_0 <=
        ~_GEN_0
        & (_T
             ? io_in_flit_0_bits_flow_egress_node_id == 2'h1 & _GEN_1 | ~_GEN_1
               & states_4_vc_sel_2_0
             : states_4_vc_sel_2_0);	// InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26
      states_4_vc_sel_1_0 <=
        ~_GEN_0
        & (_T
             ? io_in_flit_0_bits_flow_egress_node_id == 2'h0 & _GEN_1 | ~_GEN_1
               & states_4_vc_sel_1_0
             : states_4_vc_sel_1_0);	// Bitwise.scala:51:90, InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26
    end
    if (_GEN_2) begin	// InputUnit.scala:192:19, :205:60, :210:20
    ...
    salloc_outs_0_valid <= _T_59;	// Decoupled.scala:51:35, InputUnit.scala:336:8
    ...
    if (_salloc_arb_io_chosen_oh_0[4]) begin	// InputUnit.scala:296:26, Mux.scala:29:36
      ...
      salloc_outs_0_flit_flow_ingress_node <= 7'h0;	// InputUnit.scala:235:14, :336:8
      salloc_outs_0_flit_flow_ingress_node_id <= 2'h0;	// Bitwise.scala:51:90, InputUnit.scala:336:8
      salloc_outs_0_flit_flow_egress_node <= 7'h0;	// InputUnit.scala:235:14, :336:8
  ...
  `ifndef SYNTHESIS
    wire  [2:0][2:0] _GEN_3 = '{3'h0, 3'h0, 3'h0};	// InputUnit.scala:208:27
    wire  [7:0][2:0] _GEN_4 = {_GEN_3, {{states_4_g}, {3'h0}, {3'h0}, {3'h0}, {3'h0}}};	// InputUnit.scala:192:19, :208:27
    always @(posedge clock) begin	// InputUnit.scala:207:13
      ...
      if (_T & ~reset & (|_GEN_4[io_in_flit_0_bits_virt_channel_id])) begin	// InputUnit.scala:205:32, :208:{13,27}
      ...
      if (_route_arbiter_io_out_valid & ~reset
          & _GEN_4[_route_arbiter_io_out_bits_src_virt_id] != 3'h1) begin	// InputUnit.scala:187:29, :208:27, :210:26, :241:{11,25}
      ...
      if (_T_31 & vcalloc_sel[0] & ~reset) begin	// Decoupled.scala:51:35, InputUnit.scala:254:58, :291:17, Mux.scala:29:36
      ...
      if (_T_31 & vcalloc_sel[1] & ~reset) begin	// Decoupled.scala:51:35, InputUnit.scala:254:58, :291:17, Mux.scala:29:36
        if (`ASSERT_VERBOSE_COND_)	// InputUnit.scala:291:17
          $error("Assertion failed\n    at InputUnit.scala:291 assert(states(i).g === g_v)\n");	// InputUnit.scala:291:17
        if (`STOP_COND_)	// InputUnit.scala:291:17
          $fatal;	// InputUnit.scala:291:17
      end
      if (_T_31 & vcalloc_sel[2] & ~reset) begin	// Decoupled.scala:51:35, InputUnit.scala:254:58, :291:17, Mux.scala:29:36
        if (`ASSERT_VERBOSE_COND_)	// InputUnit.scala:291:17
          $error("Assertion failed\n    at InputUnit.scala:291 assert(states(i).g === g_v)\n");	// InputUnit.scala:291:17
        if (`STOP_COND_)	// InputUnit.scala:291:17
          $fatal;	// InputUnit.scala:291:17
      end
      if (_T_31 & vcalloc_sel[3] & ~reset) begin	// Decoupled.scala:51:35, InputUnit.scala:254:58, :291:17, Mux.scala:29:36
        if (`ASSERT_VERBOSE_COND_)	// InputUnit.scala:291:17
          $error("Assertion failed\n    at InputUnit.scala:291 assert(states(i).g === g_v)\n");	// InputUnit.scala:291:17
        if (`STOP_COND_)	// InputUnit.scala:291:17
          $fatal;	// InputUnit.scala:291:17
  ...
  InputBuffer_33 input_buffer (	// InputUnit.scala:181:28
    .clock                         (clock),
    .reset                         (reset),
  ...
  Arbiter route_arbiter (	// InputUnit.scala:187:29
    ...
    .io_in_1_bits_flow_ingress_node    (7'h0),	// InputUnit.scala:235:14
    .io_in_1_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_1_bits_flow_egress_node     (7'h0),	// InputUnit.scala:235:14
    ...
    .io_in_2_bits_flow_ingress_node    (7'h0),	// InputUnit.scala:235:14
    .io_in_2_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_2_bits_flow_egress_node     (7'h0),	// InputUnit.scala:235:14
    ...
    .io_in_3_bits_flow_ingress_node    (7'h0),	// InputUnit.scala:235:14
    .io_in_3_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_3_bits_flow_egress_node     (7'h0),	// InputUnit.scala:235:14
  ...
  assign io_vcalloc_req_bits_vc_sel_3_0 = vcalloc_sel[4] & states_4_vc_sel_3_0;	// InputUnit.scala:192:19, :254:58, Mux.scala:27:73, :29:36
  assign io_vcalloc_req_bits_vc_sel_2_0 = vcalloc_sel[4] & states_4_vc_sel_2_0;	// InputUnit.scala:192:19, :254:58, Mux.scala:27:73, :29:36
  assign io_vcalloc_req_bits_vc_sel_1_0 = vcalloc_sel[4] & states_4_vc_sel_1_0;	// InputUnit.scala:192:19, :254:58, Mux.scala:27:73, :29:36
  ...
  assign io_debug_sa_stall =
    {2'h0, _salloc_arb_io_in_4_valid_T_2 & ~_salloc_arb_io_in_4_ready};	// Bitwise.scala:51:90, InputUnit.scala:296:26, :305:50, :319:{67,70}
  assign io_in_credit_return = _T_59 ? _salloc_arb_io_chosen_oh_0 : 5'h0;	// Decoupled.scala:51:35, InputUnit.scala:250:21, :296:26, :340:8
