...
module IngressUnit_100(
  ...
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_59 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_59 ? 5'h11 : 5'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_62 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_62 ? 4'hA : 4'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_T_65 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_65 ? 5'h13 : 5'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _GEN =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_36 ? 4'hB : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_38 ? 4'h9 : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_39 ? 4'hC : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_40 ? 4'hD : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_46 ? 4'hE : 4'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [1:0]  _GEN_0 =
    _GEN[3:2] | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_51}};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [4:0]  _GEN_1 =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_34 ? 5'h14 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_35 ? 5'h1D : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_37 ? 5'h12 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_41 ? 5'h16 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_42 ? 5'h1A : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_43 ? 5'h1C : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_44 ? 5'h18 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_45 ? 5'h17 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_47 ? 5'h15 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_50 ? 5'h1E : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_52 ? 5'h19 : 5'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_55,
       _GEN_0[1],
       _GEN_0[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_53,
       _GEN[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_49
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_51
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_54,
       _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_48
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_51
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_54}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_57 ? 5'h1B : 5'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [1:0]  _GEN_2 =
    _GEN_1[4:3] | _route_buffer_io_enq_bits_flow_egress_node_T_59[4:3]
    | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_60}};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        _GEN_3 = _GEN_2[1] | _route_buffer_io_enq_bits_flow_egress_node_T_65[4];	// Mux.scala:27:73
  wire        _GEN_4 =
    _GEN_2[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_61
    | _route_buffer_io_enq_bits_flow_egress_node_T_62[3];	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [2:0]  _GEN_5 =
    _GEN_1[2:0] | (_route_buffer_io_enq_bits_flow_egress_node_id_T_58 ? 3'h5 : 3'h0)
    | _route_buffer_io_enq_bits_flow_egress_node_T_59[2:0]
    | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_60}}
    | _route_buffer_io_enq_bits_flow_egress_node_T_62[2:0]
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_63 ? 3'h6 : 3'h0)
    | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_64}}
    | _route_buffer_io_enq_bits_flow_egress_node_T_65[2:0];	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire        at_dest =
    {_route_buffer_io_enq_bits_flow_egress_node_id_T_56, _GEN_3, _GEN_4, _GEN_5} == 6'h21;	// IngressUnit.scala:30:72, :41:50, :55:59, Mux.scala:27:73
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (7'h21),
    ...
    .io_enq_bits_flow_egress_node
      ({1'h0,
        ...
        _GEN_3,
        _GEN_4,
        _GEN_5}),	// IngressUnit.scala:30:72, :41:50, Mux.scala:27:73
  ...
  Queue_633 route_q (	// IngressUnit.scala:27:23
    ...
    .io_enq_bits_vc_sel_3_0 (_T_73 & io_in_bits_egress_id == 7'h44),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_2_0 (_T_73 & io_in_bits_egress_id == 7'h43),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_73 & io_in_bits_egress_id == 7'h42),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
