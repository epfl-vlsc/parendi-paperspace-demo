...
module IngressUnit_96(
  ...
  wire [5:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 6'h21 : 6'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 6'h23 : 6'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 6'h22 : 6'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest =
    {_route_buffer_io_enq_bits_flow_egress_node_WIRE[5],
     _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 3'h4;	// IngressUnit.scala:41:50, :55:59, Mux.scala:27:73
  wire        _T_13 =
    _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// IngressUnit.scala:26:28, :55:59, :64:41
  wire        _GEN =
    _T_13 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26
  ...
  wire [6:0]  _c_T_2 =
    ...
    & {io_out_credit_available_2_0,
       ...
       io_out_credit_available_0_2,
       io_out_credit_available_0_1,
       io_out_credit_available_0_0};	// IngressUnit.scala:76:25, :107:{41,48,74}
    ...
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T
              ...
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_2)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
