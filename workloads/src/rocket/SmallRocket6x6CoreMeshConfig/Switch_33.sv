...
module Switch_33(
  ...
  `ifndef SYNTHESIS	// Switch.scala:47:13
    wire [1:0] _T_6 =
      {1'h0, io_sel_0_0_0_0} + {1'h0, io_sel_0_0_1_0} + {1'h0, io_sel_0_0_2_0};	// Bitwise.scala:51:90, Switch.scala:47:13
    wire [1:0] _T_17 =
      {1'h0, io_sel_1_0_0_0} + {1'h0, io_sel_1_0_1_0} + {1'h0, io_sel_1_0_2_0};	// Bitwise.scala:51:90, Switch.scala:47:13
    wire [1:0] _T_28 =
      {1'h0, io_sel_2_0_0_0} + {1'h0, io_sel_2_0_1_0} + {1'h0, io_sel_2_0_2_0};	// Bitwise.scala:51:90, Switch.scala:47:13
    wire [1:0] _T_39 =
      {1'h0, io_sel_3_0_0_0} + {1'h0, io_sel_3_0_1_0} + {1'h0, io_sel_3_0_2_0};	// Bitwise.scala:51:90, Switch.scala:47:13
  ...
  assign io_out_3_0_valid =
    (io_sel_3_0_0_0 & io_in_0_0_valid | io_sel_3_0_1_0 & io_in_1_0_valid | io_sel_3_0_2_0
     & io_in_2_0_valid) & (|{io_sel_3_0_2_0, io_sel_3_0_1_0, io_sel_3_0_0_0});	// Mux.scala:27:73, Switch.scala:46:35, :48:{67,79}
  assign io_out_3_0_bits_head =
    io_sel_3_0_0_0 & io_in_0_0_bits_flit_head | io_sel_3_0_1_0 & io_in_1_0_bits_flit_head
    | io_sel_3_0_2_0 & io_in_2_0_bits_flit_head;	// Mux.scala:27:73
  assign io_out_3_0_bits_tail =
    io_sel_3_0_0_0 & io_in_0_0_bits_flit_tail | io_sel_3_0_1_0 & io_in_1_0_bits_flit_tail
    | io_sel_3_0_2_0 & io_in_2_0_bits_flit_tail;	// Mux.scala:27:73
  assign io_out_3_0_bits_payload =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_payload : 73'h0);	// Mux.scala:27:73
  assign io_out_3_0_bits_flow_vnet_id =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_flow_vnet_id : 3'h0);	// Mux.scala:27:73
  assign io_out_3_0_bits_flow_ingress_node =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_3_0_bits_flow_ingress_node_id =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node_id : 2'h0);	// Mux.scala:27:73
  assign io_out_3_0_bits_flow_egress_node =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_3_0_bits_flow_egress_node_id =
    ...
    | (io_sel_3_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node_id : 2'h0);	// Mux.scala:27:73
  ...
  assign io_out_2_0_bits_payload =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_payload : 73'h0);	// Mux.scala:27:73
  assign io_out_2_0_bits_flow_vnet_id =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_vnet_id : 3'h0);	// Mux.scala:27:73
  assign io_out_2_0_bits_flow_ingress_node =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_2_0_bits_flow_ingress_node_id =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node_id : 2'h0);	// Mux.scala:27:73
  assign io_out_2_0_bits_flow_egress_node =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_2_0_bits_flow_egress_node_id =
    ...
    | (io_sel_2_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node_id : 2'h0);	// Mux.scala:27:73
  ...
  assign io_out_1_0_bits_payload =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_payload : 73'h0);	// Mux.scala:27:73
  assign io_out_1_0_bits_flow_vnet_id =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_flow_vnet_id : 3'h0);	// Mux.scala:27:73
  assign io_out_1_0_bits_flow_ingress_node =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_1_0_bits_flow_ingress_node_id =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node_id : 2'h0);	// Mux.scala:27:73
  assign io_out_1_0_bits_flow_egress_node =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_1_0_bits_flow_egress_node_id =
    ...
    | (io_sel_1_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node_id : 2'h0);	// Mux.scala:27:73
  ...
  assign io_out_0_0_bits_payload =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_payload : 73'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_flow_vnet_id =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_vnet_id : 3'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_flow_ingress_node =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_flow_ingress_node_id =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_ingress_node_id : 2'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_flow_egress_node =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node : 7'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_flow_egress_node_id =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_flit_flow_egress_node_id : 2'h0);	// Mux.scala:27:73
  assign io_out_0_0_bits_virt_channel_id =
    ...
    | (io_sel_0_0_2_0 ? io_in_2_0_bits_out_virt_channel : 3'h0);	// Mux.scala:27:73
endmodule
