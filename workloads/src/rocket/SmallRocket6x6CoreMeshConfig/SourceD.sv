...
module SourceD(
  ...
  input  [6:0]  io_evict_req_set,
  input  [2:0]  io_evict_req_way,
  input  [6:0]  io_grant_req_set,
  ...
  reg  [7:0]      s1_req_reg_source;	// Reg.scala:19:16
  reg  [5:0]      s1_req_reg_offset;	// Reg.scala:19:16
  reg  [5:0]      s1_req_reg_put;	// Reg.scala:19:16
  reg  [6:0]      s1_req_reg_set;	// Reg.scala:19:16
  ...
  wire [6:0]      s1_req_set = busy ? s1_req_reg_set : io_req_bits_set;	// Reg.scala:19:16, SourceD.scala:84:21, :88:19
  ...
  wire            s1_grant =
    ...
    | (&s1_req_opcode);	// Reg.scala:19:16, SourceD.scala:84:21, :88:19, :93:{33,50,66,76,93}, :282:84
  wire            s1_need_r =
    ~s1_bypass & s1_req_prio_0 & s1_req_opcode != 3'h5 & ~s1_grant
    & ((|s1_req_opcode) | s1_req_size < 3'h3);	// SourceD.scala:88:19, :91:22, :92:78, :93:76, :94:{66,78,88}, :95:{34,50,65}
  wire            _io_bs_radr_valid_output = _s1_valid_T & s1_need_r & ~s1_block_r;	// SourceD.scala:85:27, :90:40, :94:88, :96:{56,59}
  wire [2:0]      s1_beat =
    (busy ? s1_req_reg_offset[5:3] : io_req_bits_offset[5:3]) | s1_counter;	// Reg.scala:19:16, SourceD.scala:84:21, :86:27, :88:19, :102:56
  ...
  reg  [7:0]      s2_req_source;	// Reg.scala:19:16
  ...
  reg  [7:0]      s3_req_source;	// Reg.scala:19:16
  ...
  wire [7:0][2:0] _GEN =
    {{3'h4},
     ...
     {3'h1},
     {3'h0},
     {3'h0}};	// Reg.scala:19:16, SourceD.scala:86:27, :195:31, :214:{18,32}, :222:24, :281:84, :282:84
  ...
  reg  [6:0]      s4_req_set;	// Reg.scala:19:16
  ...
  assign s3_bypass_data =
    s3_bypass_data_REG ? _atomics_io_data_out : s3_bypass_data_REG_1;	// SourceD.scala:210:75, :258:23, :337:{19,66}
  assign s1_x_bypass =
    ...
    & s4_req_way == s1_req_way & s4_beat == s1_beat & s4_full;	// Reg.scala:19:16, SourceD.scala:88:19, :102:56, :147:24, :190:24, :248:24, :344:{32,61,87,110}, :345:{32,61,87,110}, :346:{32,61,87,99}, :360:44
  wire            s1_single =
    s1_req_prio_0 ? s1_req_opcode == 3'h5 | s1_grant : _s1_single_T_2;	// SourceD.scala:88:19, :93:{33,76}, :94:66, :98:{22,53,62}
  ...
  wire            s2_latch =
    _s1_valid_T & (~_io_bs_radr_valid_output | io_bs_radr_ready) & s2_ready;	// SourceD.scala:90:40, :96:56, :129:18, :141:{42,54}, :184:24
  ...
  wire [6:0]      pre_s3_req_set = s3_latch ? s2_req_set : s3_req_set;	// Reg.scala:19:16, SourceD.scala:177:18, :315:24
  ...
  always @(posedge clock) begin
    ...
    if (s2_latch) begin	// SourceD.scala:129:18
      ...
      s2_need_d <=
        ~(s1_req_prio_0 ? ~(s1_req_opcode[2]) : s1_req_opcode[0]) | s1_counter == 3'h0;	// Reg.scala:19:16, SourceD.scala:86:27, :88:19, :97:{23,40,54,72}, :104:29, :156:{29,41}
    end
    ...
    s3_bypass_data_REG <=
      ...
      & (s4_latch | ~(io_bs_wadr_ready | ~s4_need_bs) & s4_full);	// Reg.scala:19:16, SourceD.scala:247:41, :248:24, :290:29, :315:24, :316:24, :319:24, :320:24, :326:{30,34,53,69}, :328:{40,77,111,127}, :337:19
    if ((retire ? s4_req_set : s5_req_set) == pre_s3_req_set
        & (retire ? s4_req_way : s5_req_way) == pre_s3_req_way
        & (retire ? s4_beat : s5_beat) == pre_s3_beat) begin	// Reg.scala:19:16, SourceD.scala:300:24, :315:24, :317:24, :319:24, :321:24, :329:{40,77,96,111}
      if (retire)	// SourceD.scala:300:24
        ...
        s3_bypass_data_REG_1 <= s5_dat;	// Reg.scala:19:16, SourceD.scala:337:66
             ...
             & (retire ? s5_beat : s6_beat) == pre_s3_beat) begin	// Reg.scala:19:16, SourceD.scala:300:24, :315:24, :318:24, :319:24, :322:24, :330:{40,77,96,111}
      if (retire)	// SourceD.scala:300:24
        s3_bypass_data_REG_1 <= s5_dat;	// Reg.scala:19:16, SourceD.scala:337:66
      else	// SourceD.scala:300:24
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[25:18];	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_offset = {_RANDOM_0[31:30], _RANDOM_1[3:0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = _RANDOM_1[9:4];	// Reg.scala:19:16
        s1_req_reg_set = _RANDOM_1[16:10];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[19:17];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[22:20];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[23];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[24];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[25];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[26];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[27];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[28];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[29];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = {_RANDOM_1[31:30], _RANDOM_2[0]};	// Reg.scala:19:16
        s2_bypass = _RANDOM_2[1];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_2[2];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_2[4];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[8:6];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[11:9];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[14:12];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[22:15];	// Reg.scala:19:16
        s2_req_put = _RANDOM_3[6:1];	// Reg.scala:19:16
        s2_req_set = _RANDOM_3[13:7];	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[16:14];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[19:17];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[20];	// Reg.scala:19:16
        s2_last = _RANDOM_3[21];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[22];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[23];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[24];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[25];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:26], _RANDOM_4, _RANDOM_5[25:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = {_RANDOM_5[31:26], _RANDOM_6[1:0]};	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_6[2];	// Reg.scala:19:16
        s3_full = _RANDOM_6[3];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_6[4];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_beat = _RANDOM_6[7:5];	// Reg.scala:19:16
        s3_bypass = _RANDOM_6[8];	// Reg.scala:19:16
        s3_req_prio_0 = _RANDOM_6[9];	// Reg.scala:19:16
        s3_req_prio_2 = _RANDOM_6[11];	// Reg.scala:19:16
        s3_req_opcode = _RANDOM_6[15:13];	// Reg.scala:19:16
        s3_req_param = _RANDOM_6[18:16];	// Reg.scala:19:16
        s3_req_size = _RANDOM_6[21:19];	// Reg.scala:19:16
        s3_req_source = _RANDOM_6[29:22];	// Reg.scala:19:16
        s3_req_set = _RANDOM_7[20:14];	// Reg.scala:19:16
        s3_req_sink = _RANDOM_7[23:21];	// Reg.scala:19:16
        s3_req_way = _RANDOM_7[26:24];	// Reg.scala:19:16
        s3_req_bad = _RANDOM_7[27];	// Reg.scala:19:16
        s3_pdata_data = {_RANDOM_7[31:29], _RANDOM_8, _RANDOM_9[28:0]};	// Reg.scala:19:16
        s3_pdata_mask = {_RANDOM_9[31:29], _RANDOM_10[4:0]};	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_10[5];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_10[6];	// Reg.scala:19:16
        s3_retires = _RANDOM_10[7];	// Reg.scala:19:16
        s3_need_r = _RANDOM_10[8];	// Reg.scala:19:16
        s4_full = _RANDOM_10[9];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_beat = _RANDOM_10[12:10];	// Reg.scala:19:16
        s4_need_bs = _RANDOM_10[14];	// Reg.scala:19:16
        s4_need_pb = _RANDOM_10[15];	// Reg.scala:19:16
        s4_req_prio_2 = _RANDOM_10[18];	// Reg.scala:19:16
        s4_req_param = _RANDOM_10[25:23];	// Reg.scala:19:16
        s4_req_set = _RANDOM_11[27:21];	// Reg.scala:19:16
        s4_req_way = {_RANDOM_11[31], _RANDOM_12[1:0]};	// Reg.scala:19:16
        s4_adjusted_opcode = _RANDOM_12[5:3];	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_12[31:6], _RANDOM_13, _RANDOM_14[5:0]};	// Reg.scala:19:16
        s4_pdata_mask = _RANDOM_14[13:6];	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_14[14];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_14[31:15], _RANDOM_15, _RANDOM_16[14:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_17[26:20];	// Reg.scala:19:16
        s5_req_way = {_RANDOM_17[31:30], _RANDOM_18[0]};	// Reg.scala:19:16
        s5_beat = _RANDOM_18[4:2];	// Reg.scala:19:16
        s5_dat = {_RANDOM_18[31:5], _RANDOM_19, _RANDOM_20[4:0]};	// Reg.scala:19:16
        s6_req_set = _RANDOM_21[16:10];	// Reg.scala:19:16
        s6_req_way = _RANDOM_21[22:20];	// Reg.scala:19:16
        s6_beat = _RANDOM_21[26:24];	// Reg.scala:19:16
        s6_dat = {_RANDOM_21[31:27], _RANDOM_22, _RANDOM_23[26:0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_23[31:27], _RANDOM_24, _RANDOM_25[26:0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_25[27];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_25[31:28], _RANDOM_26, _RANDOM_27[27:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_1428 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_d_bits_param =
    s3_req_prio_0 & (s3_req_opcode == 3'h6 | (&s3_req_opcode))
      ...
      : 2'h0;	// Reg.scala:19:16, SourceD.scala:84:21, :86:27, :93:33, :202:{30,47,64}, :223:{24,40,54,68}
  ...
  assign io_evict_safe =
    ...
    & (~s4_full | io_evict_req_way != s4_req_way | io_evict_req_set != s4_req_set);	// Reg.scala:19:16, SourceD.scala:84:21, :87:43, :147:24, :184:15, :190:24, :232:11, :248:24, :293:30, :376:{35,54,74}, :377:{35,54,74}, :378:{35,54,74,90}, :379:{35,54,74}
  assign io_grant_safe =
    ...
    & (~s4_full | io_grant_req_way != s4_req_way | io_grant_req_set != s4_req_set);	// Reg.scala:19:16, SourceD.scala:84:21, :87:43, :147:24, :184:15, :190:24, :232:11, :248:24, :293:30, :383:{35,54,74}, :384:{35,54,74}, :385:{35,54,74,90}, :386:{35,54,74}
endmodule
