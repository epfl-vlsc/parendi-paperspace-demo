...
module RouteComputer_68(
  ...
  wire [3:0] _decoded_T_188 =
    {io_req_2_bits_flow_egress_node[1], _GEN[1], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_214 =
    {_GEN[0], _GEN[1], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_216 =
    {_GEN[0], _GEN[2], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [1:0] _decoded_T_228 =
    {io_req_2_bits_flow_egress_node[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_202,
      &_decoded_T_204,
      &_decoded_T_216};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_134, &_decoded_T_158, &_decoded_T_182, &_decoded_T_228};	// Cat.scala:33:92, pla.scala:98:74, :114:39
