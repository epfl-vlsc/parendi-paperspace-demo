...
module OutputUnit(
  ...
  output [6:0]  io_out_flit_0_bits_flow_ingress_node,
  output [1:0]  io_out_flit_0_bits_flow_ingress_node_id,
  output [6:0]  io_out_flit_0_bits_flow_egress_node,
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_3_occupied = _RANDOM_0[25];	// OutputUnit.scala:66:19
        states_3_c = _RANDOM_0[28:26];	// OutputUnit.scala:66:19
        states_2_occupied = _RANDOM_1[18];	// OutputUnit.scala:66:19
        states_2_c = _RANDOM_1[21:19];	// OutputUnit.scala:66:19
        states_1_occupied = _RANDOM_2[11];	// OutputUnit.scala:66:19
        states_1_c = _RANDOM_2[14:12];	// OutputUnit.scala:66:19
        states_0_occupied = _RANDOM_3[4];	// OutputUnit.scala:66:19
        states_0_c = _RANDOM_3[7:5];	// OutputUnit.scala:66:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
