...
module InputBuffer_168(
  ...
  wire [7:0][4:0] _GEN = {{tails_0}, {tails_0}, {tails_0}, {tails_4}, {tails_3}, {tails_2}, {tails_1}, {tails_0}};	// @[InputUnit.scala:87:24]
  ...
  wire [4:0]      to_q_oh_enc = can_to_q_0 ? 5'h1 : can_to_q_1 ? 5'h2 : can_to_q_2 ? 5'h4 : can_to_q_3 ? 5'h8 : {can_to_q_4, 4'h0};	// @[InputUnit.scala:86:32, :117:70, Mux.scala:27:73, :47:70]
  wire            _T_11 = can_to_q_0 | can_to_q_1 | can_to_q_2 | can_to_q_3 | can_to_q_4;	// @[InputUnit.scala:117:70, package.scala:73:59]
  wire [4:0]      head = (to_q_oh_enc[0] ? heads_0 : 5'h0) | (to_q_oh_enc[1] ? heads_1 : 5'h0) | (to_q_oh_enc[2] ? heads_2 : 5'h0) | (to_q_oh_enc[3] ? heads_3 : 5'h0) | (to_q_oh_enc[4] ? heads_4 : 5'h0);	// @[InputUnit.scala:86:{24,32}, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  ...
  wire            _tails_T_14 = mem_MPORT_addr == ({1'h0, {1'h0, {1'h0, {2{_tails_T_15}}} | {3{_tails_T_16}}} | (_tails_T_17 ? 4'hB : 4'h0) | {4{_tails_T_18}}} | (_tails_T_19 ? 5'h13 : 5'h0));	// @[InputUnit.scala:86:32, :104:14, Mux.scala:27:73, :29:36]
  wire [4:0]      _tails_WIRE_2 = {_tails_T_19, {_tails_T_17, _tails_T_16, 2'h0} | (_tails_T_18 ? 4'hC : 4'h0)};	// @[Mux.scala:27:73, :29:36]
  wire [4:0]      _tails_T_30 = mem_MPORT_addr + 5'h1;	// @[InputUnit.scala:106:14, Mux.scala:47:70]
  ...
  wire            _heads_T_9 = head == ({1'h0, {1'h0, {1'h0, {2{to_q_oh_enc[0]}}} | {3{to_q_oh_enc[1]}}} | (to_q_oh_enc[2] ? 4'hB : 4'h0) | {4{to_q_oh_enc[3]}}} | (to_q_oh_enc[4] ? 5'h13 : 5'h0));	// @[InputUnit.scala:86:32, :123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [4:0]      _heads_WIRE_2 = {to_q_oh_enc[4], {to_q_oh_enc[2:1], 2'h0} | (to_q_oh_enc[3] ? 4'hC : 4'h0)};	// @[Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [4:0]      _heads_T_20 = head + 5'h1;	// @[InputUnit.scala:125:16, Mux.scala:27:73, :47:70]
  always @(posedge clock) begin
    if (reset) begin
      heads_0 <= 5'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_1 <= 5'h4;	// @[InputUnit.scala:86:{24,32}]
      heads_2 <= 5'h8;	// @[InputUnit.scala:86:{24,32}]
      heads_3 <= 5'hC;	// @[InputUnit.scala:86:{24,32}]
      heads_4 <= 5'h10;	// @[InputUnit.scala:86:{24,32}]
      tails_0 <= 5'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_1 <= 5'h4;	// @[InputUnit.scala:86:32, :87:24]
      tails_2 <= 5'h8;	// @[InputUnit.scala:86:32, :87:24]
      tails_3 <= 5'hC;	// @[InputUnit.scala:86:32, :87:24]
      tails_4 <= 5'h10;	// @[InputUnit.scala:86:32, :87:24]
    end
    else begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        tails_0 = _RANDOM_0[29:25];	// @[InputUnit.scala:86:24, :87:24]
        tails_1 = {_RANDOM_0[31:30], _RANDOM_1[2:0]};	// @[InputUnit.scala:86:24, :87:24]
        tails_2 = _RANDOM_1[7:3];	// @[InputUnit.scala:87:24]
        tails_3 = _RANDOM_1[12:8];	// @[InputUnit.scala:87:24]
        tails_4 = _RANDOM_1[17:13];	// @[InputUnit.scala:87:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  mem_combMem_1 mem_ext (	// @[InputUnit.scala:85:18]
