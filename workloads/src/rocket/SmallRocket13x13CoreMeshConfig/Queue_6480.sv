...
module Queue_6480(
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[19:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[33:20];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[41:34];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[105:42];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[106];	// @[Decoupled.scala:273:95]
endmodule
