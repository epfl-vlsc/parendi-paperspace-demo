...
module IngressUnit_423(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 9'h14C;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 9'h14F;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 9'h152;	// @[IngressUnit.scala:30:72]
  wire [7:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 8'hA6 : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 8'hA8 : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 8'hA7 : 8'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[7], _route_buffer_io_enq_bits_flow_egress_node_WIRE[5], _route_buffer_io_enq_bits_flow_egress_node_WIRE[3:0]} == 6'h2D;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 9'h11B),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 9'h11A),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
