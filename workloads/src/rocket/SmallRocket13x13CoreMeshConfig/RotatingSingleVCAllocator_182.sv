...
module RotatingSingleVCAllocator_182(
  input  clock,
         reset,
         io_req_1_valid,
  ...
  assign in_arb_vals_0 = io_req_0_valid & (in_arb_reqs_0_2_0 | in_arb_reqs_0_2_1 | in_arb_reqs_0_2_2 | in_arb_reqs_0_2_3 | in_arb_reqs_0_2_4);	// @[SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59]
  ...
  assign in_arb_vals_1 = io_req_1_valid & (in_arb_reqs_1_0_1 | in_arb_reqs_1_0_2 | in_arb_reqs_1_0_3 | in_arb_reqs_1_0_4 | in_arb_reqs_1_1_1 | in_arb_reqs_1_1_2 | in_arb_reqs_1_1_3 | in_arb_reqs_1_1_4);	// @[SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59]
  ...
  wire        _in_vc_sel_WIRE_8 = in_arb_sel[1] & in_arb_reqs_1_1_1;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_9 = in_arb_sel[1] & in_arb_reqs_1_1_2;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_10 = in_arb_sel[1] & in_arb_reqs_1_1_3;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_11 = in_arb_sel[1] & in_arb_reqs_1_1_4;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_13 = in_arb_sel[0] & in_arb_reqs_0_2_0;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_14 = in_arb_sel[0] & in_arb_reqs_0_2_1;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_15 = in_arb_sel[0] & in_arb_reqs_0_2_2;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  wire        _in_vc_sel_WIRE_16 = in_arb_sel[0] & in_arb_reqs_0_2_3;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  ...
  wire [13:0] _GEN = {_in_vc_sel_WIRE_17, _in_vc_sel_WIRE_16, _in_vc_sel_WIRE_15, _in_vc_sel_WIRE_14, _in_vc_sel_WIRE_13, _in_vc_sel_WIRE_11, _in_vc_sel_WIRE_10, _in_vc_sel_WIRE_9, _in_vc_sel_WIRE_8, 1'h0, _in_vc_sel_WIRE_5, _in_vc_sel_WIRE_4, _in_vc_sel_WIRE_3, _in_vc_sel_WIRE_2} & ~(in_alloc_mask[14:1]);	// @[ISLIP.scala:17:25, :18:{29,31}, :33:18, Mux.scala:27:73]
  wire [29:0] _in_alloc_oh_T_58 = _GEN[0] ? 30'h2 : _GEN[1] ? 30'h4 : _GEN[2] ? 30'h8 : _GEN[3] ? 30'h10 : _GEN[5] ? 30'h40 : _GEN[6] ? 30'h80 : _GEN[7] ? 30'h100 : _GEN[8] ? 30'h200 : _GEN[9] ? 30'h400 : _GEN[10] ? 30'h800 : _GEN[11] ? 30'h1000 : _GEN[12] ? 30'h2000 : _GEN[13] ? 30'h4000 : _in_vc_sel_WIRE_2 ? 30'h10000 : _in_vc_sel_WIRE_3 ? 30'h20000 : _in_vc_sel_WIRE_4 ? 30'h40000 : _in_vc_sel_WIRE_5 ? 30'h80000 : _in_vc_sel_WIRE_8 ? 30'h200000 : _in_vc_sel_WIRE_9 ? 30'h400000 : _in_vc_sel_WIRE_10 ? 30'h800000 : _in_vc_sel_WIRE_11 ? 30'h1000000 : _in_vc_sel_WIRE_13 ? 30'h2000000 : _in_vc_sel_WIRE_14 ? 30'h4000000 : _in_vc_sel_WIRE_15 ? 30'h8000000 : _in_vc_sel_WIRE_16 ? 30'h10000000 : {_in_vc_sel_WIRE_17, 29'h0};	// @[ISLIP.scala:18:29, Mux.scala:27:73, :47:70, OneHot.scala:84:71]
  wire [14:0] _in_alloc_WIRE_1 = _in_alloc_oh_T_58[14:0] | _in_alloc_oh_T_58[29:15];	// @[ISLIP.scala:20:{20,28,34}, Mux.scala:47:70]
  wire        in_alloc_2_0 = _in_alloc_T & _in_alloc_WIRE_1[10];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  wire        in_alloc_2_1 = _in_alloc_T & _in_alloc_WIRE_1[11];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  wire        in_alloc_2_2 = _in_alloc_T & _in_alloc_WIRE_1[12];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  wire        in_alloc_2_3 = _in_alloc_T & _in_alloc_WIRE_1[13];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  wire        in_alloc_2_4 = _in_alloc_T & _in_alloc_WIRE_1[14];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1:0]  _GEN_2 = {1'h0, _in_alloc_T & _in_alloc_WIRE_1[0]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    ...
    wire  [1:0]  _GEN_5 = {1'h0, _in_alloc_T & _in_alloc_WIRE_1[5]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    ...
    wire  [1:0]  _GEN_12 = {1'h0, in_alloc_2_2};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_13 = {1'h0, in_alloc_2_3};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_14 = {1'h0, in_alloc_2_4};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [3:0]  _T_44 = {1'h0, {1'h0, _GEN_2 + _GEN_0 + _GEN_1} + {1'h0, _GEN_3 + _GEN_4} + {1'h0, _GEN_5 + _GEN_6}} + {1'h0, {1'h0, _GEN_7 + _GEN_8} + {1'h0, _GEN_9 + _GEN_10}} + {1'h0, {1'h0, _GEN_11 + _GEN_12} + {1'h0, _GEN_13 + _GEN_14}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_92 = {1'h0, {1'h0, _GEN_2 + _GEN_0 + _GEN_1} + {1'h0, _GEN_3 + _GEN_4} + {1'h0, _GEN_5 + _GEN_6}} + {1'h0, {1'h0, _GEN_7 + _GEN_8} + {1'h0, _GEN_9 + _GEN_10}} + {1'h0, {1'h0, _GEN_11 + _GEN_12} + {1'h0, _GEN_13 + _GEN_14}};	// @[Bitwise.scala:51:90]
    always @(posedge clock) begin	// @[SingleVCAllocator.scala:53:11]
      if (~reset & (|(_T_44[3:1]))) begin	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}]
      ...
      if (~reset & (|(_T_92[3:1]))) begin	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}]
        if (`ASSERT_VERBOSE_COND_)	// @[SingleVCAllocator.scala:53:11]
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// @[SingleVCAllocator.scala:53:11]
        if (`STOP_COND_)	// @[SingleVCAllocator.scala:53:11]
          $fatal;	// @[SingleVCAllocator.scala:53:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        in_alloc_mask = _RANDOM_0[16:2];	// @[ISLIP.scala:17:25, SingleVCAllocator.scala:16:21]
      `endif // RANDOMIZE_REG_INIT
    end // initial
