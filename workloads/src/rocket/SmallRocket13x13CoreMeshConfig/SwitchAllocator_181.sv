...
module SwitchAllocator_181(
  ...
  SwitchArbiter_746 arbs_0 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_746 arbs_1 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_746 arbs_2 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
