...
module RouteComputer_312(
  ...
  wire [7:0] _GEN = ~(io_req_1_bits_flow_egress_node[7:0]);	// @[RouteComputer.scala:74:27, pla.scala:78:21]
  ...
  wire [2:0] _decoded_T_57 = {io_req_1_bits_flow_egress_node_id[0], _GEN[7], io_req_1_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_59 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[0], io_req_1_bits_flow_egress_node[7], io_req_1_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [2:0] _decoded_T_63 = {io_req_1_bits_flow_egress_node_id[0], _GEN[7], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_65 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[0], io_req_1_bits_flow_egress_node[7], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [2:0] _decoded_T_69 = {_GEN[7], io_req_1_bits_src_virt_id[0], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_71 = {io_req_1_bits_flow_egress_node[0], io_req_1_bits_flow_egress_node[7], io_req_1_bits_src_virt_id[0], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [1:0] _decoded_T_73 = {_GEN[0], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [1:0] _decoded_T_75 = {_GEN[7], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_79 = {io_req_1_bits_flow_egress_node_id[0], _GEN[7], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_81 = {io_req_1_bits_flow_egress_node[0], io_req_1_bits_flow_egress_node[7], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [3:0] _decoded_T_83 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[0], io_req_1_bits_flow_egress_node[7], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
