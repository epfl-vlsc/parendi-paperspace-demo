...
module TLFragmenter_170(
  ...
  wire [7:0]  _GEN = {auto_out_d_bits_source[4:0], ~(_dsizeOH1_T_1[2:0])} & {1'h1, ~(auto_out_d_bits_source[4:0]), _dsizeOH1_T_1[2:1]};	// @[Cat.scala:33:92, Fragmenter.scala:194:41, OneHot.scala:64:12, package.scala:233:{35,47,49}, :235:{46,71,76}]
  wire [2:0]  _GEN_0 = _GEN[6:4] | _GEN[2:0];	// @[OneHot.scala:30:18, :31:18, :32:28, package.scala:233:47]
  wire [3:0]  dFirst_size = {_GEN[7], |(_GEN[6:3]), |(_GEN_0[2:1]), _GEN_0[2] | _GEN_0[0]};	// @[Cat.scala:33:92, OneHot.scala:30:18, :31:18, :32:{14,28}, package.scala:233:47]
  ...
  wire [3:0]  aFrag = (|(_repeater_io_deq_bits_size[3:2])) ? 4'h3 : _repeater_io_deq_bits_size;	// @[Fragmenter.scala:264:30, :287:{24,31}]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {23'h0, ~(_aOrigOH1_T_1[7:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 8'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
