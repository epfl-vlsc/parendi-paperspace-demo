...
module ClockSinkDomain_4(
  ...
  input  [2:0]  auto_buffer_in_2_flit_0_bits_flow_egress_node,
  ...
  input  [2:0]  auto_buffer_in_1_flit_0_bits_flow_egress_node,
  ...
  input  [2:0]  auto_buffer_in_0_flit_0_bits_flow_egress_node,
  ...
  output [2:0]  auto_routers_source_nodes_out_2_flit_0_bits_flow_egress_node,
  ...
  output [2:0]  auto_routers_source_nodes_out_1_flit_0_bits_flow_egress_node,
  ...
  output [2:0]  auto_routers_source_nodes_out_0_flit_0_bits_flow_egress_node,
  ...
  reg  [2:0]  buffer_x1_flit_0_b_flow_ingress_node;	// @[Reg.scala:19:16]
  reg  [1:0]  buffer_x1_flit_0_b_flow_ingress_node_id;	// @[Reg.scala:19:16]
  reg  [2:0]  buffer_x1_flit_0_b_flow_egress_node;	// @[Reg.scala:19:16]
  ...
  reg  [2:0]  buffer_1_x1_flit_0_b_flow_ingress_node;	// @[Reg.scala:19:16]
  reg  [1:0]  buffer_1_x1_flit_0_b_flow_ingress_node_id;	// @[Reg.scala:19:16]
  reg  [2:0]  buffer_1_x1_flit_0_b_flow_egress_node;	// @[Reg.scala:19:16]
  ...
  reg  [2:0]  buffer_2_x1_flit_0_b_flow_ingress_node;	// @[Reg.scala:19:16]
  reg  [1:0]  buffer_2_x1_flit_0_b_flow_ingress_node_id;	// @[Reg.scala:19:16]
  reg  [2:0]  buffer_2_x1_flit_0_b_flow_egress_node;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buffer_x1_flit_0_b_flow_ingress_node = _RANDOM_2[17:15];	// @[Reg.scala:19:16]
        buffer_x1_flit_0_b_flow_ingress_node_id = _RANDOM_2[19:18];	// @[Reg.scala:19:16]
        buffer_x1_flit_0_b_flow_egress_node = _RANDOM_2[22:20];	// @[Reg.scala:19:16]
        buffer_x1_flit_0_b_flow_egress_node_id = _RANDOM_2[24:23];	// @[Reg.scala:19:16]
        buffer_x1_flit_0_b_virt_channel_id = _RANDOM_2[27:25];	// @[Reg.scala:19:16]
        buffer_x1_credit_return_r = {_RANDOM_2[31:28], _RANDOM_3[0]};	// @[Reg.scala:19:16]
        buffer_x1_credit_return_r_1 = _RANDOM_3[5:1];	// @[Reg.scala:19:16]
        buffer_x1_credit_return_r_2 = _RANDOM_3[10:6];	// @[Reg.scala:19:16]
        buffer_x1_credit_return_r_3 = _RANDOM_3[15:11];	// @[Reg.scala:19:16]
        buffer_x1_vc_free_r = _RANDOM_3[20:16];	// @[Reg.scala:19:16]
        buffer_x1_vc_free_r_1 = _RANDOM_3[25:21];	// @[Reg.scala:19:16]
        buffer_x1_vc_free_r_2 = _RANDOM_3[30:26];	// @[Reg.scala:19:16]
        buffer_x1_vc_free_r_3 = {_RANDOM_3[31], _RANDOM_4[3:0]};	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_v = _RANDOM_4[4];	// @[Reg.scala:19:16, Valid.scala:130:22]
        buffer_1_x1_flit_0_b_head = _RANDOM_4[5];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_tail = _RANDOM_4[6];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_payload = {_RANDOM_4[31:7], _RANDOM_5, _RANDOM_6[15:0]};	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_flow_vnet_id = _RANDOM_6[18:16];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_flow_ingress_node = _RANDOM_6[21:19];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_flow_ingress_node_id = _RANDOM_6[23:22];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_flow_egress_node = _RANDOM_6[26:24];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_flow_egress_node_id = _RANDOM_6[28:27];	// @[Reg.scala:19:16]
        buffer_1_x1_flit_0_b_virt_channel_id = _RANDOM_6[31:29];	// @[Reg.scala:19:16]
        buffer_1_x1_credit_return_r = _RANDOM_7[4:0];	// @[Reg.scala:19:16]
        buffer_1_x1_credit_return_r_1 = _RANDOM_7[9:5];	// @[Reg.scala:19:16]
        buffer_1_x1_credit_return_r_2 = _RANDOM_7[14:10];	// @[Reg.scala:19:16]
        buffer_1_x1_credit_return_r_3 = _RANDOM_7[19:15];	// @[Reg.scala:19:16]
        buffer_1_x1_vc_free_r = _RANDOM_7[24:20];	// @[Reg.scala:19:16]
        buffer_1_x1_vc_free_r_1 = _RANDOM_7[29:25];	// @[Reg.scala:19:16]
        buffer_1_x1_vc_free_r_2 = {_RANDOM_7[31:30], _RANDOM_8[2:0]};	// @[Reg.scala:19:16]
        buffer_1_x1_vc_free_r_3 = _RANDOM_8[7:3];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_v = _RANDOM_8[8];	// @[Reg.scala:19:16, Valid.scala:130:22]
        buffer_2_x1_flit_0_b_head = _RANDOM_8[9];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_tail = _RANDOM_8[10];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_payload = {_RANDOM_8[31:11], _RANDOM_9, _RANDOM_10[19:0]};	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_flow_vnet_id = _RANDOM_10[22:20];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_flow_ingress_node = _RANDOM_10[25:23];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_flow_ingress_node_id = _RANDOM_10[27:26];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_flow_egress_node = _RANDOM_10[30:28];	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_flow_egress_node_id = {_RANDOM_10[31], _RANDOM_11[0]};	// @[Reg.scala:19:16]
        buffer_2_x1_flit_0_b_virt_channel_id = _RANDOM_11[3:1];	// @[Reg.scala:19:16]
        buffer_2_x1_credit_return_r = _RANDOM_11[8:4];	// @[Reg.scala:19:16]
        buffer_2_x1_credit_return_r_1 = _RANDOM_11[13:9];	// @[Reg.scala:19:16]
        buffer_2_x1_credit_return_r_2 = _RANDOM_11[18:14];	// @[Reg.scala:19:16]
        buffer_2_x1_credit_return_r_3 = _RANDOM_11[23:19];	// @[Reg.scala:19:16]
        buffer_2_x1_vc_free_r = _RANDOM_11[28:24];	// @[Reg.scala:19:16]
        buffer_2_x1_vc_free_r_1 = {_RANDOM_11[31:29], _RANDOM_12[1:0]};	// @[Reg.scala:19:16]
        buffer_2_x1_vc_free_r_2 = _RANDOM_12[6:2];	// @[Reg.scala:19:16]
        buffer_2_x1_vc_free_r_3 = _RANDOM_12[11:7];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Router_4 routers (	// @[NoC.scala:64:22]
