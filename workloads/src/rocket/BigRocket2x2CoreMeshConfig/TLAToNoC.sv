...
module TLAToNoC(
  ...
  input  [1:0]  io_protocol_bits_source,
  ...
  wire [1:0]  _q_io_deq_bits_source;	// @[Tilelink.scala:45:17]
  ...
  Queue_117 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_payload = is_body ? {_q_io_deq_bits_mask, _q_io_deq_bits_data, _q_io_deq_bits_corrupt} : {29'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_address};	// @[Cat.scala:33:92, Tilelink.scala:45:17, :59:24, :68:33]
  assign io_flit_bits_egress_id = {_q_io_deq_bits_address[31:30] == 2'h1, {1'h0, _q_io_deq_bits_address[31:30] == 2'h0, 1'h0} | (_q_io_deq_bits_address[31:30] == 2'h2 ? 3'h5 : 3'h0)};	// @[Edges.scala:92:28, Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17]
endmodule
