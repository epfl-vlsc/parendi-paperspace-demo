...
module RotatingSingleVCAllocator_4(
  input  clock,
         reset,
         io_req_2_valid,
  ...
  assign in_arb_vals_2 = io_req_2_valid & (in_arb_reqs_2_0_1 | in_arb_reqs_2_0_2 | in_arb_reqs_2_0_3 | in_arb_reqs_2_0_4);	// @[SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59]
  ...
  wire        _in_vc_sel_WIRE_17 = in_arb_sel[0] & in_arb_reqs_0_2_4;	// @[Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61]
  ...
  wire [13:0] _GEN = {_in_vc_sel_WIRE_17, 4'h0, _in_vc_sel_WIRE_11, _in_vc_sel_WIRE_10, _in_vc_sel_WIRE_9, _in_vc_sel_WIRE_8, _in_vc_sel_WIRE_7, _in_vc_sel_WIRE_5, _in_vc_sel_WIRE_4, _in_vc_sel_WIRE_3, _in_vc_sel_WIRE_2} & ~(in_alloc_mask[14:1]);	// @[ISLIP.scala:17:25, :18:{29,31}, :33:18, Mux.scala:27:73]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1:0]  _GEN_2 = {1'h0, _in_alloc_T_1 & _in_alloc_WIRE_1[0]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    ...
    wire  [1:0]  _GEN_11 = {1'h0, _in_alloc_T_1 & _in_alloc_WIRE_1[11]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    wire  [1:0]  _GEN_12 = {1'h0, _in_alloc_T_1 & _in_alloc_WIRE_1[12]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    wire  [1:0]  _GEN_13 = {1'h0, _in_alloc_T_1 & _in_alloc_WIRE_1[13]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    wire  [1:0]  _GEN_14 = {1'h0, in_alloc_2_4};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [3:0]  _T_45 = {1'h0, {1'h0, _GEN_2 + _GEN_0 + _GEN_1} + {1'h0, _GEN_3 + _GEN_4} + {1'h0, _GEN_5 + _GEN_6}} + {1'h0, {1'h0, _GEN_7 + _GEN_8} + {1'h0, _GEN_9 + _GEN_10}} + {1'h0, {1'h0, _GEN_11 + _GEN_12} + {1'h0, _GEN_13 + _GEN_14}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_93 = {1'h0, {1'h0, _GEN_2 + _GEN_0 + _GEN_1} + {1'h0, _GEN_3 + _GEN_4} + {1'h0, _GEN_5 + _GEN_6}} + {1'h0, {1'h0, _GEN_7 + _GEN_8} + {1'h0, _GEN_9 + _GEN_10}} + {1'h0, {1'h0, _GEN_11 + _GEN_12} + {1'h0, _GEN_13 + _GEN_14}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_141 = {1'h0, {1'h0, _GEN_2 + _GEN_0 + _GEN_1} + {1'h0, _GEN_3 + _GEN_4} + {1'h0, _GEN_5 + _GEN_6}} + {1'h0, {1'h0, _GEN_7 + _GEN_8} + {1'h0, _GEN_9 + _GEN_10}} + {1'h0, {1'h0, _GEN_11 + _GEN_12} + {1'h0, _GEN_13 + _GEN_14}};	// @[Bitwise.scala:51:90]
