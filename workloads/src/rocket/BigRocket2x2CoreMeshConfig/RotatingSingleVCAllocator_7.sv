...
module RotatingSingleVCAllocator_7(
  input  clock,
         reset,
         io_req_1_valid,
  ...
  assign in_arb_vals_1 = io_req_1_valid & (in_arb_reqs_1_0_0 | in_arb_reqs_1_0_1 | in_arb_reqs_1_0_2 | in_arb_reqs_1_0_3 | in_arb_reqs_1_0_4);	// @[SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59]
  ...
  wire [9:0]  _in_alloc_full_T_1 = {_in_vc_sel_WIRE_11, _in_vc_sel_WIRE_10, _in_vc_sel_WIRE_9, _in_vc_sel_WIRE_8, 1'h0, _in_vc_sel_WIRE_5, _in_vc_sel_WIRE_4, _in_vc_sel_WIRE_3, _in_vc_sel_WIRE_2, _in_vc_sel_WIRE_1} & ~in_alloc_mask;	// @[ISLIP.scala:17:25, :18:{29,31}, :33:18, Mux.scala:27:73]
  wire [19:0] in_alloc_oh = _in_alloc_full_T_1[0] ? 20'h1 : _in_alloc_full_T_1[1] ? 20'h2 : _in_alloc_full_T_1[2] ? 20'h4 : _in_alloc_full_T_1[3] ? 20'h8 : _in_alloc_full_T_1[4] ? 20'h10 : _in_alloc_full_T_1[6] ? 20'h40 : _in_alloc_full_T_1[7] ? 20'h80 : _in_alloc_full_T_1[8] ? 20'h100 : _in_alloc_full_T_1[9] ? 20'h200 : _in_vc_sel_WIRE_1 ? 20'h400 : _in_vc_sel_WIRE_2 ? 20'h800 : _in_vc_sel_WIRE_3 ? 20'h1000 : _in_vc_sel_WIRE_4 ? 20'h2000 : _in_vc_sel_WIRE_5 ? 20'h4000 : _in_vc_sel_WIRE_8 ? 20'h10000 : _in_vc_sel_WIRE_9 ? 20'h20000 : _in_vc_sel_WIRE_10 ? 20'h40000 : {_in_vc_sel_WIRE_11, 19'h0};	// @[ISLIP.scala:18:29, Mux.scala:27:73, :47:70, OneHot.scala:84:71]
  wire [9:0]  _in_alloc_WIRE_1 = in_alloc_oh[9:0] | in_alloc_oh[19:10];	// @[ISLIP.scala:20:{20,28,34}, Mux.scala:47:70]
  ...
  wire        in_alloc_0_0 = _in_alloc_T & _in_alloc_WIRE_1[0];	// @[ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1:0]  _GEN_1 = {1'h0, in_alloc_0_3};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_2 = {1'h0, in_alloc_0_4};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_3 = {1'h0, in_alloc_0_2};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_4 = {1'h0, _in_alloc_T & _in_alloc_WIRE_1[5]};	// @[Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59]
    wire  [1:0]  _GEN_5 = {1'h0, in_alloc_1_1};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_6 = {1'h0, in_alloc_1_3};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_7 = {1'h0, in_alloc_1_4};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [1:0]  _GEN_8 = {1'h0, in_alloc_1_2};	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:41:18]
    wire  [3:0]  _T_29 = {1'h0, {1'h0, _GEN + _GEN_0} + {1'h0, _GEN_3 + _GEN_1 + _GEN_2}} + {1'h0, {1'h0, _GEN_4 + _GEN_5} + {1'h0, _GEN_8 + _GEN_6 + _GEN_7}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_62 = {1'h0, {1'h0, _GEN + _GEN_0} + {1'h0, _GEN_3 + _GEN_1 + _GEN_2}} + {1'h0, {1'h0, _GEN_4 + _GEN_5} + {1'h0, _GEN_8 + _GEN_6 + _GEN_7}};	// @[Bitwise.scala:51:90]
