...
module IngressUnit(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 4'h5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 4'h8;	// @[IngressUnit.scala:30:72]
  wire [1:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_1}} | {_route_buffer_io_enq_bits_flow_egress_node_id_T_2, _route_buffer_io_enq_bits_flow_egress_node_id_T};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
