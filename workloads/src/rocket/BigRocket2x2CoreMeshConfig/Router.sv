...
module Router(
  ...
  input  [2:0]  auto_dest_nodes_in_flit_0_bits_flow_egress_node,
  ...
  output [2:0]  auto_source_nodes_out_flit_0_bits_flow_egress_node,
  ...
  wire [2:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [2:0]  _ingress_unit_3_from_2_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [2:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [2:0]  _ingress_unit_2_from_1_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [2:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:116:13]
  wire [1:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:116:13]
  wire [2:0]  _ingress_unit_1_from_0_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:116:13]
  ...
  wire [2:0]  _input_unit_0_from_4_io_out_0_bits_flit_flow_ingress_node;	// @[Router.scala:112:13]
  wire [1:0]  _input_unit_0_from_4_io_out_0_bits_flit_flow_ingress_node_id;	// @[Router.scala:112:13]
  wire [2:0]  _input_unit_0_from_4_io_out_0_bits_flit_flow_egress_node;	// @[Router.scala:112:13]
  wire [1:0]  _input_unit_0_from_4_io_out_0_bits_flit_flow_egress_node_id;	// @[Router.scala:112:13]
  wire [2:0]  fires_count = {1'h0, {1'h0, _vc_allocator_io_req_0_ready & _input_unit_0_from_4_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_1_ready & _ingress_unit_1_from_0_io_vcalloc_req_valid}} + {1'h0, {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_1_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_3_ready & _ingress_unit_3_from_2_io_vcalloc_req_valid}};	// @[Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :134:32, :137:31]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      fired <= 1'h0;	// @[Router.scala:134:32, :202:26]
      util_ctr_1 <= 64'h0;	// @[Router.scala:193:28, :201:29]
      fired_1 <= 1'h0;	// @[Router.scala:134:32, :202:26]
      util_ctr_2 <= 64'h0;	// @[Router.scala:193:28, :201:29]
      fired_2 <= 1'h0;	// @[Router.scala:134:32, :202:26]
      util_ctr_3 <= 64'h0;	// @[Router.scala:193:28, :201:29]
      fired_3 <= 1'h0;	// @[Router.scala:134:32, :202:26]
      util_ctr_4 <= 64'h0;	// @[Router.scala:193:28, :201:29]
      fired_4 <= 1'h0;	// @[Router.scala:134:32, :202:26]
      util_ctr_5 <= 64'h0;	// @[Router.scala:193:28, :201:29]
      fired_5 <= 1'h0;	// @[Router.scala:134:32, :202:26]
    end
    else begin
  ...
  InputUnit input_unit_0_from_4 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
  ...
  OutputUnit output_unit_0_to_4 (	// @[Router.scala:122:13]
    .clock                                   (clock),
    .reset                                   (reset),
