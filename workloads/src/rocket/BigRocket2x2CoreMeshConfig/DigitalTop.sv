...
module DigitalTop(
  ...
  wire [1:0]  _subsystem_cbus_auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_opcode;	// @[Buses.scala:25:35]
  ...
  wire [1:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_source;	// @[Buses.scala:25:35]
  wire [31:0] _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_address;	// @[Buses.scala:25:35]
  ...
  wire        _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_corrupt;	// @[Buses.scala:25:35]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_opcode;	// @[Buses.scala:25:35]
  ...
  wire [1:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_source;	// @[Buses.scala:25:35]
  wire [2:0]  _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_sink;	// @[Buses.scala:25:35]
  wire        _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_denied;	// @[Buses.scala:25:35]
  wire [63:0] _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_data;	// @[Buses.scala:25:35]
  wire        _subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_corrupt;	// @[Buses.scala:25:35]
  ...
  wire [1:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_source;	// @[Buses.scala:25:35]
  ...
  wire [1:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_c_bits_source;	// @[Buses.scala:25:35]
  ...
  wire [1:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_source;	// @[Buses.scala:25:35]
  ...
  ConstellationSystemBus subsystem_sbus (	// @[Buses.scala:25:35]
    ...
    .auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_opcode             (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_opcode),
    ...
    .auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_mask               (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_mask),
    .auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_data               (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_data),
    .auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_corrupt            (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_corrupt),
    ...
    .auto_coupler_from_tile_tl_master_clock_xing_in_e_ready                   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_e_ready),
  ...
  TilePRCIDomain tile_prci_domain (	// @[HasTiles.scala:250:38]
    ...
    .auto_tl_master_clock_xing_out_a_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_a_ready),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_valid        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_valid),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_opcode  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_opcode),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_param   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_param),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_size    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_size),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_source  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_source),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_address (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_address),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_mask    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_mask),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_data    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_data),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_b_bits_corrupt (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_corrupt),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_c_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_c_ready),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_valid        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_valid),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_opcode  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_opcode),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_param   (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_param),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_size    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_size),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_source  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_source),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_sink    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_sink),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_denied  (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_denied),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_data    (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_data),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_d_bits_corrupt (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_corrupt),	// @[Buses.scala:25:35]
    .auto_tl_master_clock_xing_out_e_ready        (_subsystem_sbus_auto_coupler_from_tile_tl_master_clock_xing_in_e_ready),	// @[Buses.scala:25:35]
