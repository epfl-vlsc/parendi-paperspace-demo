...
module TLBuffer_10(
  ...
  input  [8:0]  auto_out_b_bits_source,
  ...
  output [8:0]  auto_in_b_bits_source,
  ...
  Queue_3884 x1_a_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_3885 bundleIn_0_d_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
