...
module RouteComputer_194(
  ...
  wire [4:0] _decoded_T_228 =
    {_GEN[0], _GEN[1], _GEN[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_256 =
    {_GEN[1], _GEN[2], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_150, &_decoded_T_186, &_decoded_T_226, &_decoded_T_298};	// Cat.scala:33:92, pla.scala:98:74, :114:39
