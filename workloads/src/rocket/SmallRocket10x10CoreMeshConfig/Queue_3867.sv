...
module Queue_3867(
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[18:10];	// Decoupled.scala:273:95
  assign io_deq_bits_address = _ram_ext_R0_data[32:19];	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_corrupt = _ram_ext_R0_data[105];	// Decoupled.scala:273:95
endmodule
