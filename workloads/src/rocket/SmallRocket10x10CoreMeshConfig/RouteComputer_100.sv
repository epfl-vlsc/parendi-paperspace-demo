...
module RouteComputer_100(
  ...
  wire [1:0] _decoded_T_40 =
    {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_42 =
  ...
  assign io_resp_1_vc_sel_0_3 =
    |{&_decoded_T_40, &_decoded_T_42, &_decoded_T_44, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
