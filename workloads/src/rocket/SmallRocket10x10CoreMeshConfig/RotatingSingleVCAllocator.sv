...
module RotatingSingleVCAllocator(
          ...
          : _in_arb_filter_T_3[2]
              ...
              : _in_arb_filter_T_3[3]
                  ...
                  : in_arb_vals_0
                      ...
                      : in_arb_vals_1
                          ? 8'h20
                          : in_arb_vals_2 ? 8'h40 : {in_arb_vals_3, 7'h0};	// ISLIP.scala:17:25, Mux.scala:47:70, OneHot.scala:84:71, SingleVCAllocator.scala:19:84, :32:39
  ...
  assign in_arb_vals_0 = io_req_0_valid & (in_arb_reqs_0_1_0 | in_arb_reqs_0_2_0);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  ...
  assign in_arb_vals_1 =
    ...
    & (in_arb_reqs_1_0_0 | in_arb_reqs_1_0_1 | in_arb_reqs_1_0_2 | in_arb_reqs_1_0_3
       | in_arb_reqs_1_0_4 | in_arb_reqs_1_1_0 | in_arb_reqs_1_2_0);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  ...
  assign in_arb_vals_2 =
    ...
    & (in_arb_reqs_2_0_0 | in_arb_reqs_2_0_1 | in_arb_reqs_2_0_2 | in_arb_reqs_2_0_3
       | in_arb_reqs_2_0_4 | in_arb_reqs_2_1_0 | in_arb_reqs_2_2_0);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  wire        in_arb_reqs_3_0_0 =
    io_req_3_bits_vc_sel_0_0 & ~io_channel_status_0_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  ...
  wire        in_arb_reqs_3_1_0 =
    io_req_3_bits_vc_sel_1_0 & ~io_channel_status_1_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  wire        in_arb_reqs_3_2_0 =
    io_req_3_bits_vc_sel_2_0 & ~io_channel_status_2_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  assign in_arb_vals_3 =
    io_req_3_valid
    & (in_arb_reqs_3_0_0 | in_arb_reqs_3_0_1 | in_arb_reqs_3_0_2 | in_arb_reqs_3_0_3
       | in_arb_reqs_3_0_4 | in_arb_reqs_3_1_0 | in_arb_reqs_3_2_0);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  wire        _in_vc_sel_WIRE_1 =
    in_arb_sel[1] & in_arb_reqs_1_0_0 | in_arb_sel[2] & in_arb_reqs_2_0_0 | in_arb_sel[3]
    & in_arb_reqs_3_0_0;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_2 =
    in_arb_sel[1] & in_arb_reqs_1_0_1 | in_arb_sel[2] & in_arb_reqs_2_0_1 | in_arb_sel[3]
    & in_arb_reqs_3_0_1;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_3 =
    in_arb_sel[1] & in_arb_reqs_1_0_2 | in_arb_sel[2] & in_arb_reqs_2_0_2 | in_arb_sel[3]
    & in_arb_reqs_3_0_2;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_4 =
    in_arb_sel[1] & in_arb_reqs_1_0_3 | in_arb_sel[2] & in_arb_reqs_2_0_3 | in_arb_sel[3]
    & in_arb_reqs_3_0_3;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  ...
  wire        _in_vc_sel_WIRE_7 =
    ...
    & in_arb_reqs_2_1_0 | in_arb_sel[3] & in_arb_reqs_3_1_0;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_9 =
    in_arb_sel[0] & in_arb_reqs_0_2_0 | in_arb_sel[1] & in_arb_reqs_1_2_0 | in_arb_sel[2]
    & in_arb_reqs_2_2_0 | in_arb_sel[3] & in_arb_reqs_3_2_0;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_alloc_T_2 = _in_alloc_T | in_arb_vals_2 | in_arb_vals_3;	// SingleVCAllocator.scala:32:39, package.scala:73:59
  reg  [6:0]  in_alloc_mask;	// ISLIP.scala:17:25
  wire [6:0]  _in_alloc_full_T_1 =
    {_in_vc_sel_WIRE_9,
     _in_vc_sel_WIRE_7,
     _in_vc_sel_WIRE_5,
     _in_vc_sel_WIRE_4,
                                      ...
                                      : _in_vc_sel_WIRE_3
                                          ...
                                          : _in_vc_sel_WIRE_4
                                              ...
                                              : _in_vc_sel_WIRE_5
                                                  ...
                                                  : _in_vc_sel_WIRE_7
                                                      ? 14'h1000
                                                      : {_in_vc_sel_WIRE_9, 13'h0};	// ISLIP.scala:18:29, Mux.scala:27:73, :47:70, OneHot.scala:84:71
  wire [6:0]  _in_alloc_WIRE_1 = in_alloc_oh[6:0] | in_alloc_oh[13:7];	// ISLIP.scala:20:{20,28,34}, Mux.scala:47:70
  wire        in_alloc_2_0 = _in_alloc_T_2 & _in_alloc_WIRE_1[6];	// ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      in_alloc_mask <= 7'h0;	// ISLIP.scala:17:25
    end
    else begin
      ...
      if (in_arb_sel[0] & io_req_0_valid | in_arb_sel[1] & io_req_1_valid | in_arb_sel[2]
        ...
        if (_in_alloc_WIRE_1[0])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'h1;	// ISLIP.scala:17:25, Mux.scala:101:16
        else if (_in_alloc_WIRE_1[1])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'h3;	// ISLIP.scala:17:25, Mux.scala:101:16
        else if (_in_alloc_WIRE_1[2])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'h7;	// ISLIP.scala:17:25, Mux.scala:101:16
        else if (_in_alloc_WIRE_1[3])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'hF;	// ISLIP.scala:17:25, Mux.scala:101:16
        else if (_in_alloc_WIRE_1[4])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'h1F;	// ISLIP.scala:17:25, Mux.scala:101:16
        else if (_in_alloc_WIRE_1[5])	// ISLIP.scala:20:28, :23:14
          in_alloc_mask <= 7'h3F;	// ISLIP.scala:17:25, Mux.scala:101:16
        else	// ISLIP.scala:23:14
          in_alloc_mask <= {7{_in_alloc_WIRE_1[6]}};	// ISLIP.scala:17:25, :20:28, :23:14, Mux.scala:101:16
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire  [2:0]  _T_22 =
      {1'h0, _GEN_1 + _GEN + _GEN_0} + {1'h0, _GEN_2 + _GEN_3} + {1'h0, _GEN_4 + _GEN_5};	// Bitwise.scala:51:90
    wire  [2:0]  _T_46 =
      {1'h0, _GEN_1 + _GEN + _GEN_0} + {1'h0, _GEN_2 + _GEN_3} + {1'h0, _GEN_4 + _GEN_5};	// Bitwise.scala:51:90
    wire  [2:0]  _T_70 =
      {1'h0, _GEN_1 + _GEN + _GEN_0} + {1'h0, _GEN_2 + _GEN_3} + {1'h0, _GEN_4 + _GEN_5};	// Bitwise.scala:51:90
    ...
    always @(posedge clock) begin	// SingleVCAllocator.scala:53:11
      if (~reset & (|(_T_22[2:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
      ...
      if (~reset & (|(_T_46[2:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
        if (`ASSERT_VERBOSE_COND_)	// SingleVCAllocator.scala:53:11
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// SingleVCAllocator.scala:53:11
        if (`STOP_COND_)	// SingleVCAllocator.scala:53:11
          $fatal;	// SingleVCAllocator.scala:53:11
      end
      if (~reset & (|(_T_70[2:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
        if (`ASSERT_VERBOSE_COND_)	// SingleVCAllocator.scala:53:11
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// SingleVCAllocator.scala:53:11
        if (`STOP_COND_)	// SingleVCAllocator.scala:53:11
          $fatal;	// SingleVCAllocator.scala:53:11
      end
      if (~reset & (|(_T_94[2:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
        if (`ASSERT_VERBOSE_COND_)	// SingleVCAllocator.scala:53:11
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// SingleVCAllocator.scala:53:11
        if (`STOP_COND_)	// SingleVCAllocator.scala:53:11
          $fatal;	// SingleVCAllocator.scala:53:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        in_alloc_mask = _RANDOM_0[10:4];	// ISLIP.scala:17:25, SingleVCAllocator.scala:16:21
      `endif // RANDOMIZE_REG_INIT
    end // initial
