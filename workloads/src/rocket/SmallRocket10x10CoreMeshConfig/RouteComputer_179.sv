...
module RouteComputer_179(
  ...
  wire [2:0] _decoded_T_175 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[5], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_181 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[5], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_187 =
    {_GEN_0[5], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_197 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[5], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
