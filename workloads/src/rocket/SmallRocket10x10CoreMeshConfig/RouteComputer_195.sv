...
module RouteComputer_195(
  ...
  wire [4:0] _decoded_T_234 =
    {_GEN[1], _GEN[2], _GEN[4], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_240 =
    {io_req_2_bits_flow_egress_node[1], _GEN[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [6:0] _decoded_T_262 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_264 =
    {_GEN[2], _GEN[3], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_1 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_276,
      &_decoded_T_280,
      &_decoded_T_310};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_270,
      &_decoded_T_274,
      &_decoded_T_278};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_294,
      &_decoded_T_298,
      &_decoded_T_302};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_150, &_decoded_T_188, &_decoded_T_230, &_decoded_T_306};	// Cat.scala:33:92, pla.scala:98:74, :114:39
