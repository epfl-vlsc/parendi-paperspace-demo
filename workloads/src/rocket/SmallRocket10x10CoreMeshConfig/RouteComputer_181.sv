...
module RouteComputer_181(
  ...
  wire [2:0] _decoded_T_112 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[5], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_116 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[5], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_124 =
    {_GEN[5], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_132 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_134 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[1],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_136 =
    {_GEN[0], io_req_2_bits_flow_egress_node[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
