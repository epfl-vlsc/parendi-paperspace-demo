...
module OutputUnit(
  ...
  output [7:0]  io_out_flit_0_bits_flow_ingress_node,
  output [1:0]  io_out_flit_0_bits_flow_ingress_node_id,
  output [7:0]  io_out_flit_0_bits_flow_egress_node,
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_3_occupied = _RANDOM_0[27];	// OutputUnit.scala:66:19
        states_3_c = _RANDOM_0[30:28];	// OutputUnit.scala:66:19
        states_2_occupied = _RANDOM_1[22];	// OutputUnit.scala:66:19
        states_2_c = _RANDOM_1[25:23];	// OutputUnit.scala:66:19
        states_1_occupied = _RANDOM_2[17];	// OutputUnit.scala:66:19
        states_1_c = _RANDOM_2[20:18];	// OutputUnit.scala:66:19
        states_0_occupied = _RANDOM_3[12];	// OutputUnit.scala:66:19
        states_0_c = _RANDOM_3[15:13];	// OutputUnit.scala:66:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
