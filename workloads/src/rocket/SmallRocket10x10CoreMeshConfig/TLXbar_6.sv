...
module TLXbar_6(
  ...
  assign auto_out_a_bits_opcode =
    (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  ...
  assign auto_out_a_bits_size =
    (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? 4'h6 : 4'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_source =
    (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 2'h0) | {muxStateEarly_1, 1'h0};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73, Xbar.scala:240:29
  ...
  assign auto_out_a_bits_mask =
    (muxStateEarly_0 ? auto_in_0_a_bits_mask : 8'h0) | {8{muxStateEarly_1}};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  ...
  assign auto_out_d_ready =
    ~(auto_out_d_bits_source[1]) & auto_in_0_d_ready | requestDOI_0_1;	// Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}
