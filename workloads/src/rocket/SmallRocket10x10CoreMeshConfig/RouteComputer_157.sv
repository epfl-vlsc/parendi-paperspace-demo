...
module RouteComputer_157(
  ...
  wire [1:0] _decoded_T_242 =
    {io_req_4_bits_flow_egress_node[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_244 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[1],
     io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_246 =
    {_GEN[0], io_req_4_bits_flow_egress_node[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
