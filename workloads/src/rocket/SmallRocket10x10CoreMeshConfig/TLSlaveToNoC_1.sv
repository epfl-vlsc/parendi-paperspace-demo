...
module TLSlaveToNoC_1(
  ...
  input  [8:0]  io_tilelink_b_bits_source,
  ...
  input  [8:0]  io_tilelink_d_bits_source,
  ...
  output [8:0]  io_tilelink_a_bits_source,
  ...
  output [8:0]  io_tilelink_c_bits_source,
