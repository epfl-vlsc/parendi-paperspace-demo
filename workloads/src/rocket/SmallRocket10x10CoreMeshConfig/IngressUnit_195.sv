...
module IngressUnit_195(
  ...
  wire [6:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 7'h61 : 7'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 7'h63 : 7'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 7'h62 : 7'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest =
    {_route_buffer_io_enq_bits_flow_egress_node_WIRE[6:5],
     _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 4'h9;	// IngressUnit.scala:41:50, :55:59, Mux.scala:27:73
  wire        _T_13 =
