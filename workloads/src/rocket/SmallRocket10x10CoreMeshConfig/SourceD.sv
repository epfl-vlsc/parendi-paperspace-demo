...
module SourceD(
  ...
  reg  [8:0]      s1_req_reg_source;	// Reg.scala:19:16
  ...
  reg  [8:0]      s2_req_source;	// Reg.scala:19:16
  ...
  reg  [8:0]      s3_req_source;	// Reg.scala:19:16
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[26:18];	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_offset = {_RANDOM_0[31], _RANDOM_1[4:0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = _RANDOM_1[10:5];	// Reg.scala:19:16
        s1_req_reg_set = _RANDOM_1[17:11];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[20:18];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[23:21];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[24];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[25];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[26];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[27];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[28];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[29];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[30];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = {_RANDOM_1[31], _RANDOM_2[1:0]};	// Reg.scala:19:16
        s2_bypass = _RANDOM_2[2];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_2[3];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_2[5];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[9:7];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[12:10];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[15:13];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[24:16];	// Reg.scala:19:16
        s2_req_put = _RANDOM_3[8:3];	// Reg.scala:19:16
        s2_req_set = _RANDOM_3[15:9];	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[18:16];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[21:19];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[22];	// Reg.scala:19:16
        s2_last = _RANDOM_3[23];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[24];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[25];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[26];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[27];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:28], _RANDOM_4, _RANDOM_5[27:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = {_RANDOM_5[31:28], _RANDOM_6[3:0]};	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_6[4];	// Reg.scala:19:16
        s3_full = _RANDOM_6[5];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_6[6];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_beat = _RANDOM_6[9:7];	// Reg.scala:19:16
        s3_bypass = _RANDOM_6[10];	// Reg.scala:19:16
        s3_req_prio_0 = _RANDOM_6[11];	// Reg.scala:19:16
        s3_req_prio_2 = _RANDOM_6[13];	// Reg.scala:19:16
        s3_req_opcode = _RANDOM_6[17:15];	// Reg.scala:19:16
        s3_req_param = _RANDOM_6[20:18];	// Reg.scala:19:16
        s3_req_size = _RANDOM_6[23:21];	// Reg.scala:19:16
        s3_req_source = {_RANDOM_6[31:24], _RANDOM_7[0]};	// Reg.scala:19:16
        s3_req_set = _RANDOM_7[23:17];	// Reg.scala:19:16
        s3_req_sink = _RANDOM_7[26:24];	// Reg.scala:19:16
        s3_req_way = _RANDOM_7[29:27];	// Reg.scala:19:16
        s3_req_bad = _RANDOM_7[30];	// Reg.scala:19:16
        s3_pdata_data = {_RANDOM_8, _RANDOM_9};	// Reg.scala:19:16
        s3_pdata_mask = _RANDOM_10[7:0];	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_10[8];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_10[9];	// Reg.scala:19:16
        s3_retires = _RANDOM_10[10];	// Reg.scala:19:16
        s3_need_r = _RANDOM_10[11];	// Reg.scala:19:16
        s4_full = _RANDOM_10[12];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_beat = _RANDOM_10[15:13];	// Reg.scala:19:16
        s4_need_bs = _RANDOM_10[17];	// Reg.scala:19:16
        s4_need_pb = _RANDOM_10[18];	// Reg.scala:19:16
        s4_req_prio_2 = _RANDOM_10[21];	// Reg.scala:19:16
        s4_req_param = _RANDOM_10[28:26];	// Reg.scala:19:16
        s4_req_set = _RANDOM_11[31:25];	// Reg.scala:19:16
        s4_req_way = _RANDOM_12[5:3];	// Reg.scala:19:16
        s4_adjusted_opcode = _RANDOM_12[9:7];	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_12[31:10], _RANDOM_13, _RANDOM_14[9:0]};	// Reg.scala:19:16
        s4_pdata_mask = _RANDOM_14[17:10];	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_14[18];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_14[31:19], _RANDOM_15, _RANDOM_16[18:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_17[31:25];	// Reg.scala:19:16
        s5_req_way = _RANDOM_18[5:3];	// Reg.scala:19:16
        s5_beat = _RANDOM_18[9:7];	// Reg.scala:19:16
        s5_dat = {_RANDOM_18[31:10], _RANDOM_19, _RANDOM_20[9:0]};	// Reg.scala:19:16
        s6_req_set = _RANDOM_21[22:16];	// Reg.scala:19:16
        s6_req_way = _RANDOM_21[28:26];	// Reg.scala:19:16
        s6_beat = {_RANDOM_21[31:30], _RANDOM_22[0]};	// Reg.scala:19:16
        s6_dat = {_RANDOM_22[31:1], _RANDOM_23, _RANDOM_24[0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_24[31:1], _RANDOM_25, _RANDOM_26[0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_26[1];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_26[31:2], _RANDOM_27, _RANDOM_28[1:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_3876 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
