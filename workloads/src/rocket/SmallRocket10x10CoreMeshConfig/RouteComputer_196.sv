...
module RouteComputer_196(
  ...
  wire [4:0] _decoded_T_236 =
    {_GEN[0], _GEN[2], _GEN[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_250 =
    {_GEN[1], io_req_2_bits_flow_egress_node[3], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_1 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_280,
      &_decoded_T_304,
      &_decoded_T_308};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_274,
      &_decoded_T_302,
      &_decoded_T_306};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_150, &_decoded_T_192, &_decoded_T_234, &_decoded_T_314};	// Cat.scala:33:92, pla.scala:98:74, :114:39
