...
module CSRFile(
  ...
  wire [6:0]  _GEN_11 =
    ((&{io_rw_addr[2],
        ...
        io_rw_addr[11]})
       ? io_hartid
       : 7'h0) | _io_rw_rdata_T_14[6:0];	// Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74
  wire [2:0]  _GEN_12 =
  ...
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0,
       ...
       ((&{io_rw_addr[2],
          ...
          ? {4'h0, io_interrupts_meip, 4'h0}
          : 9'h0) | _io_rw_rdata_T_14[15:7] | _io_rw_rdata_T_111[15:7]
         | _io_rw_rdata_T_112[15:7] | _io_rw_rdata_T_113[15:7] | _io_rw_rdata_T_114[15:7]
         | _io_rw_rdata_T_115[15:7] | _io_rw_rdata_T_116[15:7] | _io_rw_rdata_T_117[15:7]
         | _io_rw_rdata_T_118[15:7],
       _GEN_11[6:3] | _io_rw_rdata_T_111[6:3] | _io_rw_rdata_T_112[6:3]
         | _io_rw_rdata_T_113[6:3] | _io_rw_rdata_T_114[6:3] | _io_rw_rdata_T_115[6:3]
         | _io_rw_rdata_T_116[6:3] | _io_rw_rdata_T_117[6:3] | _io_rw_rdata_T_118[6:3],
       _GEN_12[2:1],
       _GEN_12[0]
         | (&{decoded_decoded_invInputs[0],
              io_rw_addr[1],
