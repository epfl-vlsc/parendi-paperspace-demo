...
module RouteComputer_177(
  ...
  wire [2:0] _decoded_T_220 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[5], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_226 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[5], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_232 =
    {_GEN[5], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_240 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[5], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
