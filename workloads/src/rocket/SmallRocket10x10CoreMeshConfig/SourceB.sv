...
module SourceB(
  ...
  wire [7:0]  _GEN_6 =
    (_GEN_5[33] ? 8'hFC : 8'h0) | (_GEN_5[34] ? 8'hF8 : 8'h0)
    | (_GEN_5[35] ? 8'hF4 : 8'h0) | (_GEN_5[36] ? 8'hF0 : 8'h0)
    | (_GEN_5[37] ? 8'hEC : 8'h0) | (_GEN_5[38] ? 8'hE8 : 8'h0)
    | (_GEN_5[39] ? 8'hE4 : 8'h0) | (_GEN_5[40] ? 8'hE0 : 8'h0)
    | (_GEN_5[41] ? 8'hDC : 8'h0) | (_GEN_5[42] ? 8'hD8 : 8'h0)
    | (_GEN_5[43] ? 8'hD4 : 8'h0) | (_GEN_5[44] ? 8'hD0 : 8'h0)
    | (_GEN_5[45] ? 8'hCC : 8'h0) | (_GEN_5[46] ? 8'hC8 : 8'h0)
    | (_GEN_5[47] ? 8'hC4 : 8'h0) | (_GEN_5[48] ? 8'hC0 : 8'h0)
    | (_GEN_5[49] ? 8'hBC : 8'h0) | (_GEN_5[50] ? 8'hB8 : 8'h0)
    | (_GEN_5[51] ? 8'hB4 : 8'h0) | (_GEN_5[52] ? 8'hB0 : 8'h0)
    | (_GEN_5[53] ? 8'hAC : 8'h0) | (_GEN_5[54] ? 8'hA8 : 8'h0)
    | (_GEN_5[55] ? 8'hA4 : 8'h0) | (_GEN_5[56] ? 8'hA0 : 8'h0)
    | (_GEN_5[57] ? 8'h9C : 8'h0) | (_GEN_5[58] ? 8'h98 : 8'h0)
    | (_GEN_5[59] ? 8'h94 : 8'h0) | (_GEN_5[60] ? 8'h90 : 8'h0)
    | (_GEN_5[61] ? 8'h8C : 8'h0) | (_GEN_5[62] ? 8'h88 : 8'h0)
    | (_GEN_5[63] ? 8'h84 : 8'h0);	// Mux.scala:27:73, :29:36, SourceB.scala:53:37, :81:23
  wire [6:0]  _GEN_7 =
    _GEN_6[6:0] | (_GEN_5[65] ? 7'h7C : 7'h0) | (_GEN_5[66] ? 7'h78 : 7'h0)
    | (_GEN_5[67] ? 7'h74 : 7'h0) | (_GEN_5[68] ? 7'h70 : 7'h0)
    | (_GEN_5[69] ? 7'h6C : 7'h0) | (_GEN_5[70] ? 7'h68 : 7'h0)
    | (_GEN_5[71] ? 7'h64 : 7'h0) | (_GEN_5[72] ? 7'h60 : 7'h0)
    | (_GEN_5[73] ? 7'h5C : 7'h0) | (_GEN_5[74] ? 7'h58 : 7'h0)
    | (_GEN_5[75] ? 7'h54 : 7'h0) | (_GEN_5[76] ? 7'h50 : 7'h0)
    | (_GEN_5[77] ? 7'h4C : 7'h0) | (_GEN_5[78] ? 7'h48 : 7'h0)
    | (_GEN_5[79] ? 7'h44 : 7'h0);	// Mux.scala:27:73, :29:36, Parameters.scala:220:15, SourceB.scala:53:37
  wire [5:0]  _GEN_8 =
    _GEN_7[5:0] | (_GEN_5[81] ? 6'h3C : 6'h0) | (_GEN_5[82] ? 6'h38 : 6'h0)
    | (_GEN_5[83] ? 6'h34 : 6'h0) | (_GEN_5[84] ? 6'h30 : 6'h0)
    | (_GEN_5[85] ? 6'h2C : 6'h0) | (_GEN_5[86] ? 6'h28 : 6'h0)
    | (_GEN_5[87] ? 6'h24 : 6'h0);	// Mux.scala:27:73, :29:36, Parameters.scala:220:15, SourceB.scala:53:37
  wire [4:0]  _GEN_9 =
    _GEN_8[4:0] | (_GEN_5[89] ? 5'h1C : 5'h0) | (_GEN_5[90] ? 5'h18 : 5'h0)
    | (_GEN_5[91] ? 5'h14 : 5'h0);	// Mux.scala:27:73, :29:36, SourceB.scala:53:37
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      remain <=
        (remain | (_param_T_1 ? io_req_bits_clients : 97'h0))
        & ~(io_b_ready & b_valid ? _GEN_5 : 97'h0);	// Decoupled.scala:51:35, SourceB.scala:46:25, :47:30, :48:30, :49:{23,37,39}, :53:37, :62:{24,37}, :68:21, :69:{19,32}
  ...
  assign io_b_bits_source =
    (_GEN_5[0] ? 9'h180 : 9'h0) | (_GEN_5[1] ? 9'h17C : 9'h0)
    | (_GEN_5[2] ? 9'h178 : 9'h0) | (_GEN_5[3] ? 9'h174 : 9'h0)
    | (_GEN_5[4] ? 9'h170 : 9'h0) | (_GEN_5[5] ? 9'h16C : 9'h0)
    | (_GEN_5[6] ? 9'h168 : 9'h0) | (_GEN_5[7] ? 9'h164 : 9'h0)
    | (_GEN_5[8] ? 9'h160 : 9'h0) | (_GEN_5[9] ? 9'h15C : 9'h0)
    | (_GEN_5[10] ? 9'h158 : 9'h0) | (_GEN_5[11] ? 9'h154 : 9'h0)
    | (_GEN_5[12] ? 9'h150 : 9'h0) | (_GEN_5[13] ? 9'h14C : 9'h0)
    | (_GEN_5[14] ? 9'h148 : 9'h0) | (_GEN_5[15] ? 9'h144 : 9'h0)
    | (_GEN_5[16] ? 9'h140 : 9'h0) | (_GEN_5[17] ? 9'h13C : 9'h0)
    | (_GEN_5[18] ? 9'h138 : 9'h0) | (_GEN_5[19] ? 9'h134 : 9'h0)
    | (_GEN_5[20] ? 9'h130 : 9'h0) | (_GEN_5[21] ? 9'h12C : 9'h0)
    | (_GEN_5[22] ? 9'h128 : 9'h0) | (_GEN_5[23] ? 9'h124 : 9'h0)
    | (_GEN_5[24] ? 9'h120 : 9'h0) | (_GEN_5[25] ? 9'h11C : 9'h0)
    | (_GEN_5[26] ? 9'h118 : 9'h0) | (_GEN_5[27] ? 9'h114 : 9'h0)
    | (_GEN_5[28] ? 9'h110 : 9'h0) | (_GEN_5[29] ? 9'h10C : 9'h0)
    | (_GEN_5[30] ? 9'h108 : 9'h0) | (_GEN_5[31] ? 9'h104 : 9'h0)
    | {_GEN_5[32],
       _GEN_6[7] | _GEN_5[64],
       _GEN_7[6] | _GEN_5[80],
       _GEN_8[5] | _GEN_5[88],
