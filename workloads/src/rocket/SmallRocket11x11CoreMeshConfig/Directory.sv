...
module Directory(
  ...
  input  [117:0] io_write_bits_data_clients,
  ...
  output [117:0] io_result_bits_clients,
  ...
  wire [124:0] _WIRE_7;	// Directory.scala:99:44
  wire [124:0] _WIRE_6;	// Directory.scala:99:44
  wire [124:0] _WIRE_5;	// Directory.scala:99:44
  wire [124:0] _WIRE_4;	// Directory.scala:99:44
  wire [124:0] _WIRE_3;	// Directory.scala:99:44
  wire [124:0] _WIRE_2;	// Directory.scala:99:44
  wire [124:0] _WIRE_1;	// Directory.scala:99:44
  wire [124:0] _WIRE_0;	// Directory.scala:99:44
  ...
  wire [117:0] _write_io_deq_bits_data_clients;	// Decoupled.scala:375:21
  wire [3:0]   _write_io_deq_bits_data_tag;	// Decoupled.scala:375:21
  wire [999:0] _cc_dir_RW0_rdata;	// DescribedSRAM.scala:17:26
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 125'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire         _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[123:122]))
  ...
  wire         _hits_T_13 =
    _cc_dir_RW0_rdata[128:125] == tag & (|(_cc_dir_RW0_rdata[248:247]))
  ...
  wire         _hits_T_20 =
    _cc_dir_RW0_rdata[253:250] == tag & (|(_cc_dir_RW0_rdata[373:372]))
  ...
  wire         _hits_T_27 =
    _cc_dir_RW0_rdata[378:375] == tag & (|(_cc_dir_RW0_rdata[498:497]))
  ...
  wire         _hits_T_34 =
    _cc_dir_RW0_rdata[503:500] == tag & (|(_cc_dir_RW0_rdata[623:622]))
  ...
  wire         _hits_T_41 =
    _cc_dir_RW0_rdata[628:625] == tag & (|(_cc_dir_RW0_rdata[748:747]))
  ...
  wire         _hits_T_48 =
    _cc_dir_RW0_rdata[753:750] == tag & (|(_cc_dir_RW0_rdata[873:872]))
  ...
  wire         _hits_T_55 =
    _cc_dir_RW0_rdata[878:875] == tag & (|(_cc_dir_RW0_rdata[998:997]))
  ...
  Queue_4680 write (	// Decoupled.scala:375:21
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[124] | _hits_T_13 & _cc_dir_RW0_rdata[249]
        | _hits_T_20 & _cc_dir_RW0_rdata[374] | _hits_T_27 & _cc_dir_RW0_rdata[499]
        | _hits_T_34 & _cc_dir_RW0_rdata[624] | _hits_T_41 & _cc_dir_RW0_rdata[749]
        | _hits_T_48 & _cc_dir_RW0_rdata[874] | _hits_T_55 & _cc_dir_RW0_rdata[999]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[124] | victimWayOH[1]
            & _cc_dir_RW0_rdata[249] | victimWayOH[2] & _cc_dir_RW0_rdata[374]
            | victimWayOH[3] & _cc_dir_RW0_rdata[499] | victimWayOH[4]
            & _cc_dir_RW0_rdata[624] | victimWayOH[5] & _cc_dir_RW0_rdata[749]
            | victimWayOH[6] & _cc_dir_RW0_rdata[874] | victimWayOH[7]
            & _cc_dir_RW0_rdata[999];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[123:122] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[248:247] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[373:372] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[498:497] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[623:622] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[748:747] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[873:872] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[998:997] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[123:122] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[248:247] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[373:372] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[498:497] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[623:622] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[748:747] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[873:872] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[998:997] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[121:4] : 118'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[246:129] : 118'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[371:254] : 118'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[496:379] : 118'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[621:504] : 118'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[746:629] : 118'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[871:754] : 118'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[996:879] : 118'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[121:4] : 118'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[246:129] : 118'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[371:254] : 118'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[496:379] : 118'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[621:504] : 118'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[746:629] : 118'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[871:754] : 118'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[996:879] : 118'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[128:125] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[253:250] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[378:375] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[503:500] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[628:625] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[753:750] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[878:875] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[128:125] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[253:250] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[378:375] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[503:500] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[628:625] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[753:750] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[878:875] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
