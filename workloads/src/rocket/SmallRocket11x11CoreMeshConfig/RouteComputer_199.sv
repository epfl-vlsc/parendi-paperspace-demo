...
module RouteComputer_199(
  ...
  wire [2:0] _decoded_T_110 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[6], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_116 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[6], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_122 =
    {_GEN[6], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_130 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
