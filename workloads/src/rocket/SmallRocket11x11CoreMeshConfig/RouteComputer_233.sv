...
module RouteComputer_233(
  ...
  wire [4:0] _decoded_T_236 =
    {_GEN[1],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_238 = {_GEN[1], _GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [6:0] _decoded_T_284 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[5],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_286 =
    {_GEN[1], _GEN[3], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_1 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_312,
      &_decoded_T_318,
      &_decoded_T_320};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_310,
      &_decoded_T_314,
      &_decoded_T_316};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_294,
      &_decoded_T_302};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_136, &_decoded_T_178, &_decoded_T_288};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_136, &_decoded_T_178, &_decoded_T_288};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_136, &_decoded_T_178, &_decoded_T_220, &_decoded_T_286};	// Cat.scala:33:92, pla.scala:98:74, :114:39
