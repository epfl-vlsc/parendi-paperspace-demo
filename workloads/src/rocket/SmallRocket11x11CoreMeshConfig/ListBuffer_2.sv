...
module ListBuffer_2(
  ...
  input  [8:0]  io_push_bits_data_source,
  ...
  output [2:0]  io_data_opcode,
                io_data_param,
                io_data_size,
  output [8:0]  io_data_source,
  output [3:0]  io_data_tag,
  output [5:0]  io_data_offset,
                io_data_put
);

  wire [37:0] _data_ext_R0_data;	// ListBuffer.scala:51:18
  ...
  wire [33:0] freeOH =
    {~(_freeOH_T_15 | {_freeOH_T_15[0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// ListBuffer.scala:53:{16,25,32,38}, package.scala:245:{43,48,53}
  ...
  wire [5:0]  data_MPORT_addr =
    {|(freeOH[33:32]),
     ...
     |(_GEN_0[6:3]),
     |(_GEN_1[2:1]),
     _GEN_1[2] | _GEN_1[0]};	// Cat.scala:33:92, ListBuffer.scala:53:38, OneHot.scala:30:18, :31:18, :32:{14,28}
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valid <=
        valid
        & ~(io_pop_valid & _head_ext_R0_data == _tail_ext_R0_data
              ? _valid_clr_T[20:0]
              : 21'h0) | (data_MPORT_en ? _valid_set_T[20:0] : 21'h0);	// Decoupled.scala:51:35, ListBuffer.scala:46:22, :47:18, :48:18, :56:30, :57:30, :65:23, :66:15, :87:22, :89:{20,48}, :90:17, :98:{21,23,35}, OneHot.scala:64:{12,27}
      used <=
        used & ~(io_pop_valid ? _used_clr_T[32:0] : 33'h0)
        | (data_MPORT_en ? freeOH[32:0] : 33'h0);	// Decoupled.scala:51:35, ListBuffer.scala:49:22, :53:38, :58:30, :59:30, :65:23, :67:14, :87:22, :88:14, :97:{21,23,35}, OneHot.scala:64:{12,27}
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  head_combMem_0 head_ext (	// ListBuffer.scala:47:18
    ...
    .W1_clk  (clock),
    .W1_data
      (data_MPORT_en & _push_valid_T[0] & _tail_ext_R1_data == _head_ext_R0_data
         ? data_MPORT_addr
         : _next_ext_R0_data),	// Cat.scala:33:92, Decoupled.scala:51:35, ListBuffer.scala:47:18, :48:18, :50:18, :62:25, :92:{32,60,73}
  ...
  data_combMem data_ext (	// ListBuffer.scala:51:18
    ...
    .W0_data
      ({io_push_bits_data_put,
        ...
        io_push_bits_data_prio_2,
        1'h0,
        io_push_bits_data_prio_0}),	// ListBuffer.scala:51:18
  ...
  assign io_data_source = _data_ext_R0_data[21:13];	// ListBuffer.scala:51:18
  assign io_data_tag = _data_ext_R0_data[25:22];	// ListBuffer.scala:51:18
  assign io_data_offset = _data_ext_R0_data[31:26];	// ListBuffer.scala:51:18
  assign io_data_put = _data_ext_R0_data[37:32];	// ListBuffer.scala:51:18
endmodule
