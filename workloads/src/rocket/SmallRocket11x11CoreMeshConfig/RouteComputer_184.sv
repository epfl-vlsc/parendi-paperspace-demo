...
module RouteComputer_184(
  ...
  wire [2:0] _decoded_T_230 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[1], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_236 =
    {_GEN_1[1], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [1:0] _decoded_T_244 = {_GEN_1[5], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_246 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
