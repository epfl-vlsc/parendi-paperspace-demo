...
module RouteComputer_208(
  ...
  wire [2:0] _GEN = ~(io_req_3_bits_flow_egress_node[6:4]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [2:0] _decoded_T_173 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[2], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_179 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[2], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_185 =
    {_GEN[2], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_195 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[2], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
