...
module RouteComputer_129(
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_170, &_decoded_T_172, &_decoded_T_174, io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_2_4 =
    &{_GEN_0[0], io_req_1_bits_flow_egress_node[1], io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74
  ...
  assign io_resp_1_vc_sel_1_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_61, &_decoded_T_65};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_1_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_61, &_decoded_T_65};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_1_4 =
    |{io_req_1_bits_flow_egress_node_id[1],
      &_decoded_T_61,
      &{_GEN_0[1], io_req_1_bits_src_virt_id[2]},
      &{io_req_1_bits_flow_egress_node[0], io_req_1_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
