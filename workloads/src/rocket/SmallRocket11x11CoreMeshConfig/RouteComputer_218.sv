...
module RouteComputer_218(
  ...
  wire [2:0] _decoded_T_327 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[6], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_333 =
    {_GEN_0[6], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_335 =
    {io_req_4_bits_flow_egress_node[5],
     io_req_4_bits_flow_egress_node[6],
  ...
  wire [1:0] _decoded_T_339 = {_GEN_0[6], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_343 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[6], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_4_vc_sel_1_4 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_337,
      &_decoded_T_339};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_1 = |{&_decoded_T_323, &_decoded_T_329, &_decoded_T_347};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_2 = |{&_decoded_T_323, &_decoded_T_329, &_decoded_T_347};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_323, &_decoded_T_329, &_decoded_T_335, &_decoded_T_345};	// Cat.scala:33:92, pla.scala:98:74, :114:39
