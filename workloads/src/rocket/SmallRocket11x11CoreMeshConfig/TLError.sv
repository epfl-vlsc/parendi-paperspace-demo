...
module TLError(
  ...
  wire            a_last =
    a_last_counter == 9'h1
    | (_a_io_deq_bits_opcode[2] ? 9'h0 : ~(_a_last_beats1_decode_T_1[11:3])) == 9'h0;	// Decoupled.scala:375:21, Edges.scala:92:37, :221:14, :229:27, :232:{25,33,43}, package.scala:235:{46,71,76}
  ...
  wire            _a_io_deq_ready_T_3 =
    ...
    | ~a_last;	// Edges.scala:106:36, :221:14, :229:27, :232:{25,33,43}, Error.scala:32:{26,46,49}, :35:21, package.scala:235:{46,71,76}
  ...
  Queue_4663 a (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
