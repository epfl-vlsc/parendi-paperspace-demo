...
module TLAtomicAutomata(
  ...
  wire [6:0]      _GEN_1 =
    {cam_a_0_bits_data[55],
     ...
     cam_a_0_bits_data[7]} & ~_GEN_0;	// AtomicAutomata.scala:79:24, :115:63, :123:{23,31}, :127:38, Cat.scala:33:92
  wire [6:0]      _GEN_2 =
    {cam_d_0_data[55],
     cam_d_0_data[47],
     cam_d_0_data[39],
     ...
     cam_d_0_data[23],
     cam_d_0_data[15],
     cam_d_0_data[7]} & ~_GEN_0;	// AtomicAutomata.scala:80:24, :115:73, :123:{23,31}, :128:38, Cat.scala:33:92
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[19:11];	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_address = {_RANDOM_0[31:20], _RANDOM_1[2:0]};	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_mask = _RANDOM_1[10:3];	// AtomicAutomata.scala:79:24
        cam_a_0_bits_data = {_RANDOM_1[31:11], _RANDOM_2, _RANDOM_3[10:0]};	// AtomicAutomata.scala:79:24
        cam_a_0_bits_corrupt = _RANDOM_3[11];	// AtomicAutomata.scala:79:24
        cam_a_0_fifoId = _RANDOM_3[12];	// AtomicAutomata.scala:79:24
        cam_a_0_lut = _RANDOM_3[16:13];	// AtomicAutomata.scala:79:24
        cam_d_0_data = {_RANDOM_3[31:17], _RANDOM_4, _RANDOM_5[16:0]};	// AtomicAutomata.scala:79:24, :80:24
        cam_d_0_denied = _RANDOM_5[17];	// AtomicAutomata.scala:80:24
        cam_d_0_corrupt = _RANDOM_5[18];	// AtomicAutomata.scala:80:24
        beatsLeft = _RANDOM_5[21:19];	// Arbiter.scala:88:30, AtomicAutomata.scala:80:24
        state_0 = _RANDOM_5[22];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        state_1 = _RANDOM_5[23];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        d_first_counter = _RANDOM_5[26:24];	// AtomicAutomata.scala:80:24, Edges.scala:229:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_opcode =
    muxStateEarly_1 ? (_GEN ? 3'h4 : auto_in_a_bits_opcode) : 3'h0;	// Arbiter.scala:118:30, AtomicAutomata.scala:94:{32,63}, :154:24, :155:31, :156:32, Misc.scala:201:34, Mux.scala:27:73
  ...
  assign auto_out_a_bits_size =
    ...
    | (muxStateEarly_1 ? auto_in_a_bits_size : 3'h0);	// Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Misc.scala:201:34, Mux.scala:27:73
  assign auto_out_a_bits_source =
    (muxStateEarly_0 ? cam_a_0_bits_source : 9'h0)
    | (muxStateEarly_1 ? auto_in_a_bits_source : 9'h0);	// Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_address =
    (muxStateEarly_0 ? cam_a_0_bits_address : 15'h0)
    | (muxStateEarly_1 ? auto_in_a_bits_address : 15'h0);	// Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73
