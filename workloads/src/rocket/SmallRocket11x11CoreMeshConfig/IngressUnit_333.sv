...
module IngressUnit_333(
  ...
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 7'h6F;	// IngressUnit.scala:55:59, Mux.scala:27:73
  wire        _T_13 =
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (8'h6F),
  ...
  Queue_6 route_q (	// IngressUnit.scala:27:23
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 8'hDF),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 8'hDE),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
