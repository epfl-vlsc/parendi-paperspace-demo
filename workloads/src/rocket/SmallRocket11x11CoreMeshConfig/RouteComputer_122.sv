...
module RouteComputer_122(
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_80, &_decoded_T_82, &_decoded_T_84, io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_1_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_41, &_decoded_T_44};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_1_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_41, &_decoded_T_44};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_1_4 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_41, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
