...
module RotatingSingleVCAllocator_131(
  input  clock,
         reset,
         io_req_2_valid,
  ...
  assign in_arb_vals_0 =
    io_req_0_valid
    & (in_arb_reqs_0_1_1 | in_arb_reqs_0_1_2 | in_arb_reqs_0_1_3 | in_arb_reqs_0_1_4
       | in_arb_reqs_0_2_0 | in_arb_reqs_0_2_1 | in_arb_reqs_0_2_2 | in_arb_reqs_0_2_3
       | in_arb_reqs_0_2_4);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  wire        in_arb_reqs_1_0_0 =
    io_req_1_bits_vc_sel_0_0 & ~io_channel_status_0_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  ...
  wire        in_arb_reqs_1_2_0 =
    io_req_1_bits_vc_sel_2_0 & ~io_channel_status_2_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  wire        in_arb_reqs_1_2_1 =
    io_req_1_bits_vc_sel_2_1 & ~io_channel_status_2_1_occupied;	// SingleVCAllocator.scala:28:{61,64}
  wire        in_arb_reqs_1_2_2 =
    io_req_1_bits_vc_sel_2_2 & ~io_channel_status_2_2_occupied;	// SingleVCAllocator.scala:28:{61,64}
  wire        in_arb_reqs_1_2_3 =
    io_req_1_bits_vc_sel_2_3 & ~io_channel_status_2_3_occupied;	// SingleVCAllocator.scala:28:{61,64}
  ...
  assign in_arb_vals_1 =
    io_req_1_valid
    & (in_arb_reqs_1_0_0 | in_arb_reqs_1_0_1 | in_arb_reqs_1_0_2 | in_arb_reqs_1_0_3
       | in_arb_reqs_1_0_4 | in_arb_reqs_1_2_0 | in_arb_reqs_1_2_1 | in_arb_reqs_1_2_2
       | in_arb_reqs_1_2_3 | in_arb_reqs_1_2_4);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  wire        in_arb_reqs_2_0_0 =
    io_req_2_bits_vc_sel_0_0 & ~io_channel_status_0_0_occupied;	// SingleVCAllocator.scala:28:{61,64}
  ...
  assign in_arb_vals_2 =
    io_req_2_valid
    & (in_arb_reqs_2_0_0 | in_arb_reqs_2_0_1 | in_arb_reqs_2_0_2 | in_arb_reqs_2_0_3
       | in_arb_reqs_2_0_4 | in_arb_reqs_2_1_1 | in_arb_reqs_2_1_2 | in_arb_reqs_2_1_3
       | in_arb_reqs_2_1_4);	// SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59
  wire        _in_vc_sel_WIRE_1 =
    in_arb_sel[1] & in_arb_reqs_1_0_0 | in_arb_sel[2] & in_arb_reqs_2_0_0;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_2 =
    in_arb_sel[1] & in_arb_reqs_1_0_1 | in_arb_sel[2] & in_arb_reqs_2_0_1;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_3 =
    in_arb_sel[1] & in_arb_reqs_1_0_2 | in_arb_sel[2] & in_arb_reqs_2_0_2;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_4 =
    in_arb_sel[1] & in_arb_reqs_1_0_3 | in_arb_sel[2] & in_arb_reqs_2_0_3;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_5 =
    in_arb_sel[1] & in_arb_reqs_1_0_4 | in_arb_sel[2] & in_arb_reqs_2_0_4;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_8 =
    in_arb_sel[0] & in_arb_reqs_0_1_1 | in_arb_sel[2] & in_arb_reqs_2_1_1;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_9 =
    in_arb_sel[0] & in_arb_reqs_0_1_2 | in_arb_sel[2] & in_arb_reqs_2_1_2;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_10 =
    in_arb_sel[0] & in_arb_reqs_0_1_3 | in_arb_sel[2] & in_arb_reqs_2_1_3;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_11 =
    in_arb_sel[0] & in_arb_reqs_0_1_4 | in_arb_sel[2] & in_arb_reqs_2_1_4;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_13 =
    in_arb_sel[0] & in_arb_reqs_0_2_0 | in_arb_sel[1] & in_arb_reqs_1_2_0;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_14 =
    in_arb_sel[0] & in_arb_reqs_0_2_1 | in_arb_sel[1] & in_arb_reqs_1_2_1;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_15 =
    in_arb_sel[0] & in_arb_reqs_0_2_2 | in_arb_sel[1] & in_arb_reqs_1_2_2;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_16 =
    in_arb_sel[0] & in_arb_reqs_0_2_3 | in_arb_sel[1] & in_arb_reqs_1_2_3;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  wire        _in_vc_sel_WIRE_17 =
    in_arb_sel[0] & in_arb_reqs_0_2_4 | in_arb_sel[1] & in_arb_reqs_1_2_4;	// Mux.scala:27:73, :29:36, SingleVCAllocator.scala:20:57, :28:61
  ...
  wire [14:0] _in_alloc_full_T_1 =
    {_in_vc_sel_WIRE_17,
     ...
     _in_vc_sel_WIRE_3,
     _in_vc_sel_WIRE_2,
     _in_vc_sel_WIRE_1} & ~in_alloc_mask;	// ISLIP.scala:17:25, :18:{29,31}, :33:18, Mux.scala:27:73
  wire [29:0] in_alloc_oh =
    _in_alloc_full_T_1[0]
      ? 30'h1
      : _in_alloc_full_T_1[1]
          ? 30'h2
          : _in_alloc_full_T_1[2]
              ? 30'h4
              : _in_alloc_full_T_1[3]
                  ? 30'h8
                  : _in_alloc_full_T_1[4]
                      ? 30'h10
                      : _in_alloc_full_T_1[6]
                          ? 30'h40
                          : _in_alloc_full_T_1[7]
                              ? 30'h80
                              : _in_alloc_full_T_1[8]
                                  ? 30'h100
                                  : _in_alloc_full_T_1[9]
                                      ? 30'h200
                                      : _in_alloc_full_T_1[10]
                                          ? 30'h400
                                          : _in_alloc_full_T_1[11]
                                              ? 30'h800
                                              : _in_alloc_full_T_1[12]
                                                  ? 30'h1000
                                                  : _in_alloc_full_T_1[13]
                                                      ? 30'h2000
                                                      : _in_alloc_full_T_1[14]
                                                          ? 30'h4000
                                                          : _in_vc_sel_WIRE_1
                                                              ? 30'h8000
                                                              : _in_vc_sel_WIRE_2
  ...
  wire        in_alloc_2_0 = _in_alloc_T_1 & _in_alloc_WIRE_1[10];	// ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59
  ...
  wire        in_alloc_0_0 = _in_alloc_T_1 & _in_alloc_WIRE_1[0];	// ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1:0]  _GEN_4 = {1'h0, _in_alloc_T_1 & _in_alloc_WIRE_1[5]};	// Bitwise.scala:51:90, ISLIP.scala:20:28, :33:40, SingleVCAllocator.scala:41:18, package.scala:73:59
    wire  [1:0]  _GEN_5 = {1'h0, in_alloc_1_1};	// Bitwise.scala:51:90, SingleVCAllocator.scala:41:18
    ...
    wire  [1:0]  _GEN_10 = {1'h0, in_alloc_2_1};	// Bitwise.scala:51:90, SingleVCAllocator.scala:41:18
    wire  [1:0]  _GEN_11 = {1'h0, in_alloc_2_2};	// Bitwise.scala:51:90, SingleVCAllocator.scala:41:18
    ...
    wire  [3:0]  _T_45 =
      {1'h0,
       {1'h0, _GEN_1 + _GEN + _GEN_0} + {1'h0, _GEN_2 + _GEN_3} + {1'h0, _GEN_4 + _GEN_5}}
      + {1'h0, {1'h0, _GEN_6 + _GEN_7} + {1'h0, _GEN_8 + _GEN_9}}
      + {1'h0, {1'h0, _GEN_10 + _GEN_11} + {1'h0, _GEN_12 + _GEN_13}};	// Bitwise.scala:51:90
    wire  [3:0]  _T_93 =
      {1'h0,
       {1'h0, _GEN_1 + _GEN + _GEN_0} + {1'h0, _GEN_2 + _GEN_3} + {1'h0, _GEN_4 + _GEN_5}}
      + {1'h0, {1'h0, _GEN_6 + _GEN_7} + {1'h0, _GEN_8 + _GEN_9}}
    ...
    always @(posedge clock) begin	// SingleVCAllocator.scala:53:11
      if (~reset & (|(_T_45[3:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
      ...
      if (~reset & (|(_T_93[3:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
        if (`ASSERT_VERBOSE_COND_)	// SingleVCAllocator.scala:53:11
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// SingleVCAllocator.scala:53:11
        if (`STOP_COND_)	// SingleVCAllocator.scala:53:11
          $fatal;	// SingleVCAllocator.scala:53:11
      end
      if (~reset & (|(_T_141[3:1]))) begin	// Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}
        if (`ASSERT_VERBOSE_COND_)	// SingleVCAllocator.scala:53:11
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// SingleVCAllocator.scala:53:11
        if (`STOP_COND_)	// SingleVCAllocator.scala:53:11
          $fatal;	// SingleVCAllocator.scala:53:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        in_alloc_mask = _RANDOM_0[17:3];	// ISLIP.scala:17:25, SingleVCAllocator.scala:16:21
      `endif // RANDOMIZE_REG_INIT
    end // initial
