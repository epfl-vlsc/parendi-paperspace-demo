...
module RouteComputer_217(
  ...
  wire [1:0] _GEN_1 = ~(io_req_4_bits_flow_egress_node[4:3]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [3:0] _decoded_T_236 =
    {_GEN_1[0], _GEN_1[1], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_240 =
    {io_req_4_bits_flow_egress_node[4],
     io_req_4_bits_src_virt_id[0],
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_242 = {_GEN_1[0], _GEN_1[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_224, &_decoded_T_230, &_decoded_T_236, &_decoded_T_242};	// Cat.scala:33:92, pla.scala:98:74, :114:39
