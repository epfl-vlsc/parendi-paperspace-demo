...
module IngressUnit_129(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 8'hEC;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 =
    io_in_bits_egress_id == 8'hEF;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 =
    io_in_bits_egress_id == 8'hF2;	// IngressUnit.scala:30:72
  wire [6:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 7'h76 : 7'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 7'h78 : 7'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 7'h77 : 7'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 7'h2B;	// IngressUnit.scala:55:59, Mux.scala:27:73
  wire        _T_13 =
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (8'h2B),
