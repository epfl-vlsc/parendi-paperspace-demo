...
module RouteComputer_232(
  ...
  wire [5:0] _decoded_T_182 =
    {io_req_2_bits_flow_egress_node[0],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_184 = {_GEN[0], _GEN[2], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_186 = {_GEN[0], _GEN[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_192 =
    {io_req_2_bits_flow_egress_node[0], _GEN[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_196 =
    {_GEN[1], io_req_2_bits_flow_egress_node[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [5:0] _decoded_T_214 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[3],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_216 =
    {_GEN[0], _GEN[2], io_req_2_bits_flow_egress_node[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_204,
      &_decoded_T_216,
      &_decoded_T_228};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_216,
      &_decoded_T_228};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_126, &_decoded_T_150, &_decoded_T_214};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_126, &_decoded_T_150, &_decoded_T_214};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_126, &_decoded_T_150, &_decoded_T_174, &_decoded_T_212};	// Cat.scala:33:92, pla.scala:98:74, :114:39
