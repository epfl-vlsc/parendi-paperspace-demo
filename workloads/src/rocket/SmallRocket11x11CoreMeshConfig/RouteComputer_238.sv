...
module RouteComputer_238(
  ...
  wire [5:0] _decoded_T_260 =
    {_GEN[1],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_262 = {_GEN[1], _GEN[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_264 = {_GEN[0], _GEN[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [5:0] _decoded_T_272 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_274 =
    {_GEN[1], io_req_2_bits_flow_egress_node[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [8:0] _decoded_T_280 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_282 =
    {_GEN[0], io_req_2_bits_flow_egress_node[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [6:0] _decoded_T_326 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_328 =
    {_GEN[0], _GEN[3], io_req_2_bits_flow_egress_node[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_330 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[5],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_332 =
    {io_req_2_bits_flow_egress_node[0],
     _GEN[4],
     io_req_2_bits_flow_egress_node[5],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_334 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[0],
     _GEN[4],
     io_req_2_bits_flow_egress_node[5],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_336 =
    {io_req_2_bits_flow_egress_node[1],
     _GEN[2],
     io_req_2_bits_flow_egress_node[3],
     _GEN[4],
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_346,
      &_decoded_T_350,
      &_decoded_T_358};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_336,
      &_decoded_T_342};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_158, &_decoded_T_208, &_decoded_T_356};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_158, &_decoded_T_208, &_decoded_T_356};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_158, &_decoded_T_208, &_decoded_T_258, &_decoded_T_354};	// Cat.scala:33:92, pla.scala:98:74, :114:39
