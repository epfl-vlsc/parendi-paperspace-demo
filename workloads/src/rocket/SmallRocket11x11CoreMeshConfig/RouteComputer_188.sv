...
module RouteComputer_188(
  ...
  wire [1:0] _decoded_T_122 =
    {~(io_req_2_bits_flow_egress_node[6]), io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [1:0] _decoded_T_126 =
    {io_req_2_bits_flow_egress_node[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
