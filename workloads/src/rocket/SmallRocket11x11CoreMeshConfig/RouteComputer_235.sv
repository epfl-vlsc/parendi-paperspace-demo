...
module RouteComputer_235(
  ...
  wire [3:0] _decoded_T_202 =
    {_GEN[2], _GEN[4], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [6:0] _decoded_T_246 =
    {_GEN[0],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_248 = {_GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_250 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[2],
     _GEN[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_252 =
    {io_req_2_bits_flow_egress_node[1], _GEN[3], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_272 =
    {_GEN[0], io_req_2_bits_flow_egress_node[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_274 =
    {_GEN[1], io_req_2_bits_flow_egress_node[3], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_298,
      &_decoded_T_314,
      &_decoded_T_338};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_296,
      &_decoded_T_312,
      &_decoded_T_336};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_312,
      &_decoded_T_336};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_134, &_decoded_T_178, &_decoded_T_294};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_134, &_decoded_T_178, &_decoded_T_294};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_134, &_decoded_T_178, &_decoded_T_224, &_decoded_T_292};	// Cat.scala:33:92, pla.scala:98:74, :114:39
