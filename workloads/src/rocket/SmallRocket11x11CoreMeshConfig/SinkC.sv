...
module SinkC(
  ...
  output [8:0]  io_resp_bits_source,
  ...
  wire [8:0]  _c_io_deq_bits_source;	// Decoupled.scala:375:21
  ...
  Queue_4676 c (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_4677 io_bs_adr_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
