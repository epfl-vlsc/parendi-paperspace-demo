...
module EgressUnit_244(
  ...
  wire       _q_io_enq_bits_ingress_id_T_352 = io_in_0_bits_flow_ingress_node_id == 2'h2;	// EgressUnit.scala:32:27
  wire [8:0] _GEN =
  ...
  wire [8:0] _GEN_0 =
    ...
    | {1'h0,
       ...
       1'h0,
       io_in_0_bits_flow_ingress_node == 8'h0 & _q_io_enq_bits_ingress_id_T_352,
       1'h0}
