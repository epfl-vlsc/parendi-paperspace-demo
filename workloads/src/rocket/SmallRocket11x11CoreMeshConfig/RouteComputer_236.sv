...
module RouteComputer_236(
  ...
  wire [4:0] _decoded_T_250 =
    {io_req_2_bits_flow_egress_node[2],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_252 = {_GEN[0], _GEN[4], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_256 =
    {io_req_2_bits_flow_egress_node[0], _GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_330 =
    {_GEN[1], _GEN[3], io_req_2_bits_flow_egress_node[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_304,
      &_decoded_T_308,
      &_decoded_T_328};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_302,
      &_decoded_T_306,
      &_decoded_T_326};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_306,
      &_decoded_T_326};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_156, &_decoded_T_200, &_decoded_T_340};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_156, &_decoded_T_200, &_decoded_T_340};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_156, &_decoded_T_200, &_decoded_T_248, &_decoded_T_338};	// Cat.scala:33:92, pla.scala:98:74, :114:39
