...
module TLXbar_4(
  ...
  input  [8:0]  auto_out_3_d_bits_source,
  ...
  output [8:0]  auto_out_3_a_bits_source,
  output [16:0] auto_out_3_a_bits_address,
  ...
  output [14:0] auto_out_2_a_bits_address,
  ...
  wire        requestAIO_0_0 =
    {auto_in_a_bits_address[25],
     ...
     auto_in_a_bits_address[14]} == 3'h0;	// Bundles.scala:259:74, Parameters.scala:137:{45,65}
  wire [9:0]  _GEN = auto_in_a_bits_address[25:16] ^ 10'h201;	// Parameters.scala:137:31
  wire        requestAIO_0_1 = {_GEN[9], _GEN[0], auto_in_a_bits_address[14]} == 3'h0;	// Bundles.scala:259:74, Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_2 =
    {auto_in_a_bits_address[25],
     auto_in_a_bits_address[16],
     ~(auto_in_a_bits_address[14])} == 3'h0;	// Bundles.scala:259:74, Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_3 =
    {auto_in_a_bits_address[25], ~(auto_in_a_bits_address[16])} == 2'h0;	// Parameters.scala:137:{31,45,65}
  reg  [8:0]  beatsLeft;	// Arbiter.scala:88:30
  wire        idle = beatsLeft == 9'h0;	// Arbiter.scala:88:30, :89:28, Bundles.scala:259:74
  wire [3:0]  readys_valid =
    {auto_out_3_d_valid, auto_out_2_d_valid, auto_out_1_d_valid, auto_out_0_d_valid};	// Cat.scala:33:92
  ...
  wire [2:0]  _GEN_0 = _readys_filter_T_1[2:0] | _readys_filter_T_1[3:1];	// Arbiter.scala:25:28, package.scala:254:43
  wire        _GEN_1 = auto_out_3_d_valid | _readys_filter_T_1[0];	// Arbiter.scala:25:28, package.scala:254:43
  wire [3:0]  readys_readys =
    ~({readys_mask[3],
       _readys_filter_T_1[3] | readys_mask[2],
       _GEN_0[2] | readys_mask[1],
       _GEN_0[1] | _readys_filter_T_1[3] | readys_mask[0]}
      & {_GEN_0[0] | _GEN_0[2],
         _GEN_1 | _GEN_0[1],
         auto_out_2_d_valid | auto_out_3_d_valid | _GEN_0[0],
         auto_out_1_d_valid | auto_out_2_d_valid | _GEN_1});	// Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43
  ...
  wire        out_15_valid =
    idle
      ...
      : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2
        & auto_out_2_d_valid | state_3 & auto_out_3_d_valid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Mux.scala:27:73
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 9'h0;	// Arbiter.scala:88:30, Bundles.scala:259:74
          ...
          | {6'h0,
             (winnerQual_1 & auto_out_1_d_bits_opcode[0]
               ...
               | (winnerQual_2 & auto_out_2_d_bits_opcode[0]
                    ...
                    : 3'h0) | (winnerQual_3 ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0)};	// Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}
      else	// Arbiter.scala:90:24
        beatsLeft <= beatsLeft - {8'h0, auto_in_d_ready & out_15_valid};	// Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33
      if (latch & (|readys_valid))	// Arbiter.scala:28:{18,27}, :90:24, Cat.scala:33:92
        readys_mask <= _readys_mask_T_3 | {_readys_mask_T_3[1:0], 2'h0};	// Arbiter.scala:24:23, package.scala:245:{43,53}
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// Arbiter.scala:106:13
      if (~reset
          & ~((~earlyWinner_0 | ~earlyWinner_1) & (~prefixOR_2 | ~earlyWinner_2)
              & (~(prefixOR_2 | earlyWinner_2) | ~earlyWinner_3))) begin	// Arbiter.scala:98:79, :105:53, :106:{13,61,64,67,82}
      ...
      if (~reset
          & ~(~(_sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid)
              | earlyWinner_0 | earlyWinner_1 | earlyWinner_2 | earlyWinner_3)) begin	// Arbiter.scala:98:79, :108:{14,15,36,41}
      ...
      if (~reset
          & ~(~(_T_33 | auto_out_2_d_valid | auto_out_3_d_valid) | _T_33
              | auto_out_2_d_valid | auto_out_3_d_valid)) begin	// Arbiter.scala:109:{14,15,36,41}
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[12:9];	// Arbiter.scala:24:23, :88:30
        state_0 = _RANDOM_0[13];	// Arbiter.scala:88:30, :117:26
        state_1 = _RANDOM_0[14];	// Arbiter.scala:88:30, :117:26
        state_2 = _RANDOM_0[15];	// Arbiter.scala:88:30, :117:26
        state_3 = _RANDOM_0[16];	// Arbiter.scala:88:30, :117:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_a_ready =
    ...
    | requestAIO_0_2 & auto_out_2_a_ready | requestAIO_0_3 & auto_out_3_a_ready;	// Mux.scala:27:73, Parameters.scala:137:65
  ...
  assign auto_in_d_bits_opcode =
    ...
    | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_3};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_in_d_bits_param =
    (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0)
    | (muxStateEarly_2 ? auto_out_2_d_bits_param : 2'h0);	// Arbiter.scala:118:30, Mux.scala:27:73
  assign auto_in_d_bits_size =
    ...
    | (muxStateEarly_3 ? {1'h0, auto_out_3_d_bits_size} : 4'h0);	// Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_in_d_bits_source =
    (muxStateEarly_0 ? auto_out_0_d_bits_source : 9'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_source : 9'h0)
    | (muxStateEarly_2 ? auto_out_2_d_bits_source : 9'h0)
    | (muxStateEarly_3 ? auto_out_3_d_bits_source : 9'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_in_d_bits_sink =
    muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink
    | muxStateEarly_2 & auto_out_2_d_bits_sink;	// Arbiter.scala:118:30, Mux.scala:27:73
  assign auto_in_d_bits_denied =
    muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1
    & auto_out_1_d_bits_denied | muxStateEarly_2 & auto_out_2_d_bits_denied;	// Arbiter.scala:118:30, Mux.scala:27:73
  assign auto_in_d_bits_data =
    ...
    | (muxStateEarly_3 ? auto_out_3_d_bits_data : 64'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_in_d_bits_corrupt =
    muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1
    & auto_out_1_d_bits_corrupt | muxStateEarly_2 & auto_out_2_d_bits_corrupt;	// Arbiter.scala:118:30, Mux.scala:27:73
  ...
  assign auto_out_3_a_bits_address = auto_in_a_bits_address[16:0];	// BundleMap.scala:247:19
  ...
  assign auto_out_2_a_bits_address = auto_in_a_bits_address[14:0];	// BundleMap.scala:247:19
