...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 8'h76 & _q_io_enq_bits_ingress_id_T_7
          ? 9'h163
          : 9'h0)
       | (io_in_0_bits_flow_ingress_node == 8'h78 & _q_io_enq_bits_ingress_id_T_7
            ? 9'h165
            : 9'h0)
       | (io_in_0_bits_flow_ingress_node == 8'h77 & _q_io_enq_bits_ingress_id_T_7
            ? 9'h167
