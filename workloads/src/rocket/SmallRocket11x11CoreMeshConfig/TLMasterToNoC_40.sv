...
module TLMasterToNoC_40(
  ...
  input  [8:0]  io_tilelink_a_bits_source,
  ...
  input  [8:0]  io_tilelink_c_bits_source,
  ...
  output [8:0]  io_tilelink_b_bits_source,
  ...
  output [8:0]  io_tilelink_d_bits_source,
  ...
  output [7:0]  io_flits_a_bits_egress_id,
  ...
  wire [8:0]  _d_io_protocol_bits_source;	// Tilelink.scala:224:17
  wire [64:0] _c_io_flit_bits_payload;	// Tilelink.scala:223:17
  wire [8:0]  _b_io_protocol_bits_source;	// Tilelink.scala:222:17
  TLAToNoC a (	// Tilelink.scala:221:17
    ...
    .io_protocol_bits_source  (io_tilelink_a_bits_source | 9'h134),	// Tilelink.scala:227:58
  ...
  TLCToNoC c (	// Tilelink.scala:223:17
    ...
    .io_protocol_bits_source  (io_tilelink_c_bits_source | 9'h134),	// Tilelink.scala:227:58, :231:58
  ...
  assign io_tilelink_b_bits_source = {7'h0, _b_io_protocol_bits_source[1:0]};	// Tilelink.scala:219:67, :222:17, :229:29
  assign io_tilelink_d_bits_source = {7'h0, _d_io_protocol_bits_source[1:0]};	// Tilelink.scala:219:67, :224:17, :229:29, :233:29
