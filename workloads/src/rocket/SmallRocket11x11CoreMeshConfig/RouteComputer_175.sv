...
module RouteComputer_175(
  ...
  wire [3:0] _decoded_T_187 =
    {_GEN[0],
     ...
     io_req_3_bits_src_virt_id[0],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_189 = {_GEN[2], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [1:0] _decoded_T_195 =
    {io_req_3_bits_flow_egress_node[0], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_197 =
    {_GEN[0], io_req_3_bits_flow_egress_node[2], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
