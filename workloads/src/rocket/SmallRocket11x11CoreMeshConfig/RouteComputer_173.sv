...
module RouteComputer_173(
  ...
  wire [1:0] _GEN_1 = ~(io_req_4_bits_flow_egress_node[3:2]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [2:0] _decoded_T_250 =
    {io_req_4_bits_flow_egress_node[2], _GEN_1[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_4_vc_sel_1_4 =
    |{&_decoded_T_224,
      ...
      &_decoded_T_242,
      &_decoded_T_246};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_1 = |{&_decoded_T_226, &_decoded_T_234, &_decoded_T_252};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_2 = |{&_decoded_T_226, &_decoded_T_234, &_decoded_T_252};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_226, &_decoded_T_234, &_decoded_T_240, &_decoded_T_250};	// Cat.scala:33:92, pla.scala:98:74, :114:39
