...
module RouteComputer_234(
  ...
  wire [5:0] _decoded_T_254 =
    {_GEN[1],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_256 = {_GEN[0], _GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_258 =
    {_GEN[0], _GEN[1], _GEN[4], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [6:0] _decoded_T_286 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_288 =
    {_GEN[2], io_req_2_bits_flow_egress_node[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_312,
      &_decoded_T_326,
      &_decoded_T_334};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_310,
      &_decoded_T_324,
      &_decoded_T_332};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_324,
      &_decoded_T_332};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_134, &_decoded_T_184, &_decoded_T_306};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_134, &_decoded_T_184, &_decoded_T_306};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_134, &_decoded_T_184, &_decoded_T_232, &_decoded_T_304};	// Cat.scala:33:92, pla.scala:98:74, :114:39
