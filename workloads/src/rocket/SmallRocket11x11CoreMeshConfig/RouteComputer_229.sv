...
module RouteComputer_229(
  ...
  wire [2:0] _decoded_T_345 =
    {io_req_4_bits_flow_egress_node[2], _GEN_0[2], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_347 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[2],
     _GEN_0[2],
     io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_349 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[4],
  ...
  assign io_resp_4_vc_sel_1_4 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_341,
      &_decoded_T_343};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_1 = |{&_decoded_T_319, &_decoded_T_325, &_decoded_T_347};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_2 = |{&_decoded_T_319, &_decoded_T_325, &_decoded_T_347};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_319, &_decoded_T_325, &_decoded_T_335, &_decoded_T_345};	// Cat.scala:33:92, pla.scala:98:74, :114:39
