...
module RouteComputer_230(
  ...
  wire [1:0] _decoded_T_63 =
    {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_116 =
    {io_req_2_bits_flow_egress_node_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_119 =
    {io_req_2_bits_flow_egress_node_id[0], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _GEN = ~(io_req_3_bits_flow_egress_node[3:0]);	// RouteComputer.scala:74:27, pla.scala:78:21
  wire [2:0] _decoded_T_171 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[0], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_173 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[3], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_179 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_181 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[3], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_183 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[1],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_185 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[0],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
  ...
  wire [2:0] _decoded_T_187 =
    {_GEN[0], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_189 =
    {_GEN[3], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_191 =
    {io_req_3_bits_flow_egress_node[1],
     io_req_3_bits_src_virt_id[0],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_193 =
    {io_req_3_bits_flow_egress_node[0],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
     io_req_3_bits_src_virt_id[0],
  ...
  wire [1:0] _decoded_T_197 = {_GEN[3], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_199 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[0], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_201 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[3], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_3_vc_sel_1_3 =
    |{&_decoded_T_171,
      ...
      &_decoded_T_195,
      &_decoded_T_197,
      &_decoded_T_203};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_177, &_decoded_T_185, &_decoded_T_193, &_decoded_T_207};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_3_2 =
    |{io_req_2_bits_flow_egress_node_id[1], &_decoded_T_116, &_decoded_T_119};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_3_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_60, &_decoded_T_63};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_3_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_60, &_decoded_T_63};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_3_4 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_60, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_3_4 =
    |{io_req_0_bits_flow_egress_node_id[1],
      &_decoded_T_1,
      &{~(io_req_0_bits_flow_egress_node[1]), io_req_0_bits_src_virt_id[2]}};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45, :98:74, :114:39
  assign io_resp_0_vc_sel_2_4 =
    &{io_req_0_bits_flow_egress_node[1], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74
endmodule
