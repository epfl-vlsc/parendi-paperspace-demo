...
module RouteComputer_164(
  ...
  wire [2:0] _decoded_T_173 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[1], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_175 =
  ...
  wire [2:0] _decoded_T_179 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[1], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_181 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[0],
     io_req_3_bits_flow_egress_node[1],
  ...
  wire [2:0] _decoded_T_185 =
    {_GEN[1], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_187 =
    {io_req_3_bits_flow_egress_node[0],
     io_req_3_bits_flow_egress_node[1],
  ...
  wire [2:0] _decoded_T_195 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN[1], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_3_vc_sel_1_1 =
    |{&_decoded_T_171,
      ...
      &_decoded_T_179,
      &_decoded_T_193,
      &_decoded_T_195};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_1_3 =
    |{&_decoded_T_171,
      ...
      &_decoded_T_185,
      &_decoded_T_189,
      &_decoded_T_191};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_175, &_decoded_T_181, &_decoded_T_187, &_decoded_T_197};	// Cat.scala:33:92, pla.scala:98:74, :114:39
