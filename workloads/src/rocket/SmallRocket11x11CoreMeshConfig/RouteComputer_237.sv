...
module RouteComputer_237(
  ...
  wire [4:0] _decoded_T_250 =
    {_GEN[0], _GEN[1], _GEN[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_252 = {_GEN[1], _GEN[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_258 =
    {io_req_2_bits_flow_egress_node[1], _GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_322,
      &_decoded_T_326,
      &_decoded_T_330};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_318,
      &_decoded_T_338};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_154, &_decoded_T_202, &_decoded_T_336};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_154, &_decoded_T_202, &_decoded_T_336};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_154, &_decoded_T_202, &_decoded_T_246, &_decoded_T_334};	// Cat.scala:33:92, pla.scala:98:74, :114:39
