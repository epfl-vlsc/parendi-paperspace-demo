...
module RouteComputer_228(
  ...
  wire [2:0] _decoded_T_224 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[0], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_226 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[4], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_232 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_234 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[4], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_240 =
    {_GEN_1[0], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_242 =
    {_GEN_1[4], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [1:0] _decoded_T_250 = {_GEN_1[4], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_252 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[0], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_254 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_1[4], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_4_vc_sel_1_4 =
    |{&_decoded_T_224,
      ...
      &_decoded_T_250,
      &_decoded_T_260};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_1 = |{&_decoded_T_228, &_decoded_T_236, &_decoded_T_258};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_2 = |{&_decoded_T_228, &_decoded_T_236, &_decoded_T_258};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_228, &_decoded_T_236, &_decoded_T_244, &_decoded_T_256};	// Cat.scala:33:92, pla.scala:98:74, :114:39
