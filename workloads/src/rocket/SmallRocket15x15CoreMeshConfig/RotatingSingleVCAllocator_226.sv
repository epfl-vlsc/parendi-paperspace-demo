...
module RotatingSingleVCAllocator_226(
  input  clock,
         reset,
         io_req_2_valid,
  ...
  assign in_arb_vals_1 = io_req_1_valid & (in_arb_reqs_1_1_0 | in_arb_reqs_1_1_1 | in_arb_reqs_1_1_2 | in_arb_reqs_1_1_3 | in_arb_reqs_1_1_4);	// @[SingleVCAllocator.scala:28:61, :32:39, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [3:0]  _T_30 = {1'h0, {1'h0, _GEN_0 + _GEN_1} + {1'h0, _GEN_4 + _GEN_2 + _GEN_3}} + {1'h0, {1'h0, _GEN_5 + _GEN_6} + {1'h0, _GEN_9 + _GEN_7 + _GEN_8}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_63 = {1'h0, {1'h0, _GEN_0 + _GEN_1} + {1'h0, _GEN_4 + _GEN_2 + _GEN_3}} + {1'h0, {1'h0, _GEN_5 + _GEN_6} + {1'h0, _GEN_9 + _GEN_7 + _GEN_8}};	// @[Bitwise.scala:51:90]
    wire  [3:0]  _T_96 = {1'h0, {1'h0, _GEN_0 + _GEN_1} + {1'h0, _GEN_4 + _GEN_2 + _GEN_3}} + {1'h0, {1'h0, _GEN_5 + _GEN_6} + {1'h0, _GEN_9 + _GEN_7 + _GEN_8}};	// @[Bitwise.scala:51:90]
    always @(posedge clock) begin	// @[SingleVCAllocator.scala:53:11]
      if (~reset & (|(_T_30[3:1]))) begin	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}]
      ...
      if (~reset & (|(_T_63[3:1]))) begin	// @[Bitwise.scala:51:90, SingleVCAllocator.scala:53:{11,47}]
        if (`ASSERT_VERBOSE_COND_)	// @[SingleVCAllocator.scala:53:11]
          $error("Assertion failed\n    at SingleVCAllocator.scala:53 assert(PopCount(io.resp(i).vc_sel.asUInt) <= 1.U)\n");	// @[SingleVCAllocator.scala:53:11]
        if (`STOP_COND_)	// @[SingleVCAllocator.scala:53:11]
          $fatal;	// @[SingleVCAllocator.scala:53:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        in_alloc_mask = _RANDOM_0[12:3];	// @[ISLIP.scala:17:25, SingleVCAllocator.scala:16:21]
      `endif // RANDOMIZE_REG_INIT
    end // initial
