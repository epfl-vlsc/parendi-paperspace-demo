...
module InputUnit_608(
  ...
  wire [10:0] _GEN_0 = {states_4_vc_sel_4_4, 9'h0, states_4_vc_sel_2_4} & {io_out_credit_available_4_4, 4'hF, io_out_credit_available_3_4, io_out_credit_available_3_3, io_out_credit_available_3_2, io_out_credit_available_3_1, io_out_credit_available_3_0, io_out_credit_available_2_4};	// @[InputUnit.scala:192:19, :235:14, :304:{40,47,73}]
  wire        _salloc_arb_io_in_4_valid_T_2 = states_4_g == 3'h3 & (|{_GEN_0[10], _GEN_0[0]}) & _input_buffer_io_deq_4_valid;	// @[InputUnit.scala:181:28, :192:19, :210:20, :304:{47,81}, :305:{22,50}]
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2 & _input_buffer_io_deq_4_bits_tail)	// @[InputUnit.scala:181:28, :285:32, :296:26, :305:50, :309:{22,35}, :310:13, :395:23, :396:24]
      ...
      if (io_in_flit_0_bits_flow_egress_node == 9'h157)	// @[InputUnit.scala:209:57]
        states_4_g <= 3'h2;	// @[InputUnit.scala:192:19, :210:26]
    ...
    salloc_outs_0_out_vid <= (_vc_sel_WIRE_17 ? {_vc_sel_WIRE_17, 2'h0} : 3'h0) | (_vc_sel_WIRE_29 ? {_vc_sel_WIRE_29, 2'h0} : 3'h0);	// @[Bitwise.scala:51:90, Cat.scala:33:92, InputUnit.scala:208:27, :336:8, Mux.scala:27:73]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[InputUnit.scala:207:13]
      ...
      if (_route_arbiter_io_out_valid & ~reset & _GEN_3[_route_arbiter_io_out_bits_src_virt_id] != 3'h1) begin	// @[InputUnit.scala:187:29, :208:27, :210:26, :241:{11,25}]
