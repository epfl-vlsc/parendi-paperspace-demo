...
module TLAToNoC(
  ...
  Queue_7911 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id = (_q_io_deq_bits_address[31:30] == 2'h0 ? 9'h1BC : 9'h0) | (_q_io_deq_bits_address[31:30] == 2'h2 ? 9'h1BF : 9'h0) | (_q_io_deq_bits_address[31:30] == 2'h1 ? 9'h1C2 : 9'h0);	// @[Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17]
endmodule
