...
module ClockSinkDomain_283(
  ...
  input  [8:0]  auto_buffer_in_4_flit_0_bits_flow_ingress_node,
  input  [1:0]  auto_buffer_in_4_flit_0_bits_flow_ingress_node_id,
  input  [8:0]  auto_buffer_in_4_flit_0_bits_flow_egress_node,
  ...
  output [8:0]  auto_routers_source_nodes_out_4_flit_0_bits_flow_ingress_node,
  output [1:0]  auto_routers_source_nodes_out_4_flit_0_bits_flow_ingress_node_id,
  output [8:0]  auto_routers_source_nodes_out_4_flit_0_bits_flow_egress_node,
  ...
  reg  [8:0]  buffer_4_x1_flit_0_b_flow_ingress_node;	// @[Reg.scala:19:16]
  reg  [1:0]  buffer_4_x1_flit_0_b_flow_ingress_node_id;	// @[Reg.scala:19:16]
  reg  [8:0]  buffer_4_x1_flit_0_b_flow_egress_node;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buffer_4_x1_flit_0_v = _RANDOM_18[0];	// @[Valid.scala:130:22]
        buffer_4_x1_flit_0_b_head = _RANDOM_18[1];	// @[Reg.scala:19:16, Valid.scala:130:22]
        buffer_4_x1_flit_0_b_tail = _RANDOM_18[2];	// @[Reg.scala:19:16, Valid.scala:130:22]
        buffer_4_x1_flit_0_b_payload = {_RANDOM_18[31:3], _RANDOM_19, _RANDOM_20[11:0]};	// @[Reg.scala:19:16, Valid.scala:130:22]
        buffer_4_x1_flit_0_b_flow_vnet_id = _RANDOM_20[14:12];	// @[Reg.scala:19:16]
        buffer_4_x1_flit_0_b_flow_ingress_node = _RANDOM_20[23:15];	// @[Reg.scala:19:16]
        buffer_4_x1_flit_0_b_flow_ingress_node_id = _RANDOM_20[25:24];	// @[Reg.scala:19:16]
        buffer_4_x1_flit_0_b_flow_egress_node = {_RANDOM_20[31:26], _RANDOM_21[2:0]};	// @[Reg.scala:19:16]
        buffer_4_x1_flit_0_b_flow_egress_node_id = _RANDOM_21[4:3];	// @[Reg.scala:19:16]
        buffer_4_x1_flit_0_b_virt_channel_id = _RANDOM_21[7:5];	// @[Reg.scala:19:16]
        buffer_4_x1_credit_return_r = _RANDOM_21[12:8];	// @[Reg.scala:19:16]
        buffer_4_x1_credit_return_r_1 = _RANDOM_21[17:13];	// @[Reg.scala:19:16]
        buffer_4_x1_credit_return_r_2 = _RANDOM_21[22:18];	// @[Reg.scala:19:16]
        buffer_4_x1_credit_return_r_3 = _RANDOM_21[27:23];	// @[Reg.scala:19:16]
        buffer_4_x1_vc_free_r = {_RANDOM_21[31:28], _RANDOM_22[0]};	// @[Reg.scala:19:16]
        buffer_4_x1_vc_free_r_1 = _RANDOM_22[5:1];	// @[Reg.scala:19:16]
        buffer_4_x1_vc_free_r_2 = _RANDOM_22[10:6];	// @[Reg.scala:19:16]
        buffer_4_x1_vc_free_r_3 = _RANDOM_22[15:11];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Router_283 routers (	// @[NoC.scala:64:22]
