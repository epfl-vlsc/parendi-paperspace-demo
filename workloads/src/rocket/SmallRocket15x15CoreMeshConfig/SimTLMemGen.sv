...
module SimTLMemGen(
  ...
  input  [31:0] io_tl_0_a_bits_address,
  ...
  SimTLRAM srams (	// @[HarnessExtMem.scala:186:15]
    .clock                  (clock),
    .reset                  (reset),
  ...
  TLFragmenter_225 fragmenter (	// @[Fragmenter.scala:335:34]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLBuffer_900 buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
