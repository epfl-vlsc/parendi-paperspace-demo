...
module PeripheryBus_1(
  ...
  input  [13:0] auto_coupler_to_bootrom_fragmenter_out_d_bits_source,
  ...
  input  [9:0]  auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_d_bits_source,
  ...
  input  [13:0] auto_coupler_to_l2_ctrl_buffer_out_d_bits_source,
  ...
  input  [9:0]  auto_bus_xing_in_a_bits_source,
  input  [25:0] auto_bus_xing_in_a_bits_address,
  ...
  output [13:0] auto_coupler_to_bootrom_fragmenter_out_a_bits_source,
  output [20:0] auto_coupler_to_bootrom_fragmenter_out_a_bits_address,
  ...
  output [9:0]  auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_source,
  output [14:0] auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_address,
  ...
  output [13:0] auto_coupler_to_l2_ctrl_buffer_out_a_bits_source,
  ...
  output [9:0]  auto_bus_xing_in_d_bits_source,
  ...
  wire [9:0]  _coupler_to_bootrom_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [9:0]  _coupler_to_l2_ctrl_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [9:0]  _wrapped_error_device_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [9:0]  _atomics_auto_out_a_bits_source;	// @[AtomicAutomata.scala:285:29]
  wire [25:0] _atomics_auto_out_a_bits_address;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [9:0]  _buffer_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  wire [25:0] _buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  ...
  wire [9:0]  _out_xbar_auto_in_d_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [9:0]  _out_xbar_auto_out_3_a_bits_source;	// @[PeripheryBus.scala:50:30]
  wire [20:0] _out_xbar_auto_out_3_a_bits_address;	// @[PeripheryBus.scala:50:30]
  ...
  wire [9:0]  _out_xbar_auto_out_1_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [9:0]  _out_xbar_auto_out_0_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [9:0]  _fixer_auto_in_d_bits_source;	// @[PeripheryBus.scala:47:33]
  ...
  wire [9:0]  _fixer_auto_out_a_bits_source;	// @[PeripheryBus.scala:47:33]
  wire [25:0] _fixer_auto_out_a_bits_address;	// @[PeripheryBus.scala:47:33]
  ...
  TLXbar_4 out_xbar (	// @[PeripheryBus.scala:50:30]
    ...
    .auto_out_3_a_ready        (_coupler_to_bootrom_auto_tl_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_3_d_valid        (_coupler_to_bootrom_auto_tl_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_3_d_bits_size    (_coupler_to_bootrom_auto_tl_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_3_d_bits_source  (_coupler_to_bootrom_auto_tl_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_3_d_bits_data    (_coupler_to_bootrom_auto_tl_in_d_bits_data),	// @[LazyModule.scala:489:27]
  ...
  TLInterconnectCoupler_227 coupler_to_l2_ctrl (	// @[LazyModule.scala:489:27]
    .clock                          (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                          (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_451 coupler_to_bootrom (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
