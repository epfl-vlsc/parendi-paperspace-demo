...
module CSRFile(
  ...
  wire [7:0]  _GEN_11 = ((&{io_rw_addr[2], decoded_decoded_invInputs[3], io_rw_addr[4], decoded_decoded_invInputs[5], decoded_decoded_invInputs[6], decoded_decoded_invInputs[7], io_rw_addr[8], io_rw_addr[9], io_rw_addr[10], io_rw_addr[11]}) ? io_hartid : 8'h0) | _io_rw_rdata_T_14[7:0];	// @[Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74]
  wire [2:0]  _GEN_12 = _GEN_11[2:0] | ((&_decoded_decoded_T_8) ? reg_mcountinhibit : 3'h0) | _io_rw_rdata_T_111[2:0] | _io_rw_rdata_T_112[2:0] | _io_rw_rdata_T_113[2:0] | _io_rw_rdata_T_114[2:0] | _io_rw_rdata_T_115[2:0] | _io_rw_rdata_T_116[2:0] | _io_rw_rdata_T_117[2:0] | _io_rw_rdata_T_118[2:0];	// @[CSR.scala:551:34, :611:32, Cat.scala:33:92, Mux.scala:27:73, pla.scala:98:74]
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0, _io_rw_rdata_T_14[31:30], _io_rw_rdata_T_111[29:16] | _io_rw_rdata_T_112[29:16] | _io_rw_rdata_T_113[29:16] | _io_rw_rdata_T_114[29:16] | _io_rw_rdata_T_115[29:16] | _io_rw_rdata_T_116[29:16] | _io_rw_rdata_T_117[29:16] | _io_rw_rdata_T_118[29:16], ((&{io_rw_addr[2], decoded_decoded_invInputs[3], decoded_decoded_invInputs[4], decoded_decoded_invInputs[5], io_rw_addr[6], decoded_decoded_invInputs[7], io_rw_addr[8], io_rw_addr[9], decoded_decoded_invInputs[10], decoded_decoded_invInputs[11]}) ? {4'h0, io_interrupts_meip, 3'h0} : 8'h0) | _io_rw_rdata_T_14[15:8] | _io_rw_rdata_T_111[15:8] | _io_rw_rdata_T_112[15:8] | _io_rw_rdata_T_113[15:8] | _io_rw_rdata_T_114[15:8] | _io_rw_rdata_T_115[15:8] | _io_rw_rdata_T_116[15:8] | _io_rw_rdata_T_117[15:8] | _io_rw_rdata_T_118[15:8], _GEN_11[7:3] | _io_rw_rdata_T_111[7:3] | _io_rw_rdata_T_112[7:3] | _io_rw_rdata_T_113[7:3] | _io_rw_rdata_T_114[7:3] | _io_rw_rdata_T_115[7:3] | _io_rw_rdata_T_116[7:3] | _io_rw_rdata_T_117[7:3] | _io_rw_rdata_T_118[7:3], _GEN_12[2:1], _GEN_12[0] | (&{decoded_decoded_invInputs[0], io_rw_addr[1], decoded_decoded_invInputs[2], decoded_decoded_invInputs[3], io_rw_addr[4], decoded_decoded_invInputs[5], decoded_decoded_invInputs[6], decoded_decoded_invInputs[7], io_rw_addr[8], io_rw_addr[9], io_rw_addr[10], io_rw_addr[11]})} | ((&{io_rw_addr[0], io_rw_addr[1], decoded_decoded_invInputs[2], decoded_decoded_invInputs[3], io_rw_addr[4], decoded_decoded_invInputs[5], decoded_decoded_invInputs[6], decoded_decoded_invInputs[7], io_rw_addr[8], io_rw_addr[9], io_rw_addr[10], io_rw_addr[11]}) ? 64'h20181004 : 64'h0);	// @[Bitwise.scala:77:12, CSR.scala:369:47, :373:28, :455:26, :463:19, :464:20, :466:20, :477:27, :478:22, :480:25, :571:22, :610:25, :611:32, :617:48, :753:43, :1408:67, :1583:26, Cat.scala:33:92, Mux.scala:27:73, :47:70, package.scala:124:38, :155:13, :166:35, pla.scala:78:21, :90:45, :91:29, :98:74]
  wire        csr_wen = io_rw_cmd == 3'h6 | (&io_rw_cmd) | io_rw_cmd == 3'h5;	// @[Mux.scala:47:70, package.scala:16:47, :73:59]
  wire [47:0] _GEN_13 = ((io_rw_cmd[1] ? {reg_bp_0_control_dmode, 46'h40000000000, reg_bp_0_control_action} : 48'h0) | io_rw_wdata[59:12]) & ~((&(io_rw_cmd[1:0])) ? io_rw_wdata[59:12] : 48'h0);	// @[CSR.scala:463:19, :1408:67, :1561:{9,13,30,39,41,45,49,55}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (csr_wen & (&_decoded_decoded_T)) begin	// @[CSR.scala:1053:19, :1162:18, :1166:39, :1168:23, Cat.scala:33:92, package.scala:73:59, pla.scala:98:74]
        ...
        reg_mstatus_mpie <= insn_ret & ~_T_375 | (_GEN_15 ? reg_mstatus_mpie : reg_mstatus_mie);	// @[CSR.scala:373:28, :835:83, :975:20, :976:24, :1053:19, :1055:48, :1072:{48,66}, :1077:65]
