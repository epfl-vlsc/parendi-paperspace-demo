...
module IngressUnit_393(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 9'h1BC;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 9'h1BF;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 9'h1C2;	// @[IngressUnit.scala:30:72]
  wire [7:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 8'hDE : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 8'hE0 : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 8'hDF : 8'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 8'h83;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
