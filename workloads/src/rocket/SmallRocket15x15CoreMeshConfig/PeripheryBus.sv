...
module PeripheryBus(
  ...
  wire [13:0] _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [9:0]  _coupler_to_bootaddressreg_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [9:0]  _buffer_1_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [9:0]  _atomics_auto_in_d_bits_source;	// @[AtomicAutomata.scala:285:29]
  ...
  TLInterconnectCoupler_226 coupler_to_bootaddressreg (	// @[LazyModule.scala:489:27]
    .clock                              (auto_subsystem_pbus_clock_groups_in_member_subsystem_pbus_0_clock),
    .reset                              (auto_subsystem_pbus_clock_groups_in_member_subsystem_pbus_0_reset),
