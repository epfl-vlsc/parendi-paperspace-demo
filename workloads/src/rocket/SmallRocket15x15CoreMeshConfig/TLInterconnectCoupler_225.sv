...
module TLInterconnectCoupler_225(
  input         clock,
                reset,
  ...
  output [30:0] auto_buffer_out_a_bits_address,
  ...
  wire        _shrinker_auto_out_a_valid;	// @[SourceShrinker.scala:90:30]
  wire [2:0]  _shrinker_auto_out_a_bits_opcode;	// @[SourceShrinker.scala:90:30]
  wire [2:0]  _shrinker_auto_out_a_bits_param;	// @[SourceShrinker.scala:90:30]
  wire [2:0]  _shrinker_auto_out_a_bits_size;	// @[SourceShrinker.scala:90:30]
  wire [3:0]  _shrinker_auto_out_a_bits_source;	// @[SourceShrinker.scala:90:30]
  wire [30:0] _shrinker_auto_out_a_bits_address;	// @[SourceShrinker.scala:90:30]
  wire [7:0]  _shrinker_auto_out_a_bits_mask;	// @[SourceShrinker.scala:90:30]
  wire [63:0] _shrinker_auto_out_a_bits_data;	// @[SourceShrinker.scala:90:30]
  wire        _shrinker_auto_out_a_bits_corrupt;	// @[SourceShrinker.scala:90:30]
  wire        _shrinker_auto_out_d_ready;	// @[SourceShrinker.scala:90:30]
  ...
  TLBuffer buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
    .auto_in_a_valid         (_shrinker_auto_out_a_valid),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_opcode   (_shrinker_auto_out_a_bits_opcode),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_param    (_shrinker_auto_out_a_bits_param),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_size     (_shrinker_auto_out_a_bits_size),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_source   (_shrinker_auto_out_a_bits_source),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_address  (_shrinker_auto_out_a_bits_address),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_mask     (_shrinker_auto_out_a_bits_mask),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_data     (_shrinker_auto_out_a_bits_data),	// @[SourceShrinker.scala:90:30]
    .auto_in_a_bits_corrupt  (_shrinker_auto_out_a_bits_corrupt),	// @[SourceShrinker.scala:90:30]
    .auto_in_d_ready         (_shrinker_auto_out_d_ready),	// @[SourceShrinker.scala:90:30]
  ...
  TLSourceShrinker shrinker (	// @[SourceShrinker.scala:90:30]
    .clock                   (clock),
    .reset                   (reset),
