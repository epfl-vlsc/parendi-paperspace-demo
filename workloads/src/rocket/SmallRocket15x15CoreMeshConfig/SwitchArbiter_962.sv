...
module SwitchArbiter_962(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      mask <= _io_chosen_oh_0_output | {1'h0, _io_chosen_oh_0_output[4], _GEN[2], _GEN_0[1], _GEN_0[0] | _io_chosen_oh_0_output[4]};	// @[SwitchAllocator.scala:27:21, :30:60, :42:21, :58:{55,71}]
    end
  ...
  assign io_out_0_bits_vc_sel_1_0 = _io_chosen_oh_0_output[0] & io_in_0_bits_vc_sel_1_0 | _io_chosen_oh_0_output[1] & io_in_1_bits_vc_sel_1_0 | _io_chosen_oh_0_output[2] & io_in_2_bits_vc_sel_1_0 | _io_chosen_oh_0_output[3] & io_in_3_bits_vc_sel_1_0 | _io_chosen_oh_0_output[4] & io_in_4_bits_vc_sel_1_0;	// @[Mux.scala:27:73, :29:36, SwitchAllocator.scala:42:21]
  ...
  assign io_out_0_bits_vc_sel_0_0 = _io_chosen_oh_0_output[0] & io_in_0_bits_vc_sel_0_0 | _io_chosen_oh_0_output[1] & io_in_1_bits_vc_sel_0_0 | _io_chosen_oh_0_output[2] & io_in_2_bits_vc_sel_0_0 | _io_chosen_oh_0_output[3] & io_in_3_bits_vc_sel_0_0 | _io_chosen_oh_0_output[4] & io_in_4_bits_vc_sel_0_0;	// @[Mux.scala:27:73, :29:36, SwitchAllocator.scala:42:21]
