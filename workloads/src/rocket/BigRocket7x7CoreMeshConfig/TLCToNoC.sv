...
module TLCToNoC(
  ...
  assign io_flit_bits_payload = is_body ? {_q_io_deq_bits_data, _q_io_deq_bits_corrupt} : {15'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_address};	// @[Cat.scala:33:92, Tilelink.scala:45:17, :59:24, :68:33, package.scala:235:71]
endmodule
