...
module TLDToNoC(
  ...
  Queue_1906 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id =
    {1'h0, {1'h0, {1'h0, {1'h0, {1'h0, {1'h0, _q_io_deq_bits_source[7:2] == 6'h2D} | {2{_q_io_deq_bits_source[7:2] == 6'h2C}}} | (_q_io_deq_bits_source[7:2] == 6'h2B ? 3'h5 : 3'h0) | {3{_q_io_deq_bits_source[7:2] == 6'h2A}}} | (_q_io_deq_bits_source[7:2] == 6'h29 ? 4'h9 : 4'h0) | (_q_io_deq_bits_source[7:2] == 6'h28 ? 4'hB : 4'h0) | (_q_io_deq_bits_source[7:2] == 6'h27 ? 4'hD : 4'h0) | {4{_q_io_deq_bits_source[7:2] == 6'h26}}} | (_q_io_deq_bits_source[7:2] == 6'h25 ? 5'h11 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h24 ? 5'h13 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h23 ? 5'h15 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h22 ? 5'h17 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h21 ? 5'h19 : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h20 ? 5'h1B : 5'h0) | (_q_io_deq_bits_source[7:2] == 6'h1F ? 5'h1D : 5'h0) | {5{_q_io_deq_bits_source[7:2] == 6'h1E}}} | (_q_io_deq_bits_source[7:2] == 6'h1D ? 6'h21 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h1C ? 6'h23 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h1B ? 6'h25 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h1A ? 6'h27 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h19 ? 6'h29 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h18 ? 6'h2B : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h17 ? 6'h2D : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h16 ? 6'h2F : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h15 ? 6'h31 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h14 ? 6'h33 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h13 ? 6'h35 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h12 ? 6'h37 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h11 ? 6'h39 : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'h10 ? 6'h3B : 6'h0) | (_q_io_deq_bits_source[7:2] == 6'hF ? 6'h3D : 6'h0) | {6{_q_io_deq_bits_source[7:2] == 6'hE}}} | (_q_io_deq_bits_source[7:2] == 6'hD ? 7'h41 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'hC ? 7'h43 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'hB ? 7'h45 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'hA ? 7'h47 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h9 ? 7'h49 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h8 ? 7'h4B : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h7 ? 7'h4D : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h6 ? 7'h4F : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h5 ? 7'h51 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h4 ? 7'h53 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h3 ? 7'h55 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h2 ? 7'h57 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h1 ? 7'h59 : 7'h0) | (_q_io_deq_bits_source[7:2] == 6'h0 ? 7'h5B : 7'h0);	// @[Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17]
endmodule
