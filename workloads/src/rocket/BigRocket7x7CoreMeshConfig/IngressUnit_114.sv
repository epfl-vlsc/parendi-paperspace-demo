...
module IngressUnit_114(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 7'h5C;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 7'h5F;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 7'h62;	// @[IngressUnit.scala:30:72]
  wire [5:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 6'h2E : 6'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 6'h30 : 6'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 6'h2F : 6'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 6'h26;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (7'h26),
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 7'h4D),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 7'h4C),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
