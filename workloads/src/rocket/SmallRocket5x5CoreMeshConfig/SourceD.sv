...
module SourceD(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[24:18];	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_offset = {_RANDOM_0[31:29], _RANDOM_1[2:0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = _RANDOM_1[8:3];	// Reg.scala:19:16
        s1_req_reg_set = _RANDOM_1[15:9];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[18:16];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[21:19];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[22];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[23];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[24];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[25];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[26];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[27];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[28];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = _RANDOM_1[31:29];	// Reg.scala:19:16
        s2_bypass = _RANDOM_2[0];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_2[1];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_2[3];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[7:5];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[10:8];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[13:11];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[20:14];	// Reg.scala:19:16
        s2_req_put = {_RANDOM_2[31], _RANDOM_3[4:0]};	// Reg.scala:19:16
        s2_req_set = _RANDOM_3[11:5];	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[14:12];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[17:15];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[18];	// Reg.scala:19:16
        s2_last = _RANDOM_3[19];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[20];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[21];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[22];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[23];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:24], _RANDOM_4, _RANDOM_5[23:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = _RANDOM_5[31:24];	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_6[0];	// Reg.scala:19:16
        s3_full = _RANDOM_6[1];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_6[2];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_beat = _RANDOM_6[5:3];	// Reg.scala:19:16
        s3_bypass = _RANDOM_6[6];	// Reg.scala:19:16
        s3_req_prio_0 = _RANDOM_6[7];	// Reg.scala:19:16
        s3_req_prio_2 = _RANDOM_6[9];	// Reg.scala:19:16
        s3_req_opcode = _RANDOM_6[13:11];	// Reg.scala:19:16
        s3_req_param = _RANDOM_6[16:14];	// Reg.scala:19:16
        s3_req_size = _RANDOM_6[19:17];	// Reg.scala:19:16
        s3_req_source = _RANDOM_6[26:20];	// Reg.scala:19:16
        s3_req_set = _RANDOM_7[17:11];	// Reg.scala:19:16
        s3_req_sink = _RANDOM_7[20:18];	// Reg.scala:19:16
        s3_req_way = _RANDOM_7[23:21];	// Reg.scala:19:16
        s3_req_bad = _RANDOM_7[24];	// Reg.scala:19:16
        s3_pdata_data = {_RANDOM_7[31:26], _RANDOM_8, _RANDOM_9[25:0]};	// Reg.scala:19:16
        s3_pdata_mask = {_RANDOM_9[31:26], _RANDOM_10[1:0]};	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_10[2];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_10[3];	// Reg.scala:19:16
        s3_retires = _RANDOM_10[4];	// Reg.scala:19:16
        s3_need_r = _RANDOM_10[5];	// Reg.scala:19:16
        s4_full = _RANDOM_10[6];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_beat = _RANDOM_10[9:7];	// Reg.scala:19:16
        s4_need_bs = _RANDOM_10[11];	// Reg.scala:19:16
        s4_need_pb = _RANDOM_10[12];	// Reg.scala:19:16
        s4_req_prio_2 = _RANDOM_10[15];	// Reg.scala:19:16
        s4_req_param = _RANDOM_10[22:20];	// Reg.scala:19:16
        s4_req_set = _RANDOM_11[23:17];	// Reg.scala:19:16
        s4_req_way = _RANDOM_11[29:27];	// Reg.scala:19:16
        s4_adjusted_opcode = {_RANDOM_11[31], _RANDOM_12[1:0]};	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_12[31:2], _RANDOM_13, _RANDOM_14[1:0]};	// Reg.scala:19:16
        s4_pdata_mask = _RANDOM_14[9:2];	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_14[10];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_14[31:11], _RANDOM_15, _RANDOM_16[10:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_17[21:15];	// Reg.scala:19:16
        s5_req_way = _RANDOM_17[27:25];	// Reg.scala:19:16
        s5_beat = _RANDOM_17[31:29];	// Reg.scala:19:16
        s5_dat = {_RANDOM_18, _RANDOM_19};	// Reg.scala:19:16
        s6_req_set = _RANDOM_21[10:4];	// Reg.scala:19:16
        s6_req_way = _RANDOM_21[16:14];	// Reg.scala:19:16
        s6_beat = _RANDOM_21[20:18];	// Reg.scala:19:16
        s6_dat = {_RANDOM_21[31:21], _RANDOM_22, _RANDOM_23[20:0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_23[31:21], _RANDOM_24, _RANDOM_25[20:0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_25[21];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_25[31:22], _RANDOM_26, _RANDOM_27[21:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_1001 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
