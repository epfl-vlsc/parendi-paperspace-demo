...
module IngressUnit_70(
  ...
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_38 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_16 ? 3'h5 : 3'h0;	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_47 =
    {2'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T, 1'h0}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 4'hB : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 4'hD : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_3 ? 4'h9 : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_4 ? 4'hC : 4'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [1:0]  _GEN_0 =
    _route_buffer_io_enq_bits_flow_egress_node_T_47[2:1]
    | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_8}}
    | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_9}} | _GEN[1:0];	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_7 ? 5'h15 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_10 ? 5'h12 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_13 ? 5'h11 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_14 ? 5'h13 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_19 ? 5'h14 : 5'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_5,
       _route_buffer_io_enq_bits_flow_egress_node_T_47[3]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_9 | _GEN[2]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_15
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_18,
       _GEN_0[1] | _route_buffer_io_enq_bits_flow_egress_node_T_38[2]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_18
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_20
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_21,
       _GEN_0[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_12
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_18
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_21,
       _route_buffer_io_enq_bits_flow_egress_node_T_47[0]
    ...
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T
              ...
              | io_in_bits_egress_id == 6'h0
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_18
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_19
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_20
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_21)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
