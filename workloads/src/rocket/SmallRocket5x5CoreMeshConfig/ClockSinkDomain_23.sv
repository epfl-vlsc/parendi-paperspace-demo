...
module ClockSinkDomain_23(
  ...
  input  [5:0]  auto_routers_ingress_nodes_in_1_flit_bits_egress_id,
  ...
  output        auto_routers_egress_nodes_out_2_flit_valid,
  ...
  output        auto_routers_ingress_nodes_in_1_flit_ready,
  ...
  output [5:0]  auto_routers_source_nodes_out_flit_0_bits_flow_ingress_node,
  output [1:0]  auto_routers_source_nodes_out_flit_0_bits_flow_ingress_node_id,
  output [5:0]  auto_routers_source_nodes_out_flit_0_bits_flow_egress_node,
  ...
  always @(posedge auto_clock_in_clock) begin
    if (auto_clock_in_reset)
      buffer_x1_flit_0_v <= 1'h0;	// Valid.scala:130:22
    else
