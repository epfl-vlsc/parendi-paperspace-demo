...
module RouteComputer_49(
  ...
  wire [3:0]  _decoded_T_40 =
    {_GEN[0], _GEN[2], io_req_0_bits_src_virt_id[0], io_req_0_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0]  _decoded_T_68 =
    {_GEN[0], io_req_0_bits_flow_egress_node[1], _GEN[3], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0]  _decoded_T_92 =
    {_GEN[0], io_req_0_bits_flow_egress_node[4], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [1:0]  _decoded_T_206 =
    {io_req_2_bits_flow_ingress_node[1], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0]  _decoded_T_208 =
    {io_req_2_bits_flow_ingress_node[1], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0]  _decoded_T_210 =
    {io_req_2_bits_flow_vnet_id[1], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0]  _decoded_T_214 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN_0[11], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0]  _decoded_T_216 =
    {io_req_2_bits_flow_ingress_node[1], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_2_vc_sel_0_4 =
    |{&_decoded_T_204, &_decoded_T_210, &{_GEN_0[11], io_req_2_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_0_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_150, &_decoded_T_153};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
