...
module AMOALU(
  ...
  wire [63:0] wmask =
    {{8{io_mask[7]}},
     ...
     {8{io_mask[2]}},
     {8{io_mask[1]}},
     {8{io_mask[0]}}};	// AMOALU.scala:73:69, :92:49, Bitwise.scala:28:17, :77:12, Cat.scala:33:92
  assign io_out =
    wmask
    & (io_cmd == 5'h8
         ...
         : logic_and | logic_xor
             ...
             : ((io_mask[4]
                 ...
                 ? io_lhs
                 : io_rhs) | ~wmask & io_lhs;	// AMOALU.scala:65:{20,33,43}, :66:{20,33,43}, :67:20, :68:38, :69:39, :73:96, :74:{13,21,31}, :80:{26,35,38}, :81:{13,24,27,38,53,69}, :87:17, :89:{10,12,18,23,58}, :92:49, :95:{19,23}, :97:{8,27,42}, :98:{8,27}, :100:8, :101:{8,19}, :105:{19,25,27,34}, Cat.scala:33:92, Mux.scala:47:70
endmodule
