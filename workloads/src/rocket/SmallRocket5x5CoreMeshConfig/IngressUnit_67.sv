...
module IngressUnit_67(
  ...
  input  [5:0]  io_in_bits_egress_id,
  ...
  wire        _T_51;	// IngressUnit.scala:64:41
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 =
    io_in_bits_egress_id == 6'hF;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 =
    io_in_bits_egress_id == 6'h19;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 =
    io_in_bits_egress_id == 6'h1;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 =
    io_in_bits_egress_id == 6'hB;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_26 =
    io_in_bits_egress_id == 6'h5;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_27 =
    io_in_bits_egress_id == 6'h25;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_28 =
    io_in_bits_egress_id == 6'h2B;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_29 =
    io_in_bits_egress_id == 6'hD;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_30 =
    io_in_bits_egress_id == 6'h1F;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_31 =
    io_in_bits_egress_id == 6'h1D;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_32 =
    io_in_bits_egress_id == 6'h11;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_33 =
    io_in_bits_egress_id == 6'h29;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_34 =
    io_in_bits_egress_id == 6'h21;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_35 =
    io_in_bits_egress_id == 6'h13;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_36 =
    io_in_bits_egress_id == 6'h3;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_37 =
    io_in_bits_egress_id == 6'h1B;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_38 =
    io_in_bits_egress_id == 6'h27;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_39 =
    io_in_bits_egress_id == 6'h9;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_40 =
    io_in_bits_egress_id == 6'h17;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_41 =
    io_in_bits_egress_id == 6'h23;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_42 =
    io_in_bits_egress_id == 6'h15;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_43 =
    io_in_bits_egress_id == 6'h7;	// IngressUnit.scala:30:72
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_31 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_31 ? 4'hE : 4'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_35 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_35 ? 4'h9 : 4'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_37 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_37 ? 4'hD : 4'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_40 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_40 ? 4'hB : 4'h0;	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [2:0]  _GEN = _route_buffer_io_enq_bits_flow_egress_node_id_T_42 ? 3'h5 : 3'h0;	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [2:0]  _GEN_0 =
    {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_22}}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 3'h5 : 3'h0);	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_47 =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_23 ? 4'hC : 4'h0)
    | {1'h0,
       _GEN_0[2],
       _GEN_0[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_26,
       _GEN_0[0]};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [2:0]  _GEN_1 =
    _route_buffer_io_enq_bits_flow_egress_node_T_47[2:0]
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_29 ? 3'h6 : 3'h0)
    | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_30}}
    | _route_buffer_io_enq_bits_flow_egress_node_T_31[2:0]
    | _route_buffer_io_enq_bits_flow_egress_node_T_35[2:0];	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [1:0]  _GEN_2 = _GEN_1[2:1] | _route_buffer_io_enq_bits_flow_egress_node_T_37[2:1];	// Mux.scala:27:73
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_27 ? 5'h12 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_28 ? 5'h15 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_33 ? 5'h14 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_38 ? 5'h13 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_41 ? 5'h11 : 5'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_34,
       _route_buffer_io_enq_bits_flow_egress_node_T_47[3]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_30
         | _route_buffer_io_enq_bits_flow_egress_node_T_31[3]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_32
         | _route_buffer_io_enq_bits_flow_egress_node_T_35[3]
         | _route_buffer_io_enq_bits_flow_egress_node_T_37[3]
         | _route_buffer_io_enq_bits_flow_egress_node_T_40[3] | _GEN[2],
       _GEN_2[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_39,
       _GEN_2[0] | _route_buffer_io_enq_bits_flow_egress_node_T_40[1] | _GEN[0]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_43,
       _GEN_1[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_36
         | _route_buffer_io_enq_bits_flow_egress_node_T_37[0]
         | _route_buffer_io_enq_bits_flow_egress_node_T_40[0]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_43};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 5'h16;	// IngressUnit.scala:55:59, Mux.scala:27:73
  assign _T_51 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// IngressUnit.scala:26:28, :55:59, :64:41
  wire        _GEN_3 =
    _T_51 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26
  ...
  reg  [5:0]  out_bundle_bits_flit_flow_ingress_node;	// IngressUnit.scala:116:8
  reg  [1:0]  out_bundle_bits_flit_flow_ingress_node_id;	// IngressUnit.scala:116:8
  reg  [5:0]  out_bundle_bits_flit_flow_egress_node;	// IngressUnit.scala:116:8
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T_22
              ...
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_43)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bundle_bits_flit_flow_ingress_node = _RANDOM_2[20:15];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_ingress_node_id = _RANDOM_2[22:21];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node = _RANDOM_2[28:23];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node_id = _RANDOM_2[30:29];	// IngressUnit.scala:116:8
        out_bundle_bits_out_virt_channel = _RANDOM_3[4:2];	// IngressUnit.scala:116:8
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (6'h16),
    ...
    .io_enq_bits_flow_egress_node_id
      ({1'h0,
        _route_buffer_io_enq_bits_flow_egress_node_id_T_22
          ...
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_41
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_42
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_43}),	// IngressUnit.scala:30:72, :45:50, Mux.scala:27:73
  ...
  Queue_424 route_q (	// IngressUnit.scala:27:23
    ...
    .io_enq_bits_vc_sel_3_0 (_T_51 & io_in_bits_egress_id == 6'h2E),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_2_0 (_T_51 & io_in_bits_egress_id == 6'h2D),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_51 & io_in_bits_egress_id == 6'h2C),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_0_1 (~_T_51),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_2 (~_T_51),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_3 (~_T_51),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_4 (~_T_51),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_deq_ready
