...
module TLBToNoC_1(
  ...
  assign io_flit_bits_egress_id =
    {_q_io_deq_bits_source[6:2] == 5'h5,
     {_q_io_deq_bits_source[6:2] == 5'hD,
      {_q_io_deq_bits_source[6:2] == 5'h11,
       {_q_io_deq_bits_source[6:2] == 5'h13, _q_io_deq_bits_source[6:2] == 5'h14, 1'h0}
         | (_q_io_deq_bits_source[6:2] == 5'h12 ? 3'h6 : 3'h0)}
        | (_q_io_deq_bits_source[6:2] == 5'h10 ? 4'hA : 4'h0)
        | (_q_io_deq_bits_source[6:2] == 5'hF ? 4'hC : 4'h0)
        | (_q_io_deq_bits_source[6:2] == 5'hE ? 4'hE : 4'h0)}
       | (_q_io_deq_bits_source[6:2] == 5'hC ? 5'h12 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'hB ? 5'h14 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'hA ? 5'h16 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h9 ? 5'h18 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h8 ? 5'h1A : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h7 ? 5'h1C : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h6 ? 5'h1E : 5'h0)}
    | (_q_io_deq_bits_source[6:2] == 5'h4 ? 6'h22 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h3 ? 6'h24 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h2 ? 6'h26 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h1 ? 6'h28 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h0 ? 6'h2A : 6'h0);	// Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
