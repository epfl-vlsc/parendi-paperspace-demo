...
module Queue_17(
  ...
  ram_combMem_10 ram_ext (	// Decoupled.scala:273:95
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_enq_bits_ingress_id, io_enq_bits_payload, io_enq_bits_tail, io_enq_bits_head}),	// Decoupled.scala:273:95
  ...
  assign io_count =
    ptr_match
      ? {2{maybe_full}}
      : deq_ptr_value > enq_ptr_value ? ptr_diff - 2'h1 : ptr_diff;	// Counter.scala:61:40, Decoupled.scala:276:27, :277:33, :326:32, :331:20, :333:10, :334:{10,25,57}
endmodule
