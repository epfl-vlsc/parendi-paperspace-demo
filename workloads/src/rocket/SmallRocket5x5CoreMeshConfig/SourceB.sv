...
module SourceB(
  ...
  wire [5:0]  _GEN_4 =
    (_GEN_3[6] ? 6'h3C : 6'h0) | (_GEN_3[7] ? 6'h38 : 6'h0) | (_GEN_3[8] ? 6'h34 : 6'h0)
    | (_GEN_3[9] ? 6'h30 : 6'h0) | (_GEN_3[10] ? 6'h2C : 6'h0)
    | (_GEN_3[11] ? 6'h28 : 6'h0) | (_GEN_3[12] ? 6'h24 : 6'h0);	// Mux.scala:27:73, :29:36, Parameters.scala:220:15, SourceB.scala:53:37
  wire [4:0]  _GEN_5 =
    _GEN_4[4:0] | (_GEN_3[14] ? 5'h1C : 5'h0) | (_GEN_3[15] ? 5'h18 : 5'h0)
    | (_GEN_3[16] ? 5'h14 : 5'h0);	// Mux.scala:27:73, :29:36, SourceB.scala:53:37
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      remain <=
        (remain | (_param_T_1 ? io_req_bits_clients : 22'h0))
        & ~(io_b_ready & b_valid ? _GEN_3 : 22'h0);	// Decoupled.scala:51:35, SourceB.scala:46:25, :47:30, :48:30, :49:{23,37,39}, :53:37, :62:{24,37}, :68:21, :69:{19,32}
  ...
  assign io_b_bits_source =
    (_GEN_3[0] ? 7'h54 : 7'h0) | (_GEN_3[1] ? 7'h50 : 7'h0) | (_GEN_3[2] ? 7'h4C : 7'h0)
    | (_GEN_3[3] ? 7'h48 : 7'h0) | (_GEN_3[4] ? 7'h44 : 7'h0)
    | {_GEN_3[5],
       _GEN_4[5] | _GEN_3[13],
       _GEN_5[4] | _GEN_3[17],
       _GEN_6[3] | _GEN_3[19],
       _GEN_6[2] | _GEN_3[20],
       _GEN_6[1:0]};	// Mux.scala:27:73, :29:36, Parameters.scala:220:15, SourceB.scala:53:37
