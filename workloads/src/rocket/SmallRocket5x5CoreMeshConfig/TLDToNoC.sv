  ...
  assign io_flit_bits_egress_id =
    {1'h0,
     {1'h0,
      {1'h0,
       {1'h0,
        {1'h0, _q_io_deq_bits_source[6:2] == 5'h15}
          | {2{_q_io_deq_bits_source[6:2] == 5'h14}}}
         | (_q_io_deq_bits_source[6:2] == 5'h13 ? 3'h5 : 3'h0)
         | {3{_q_io_deq_bits_source[6:2] == 5'h12}}}
        | (_q_io_deq_bits_source[6:2] == 5'h11 ? 4'h9 : 4'h0)
        | (_q_io_deq_bits_source[6:2] == 5'h10 ? 4'hB : 4'h0)
        | (_q_io_deq_bits_source[6:2] == 5'hF ? 4'hD : 4'h0)
        | {4{_q_io_deq_bits_source[6:2] == 5'hE}}}
       | (_q_io_deq_bits_source[6:2] == 5'hD ? 5'h11 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'hC ? 5'h13 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'hB ? 5'h15 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'hA ? 5'h17 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h9 ? 5'h19 : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h8 ? 5'h1B : 5'h0)
       | (_q_io_deq_bits_source[6:2] == 5'h7 ? 5'h1D : 5'h0)
       | {5{_q_io_deq_bits_source[6:2] == 5'h6}}}
    | (_q_io_deq_bits_source[6:2] == 5'h5 ? 6'h21 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h4 ? 6'h23 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h3 ? 6'h25 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h2 ? 6'h27 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h1 ? 6'h29 : 6'h0)
    | (_q_io_deq_bits_source[6:2] == 5'h0 ? 6'h2B : 6'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
