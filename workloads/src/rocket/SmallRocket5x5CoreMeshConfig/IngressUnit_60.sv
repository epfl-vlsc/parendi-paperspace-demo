...
module IngressUnit_60(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 6'h2C;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 =
    io_in_bits_egress_id == 6'h2F;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 =
    io_in_bits_egress_id == 6'h32;	// IngressUnit.scala:30:72
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 5'h16 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 5'h18 : 5'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 5'h17 : 5'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
