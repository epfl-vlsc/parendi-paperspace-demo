...
module OutputUnit(
  ...
  output [5:0]  io_out_flit_0_bits_flow_ingress_node,
  output [1:0]  io_out_flit_0_bits_flow_ingress_node_id,
  output [5:0]  io_out_flit_0_bits_flow_egress_node,
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_3_occupied = _RANDOM_0[23];	// OutputUnit.scala:66:19
        states_3_c = _RANDOM_0[26:24];	// OutputUnit.scala:66:19
        states_2_occupied = _RANDOM_1[14];	// OutputUnit.scala:66:19
        states_2_c = _RANDOM_1[17:15];	// OutputUnit.scala:66:19
        states_1_occupied = _RANDOM_2[5];	// OutputUnit.scala:66:19
        states_1_c = _RANDOM_2[8:6];	// OutputUnit.scala:66:19
        states_0_occupied = _RANDOM_2[28];	// OutputUnit.scala:66:19
        states_0_c = _RANDOM_2[31:29];	// OutputUnit.scala:66:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
