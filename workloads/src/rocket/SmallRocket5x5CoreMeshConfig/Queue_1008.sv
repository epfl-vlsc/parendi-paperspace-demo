...
module Queue_1008(
  ...
  input  [21:0] io_enq_bits_data_clients,
  ...
  output [21:0] io_deq_bits_data_clients,
  output [3:0]  io_deq_bits_data_tag
);

  wire [38:0] _ram_ext_R0_data;	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_data_clients = _ram_ext_R0_data[34:13];	// Decoupled.scala:273:95
  assign io_deq_bits_data_tag = _ram_ext_R0_data[38:35];	// Decoupled.scala:273:95
endmodule
