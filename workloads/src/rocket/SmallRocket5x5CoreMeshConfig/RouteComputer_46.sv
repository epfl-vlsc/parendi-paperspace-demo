...
module RouteComputer_46(
  ...
  wire [2:0] _decoded_T_158 =
    {io_req_2_bits_flow_egress_node[0], _GEN[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_164 =
    {_GEN[0], _GEN[1], io_req_2_bits_flow_egress_node[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_160,
      &_decoded_T_172,
      &_decoded_T_176};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_158,
      &_decoded_T_162,
      &_decoded_T_174};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_124, &_decoded_T_138, &_decoded_T_152, &_decoded_T_178};	// Cat.scala:33:92, pla.scala:98:74, :114:39
