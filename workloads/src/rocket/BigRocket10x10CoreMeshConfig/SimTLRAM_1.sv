  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_address = {_RANDOM_0[31:23], _RANDOM_1[21:0]};	// @[HarnessExtMem.scala:598:30, :607:26]
        d_mask = _RANDOM_1[29:22];	// @[HarnessExtMem.scala:607:26, :608:26]
        d_rmw_data = {_RANDOM_1[31:30], _RANDOM_2, _RANDOM_3[29:0]};	// @[HarnessExtMem.scala:607:26, :609:26]
        d_raw_data_0 = {_RANDOM_3[31], _RANDOM_4[6:0]};	// @[HarnessExtMem.scala:609:26, :611:26]
        d_raw_data_1 = _RANDOM_4[14:7];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_2 = _RANDOM_4[22:15];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_3 = _RANDOM_4[30:23];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_4 = {_RANDOM_4[31], _RANDOM_5[6:0]};	// @[HarnessExtMem.scala:611:26]
        d_raw_data_5 = _RANDOM_5[14:7];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_6 = _RANDOM_5[22:15];	// @[HarnessExtMem.scala:611:26]
        d_raw_data_7 = _RANDOM_5[30:23];	// @[HarnessExtMem.scala:611:26]
        r_full = _RANDOM_5[31];	// @[HarnessExtMem.scala:611:26, :614:30]
        r_opcode = _RANDOM_6[2:0];	// @[HarnessExtMem.scala:615:26]
        r_param = _RANDOM_6[5:3];	// @[HarnessExtMem.scala:615:26, :616:26]
        r_size = _RANDOM_6[7:6];	// @[HarnessExtMem.scala:615:26, :617:26]
        r_source = _RANDOM_6[17:8];	// @[HarnessExtMem.scala:615:26, :618:26]
        r_read = _RANDOM_6[18];	// @[HarnessExtMem.scala:615:26, :619:26]
        r_atomic = _RANDOM_6[19];	// @[HarnessExtMem.scala:615:26, :620:26]
        r_sublane = _RANDOM_6[20];	// @[HarnessExtMem.scala:615:26, :621:26]
        r_address = {_RANDOM_6[31:21], _RANDOM_7[19:0]};	// @[HarnessExtMem.scala:615:26, :622:26]
        r_mask = _RANDOM_7[27:20];	// @[HarnessExtMem.scala:622:26, :623:26]
        r_rmw_data = {_RANDOM_7[31:28], _RANDOM_8, _RANDOM_9[27:0]};	// @[HarnessExtMem.scala:622:26, :624:26]
        REG = _RANDOM_9[30];	// @[HarnessExtMem.scala:624:26, :807:47]
        r_0 = {_RANDOM_9[31], _RANDOM_10[6:0]};	// @[HarnessExtMem.scala:624:26, Reg.scala:19:16]
