...
module IngressUnit_105(
  ...
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[6:5], _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 4'h7;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (8'h23),
