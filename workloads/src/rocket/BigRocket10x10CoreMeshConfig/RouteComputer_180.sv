...
module RouteComputer_180(
  ...
  wire [5:0] _GEN = ~(io_req_1_bits_flow_egress_node[6:1]);	// @[RouteComputer.scala:74:27, pla.scala:78:21]
  ...
  wire [2:0] _decoded_T_57 = {io_req_1_bits_flow_egress_node_id[0], _GEN[5], io_req_1_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_61 = {io_req_1_bits_flow_egress_node_id[0], _GEN[5], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_69 = {_GEN[5], io_req_1_bits_src_virt_id[0], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [1:0] _decoded_T_75 = {_GEN[5], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_77 = {io_req_1_bits_flow_egress_node_id[0], _GEN[5], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
