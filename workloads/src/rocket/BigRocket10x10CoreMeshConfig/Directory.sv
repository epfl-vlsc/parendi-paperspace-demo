...
module Directory(
  ...
  input  [96:0] io_write_bits_data_clients,
  ...
  output [96:0] io_result_bits_clients,
  ...
  wire [103:0] _WIRE_7;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_6;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_5;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_4;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_3;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_2;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_1;	// @[Directory.scala:99:44]
  wire [103:0] _WIRE_0;	// @[Directory.scala:99:44]
  ...
  wire [96:0]  _write_io_deq_bits_data_clients;	// @[Decoupled.scala:375:21]
  wire [3:0]   _write_io_deq_bits_data_tag;	// @[Decoupled.scala:375:21]
  wire [831:0] _cc_dir_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  assign _WIRE_0 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_1 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_2 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_3 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_4 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_5 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_6 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_7 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 104'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  ...
  wire         _hits_T_6 = _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[102:101])) & (~setQuash | (|_write_io_deq_bits_way));	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_13 = _cc_dir_RW0_rdata[107:104] == tag & (|(_cc_dir_RW0_rdata[206:205])) & (~setQuash | _write_io_deq_bits_way != 3'h1);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_20 = _cc_dir_RW0_rdata[211:208] == tag & (|(_cc_dir_RW0_rdata[310:309])) & (~setQuash | _write_io_deq_bits_way != 3'h2);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_27 = _cc_dir_RW0_rdata[315:312] == tag & (|(_cc_dir_RW0_rdata[414:413])) & (~setQuash | _write_io_deq_bits_way != 3'h3);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_34 = _cc_dir_RW0_rdata[419:416] == tag & (|(_cc_dir_RW0_rdata[518:517])) & (~setQuash | _write_io_deq_bits_way != 3'h4);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_41 = _cc_dir_RW0_rdata[523:520] == tag & (|(_cc_dir_RW0_rdata[622:621])) & (~setQuash | _write_io_deq_bits_way != 3'h5);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_48 = _cc_dir_RW0_rdata[627:624] == tag & (|(_cc_dir_RW0_rdata[726:725])) & (~setQuash | _write_io_deq_bits_way != 3'h6);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_55 = _cc_dir_RW0_rdata[731:728] == tag & (|(_cc_dir_RW0_rdata[830:829])) & (~setQuash | _write_io_deq_bits_way != 3'h7);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  ...
  Queue_3883 write (	// @[Decoupled.scala:375:21]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty = (|hits) ? _hits_T_6 & _cc_dir_RW0_rdata[103] | _hits_T_13 & _cc_dir_RW0_rdata[207] | _hits_T_20 & _cc_dir_RW0_rdata[311] | _hits_T_27 & _cc_dir_RW0_rdata[415] | _hits_T_34 & _cc_dir_RW0_rdata[519] | _hits_T_41 & _cc_dir_RW0_rdata[623] | _hits_T_48 & _cc_dir_RW0_rdata[727] | _hits_T_55 & _cc_dir_RW0_rdata[831] : _view__T_69 ? _write_io_deq_bits_data_dirty : victimWayOH[0] & _cc_dir_RW0_rdata[103] | victimWayOH[1] & _cc_dir_RW0_rdata[207] | victimWayOH[2] & _cc_dir_RW0_rdata[311] | victimWayOH[3] & _cc_dir_RW0_rdata[415] | victimWayOH[4] & _cc_dir_RW0_rdata[519] | victimWayOH[5] & _cc_dir_RW0_rdata[623] | victimWayOH[6] & _cc_dir_RW0_rdata[727] | victimWayOH[7] & _cc_dir_RW0_rdata[831];	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_state = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[102:101] : 2'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[206:205] : 2'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[310:309] : 2'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[414:413] : 2'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[518:517] : 2'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[622:621] : 2'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[726:725] : 2'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[830:829] : 2'h0) : _view__T_69 ? _write_io_deq_bits_data_state : (victimWayOH[0] ? _cc_dir_RW0_rdata[102:101] : 2'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[206:205] : 2'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[310:309] : 2'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[414:413] : 2'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[518:517] : 2'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[622:621] : 2'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[726:725] : 2'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[830:829] : 2'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_clients = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[100:4] : 97'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[204:108] : 97'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[308:212] : 97'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[412:316] : 97'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[516:420] : 97'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[620:524] : 97'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[724:628] : 97'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[828:732] : 97'h0) : _view__T_69 ? _write_io_deq_bits_data_clients : (victimWayOH[0] ? _cc_dir_RW0_rdata[100:4] : 97'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[204:108] : 97'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[308:212] : 97'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[412:316] : 97'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[516:420] : 97'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[620:524] : 97'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[724:628] : 97'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[828:732] : 97'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_tag = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[107:104] : 4'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[211:208] : 4'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[315:312] : 4'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[419:416] : 4'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[523:520] : 4'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[627:624] : 4'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[731:728] : 4'h0) : _view__T_69 ? _write_io_deq_bits_data_tag : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[107:104] : 4'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[211:208] : 4'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[315:312] : 4'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[419:416] : 4'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[523:520] : 4'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[627:624] : 4'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[731:728] : 4'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
