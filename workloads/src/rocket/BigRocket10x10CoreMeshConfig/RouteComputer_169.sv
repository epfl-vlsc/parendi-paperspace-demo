...
module RouteComputer_169(
  ...
  wire [2:0] _decoded_T_173 = {io_req_3_bits_flow_egress_node_id[0], ~(io_req_3_bits_flow_egress_node[6]), io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45]
  wire [2:0] _decoded_T_175 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[6], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [2:0] _decoded_T_177 = {io_req_3_bits_flow_egress_node_id[0], ~(io_req_3_bits_flow_egress_node[6]), io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45]
  wire [2:0] _decoded_T_179 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[6], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [2:0] _decoded_T_181 = {~(io_req_3_bits_flow_egress_node[6]), io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45]
  wire [2:0] _decoded_T_183 = {io_req_3_bits_flow_egress_node[6], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [1:0] _decoded_T_185 = {~(io_req_3_bits_flow_egress_node[6]), io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45]
  wire [2:0] _decoded_T_187 = {io_req_3_bits_flow_egress_node_id[0], ~(io_req_3_bits_flow_egress_node[6]), io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45]
  wire [1:0] _decoded_T_189 = {io_req_3_bits_flow_egress_node[6], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [2:0] _decoded_T_191 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[6], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
