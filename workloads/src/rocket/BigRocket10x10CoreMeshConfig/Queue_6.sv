...
module Queue_6(
  ...
  ram_combMem_0 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_vc_sel_0_4, io_enq_bits_vc_sel_0_3, io_enq_bits_vc_sel_0_2, io_enq_bits_vc_sel_0_1, io_enq_bits_vc_sel_0_0, io_enq_bits_vc_sel_1_0, io_enq_bits_vc_sel_2_0}),	// @[Decoupled.scala:273:95]
    .R0_data (_ram_ext_R0_data)
  );
  assign io_enq_ready = ~full;	// @[Decoupled.scala:279:24, :303:19]
  assign io_deq_valid = ~empty;	// @[Decoupled.scala:278:25, :302:19]
  assign io_deq_bits_vc_sel_2_0 = _ram_ext_R0_data[0];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_1_0 = _ram_ext_R0_data[1];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_0_0 = _ram_ext_R0_data[2];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_0_1 = _ram_ext_R0_data[3];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_0_2 = _ram_ext_R0_data[4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_0_3 = _ram_ext_R0_data[5];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_vc_sel_0_4 = _ram_ext_R0_data[6];	// @[Decoupled.scala:273:95]
endmodule
