...
module IngressUnit_288(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 8'hC2;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 8'hC5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 8'hC8;	// @[IngressUnit.scala:30:72]
  wire [6:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 7'h61 : 7'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 7'h63 : 7'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 7'h62 : 7'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[6:5], _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 4'hC;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (8'h60),
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 8'hC1),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 8'hC0),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
