...
module RouteComputer_149(
  ...
  wire [4:0] _GEN_0 = ~(io_req_3_bits_flow_egress_node[5:1]);	// @[RouteComputer.scala:74:27, pla.scala:78:21]
  wire [2:0] _decoded_T_173 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[3], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_175 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[4], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_177 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_181 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[3], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [3:0] _decoded_T_183 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_185 = {_GEN_0[3], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_187 = {_GEN_0[4], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_189 = {_GEN_0[0], io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [1:0] _decoded_T_191 = {_GEN_0[3], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [1:0] _decoded_T_193 = {_GEN_0[4], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_195 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[4], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_199 = {_GEN_0[0], io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_201 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  assign io_resp_3_vc_sel_1_1 = |{&_decoded_T_173, &_decoded_T_175, &_decoded_T_179, &_decoded_T_181, &_decoded_T_195, &_decoded_T_197};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_1_2 = |{&_decoded_T_173, &_decoded_T_175, &_decoded_T_179, &_decoded_T_181, &_decoded_T_195, &_decoded_T_197};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_1_3 = |{&_decoded_T_173, &_decoded_T_175, &_decoded_T_179, &_decoded_T_181, &_decoded_T_185, &_decoded_T_187, &_decoded_T_191, &_decoded_T_193};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_1_4 = |{&_decoded_T_173, &_decoded_T_175, &_decoded_T_179, &_decoded_T_181, &_decoded_T_185, &_decoded_T_187, &_decoded_T_191, &_decoded_T_193};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_0_1 = |{&_decoded_T_177, &_decoded_T_183, &_decoded_T_201};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_0_2 = |{&_decoded_T_177, &_decoded_T_183, &_decoded_T_201};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_0_3 = |{&_decoded_T_177, &_decoded_T_183, &_decoded_T_189, &_decoded_T_199};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
  assign io_resp_3_vc_sel_0_4 = |{&_decoded_T_177, &_decoded_T_183, &_decoded_T_189, &_decoded_T_199};	// @[Cat.scala:33:92, pla.scala:98:74, :114:39]
