...
module PeripheryBus_1(
  ...
  input  [12:0] auto_coupler_to_bootrom_fragmenter_out_d_bits_source,
  ...
  input  [8:0]  auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_d_bits_source,
  ...
  input  [12:0] auto_coupler_to_l2_ctrl_buffer_out_d_bits_source,
  ...
  output [12:0] auto_coupler_to_bootrom_fragmenter_out_a_bits_source,
  ...
  output [8:0]  auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_source,
  ...
  output [12:0] auto_coupler_to_l2_ctrl_buffer_out_a_bits_source,
  ...
  wire [8:0]  _coupler_to_bootrom_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [8:0]  _coupler_to_l2_ctrl_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [8:0]  _wrapped_error_device_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [8:0]  _atomics_auto_out_a_bits_source;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [8:0]  _buffer_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [8:0]  _out_xbar_auto_in_d_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [8:0]  _out_xbar_auto_out_3_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [8:0]  _out_xbar_auto_out_1_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [8:0]  _out_xbar_auto_out_0_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [8:0]  _fixer_auto_in_d_bits_source;	// @[PeripheryBus.scala:47:33]
  ...
  wire [8:0]  _fixer_auto_out_a_bits_source;	// @[PeripheryBus.scala:47:33]
  ...
  TLInterconnectCoupler_102 coupler_to_l2_ctrl (	// @[LazyModule.scala:489:27]
    .clock                          (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                          (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_201 coupler_to_bootrom (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
