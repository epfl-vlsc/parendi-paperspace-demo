...
module TLAToNoC(
  ...
  assign io_flit_bits_egress_id = (_q_io_deq_bits_address[31:30] == 2'h0 ? 8'hC2 : 8'h0) | (_q_io_deq_bits_address[31:30] == 2'h2 ? 8'hC5 : 8'h0) | (_q_io_deq_bits_address[31:30] == 2'h1 ? 8'hC8 : 8'h0);	// @[Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17]
endmodule
