...
module Repeater_2(
  ...
  reg  [8:0]  saved_source;	// @[Repeater.scala:20:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM_0[18:10];	// @[Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM_0[31:19], _RANDOM_1[7:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM_1[15:8];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
