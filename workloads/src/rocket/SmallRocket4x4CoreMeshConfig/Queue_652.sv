...
module Queue_652(
  ...
  ram_combMem_3 ram_ext (	// Decoupled.scala:273:95
    ...
    .W0_clk  (clock),
    .W0_data
      ({1'h1, io_enq_bits_beat, io_enq_bits_set, io_enq_bits_way, io_enq_bits_noop}),	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_set = _ram_ext_R0_data[10:4];	// Decoupled.scala:273:95
  assign io_deq_bits_beat = _ram_ext_R0_data[13:11];	// Decoupled.scala:273:95
  assign io_deq_bits_mask = _ram_ext_R0_data[14];	// Decoupled.scala:273:95
endmodule
