...
module CSRFile(
  ...
  wire [3:0]  _GEN_11 =
    ((&{io_rw_addr[2],
        ...
        io_rw_addr[11]})
       ? io_hartid
       : 4'h0) | _io_rw_rdata_T_14[3:0];	// Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74
  wire [2:0]  _GEN_12 =
  ...
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0,
       ...
       ((&{io_rw_addr[2],
          ...
          ? {4'h0, io_interrupts_meip, 7'h0}
          : 12'h0) | _io_rw_rdata_T_14[15:4] | _io_rw_rdata_T_111[15:4]
         | _io_rw_rdata_T_112[15:4] | _io_rw_rdata_T_113[15:4] | _io_rw_rdata_T_114[15:4]
         | _io_rw_rdata_T_115[15:4] | _io_rw_rdata_T_116[15:4] | _io_rw_rdata_T_117[15:4]
         | _io_rw_rdata_T_118[15:4],
       _GEN_11[3] | _io_rw_rdata_T_111[3] | _io_rw_rdata_T_112[3] | _io_rw_rdata_T_113[3]
         | _io_rw_rdata_T_114[3] | _io_rw_rdata_T_115[3] | _io_rw_rdata_T_116[3]
         | _io_rw_rdata_T_117[3] | _io_rw_rdata_T_118[3],
       _GEN_12[2:1],
       _GEN_12[0]
         | (&{decoded_decoded_invInputs[0],
              io_rw_addr[1],
    ...
    if (reset) begin
      ...
      if (csr_wen & (&_decoded_decoded_T_2) & (~(io_pc[1]) | _reg_bp_0_control_WIRE_1[2]))	// CSR.scala:610:25, :1162:18, :1195:36, :1199:{35,41,45,53,66}, :1201:20, :1561:39, Cat.scala:33:92, package.scala:73:59, pla.scala:98:74
        reg_misa <=
          ...
          & 64'h1005 | reg_misa & 64'hFFFFFFFFFFFFEFFA;	// CSR.scala:610:25, :611:32, :1197:20, :1201:{23,25,32,35,55,62,73,75}, :1561:39, Mux.scala:27:73
  ...
  assign io_interrupt_cause =
    ...
    - 64'h8000000000000000;	// CSR.scala:581:25, :586:63, Mux.scala:27:73, :47:70
