...
module RouteComputer_22(
  ...
  wire [2:0] _decoded_T_317 =
    {io_req_4_bits_flow_egress_node_id[0],
     ...
     io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [2:0] _decoded_T_321 =
    {io_req_4_bits_flow_egress_node_id[0],
     ~(io_req_4_bits_flow_egress_node[2]),
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [2:0] _decoded_T_327 =
    {io_req_4_bits_flow_egress_node[2],
     io_req_4_bits_src_virt_id[0],
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_329 =
    {~(io_req_4_bits_flow_egress_node[2]), io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [2:0] _decoded_T_331 =
    {io_req_4_bits_flow_egress_node_id[0],
     ~(io_req_4_bits_flow_egress_node[2]),
     io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [1:0] _decoded_T_333 =
    {io_req_4_bits_flow_egress_node[2], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_4_vc_sel_1_3 =
    |{&_decoded_T_317, &_decoded_T_321, &_decoded_T_325, &_decoded_T_329};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_319, &_decoded_T_323, &_decoded_T_327, &_decoded_T_333};	// Cat.scala:33:92, pla.scala:98:74, :114:39
