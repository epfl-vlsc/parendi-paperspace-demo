...
module RouteComputer_23(
  ...
  wire [2:0] _decoded_T_183 =
    {io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_src_virt_id[0],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_185 =
    {~(io_req_3_bits_flow_egress_node[2]), io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [2:0] _decoded_T_187 =
    {io_req_3_bits_flow_egress_node_id[0],
     ~(io_req_3_bits_flow_egress_node[2]),
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [1:0] _decoded_T_189 =
  ...
  assign io_resp_3_vc_sel_1_3 =
    |{&_decoded_T_173, &_decoded_T_177, &_decoded_T_181, &_decoded_T_185};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_175, &_decoded_T_179, &_decoded_T_183, &_decoded_T_189};	// Cat.scala:33:92, pla.scala:98:74, :114:39
