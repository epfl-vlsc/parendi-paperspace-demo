...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 5'hD & _q_io_enq_bits_ingress_id_T_7
          ? 6'h28
          : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'hF & _q_io_enq_bits_ingress_id_T_7
            ? 6'h2A
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'hE & _q_io_enq_bits_ingress_id_T_7
            ? 6'h2C
