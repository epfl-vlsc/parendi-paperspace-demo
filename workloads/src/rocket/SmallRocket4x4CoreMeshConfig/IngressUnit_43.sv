...
module IngressUnit_43(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 5'h18;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 =
    io_in_bits_egress_id == 5'h8;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 =
    io_in_bits_egress_id == 5'h2;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_3 =
    io_in_bits_egress_id == 5'h4;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_4 =
    io_in_bits_egress_id == 5'h12;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_6 =
    io_in_bits_egress_id == 5'hA;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_7 =
    io_in_bits_egress_id == 5'hE;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_8 =
    io_in_bits_egress_id == 5'hC;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_9 =
    io_in_bits_egress_id == 5'h10;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_10 =
    io_in_bits_egress_id == 5'h6;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_11 =
    io_in_bits_egress_id == 5'h14;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_12 =
    io_in_bits_egress_id == 5'h16;	// IngressUnit.scala:30:72
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_19 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_6 ? 3'h5 : 3'h0;	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 4'hC : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_4 ? 4'h9 : 4'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_9,
       _route_buffer_io_enq_bits_flow_egress_node_id_T_1
         | _route_buffer_io_enq_bits_flow_egress_node_T_19[2]
       ...
       _route_buffer_io_enq_bits_flow_egress_node_id_T_2
         | _route_buffer_io_enq_bits_flow_egress_node_T_19[0]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_7
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_10}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_11 ? 4'hA : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_12 ? 4'hB : 4'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  assign _T_33 =
    ...
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T
              ...
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_12)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
