...
module InputUnit_24(
  ...
  wire [10:0] _GEN_0 =
    {states_4_vc_sel_3_4, 9'h0, states_4_vc_sel_1_4}
    & {io_out_credit_available_3_4,
       4'hF,
       io_out_credit_available_2_4,
       io_out_credit_available_2_3,
       ...
       io_out_credit_available_2_1,
       io_out_credit_available_2_0,
       io_out_credit_available_1_4};	// InputUnit.scala:192:19, :304:{40,47,73}, Mux.scala:47:70
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2
      ...
      if (io_in_flit_0_bits_flow_egress_node == 5'h12)	// InputUnit.scala:209:57
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
    ...
    if (_GEN) begin	// InputUnit.scala:287:29
      ...
      states_4_vc_sel_3_4 <= ~_GEN_1 & states_4_vc_sel_3_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
      states_4_vc_sel_1_4 <= ~_GEN_1 & states_4_vc_sel_1_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
    end
    ...
    salloc_outs_0_out_vid <=
      ...
      | (_vc_sel_WIRE_23 ? {_vc_sel_WIRE_23, 2'h0} : 3'h0);	// Bitwise.scala:51:90, Cat.scala:33:92, InputUnit.scala:208:27, :336:8, Mux.scala:27:73
