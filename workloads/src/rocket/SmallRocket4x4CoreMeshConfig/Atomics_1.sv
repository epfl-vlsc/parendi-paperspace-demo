...
module Atomics_1(
  ...
  wire [63:0]     _GEN_0 =
    ({{8{io_a_mask[7]}},
      ...
      {8{io_a_mask[2]}},
      {8{io_a_mask[1]}},
      {8{io_a_mask[0]}}} & io_a_data) + ({64{~(io_a_param[2])}} ^ io_data_in);	// Atomics.scala:20:28, :25:18, :26:{44,57}, Bitwise.scala:28:17, :77:12, Cat.scala:33:92
  wire [7:0]      _sign_a_T_65 =
    {io_a_data[63],
     io_a_data[55],
     io_a_data[47],
     io_a_data[39],
     ...
     io_a_data[23],
     io_a_data[15],
     io_a_data[7]} & signBit;	// Atomics.scala:24:27, :27:{36,83}, Cat.scala:33:92
  ...
  wire [7:0][1:0] _GEN_2 =
    {{2'h0},
     ...
     {io_a_param[2]
        ? 2'h2
        : {1'h0,
           io_a_param[0] == ((|_sign_a_T_65) == (|({io_data_in[63],
                                                    io_data_in[55],
                                                    io_data_in[47],
                                                    io_data_in[39],
                                                    io_data_in[31],
                               ...
                               ? ({_GEN_0[63],
                                   ...
                                   _GEN_0[23],
                                   _GEN_0[15],
                                   _GEN_0[7]} & signBit) == 8'h0
                               : io_a_param[1] == (|_sign_a_T_65))}},
     {2'h1},
     {2'h1}};	// Atomics.scala:20:28, :21:28, :22:28, :24:27, :26:57, :27:{36,83,94}, :31:32, :32:{21,29}, :33:25, :47:{19,42}, :50:8, Bitwise.scala:77:12, Cat.scala:33:92
  ...
  wire [3:0][7:0] _GEN_4 =
    {{{_logical_T_174[0],
     ...
     {_GEN_0[15:8]},
     {io_a_data[15:8]},
     {io_data_in[15:8]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_5 =
    {{{_logical_T_150[0],
       _logical_T_147[0],
       _logical_T_144[0],
     ...
     {_GEN_0[7:0]},
     {io_a_data[7:0]},
     {io_data_in[7:0]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_6 =
    {{{_logical_T_222[0],
       _logical_T_219[0],
       _logical_T_216[0],
     ...
     {_GEN_0[31:24]},
     {io_a_data[31:24]},
     {io_data_in[31:24]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_7 =
    {{{_logical_T_198[0],
       _logical_T_195[0],
       _logical_T_192[0],
     ...
     {_GEN_0[23:16]},
     {io_a_data[23:16]},
     {io_data_in[23:16]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_8 =
    {{{_logical_T_270[0],
       _logical_T_267[0],
       _logical_T_264[0],
     ...
     {_GEN_0[47:40]},
     {io_a_data[47:40]},
     {io_data_in[47:40]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_9 =
    {{{_logical_T_246[0],
       _logical_T_243[0],
       _logical_T_240[0],
     ...
     {_GEN_0[39:32]},
     {io_a_data[39:32]},
     {io_data_in[39:32]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_10 =
    {{{_logical_T_318[0],
     ...
     {_GEN_0[63:56]},
     {io_a_data[63:56]},
     {io_data_in[63:56]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  wire [3:0][7:0] _GEN_11 =
    {{{_logical_T_294[0],
     ...
     {_GEN_0[55:48]},
     {io_a_data[55:48]},
     {io_data_in[55:48]}};	// Atomics.scala:26:57, :43:8, :61:59, Cat.scala:33:92
  assign io_data_out =
    {_GEN_10[io_a_mask[7] ? _GEN_3 : 2'h0],
     _GEN_11[io_a_mask[6] ? _GEN_3 : 2'h0],
     _GEN_8[io_a_mask[5] ? _GEN_3 : 2'h0],
     _GEN_9[io_a_mask[4] ? _GEN_3 : 2'h0],
     _GEN_6[io_a_mask[3] ? _GEN_3 : 2'h0],
     _GEN_7[io_a_mask[2] ? _GEN_3 : 2'h0],
     _GEN_4[io_a_mask[1] ? _GEN_3 : 2'h0],
     _GEN_5[io_a_mask[0] ? _GEN_3 : 2'h0]};	// Atomics.scala:47:{19,42}, :59:47, Bitwise.scala:28:17, Cat.scala:33:92
endmodule
