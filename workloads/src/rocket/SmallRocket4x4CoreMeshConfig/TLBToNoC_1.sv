...
module TLBToNoC_1(
  ...
  assign io_flit_bits_egress_id =
    {_q_io_deq_bits_source[5:2] == 4'h4,
     {_q_io_deq_bits_source[5:2] == 4'h8,
      {_q_io_deq_bits_source[5:2] == 4'hA, _q_io_deq_bits_source[5:2] == 4'hB, 1'h0}
        | (_q_io_deq_bits_source[5:2] == 4'h9 ? 3'h6 : 3'h0)}
       | (_q_io_deq_bits_source[5:2] == 4'h7 ? 4'hA : 4'h0)
       | (_q_io_deq_bits_source[5:2] == 4'h6 ? 4'hC : 4'h0)
       | (_q_io_deq_bits_source[5:2] == 4'h5 ? 4'hE : 4'h0)}
    | (_q_io_deq_bits_source[5:2] == 4'h3 ? 5'h12 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h2 ? 5'h14 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h1 ? 5'h16 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h0 ? 5'h18 : 5'h0);	// Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
