  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = _RANDOM_0[31:17];	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_mask = _RANDOM_1[7:0];	// AtomicAutomata.scala:79:24
        cam_a_0_bits_data = {_RANDOM_1[31:8], _RANDOM_2, _RANDOM_3[7:0]};	// AtomicAutomata.scala:79:24
        cam_a_0_bits_corrupt = _RANDOM_3[8];	// AtomicAutomata.scala:79:24
        cam_a_0_fifoId = _RANDOM_3[9];	// AtomicAutomata.scala:79:24
        cam_a_0_lut = _RANDOM_3[13:10];	// AtomicAutomata.scala:79:24
        cam_d_0_data = {_RANDOM_3[31:14], _RANDOM_4, _RANDOM_5[13:0]};	// AtomicAutomata.scala:79:24, :80:24
        cam_d_0_denied = _RANDOM_5[14];	// AtomicAutomata.scala:80:24
        cam_d_0_corrupt = _RANDOM_5[15];	// AtomicAutomata.scala:80:24
        beatsLeft = _RANDOM_5[18:16];	// Arbiter.scala:88:30, AtomicAutomata.scala:80:24
        state_0 = _RANDOM_5[19];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        state_1 = _RANDOM_5[20];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        d_first_counter = _RANDOM_5[23:21];	// AtomicAutomata.scala:80:24, Edges.scala:229:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
