...
module OutputUnit(
  ...
  output [4:0]  io_out_flit_0_bits_flow_ingress_node,
  output [1:0]  io_out_flit_0_bits_flow_ingress_node_id,
  output [4:0]  io_out_flit_0_bits_flow_egress_node,
  ...
  wire       _GEN_1 = ~(io_out_vc_free[2]) & states_2_occupied;	// OutputUnit.scala:66:19, :74:{25,30}, :76:18
  wire       _GEN_2 = ~(io_out_vc_free[3]) & states_3_occupied;	// OutputUnit.scala:66:19, :74:{25,30}, :76:18
  wire       _GEN_3 = ~(io_out_vc_free[4]) & states_4_occupied;	// OutputUnit.scala:66:19, :74:{25,30}, :76:18
  always @(posedge clock) begin
    if (reset) begin
      ...
      states_4_occupied <= io_allocs_4_alloc | _GEN_3;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_4_c <=
        states_4_c + {2'h0, io_out_credit_return[4]} - {2'h0, io_credit_alloc_4_alloc};	// OutputUnit.scala:66:19, :94:36, :97:{18,26}
      states_3_occupied <= io_allocs_3_alloc | _GEN_2;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_3_c <=
        states_3_c + {2'h0, io_out_credit_return[3]} - {2'h0, io_credit_alloc_3_alloc};	// OutputUnit.scala:66:19, :94:36, :97:{18,26}
      states_2_occupied <= io_allocs_2_alloc | _GEN_1;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_2_c <=
        states_2_c + {2'h0, io_out_credit_return[2]} - {2'h0, io_credit_alloc_2_alloc};	// OutputUnit.scala:66:19, :94:36, :97:{18,26}
      states_1_occupied <= io_allocs_1_alloc | _GEN_0;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_1_c <=
        states_1_c + {2'h0, io_out_credit_return[1]} - {2'h0, io_credit_alloc_1_alloc};	// OutputUnit.scala:66:19, :94:36, :97:{18,26}
      states_0_occupied <= io_allocs_0_alloc | _GEN;	// OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18
      states_0_c <=
        states_0_c + {2'h0, io_out_credit_return[0]} - {2'h0, io_credit_alloc_0_alloc};	// OutputUnit.scala:66:19, :94:36, :97:{18,26}
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_3_occupied = _RANDOM_0[21];	// OutputUnit.scala:66:19
        states_3_c = _RANDOM_0[24:22];	// OutputUnit.scala:66:19
        states_2_occupied = _RANDOM_1[10];	// OutputUnit.scala:66:19
        states_2_c = _RANDOM_1[13:11];	// OutputUnit.scala:66:19
        states_1_occupied = _RANDOM_1[31];	// OutputUnit.scala:66:19
        states_1_c = _RANDOM_2[2:0];	// OutputUnit.scala:66:19
        states_0_occupied = _RANDOM_2[20];	// OutputUnit.scala:66:19
        states_0_c = _RANDOM_2[23:21];	// OutputUnit.scala:66:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_channel_status_2_occupied = _GEN_1;	// OutputUnit.scala:66:19, :74:30, :76:18
  assign io_channel_status_3_occupied = _GEN_2;	// OutputUnit.scala:66:19, :74:30, :76:18
  assign io_channel_status_4_occupied = _GEN_3;	// OutputUnit.scala:66:19, :74:30, :76:18
