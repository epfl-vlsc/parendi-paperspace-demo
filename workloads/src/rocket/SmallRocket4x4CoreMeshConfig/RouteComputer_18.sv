...
module RouteComputer_18(
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_174, &_decoded_T_176, &_decoded_T_178, io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_3_4 =
    &{~(io_req_1_bits_flow_egress_node[0]), io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45, :98:74
  ...
  assign io_resp_1_vc_sel_2_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_62, &_decoded_T_66};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_2_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_62, &_decoded_T_66};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_2_4 =
    |{io_req_1_bits_flow_egress_node_id[1],
      &_decoded_T_62,
      &{io_req_1_bits_flow_egress_node[0], io_req_1_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
