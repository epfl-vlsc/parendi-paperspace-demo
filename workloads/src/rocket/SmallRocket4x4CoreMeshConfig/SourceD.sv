...
module SourceD(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_offset = {_RANDOM_0[31:28], _RANDOM_1[1:0]};	// Reg.scala:19:16, SourceD.scala:84:21
        s1_req_reg_put = _RANDOM_1[7:2];	// Reg.scala:19:16
        s1_req_reg_set = _RANDOM_1[14:8];	// Reg.scala:19:16
        s1_req_reg_sink = _RANDOM_1[17:15];	// Reg.scala:19:16
        s1_req_reg_way = _RANDOM_1[20:18];	// Reg.scala:19:16
        s1_req_reg_bad = _RANDOM_1[21];	// Reg.scala:19:16
        s1_latch_bypass = _RANDOM_1[22];	// Reg.scala:19:16, SourceD.scala:90:32
        s1_bypass_r = _RANDOM_1[23];	// Reg.scala:19:16
        queue_io_enq_valid_REG = _RANDOM_1[24];	// Reg.scala:19:16, SourceD.scala:121:40
        queue_io_enq_valid_REG_1 = _RANDOM_1[25];	// Reg.scala:19:16, SourceD.scala:121:32
        s2_full = _RANDOM_1[26];	// Reg.scala:19:16, SourceD.scala:147:24
        s2_valid_pb = _RANDOM_1[27];	// Reg.scala:19:16, SourceD.scala:148:28
        s2_beat = _RANDOM_1[30:28];	// Reg.scala:19:16
        s2_bypass = _RANDOM_1[31];	// Reg.scala:19:16
        s2_req_prio_0 = _RANDOM_2[0];	// Reg.scala:19:16
        s2_req_prio_2 = _RANDOM_2[2];	// Reg.scala:19:16
        s2_req_opcode = _RANDOM_2[6:4];	// Reg.scala:19:16
        s2_req_param = _RANDOM_2[9:7];	// Reg.scala:19:16
        s2_req_size = _RANDOM_2[12:10];	// Reg.scala:19:16
        s2_req_source = _RANDOM_2[18:13];	// Reg.scala:19:16
        s2_req_put = {_RANDOM_2[31:29], _RANDOM_3[2:0]};	// Reg.scala:19:16
        s2_req_set = _RANDOM_3[9:3];	// Reg.scala:19:16
        s2_req_sink = _RANDOM_3[12:10];	// Reg.scala:19:16
        s2_req_way = _RANDOM_3[15:13];	// Reg.scala:19:16
        s2_req_bad = _RANDOM_3[16];	// Reg.scala:19:16
        s2_last = _RANDOM_3[17];	// Reg.scala:19:16
        s2_need_r = _RANDOM_3[18];	// Reg.scala:19:16
        s2_need_pb = _RANDOM_3[19];	// Reg.scala:19:16
        s2_retires = _RANDOM_3[20];	// Reg.scala:19:16
        s2_need_d = _RANDOM_3[21];	// Reg.scala:19:16
        s2_pdata_r_data = {_RANDOM_3[31:22], _RANDOM_4, _RANDOM_5[21:0]};	// Reg.scala:19:16
        s2_pdata_r_mask = _RANDOM_5[29:22];	// Reg.scala:19:16
        s2_pdata_r_corrupt = _RANDOM_5[30];	// Reg.scala:19:16
        s3_full = _RANDOM_5[31];	// Reg.scala:19:16, SourceD.scala:190:24
        s3_valid_d = _RANDOM_6[0];	// SourceD.scala:191:27
        s3_beat = _RANDOM_6[3:1];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_bypass = _RANDOM_6[4];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_prio_0 = _RANDOM_6[5];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_prio_2 = _RANDOM_6[7];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_opcode = _RANDOM_6[11:9];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_param = _RANDOM_6[14:12];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_size = _RANDOM_6[17:15];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_source = _RANDOM_6[23:18];	// Reg.scala:19:16, SourceD.scala:191:27
        s3_req_set = _RANDOM_7[14:8];	// Reg.scala:19:16
        s3_req_sink = _RANDOM_7[17:15];	// Reg.scala:19:16
        s3_req_way = _RANDOM_7[20:18];	// Reg.scala:19:16
        s3_req_bad = _RANDOM_7[21];	// Reg.scala:19:16
        s3_pdata_data = {_RANDOM_7[31:23], _RANDOM_8, _RANDOM_9[22:0]};	// Reg.scala:19:16
        s3_pdata_mask = _RANDOM_9[30:23];	// Reg.scala:19:16
        s3_pdata_corrupt = _RANDOM_9[31];	// Reg.scala:19:16
        s3_need_bs = _RANDOM_10[0];	// Reg.scala:19:16
        s3_retires = _RANDOM_10[1];	// Reg.scala:19:16
        s3_need_r = _RANDOM_10[2];	// Reg.scala:19:16
        s4_full = _RANDOM_10[3];	// Reg.scala:19:16, SourceD.scala:248:24
        s4_beat = _RANDOM_10[6:4];	// Reg.scala:19:16
        s4_need_bs = _RANDOM_10[8];	// Reg.scala:19:16
        s4_need_pb = _RANDOM_10[9];	// Reg.scala:19:16
        s4_req_prio_2 = _RANDOM_10[12];	// Reg.scala:19:16
        s4_req_param = _RANDOM_10[19:17];	// Reg.scala:19:16
        s4_req_set = _RANDOM_11[19:13];	// Reg.scala:19:16
        s4_req_way = _RANDOM_11[25:23];	// Reg.scala:19:16
        s4_adjusted_opcode = _RANDOM_11[29:27];	// Reg.scala:19:16
        s4_pdata_data = {_RANDOM_11[31:30], _RANDOM_12, _RANDOM_13[29:0]};	// Reg.scala:19:16
        s4_pdata_mask = {_RANDOM_13[31:30], _RANDOM_14[5:0]};	// Reg.scala:19:16
        s4_pdata_corrupt = _RANDOM_14[6];	// Reg.scala:19:16
        s4_rdata = {_RANDOM_14[31:7], _RANDOM_15, _RANDOM_16[6:0]};	// Reg.scala:19:16
        s5_req_set = _RANDOM_17[16:10];	// Reg.scala:19:16
        s5_req_way = _RANDOM_17[22:20];	// Reg.scala:19:16
        s5_beat = _RANDOM_17[26:24];	// Reg.scala:19:16
        s5_dat = {_RANDOM_17[31:27], _RANDOM_18, _RANDOM_19[26:0]};	// Reg.scala:19:16
        s6_req_set = {_RANDOM_20[31:30], _RANDOM_21[4:0]};	// Reg.scala:19:16
        s6_req_way = _RANDOM_21[10:8];	// Reg.scala:19:16
        s6_beat = _RANDOM_21[14:12];	// Reg.scala:19:16
        s6_dat = {_RANDOM_21[31:15], _RANDOM_22, _RANDOM_23[14:0]};	// Reg.scala:19:16
        s7_dat = {_RANDOM_23[31:15], _RANDOM_24, _RANDOM_25[14:0]};	// Reg.scala:19:16
        s3_bypass_data_REG = _RANDOM_25[15];	// Reg.scala:19:16, SourceD.scala:337:19
        s3_bypass_data_REG_1 = {_RANDOM_25[31:16], _RANDOM_26, _RANDOM_27[15:0]};	// Reg.scala:19:16, SourceD.scala:337:66
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_648 queue (	// SourceD.scala:120:21
    .clock            (clock),
    .reset            (reset),
