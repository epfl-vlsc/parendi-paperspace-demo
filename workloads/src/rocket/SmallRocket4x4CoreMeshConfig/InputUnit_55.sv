...
module InputUnit_55(
  ...
  wire [10:0] _GEN_0 =
    {states_4_vc_sel_4_4, 9'h0, states_4_vc_sel_2_4}
    & {io_out_credit_available_4_4,
       4'hF,
       io_out_credit_available_3_4,
       io_out_credit_available_3_3,
       ...
       io_out_credit_available_3_1,
       io_out_credit_available_3_0,
       io_out_credit_available_2_4};	// InputUnit.scala:192:19, :304:{40,47,73}, Mux.scala:47:70
  wire        _salloc_arb_io_in_4_valid_T_2 =
    states_4_g == 3'h3 & (|{_GEN_0[10], _GEN_0[0]}) & _input_buffer_io_deq_4_valid;	// InputUnit.scala:181:28, :192:19, :210:20, :304:{47,81}, :305:{22,50}
  ...
  wire        _GEN_1 = _T & io_in_flit_0_bits_virt_channel_id == 3'h4;	// InputUnit.scala:192:19, :205:{32,60}, :210:20
  ...
  always @(posedge clock) begin
    ...
    else if (_T_28 & vcalloc_sel[4] | vcalloc_vals_4 & vcalloc_sel[4]
    ...
    else if (_GEN_1) begin	// InputUnit.scala:192:19, :205:60, :210:20
      if (io_in_flit_0_bits_flow_egress_node == 5'h1A)	// InputUnit.scala:209:57
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
    ...
    if (_GEN) begin	// InputUnit.scala:287:29
      ...
      states_4_vc_sel_4_4 <= ~_GEN_1 & states_4_vc_sel_4_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
      states_4_vc_sel_2_4 <= ~_GEN_1 & states_4_vc_sel_2_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
    end
    if (_GEN_1) begin	// InputUnit.scala:192:19, :205:60, :210:20
    ...
    salloc_outs_0_out_vid <=
      ...
      | (_vc_sel_WIRE_29 ? {_vc_sel_WIRE_29, 2'h0} : 3'h0);	// Bitwise.scala:51:90, Cat.scala:33:92, InputUnit.scala:208:27, :336:8, Mux.scala:27:73
  ...
  `ifndef SYNTHESIS
    wire  [2:0][2:0] _GEN_2 = '{3'h0, 3'h0, 3'h0};	// InputUnit.scala:208:27
    wire  [7:0][2:0] _GEN_3 = {_GEN_2, {{states_4_g}, {3'h0}, {3'h0}, {3'h0}, {3'h0}}};	// InputUnit.scala:192:19, :208:27
    always @(posedge clock) begin	// InputUnit.scala:207:13
      ...
      if (_T & ~reset & (|_GEN_3[io_in_flit_0_bits_virt_channel_id])) begin	// InputUnit.scala:205:32, :208:{13,27}
      ...
      if (_route_arbiter_io_out_valid & ~reset
          & _GEN_3[_route_arbiter_io_out_bits_src_virt_id] != 3'h1) begin	// InputUnit.scala:187:29, :208:27, :210:26, :241:{11,25}
  ...
  assign io_in_credit_return = _T_56 ? _salloc_arb_io_chosen_oh_0 : 5'h0;	// Decoupled.scala:51:35, InputUnit.scala:235:14, :296:26, :340:8
