...
module InputUnit_13(
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2
      ...
      if (io_in_flit_0_bits_flow_egress_node == 5'hD)	// InputUnit.scala:209:57
        states_4_g <= 3'h2;	// InputUnit.scala:192:19, :210:26
    ...
    if (_salloc_arb_io_chosen_oh_0[4]) begin	// InputUnit.scala:296:26, Mux.scala:29:36
      ...
      salloc_outs_0_flit_flow_ingress_node <= 5'h0;	// InputUnit.scala:235:14, :336:8
      salloc_outs_0_flit_flow_ingress_node_id <= 2'h0;	// Bitwise.scala:51:90, InputUnit.scala:336:8
      salloc_outs_0_flit_flow_egress_node <= 5'h0;	// InputUnit.scala:235:14, :336:8
  ...
  InputBuffer_13 input_buffer (	// InputUnit.scala:181:28
    .clock                         (clock),
    .reset                         (reset),
  ...
  Arbiter route_arbiter (	// InputUnit.scala:187:29
    ...
    .io_in_1_bits_flow_ingress_node    (5'h0),	// InputUnit.scala:235:14
    .io_in_1_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_1_bits_flow_egress_node     (5'h0),	// InputUnit.scala:235:14
    ...
    .io_in_2_bits_flow_ingress_node    (5'h0),	// InputUnit.scala:235:14
    .io_in_2_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_2_bits_flow_egress_node     (5'h0),	// InputUnit.scala:235:14
    ...
    .io_in_3_bits_flow_ingress_node    (5'h0),	// InputUnit.scala:235:14
    .io_in_3_bits_flow_ingress_node_id (2'h0),	// Bitwise.scala:51:90
    .io_in_3_bits_flow_egress_node     (5'h0),	// InputUnit.scala:235:14
  ...
  assign io_in_credit_return = _T_59 ? _salloc_arb_io_chosen_oh_0 : 5'h0;	// Decoupled.scala:51:35, InputUnit.scala:235:14, :296:26, :340:8
