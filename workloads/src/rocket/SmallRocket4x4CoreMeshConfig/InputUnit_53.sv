...
module InputUnit_53(
  ...
  wire        _salloc_arb_io_in_4_valid_T_2 =
    states_4_g == 3'h3 & states_4_vc_sel_4_4 & io_out_credit_available_4_4
    & _input_buffer_io_deq_4_valid;	// InputUnit.scala:181:28, :192:19, :210:20, :305:{22,50}
  ...
  always @(posedge clock) begin
    ...
    if (_GEN)	// InputUnit.scala:287:29
      ...
      states_4_vc_sel_4_4 <= ~_GEN_0 & states_4_vc_sel_4_4;	// InputUnit.scala:192:19, :205:60, :210:20, :211:45
    ...
    if (_vc_sel_WIRE_29)	// Mux.scala:27:73
      salloc_outs_0_out_vid <= {_vc_sel_WIRE_29, 2'h0};	// Bitwise.scala:51:90, Cat.scala:33:92, InputUnit.scala:336:8, Mux.scala:27:73
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// InputUnit.scala:207:13
      ...
      if (_route_arbiter_io_out_valid & ~reset
          & _GEN_2[_route_arbiter_io_out_bits_src_virt_id] != 3'h1) begin	// InputUnit.scala:187:29, :208:27, :210:26, :241:{11,25}
