...
module IngressUnit_44(
  ...
  input  [4:0]  io_in_bits_egress_id,
  ...
  wire        _T_33;	// IngressUnit.scala:64:41
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_13 =
    io_in_bits_egress_id == 5'h17;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_14 =
    io_in_bits_egress_id == 5'h7;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_15 =
    io_in_bits_egress_id == 5'hD;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_16 =
    io_in_bits_egress_id == 5'h11;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_17 =
    io_in_bits_egress_id == 5'hF;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_18 =
    io_in_bits_egress_id == 5'h5;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_19 =
    io_in_bits_egress_id == 5'h15;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_20 =
    io_in_bits_egress_id == 5'h9;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_21 =
    io_in_bits_egress_id == 5'h1;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 =
    io_in_bits_egress_id == 5'h19;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 =
    io_in_bits_egress_id == 5'h3;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 =
    io_in_bits_egress_id == 5'hB;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 =
    io_in_bits_egress_id == 5'h13;	// IngressUnit.scala:30:72
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_15 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_15 ? 3'h6 : 3'h0;	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_24 =
    _route_buffer_io_enq_bits_flow_egress_node_id_T_24 ? 3'h5 : 3'h0;	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [1:0]  _GEN =
    {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_14}}
    | _route_buffer_io_enq_bits_flow_egress_node_T_15[1:0]
    | {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_17}};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_13 ? 4'hB : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_19 ? 4'hA : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_22 ? 4'hC : 4'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_16,
       _route_buffer_io_enq_bits_flow_egress_node_T_15[2]
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_17
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_20
         | _route_buffer_io_enq_bits_flow_egress_node_T_24[2],
       _GEN[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_18,
       _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_23
         | _route_buffer_io_enq_bits_flow_egress_node_T_24[0]}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 4'h9 : 4'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  assign _T_33 =
  ...
  wire        _GEN_0 =
    _T_33 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head
  ...
  reg  [4:0]  out_bundle_bits_flit_flow_ingress_node;	// IngressUnit.scala:116:8
  reg  [1:0]  out_bundle_bits_flit_flow_ingress_node_id;	// IngressUnit.scala:116:8
  reg  [4:0]  out_bundle_bits_flit_flow_egress_node;	// IngressUnit.scala:116:8
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// IngressUnit.scala:30:9
      if (~reset & io_in_valid
          & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T_13
              ...
              | _route_buffer_io_enq_bits_flow_egress_node_id_T_25)) begin	// IngressUnit.scala:30:{9,27,72}, package.scala:73:59
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bundle_bits_flit_flow_ingress_node = _RANDOM_2[19:15];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_ingress_node_id = _RANDOM_2[21:20];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node = _RANDOM_2[26:22];	// IngressUnit.scala:116:8
        out_bundle_bits_flit_flow_egress_node_id = _RANDOM_2[28:27];	// IngressUnit.scala:116:8
        out_bundle_bits_out_virt_channel = _RANDOM_3[2:0];	// IngressUnit.scala:116:8
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (5'hF),
    ...
    .io_enq_bits_flow_egress_node_id
      ({1'h0,
        _route_buffer_io_enq_bits_flow_egress_node_id_T_13
          ...
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_23
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_24
          | _route_buffer_io_enq_bits_flow_egress_node_id_T_25}),	// IngressUnit.scala:30:72, :45:50, Mux.scala:27:73
  ...
  Queue_253 route_q (	// IngressUnit.scala:27:23
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN_0),	// IngressUnit.scala:62:24, :64:53, :65:26
    .io_enq_bits_vc_sel_3_0 (_T_33 & (&io_in_bits_egress_id)),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_2_0 (_T_33 & io_in_bits_egress_id == 5'h1E),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_1_0 (_T_33 & io_in_bits_egress_id == 5'h1D),	// IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}
    .io_enq_bits_vc_sel_0_1 (~_T_33),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_2 (~_T_33),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_3 (~_T_33),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_enq_bits_vc_sel_0_4 (~_T_33),	// IngressUnit.scala:63:23, :64:{41,53}, :66:52
    .io_deq_ready
  ...
  Queue_255 vcalloc_q (	// IngressUnit.scala:76:25
    .clock                  (clock),
    .reset                  (reset),
