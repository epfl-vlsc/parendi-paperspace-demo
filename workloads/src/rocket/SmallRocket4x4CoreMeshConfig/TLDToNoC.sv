...
module TLDToNoC(
  ...
  assign io_flit_bits_egress_id =
    {1'h0,
     {1'h0,
      {1'h0,
       {1'h0, _q_io_deq_bits_source[5:2] == 4'hC}
         | {2{_q_io_deq_bits_source[5:2] == 4'hB}}}
        | (_q_io_deq_bits_source[5:2] == 4'hA ? 3'h5 : 3'h0)
        | {3{_q_io_deq_bits_source[5:2] == 4'h9}}}
       | (_q_io_deq_bits_source[5:2] == 4'h8 ? 4'h9 : 4'h0)
       | (_q_io_deq_bits_source[5:2] == 4'h7 ? 4'hB : 4'h0)
       | (_q_io_deq_bits_source[5:2] == 4'h6 ? 4'hD : 4'h0)
       | {4{_q_io_deq_bits_source[5:2] == 4'h5}}}
    | (_q_io_deq_bits_source[5:2] == 4'h4 ? 5'h11 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h3 ? 5'h13 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h2 ? 5'h15 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h1 ? 5'h17 : 5'h0)
    | (_q_io_deq_bits_source[5:2] == 4'h0 ? 5'h19 : 5'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
