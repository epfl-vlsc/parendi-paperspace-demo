...
module EgressUnit_33(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 5'hA & _q_io_enq_bits_ingress_id_T_37
          ? 6'h1F
          : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'hC & _q_io_enq_bits_ingress_id_T_37
            ? 6'h25
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h8 & _q_io_enq_bits_ingress_id_T_37
            ? 6'h19
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h2 & _q_io_enq_bits_ingress_id_T_37
            ? 6'h7
            : 6'h0)
       | {1'h0,
          io_in_0_bits_flow_ingress_node == 5'h5 & _q_io_enq_bits_ingress_id_T_37,
          1'h0,
          io_in_0_bits_flow_ingress_node == 5'h1 & _q_io_enq_bits_ingress_id_T_37,
          1'h0,
          io_in_0_bits_flow_ingress_node == 5'h0 & _q_io_enq_bits_ingress_id_T_37}
       | (io_in_0_bits_flow_ingress_node == 5'hB & _q_io_enq_bits_ingress_id_T_37
            ? 6'h22
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h6 & _q_io_enq_bits_ingress_id_T_37
            ? 6'h13
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h3 & _q_io_enq_bits_ingress_id_T_37
            ? 6'hA
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h7 & _q_io_enq_bits_ingress_id_T_37
            ? 6'h16
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h4 & _q_io_enq_bits_ingress_id_T_37
            ? 6'hD
            : 6'h0)
       | (io_in_0_bits_flow_ingress_node == 5'h9 & _q_io_enq_bits_ingress_id_T_37
            ? 6'h1C
            : 6'h0)),	// EgressUnit.scala:21:17, :31:{39,75}, :32:27, Mux.scala:27:73
