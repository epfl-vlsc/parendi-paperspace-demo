...
module IngressUnit_42(
  ...
  wire [2:0]  _GEN =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_14 ? 3'h5 : 3'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_15, 2'h0}
    | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_18}};	// IngressUnit.scala:30:72, :51:44, Mux.scala:27:73
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T_16 ? 4'h9 : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_17 ? 4'hA : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_21 ? 4'hB : 4'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_22 ? 4'hC : 4'h0)
    | {_route_buffer_io_enq_bits_flow_egress_node_id_T_23,
       _GEN[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_24,
       _GEN[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_20
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_24
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_25,
       _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_19
         | _route_buffer_io_enq_bits_flow_egress_node_id_T_20};	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 4'hE;	// IngressUnit.scala:55:59, Mux.scala:27:73
  ...
  Queue_5 route_buffer (	// IngressUnit.scala:26:28
    ...
    .io_enq_bits_flow_ingress_node    (5'hE),
