...
module RouteComputer_19(
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_115, &_decoded_T_117, &_decoded_T_119, io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_2_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_61, &_decoded_T_64};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_2_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_61, &_decoded_T_64};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_2_4 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_61, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
