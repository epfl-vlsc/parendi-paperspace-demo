...
module IngressUnit_27(
  ...
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 4'hD : 4'h0)
    | {4{_route_buffer_io_enq_bits_flow_egress_node_id_T_1}}
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 4'hE : 4'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
