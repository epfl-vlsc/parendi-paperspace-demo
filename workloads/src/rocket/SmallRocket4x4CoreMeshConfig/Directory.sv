...
module Directory(
  ...
  input  [12:0] io_write_bits_data_clients,
  ...
  output [12:0] io_result_bits_clients,
  ...
  wire [12:0]  _write_io_deq_bits_data_clients;	// Decoupled.scala:375:21
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 20'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire         _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[18:17]))
  ...
  wire         _hits_T_13 =
    _cc_dir_RW0_rdata[23:20] == tag & (|(_cc_dir_RW0_rdata[38:37]))
  ...
  wire         _hits_T_20 =
    _cc_dir_RW0_rdata[43:40] == tag & (|(_cc_dir_RW0_rdata[58:57]))
  ...
  wire         _hits_T_27 =
    _cc_dir_RW0_rdata[63:60] == tag & (|(_cc_dir_RW0_rdata[78:77]))
  ...
  wire         _hits_T_34 =
    _cc_dir_RW0_rdata[83:80] == tag & (|(_cc_dir_RW0_rdata[98:97]))
  ...
  wire         _hits_T_41 =
    _cc_dir_RW0_rdata[103:100] == tag & (|(_cc_dir_RW0_rdata[118:117]))
  ...
  wire         _hits_T_48 =
    _cc_dir_RW0_rdata[123:120] == tag & (|(_cc_dir_RW0_rdata[138:137]))
  ...
  wire         _hits_T_55 =
    _cc_dir_RW0_rdata[143:140] == tag & (|(_cc_dir_RW0_rdata[158:157]))
  ...
  Queue_655 write (	// Decoupled.scala:375:21
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[19] | _hits_T_13 & _cc_dir_RW0_rdata[39]
        | _hits_T_20 & _cc_dir_RW0_rdata[59] | _hits_T_27 & _cc_dir_RW0_rdata[79]
        | _hits_T_34 & _cc_dir_RW0_rdata[99] | _hits_T_41 & _cc_dir_RW0_rdata[119]
        | _hits_T_48 & _cc_dir_RW0_rdata[139] | _hits_T_55 & _cc_dir_RW0_rdata[159]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[19] | victimWayOH[1]
            & _cc_dir_RW0_rdata[39] | victimWayOH[2] & _cc_dir_RW0_rdata[59]
            | victimWayOH[3] & _cc_dir_RW0_rdata[79] | victimWayOH[4]
            & _cc_dir_RW0_rdata[99] | victimWayOH[5] & _cc_dir_RW0_rdata[119]
            | victimWayOH[6] & _cc_dir_RW0_rdata[139] | victimWayOH[7]
            & _cc_dir_RW0_rdata[159];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[18:17] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[38:37] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[58:57] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[78:77] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[98:97] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[118:117] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[138:137] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[158:157] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[18:17] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[38:37] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[58:57] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[78:77] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[98:97] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[118:117] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[138:137] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[158:157] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[16:4] : 13'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[36:24] : 13'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[56:44] : 13'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[76:64] : 13'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[96:84] : 13'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[116:104] : 13'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[136:124] : 13'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[156:144] : 13'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[16:4] : 13'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[36:24] : 13'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[56:44] : 13'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[76:64] : 13'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[96:84] : 13'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[116:104] : 13'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[136:124] : 13'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[156:144] : 13'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[23:20] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[43:40] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[63:60] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[83:80] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[103:100] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[123:120] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[143:140] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[23:20] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[43:40] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[63:60] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[83:80] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[103:100] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[123:120] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[143:140] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
