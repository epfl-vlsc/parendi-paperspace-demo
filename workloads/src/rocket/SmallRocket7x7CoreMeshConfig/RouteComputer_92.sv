...
module RouteComputer_92(
  ...
  wire [4:0] _decoded_T_170 =
    {io_req_2_bits_flow_egress_node[0],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_172 = {_GEN[0], _GEN[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_176 =
    {io_req_2_bits_flow_egress_node[0], _GEN[1], _GEN[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_180 =
    {_GEN[0], io_req_2_bits_flow_egress_node[1], _GEN[2], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_196 =
    {_GEN[1], _GEN[2], io_req_2_bits_flow_egress_node[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_196,
      &_decoded_T_208};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_126, &_decoded_T_146, &_decoded_T_202};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_126, &_decoded_T_146, &_decoded_T_202};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_126, &_decoded_T_146, &_decoded_T_166, &_decoded_T_200};	// Cat.scala:33:92, pla.scala:98:74, :114:39
