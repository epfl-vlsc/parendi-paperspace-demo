...
module TLAToNoC(
  ...
  Queue_1767 q (	// Tilelink.scala:45:17
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_payload =
    is_body
      ...
      : {23'h0,
         ...
         _q_io_deq_bits_address};	// Cat.scala:33:92, Tilelink.scala:45:17, :59:24, :68:33, package.scala:235:71
  assign io_flit_bits_egress_id =
    (_q_io_deq_bits_address[31:30] == 2'h0 ? 7'h5C : 7'h0)
    | (_q_io_deq_bits_address[31:30] == 2'h2 ? 7'h5F : 7'h0)
    | (_q_io_deq_bits_address[31:30] == 2'h1 ? 7'h62 : 7'h0);	// Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17
endmodule
