...
module RouteComputer_97(
  ...
  wire [4:0]  _decoded_T_98 =
    {io_req_0_bits_flow_egress_node_id[0],
     ...
     _GEN[5],
     io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0]  _decoded_T_100 =
    {io_req_0_bits_flow_egress_node[0], _GEN[3], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0]  _decoded_T_112 =
    {_GEN[0], io_req_0_bits_flow_egress_node[3], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_4 =
    |{&_decoded_T_252, &_decoded_T_258, &{_GEN_0[18], io_req_2_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_0_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_198, &_decoded_T_201};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_2_3 =
    |{&_decoded_T,
      ...
      &_decoded_T_120,
      &_decoded_T_128,
      &_decoded_T_140};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_0_vc_sel_1_3 =
    |{&_decoded_T_8,
      ...
      &_decoded_T_132,
      &_decoded_T_136,
      &_decoded_T_144};	// Cat.scala:33:92, pla.scala:98:74, :114:39
