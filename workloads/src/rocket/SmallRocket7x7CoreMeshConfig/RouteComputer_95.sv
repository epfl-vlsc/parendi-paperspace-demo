...
module RouteComputer_95(
  ...
  wire [4:0] _decoded_T =
    {_GEN[0], _GEN[2], _GEN[4], _GEN[5], io_req_0_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_2 =
    {_GEN[1], _GEN[2], _GEN[4], _GEN[5], io_req_0_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_54 =
    {_GEN[1], _GEN[2], _GEN[4], _GEN[5], io_req_0_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_106 =
    {_GEN[1], _GEN[2], _GEN[4], _GEN[5], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_148 =
    {io_req_0_bits_flow_egress_node[0],
     ...
     io_req_0_bits_flow_egress_node[5],
     io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_150 =
    {_GEN[0],
     io_req_0_bits_flow_egress_node[2],
     io_req_0_bits_flow_egress_node[5],
     io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_152 =
    {_GEN[1],
     io_req_0_bits_flow_egress_node[2],
     io_req_0_bits_flow_egress_node[5],
     io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_404 =
    {_GEN_1[1], _GEN_1[2], _GEN_1[3], _GEN_1[5], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_446 =
    {io_req_3_bits_flow_egress_node_id[0],
     ...
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_448 =
    {io_req_3_bits_flow_egress_node[0],
     _GEN_1[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_450 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[0],
     _GEN_1[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_452 =
    {_GEN_1[0],
     io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_454 =
    {io_req_3_bits_flow_egress_node_id[0],
     _GEN_1[0],
     io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
  ...
  assign io_resp_3_vc_sel_2_1 =
    |{&_decoded_T_320,
      ...
      &_decoded_T_430,
      &_decoded_T_450,
      &_decoded_T_454};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_2_3 =
    |{&_decoded_T_320,
      ...
      &_decoded_T_428,
      &_decoded_T_448,
      &_decoded_T_452};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_1_1 =
    |{&_decoded_T_328,
      ...
      &_decoded_T_442,
      &_decoded_T_446,
      &_decoded_T_458};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_1_3 =
    |{&_decoded_T_328,
      ...
      &_decoded_T_440,
      &_decoded_T_444,
      &_decoded_T_456};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_3_2 =
    |{io_req_2_bits_flow_egress_node_id[1], &_decoded_T_260, &_decoded_T_264};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_3_1 =
    |{&_decoded_T_8,
      ...
      &_decoded_T_144,
      &_decoded_T_146,
      &_decoded_T_156};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_0_vc_sel_2_1 =
    |{&_decoded_T,
      ...
      &_decoded_T_148,
      &_decoded_T_150,
      &_decoded_T_152};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_0_vc_sel_1_1 =
    |{&_decoded_T_6,
      ...
      &_decoded_T_136,
      &_decoded_T_142,
      &_decoded_T_154};	// Cat.scala:33:92, pla.scala:98:74, :114:39
