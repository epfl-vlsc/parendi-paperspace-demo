  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:19], _RANDOM_1[1:0]};	// AtomicAutomata.scala:78:28, :79:24
        cam_a_0_bits_mask = _RANDOM_1[9:2];	// AtomicAutomata.scala:79:24
        cam_a_0_bits_data = {_RANDOM_1[31:10], _RANDOM_2, _RANDOM_3[9:0]};	// AtomicAutomata.scala:79:24
        cam_a_0_bits_corrupt = _RANDOM_3[10];	// AtomicAutomata.scala:79:24
        cam_a_0_fifoId = _RANDOM_3[11];	// AtomicAutomata.scala:79:24
        cam_a_0_lut = _RANDOM_3[15:12];	// AtomicAutomata.scala:79:24
        cam_d_0_data = {_RANDOM_3[31:16], _RANDOM_4, _RANDOM_5[15:0]};	// AtomicAutomata.scala:79:24, :80:24
        cam_d_0_denied = _RANDOM_5[16];	// AtomicAutomata.scala:80:24
        cam_d_0_corrupt = _RANDOM_5[17];	// AtomicAutomata.scala:80:24
        beatsLeft = _RANDOM_5[20:18];	// Arbiter.scala:88:30, AtomicAutomata.scala:80:24
        state_0 = _RANDOM_5[21];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        state_1 = _RANDOM_5[22];	// Arbiter.scala:117:26, AtomicAutomata.scala:80:24
        d_first_counter = _RANDOM_5[25:23];	// AtomicAutomata.scala:80:24, Edges.scala:229:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
