...
module Directory(
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 53'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire         _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[51:50]))
  ...
  wire         _hits_T_13 =
    _cc_dir_RW0_rdata[56:53] == tag & (|(_cc_dir_RW0_rdata[104:103]))
  ...
  wire         _hits_T_20 =
    _cc_dir_RW0_rdata[109:106] == tag & (|(_cc_dir_RW0_rdata[157:156]))
  ...
  wire         _hits_T_27 =
    _cc_dir_RW0_rdata[162:159] == tag & (|(_cc_dir_RW0_rdata[210:209]))
  ...
  wire         _hits_T_34 =
    _cc_dir_RW0_rdata[215:212] == tag & (|(_cc_dir_RW0_rdata[263:262]))
  ...
  wire         _hits_T_41 =
    _cc_dir_RW0_rdata[268:265] == tag & (|(_cc_dir_RW0_rdata[316:315]))
  ...
  wire         _hits_T_48 =
    _cc_dir_RW0_rdata[321:318] == tag & (|(_cc_dir_RW0_rdata[369:368]))
  ...
  wire         _hits_T_55 =
    _cc_dir_RW0_rdata[374:371] == tag & (|(_cc_dir_RW0_rdata[422:421]))
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[52] | _hits_T_13 & _cc_dir_RW0_rdata[105]
        | _hits_T_20 & _cc_dir_RW0_rdata[158] | _hits_T_27 & _cc_dir_RW0_rdata[211]
        | _hits_T_34 & _cc_dir_RW0_rdata[264] | _hits_T_41 & _cc_dir_RW0_rdata[317]
        | _hits_T_48 & _cc_dir_RW0_rdata[370] | _hits_T_55 & _cc_dir_RW0_rdata[423]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[52] | victimWayOH[1]
            & _cc_dir_RW0_rdata[105] | victimWayOH[2] & _cc_dir_RW0_rdata[158]
            | victimWayOH[3] & _cc_dir_RW0_rdata[211] | victimWayOH[4]
            & _cc_dir_RW0_rdata[264] | victimWayOH[5] & _cc_dir_RW0_rdata[317]
            | victimWayOH[6] & _cc_dir_RW0_rdata[370] | victimWayOH[7]
            & _cc_dir_RW0_rdata[423];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[51:50] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[104:103] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[157:156] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[210:209] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[263:262] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[316:315] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[369:368] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[422:421] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[51:50] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[104:103] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[157:156] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[210:209] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[263:262] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[316:315] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[369:368] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[422:421] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[49:4] : 46'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[102:57] : 46'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[155:110] : 46'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[208:163] : 46'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[261:216] : 46'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[314:269] : 46'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[367:322] : 46'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[420:375] : 46'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[49:4] : 46'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[102:57] : 46'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[155:110] : 46'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[208:163] : 46'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[261:216] : 46'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[314:269] : 46'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[367:322] : 46'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[420:375] : 46'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[56:53] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[109:106] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[162:159] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[215:212] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[268:265] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[321:318] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[374:371] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[56:53] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[109:106] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[162:159] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[215:212] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[268:265] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[321:318] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[374:371] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
