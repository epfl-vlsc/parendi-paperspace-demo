...
module RouteComputer_93(
  ...
  wire [4:0] _decoded_T_192 =
    {_GEN[1], _GEN[2], _GEN[3], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_196 =
    {io_req_2_bits_flow_egress_node[1], _GEN[2], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_222 =
    {_GEN[2], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_204,
      &_decoded_T_220,
      &_decoded_T_230};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_222,
      &_decoded_T_226,
      &_decoded_T_234};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_136, &_decoded_T_162, &_decoded_T_188, &_decoded_T_238};	// Cat.scala:33:92, pla.scala:98:74, :114:39
