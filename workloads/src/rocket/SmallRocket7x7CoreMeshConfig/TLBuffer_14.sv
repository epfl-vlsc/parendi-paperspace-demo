...
module TLBuffer_14(
  ...
  Queue_1941 x1_a_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1942 bundleIn_0_d_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1943 bundleIn_0_b_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1944 x1_c_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1930 x1_e_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
