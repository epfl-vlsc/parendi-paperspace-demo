...
module RouteComputer_94(
  ...
  wire [5:0] _decoded_T_250 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_252 =
    {_GEN[2], io_req_2_bits_flow_egress_node[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_242,
      &_decoded_T_246,
      &_decoded_T_250};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_140, &_decoded_T_170, &_decoded_T_200, &_decoded_T_258};	// Cat.scala:33:92, pla.scala:98:74, :114:39
