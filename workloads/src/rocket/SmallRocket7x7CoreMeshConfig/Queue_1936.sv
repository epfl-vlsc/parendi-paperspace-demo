...
module Queue_1936(
  ...
  input  [45:0] io_enq_bits_data_clients,
  ...
  output [45:0] io_deq_bits_data_clients,
  output [3:0]  io_deq_bits_data_tag
);

  wire [62:0] _ram_ext_R0_data;	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_data_clients = _ram_ext_R0_data[58:13];	// Decoupled.scala:273:95
  assign io_deq_bits_data_tag = _ram_ext_R0_data[62:59];	// Decoupled.scala:273:95
endmodule
