...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 7'h2E & _q_io_enq_bits_ingress_id_T_7
          ? 8'h8B
          : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 7'h30 & _q_io_enq_bits_ingress_id_T_7
            ? 8'h8D
            : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 7'h2F & _q_io_enq_bits_ingress_id_T_7
            ? 8'h8F
