...
module ICache(
  ...
  wire         refill_one_beat =
    auto_master_out_d_valid & auto_master_out_d_bits_opcode[0];	// Edges.scala:106:36, ICache.scala:383:41
  ...
  wire [8:0]   beats1 =
    auto_master_out_d_bits_opcode[0] ? ~(_beats1_decode_T_1[11:3]) : 9'h0;	// Edges.scala:106:36, :221:14, :229:27, package.scala:235:{46,71,76}
  ...
  wire         writeEnable_1 =
    refill_one_beat & (counter == 9'h1 | beats1 == 9'h0) & auto_master_out_d_valid;	// Edges.scala:221:14, :229:27, :232:{25,33,43}, ICache.scala:383:41, :391:37
  ...
  wire         refillError =
    auto_master_out_d_bits_corrupt | (|refill_cnt) & accruedRefillError;	// Edges.scala:234:25, ICache.scala:420:31, :422:{43,58,64}
  reg  [63:0]  vb_array;	// ICache.scala:440:25
  wire [63:0]  _s1_vb_T_1 = vb_array >> io_s1_paddr[11:6];	// ICache.scala:440:25, :500:25, :850:21
  assign s1_tag_hit_0 =
    _s1_vb_T_1[0] & _tag_array_0_RW0_rdata[19:0] == io_s1_paddr[31:12];	// DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      refill_valid <=
        ~writeEnable_1 & (auto_master_out_a_ready & tl_out_a_valid | refill_valid);	// Decoupled.scala:51:35, ICache.scala:360:29, :377:35, :391:37, :821:{22,37}, :822:{22,37}
