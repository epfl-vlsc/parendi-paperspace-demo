...
module RouteComputer_73(
  ...
  wire [3:0] _decoded_T_122 =
    {_GEN[0], _GEN[1], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_110, &_decoded_T_116, &_decoded_T_122, &_decoded_T_128};	// Cat.scala:33:92, pla.scala:98:74, :114:39
