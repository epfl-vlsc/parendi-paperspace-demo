...
module TLBToNoC_1(
  ...
  assign io_flit_bits_egress_id =
    {_q_io_deq_bits_source[7:2] == 6'hD,
     {_q_io_deq_bits_source[7:2] == 6'h1D,
      {_q_io_deq_bits_source[7:2] == 6'h25,
       {_q_io_deq_bits_source[7:2] == 6'h29,
        {_q_io_deq_bits_source[7:2] == 6'h2B, _q_io_deq_bits_source[7:2] == 6'h2C, 1'h0}
          | (_q_io_deq_bits_source[7:2] == 6'h2A ? 3'h6 : 3'h0)}
         | (_q_io_deq_bits_source[7:2] == 6'h28 ? 4'hA : 4'h0)
         | (_q_io_deq_bits_source[7:2] == 6'h27 ? 4'hC : 4'h0)
         | (_q_io_deq_bits_source[7:2] == 6'h26 ? 4'hE : 4'h0)}
        | (_q_io_deq_bits_source[7:2] == 6'h24 ? 5'h12 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h23 ? 5'h14 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h22 ? 5'h16 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h21 ? 5'h18 : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h20 ? 5'h1A : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h1F ? 5'h1C : 5'h0)
        | (_q_io_deq_bits_source[7:2] == 6'h1E ? 5'h1E : 5'h0)}
       | (_q_io_deq_bits_source[7:2] == 6'h1C ? 6'h22 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h1B ? 6'h24 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h1A ? 6'h26 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h19 ? 6'h28 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h18 ? 6'h2A : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h17 ? 6'h2C : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h16 ? 6'h2E : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h15 ? 6'h30 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h14 ? 6'h32 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h13 ? 6'h34 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h12 ? 6'h36 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h11 ? 6'h38 : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'h10 ? 6'h3A : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'hF ? 6'h3C : 6'h0)
       | (_q_io_deq_bits_source[7:2] == 6'hE ? 6'h3E : 6'h0)}
    | (_q_io_deq_bits_source[7:2] == 6'hC ? 7'h42 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hB ? 7'h44 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'hA ? 7'h46 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h9 ? 7'h48 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h8 ? 7'h4A : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h7 ? 7'h4C : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h6 ? 7'h4E : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h5 ? 7'h50 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h4 ? 7'h52 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h3 ? 7'h54 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h2 ? 7'h56 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h1 ? 7'h58 : 7'h0)
    | (_q_io_deq_bits_source[7:2] == 6'h0 ? 7'h5A : 7'h0);	// Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
