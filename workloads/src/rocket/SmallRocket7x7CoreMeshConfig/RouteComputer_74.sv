...
module RouteComputer_74(
  ...
  wire [2:0] _decoded_T_246 =
    {io_req_4_bits_flow_egress_node[0], _GEN_1[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_248 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[0],
     _GEN_1[1],
     io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_250 =
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_226, &_decoded_T_232, &_decoded_T_238, &_decoded_T_246};	// Cat.scala:33:92, pla.scala:98:74, :114:39
