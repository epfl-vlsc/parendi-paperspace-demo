...
module SinkC(
  ...
  output [2:0]  io_req_bits_opcode,
                io_req_bits_param,
                io_req_bits_size,
  output [7:0]  io_req_bits_source,
  output [3:0]  io_req_bits_tag,
  ...
  output [3:0]  io_resp_bits_tag,
  output [7:0]  io_resp_bits_source,
  ...
  wire [7:0]  _c_io_deq_bits_source;	// Decoupled.scala:375:21
  ...
  reg  [6:0]  io_set_r;	// Reg.scala:19:16
  wire [6:0]  _io_set_output = _c_io_deq_valid ? _c_io_deq_bits_address[12:6] : io_set_r;	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16, SinkC.scala:92:18
  reg  [63:0] io_bs_dat_data_r;	// Reg.scala:19:16
  wire        bs_adr_valid =
    resp & ((|counter) | _c_io_deq_valid & _c_io_deq_bits_opcode[0]);	// Decoupled.scala:375:21, Edges.scala:102:36, :229:27, :231:25, SinkC.scala:79:19, :99:{30,41,53}
  ...
  wire        _c_io_deq_ready_T_7 =
    raw_resp
      ...
      : ~req_block & ~buf_block & ~set_block;	// Decoupled.scala:375:21, Edges.scala:102:36, SinkC.scala:78:58, :107:61, :126:27, :127:29, :128:38, :134:{19,39,56,70,81,84}
        ...
        (lists
         | (~resp & _c_io_deq_valid & ~(|counter) & _c_io_deq_bits_opcode[0] & ~req_block
            & ~buf_block
              ? _GEN
              : 2'h0))
        & ~(_T_25 & io_rel_pop_bits_last ? 2'h1 << io_rel_pop_bits_index[0] : 2'h0);	// Decoupled.scala:51:35, :375:21, Edges.scala:102:36, :229:27, :231:25, OneHot.scala:63:49, :64:12, SinkC.scala:79:19, :116:24, :118:29, :119:29, :120:{21,34,36}, :123:41, :126:27, :127:29, :134:{56,70}, :136:21, :138:{62,77,89}, :163:{27,52}, :164:17
    end
    if (_c_io_deq_valid) begin	// Decoupled.scala:375:21
      resp_r <= raw_resp;	// Reg.scala:19:16, SinkC.scala:78:58
      io_set_r <= _c_io_deq_bits_address[12:6];	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28, Reg.scala:19:16
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_set_r = _RANDOM_0[10:4];	// Edges.scala:229:27, Reg.scala:19:16
        io_bs_dat_data_r = {_RANDOM_0[31:11], _RANDOM_1, _RANDOM_2[10:0]};	// Edges.scala:229:27, Reg.scala:19:16
        bs_adr_bits_beat_r = _RANDOM_2[13:11];	// Reg.scala:19:16
        lists = _RANDOM_2[15:14];	// Reg.scala:19:16, SinkC.scala:116:24
        put_r = _RANDOM_2[17:16];	// Reg.scala:19:16
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_1932 c (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1933 io_bs_adr_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
  ...
  ListBuffer_1 putbuffer (	// SinkC.scala:115:27
    ...
    .reset                     (reset),
    .io_push_valid
      (~resp & _c_io_deq_valid & _c_io_deq_bits_opcode[0] & ~req_block & ~set_block),	// Decoupled.scala:375:21, Edges.scala:102:36, SinkC.scala:79:19, :126:27, :128:38, :134:{56,84}, :136:21, :137:74
  ...
  assign io_req_bits_tag = _c_io_deq_bits_address[16:13];	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19
  ...
  assign io_req_bits_set = _c_io_deq_bits_address[12:6];	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28
  assign io_resp_valid =
    resp & _c_io_deq_valid & (~(|counter) | last)
    & (~(_c_io_deq_bits_opcode[0]) | _io_bs_adr_q_io_enq_ready);	// Decoupled.scala:375:21, Edges.scala:102:36, :229:27, :231:25, :232:33, SinkC.scala:79:19, :107:{48,57,61,70}
  assign io_resp_bits_last = last;	// Edges.scala:232:33
  assign io_resp_bits_set = _c_io_deq_bits_address[12:6];	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :216:28
  assign io_resp_bits_tag = _c_io_deq_bits_address[16:13];	// Cat.scala:33:92, Decoupled.scala:375:21, Parameters.scala:214:22, :215:19
