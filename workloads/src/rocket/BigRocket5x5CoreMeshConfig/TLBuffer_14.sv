...
module TLBuffer_14(
  ...
  Queue_1013 x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1014 bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1015 bundleIn_0_b_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1016 x1_c_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1002 x1_e_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
