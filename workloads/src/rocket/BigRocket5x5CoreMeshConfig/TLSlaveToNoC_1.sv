...
module TLSlaveToNoC_1(
  ...
  input  [6:0]  io_tilelink_b_bits_source,
  ...
  input  [6:0]  io_tilelink_d_bits_source,
  ...
  output [6:0]  io_tilelink_a_bits_source,
  ...
  output [6:0]  io_tilelink_c_bits_source,
