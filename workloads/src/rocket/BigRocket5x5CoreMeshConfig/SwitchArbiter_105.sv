...
module SwitchArbiter_105(
  ...
  assign io_out_0_bits_vc_sel_1_0 = _io_chosen_oh_0_output[0] & io_in_0_bits_vc_sel_1_0 | _io_chosen_oh_0_output[1] & io_in_1_bits_vc_sel_1_0;	// @[Mux.scala:27:73, :29:36, SwitchAllocator.scala:42:21]
