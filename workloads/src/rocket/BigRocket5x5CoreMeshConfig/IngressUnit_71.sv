...
module IngressUnit_71(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_22 = io_in_bits_egress_id == 6'h29;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 = io_in_bits_egress_id == 6'h25;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 = io_in_bits_egress_id == 6'hD;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 = io_in_bits_egress_id == 6'h27;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_26 = io_in_bits_egress_id == 6'h19;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_27 = io_in_bits_egress_id == 6'h17;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_28 = io_in_bits_egress_id == 6'h3;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_29 = io_in_bits_egress_id == 6'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_30 = io_in_bits_egress_id == 6'h11;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_31 = io_in_bits_egress_id == 6'h2B;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_32 = io_in_bits_egress_id == 6'h21;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_33 = io_in_bits_egress_id == 6'h5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_34 = io_in_bits_egress_id == 6'h7;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_35 = io_in_bits_egress_id == 6'h13;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_36 = io_in_bits_egress_id == 6'hF;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_37 = io_in_bits_egress_id == 6'h1D;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_38 = io_in_bits_egress_id == 6'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_39 = io_in_bits_egress_id == 6'h23;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_40 = io_in_bits_egress_id == 6'h15;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_41 = io_in_bits_egress_id == 6'h1F;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_42 = io_in_bits_egress_id == 6'h1B;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_43 = io_in_bits_egress_id == 6'h9;	// @[IngressUnit.scala:30:72]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_26 = _route_buffer_io_enq_bits_flow_egress_node_id_T_26 ? 4'hC : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_27 = _route_buffer_io_enq_bits_flow_egress_node_id_T_27 ? 4'hB : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_35 = _route_buffer_io_enq_bits_flow_egress_node_id_T_35 ? 4'h9 : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_38 = _route_buffer_io_enq_bits_flow_egress_node_id_T_38 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [2:0]  _GEN = _route_buffer_io_enq_bits_flow_egress_node_id_T_40 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_42 = _route_buffer_io_enq_bits_flow_egress_node_id_T_42 ? 4'hD : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [2:0]  _GEN_0 = (_route_buffer_io_enq_bits_flow_egress_node_id_T_24 ? 3'h6 : 3'h0) | _route_buffer_io_enq_bits_flow_egress_node_T_26[2:0] | _route_buffer_io_enq_bits_flow_egress_node_T_27[2:0];	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T_22 ? 5'h14 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_23 ? 5'h12 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 5'h13 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_31 ? 5'h15 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_39 ? 5'h11 : 5'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_32, _route_buffer_io_enq_bits_flow_egress_node_T_26[3] | _route_buffer_io_enq_bits_flow_egress_node_T_27[3] | _route_buffer_io_enq_bits_flow_egress_node_id_T_30 | _route_buffer_io_enq_bits_flow_egress_node_T_35[3] | _route_buffer_io_enq_bits_flow_egress_node_id_T_37 | _GEN[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_T_42[3], _GEN_0[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_36 | _route_buffer_io_enq_bits_flow_egress_node_id_T_37 | _route_buffer_io_enq_bits_flow_egress_node_T_38[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_T_42[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_43, _GEN_0[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_33 | _route_buffer_io_enq_bits_flow_egress_node_id_T_34 | _route_buffer_io_enq_bits_flow_egress_node_id_T_36 | _route_buffer_io_enq_bits_flow_egress_node_id_T_37 | _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_41, _GEN_0[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_28 | _route_buffer_io_enq_bits_flow_egress_node_id_T_34 | _route_buffer_io_enq_bits_flow_egress_node_T_35[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_36 | _route_buffer_io_enq_bits_flow_egress_node_T_38[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_T_42[0]};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 5'h18;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  assign _T_51 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN_1 = _T_51 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      ...
      if (~reset & _GEN_1 & ~_route_q_io_enq_ready) begin	// @[IngressUnit.scala:27:23, :62:24, :64:53, :65:26, :73:{9,36}]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (6'h18),
    ...
    .io_enq_bits_flow_egress_node_id  ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_22 | _route_buffer_io_enq_bits_flow_egress_node_id_T_23 | _route_buffer_io_enq_bits_flow_egress_node_id_T_24 | _route_buffer_io_enq_bits_flow_egress_node_id_T_25 | _route_buffer_io_enq_bits_flow_egress_node_id_T_26 | _route_buffer_io_enq_bits_flow_egress_node_id_T_27 | _route_buffer_io_enq_bits_flow_egress_node_id_T_28 | _route_buffer_io_enq_bits_flow_egress_node_id_T_29 | _route_buffer_io_enq_bits_flow_egress_node_id_T_30 | _route_buffer_io_enq_bits_flow_egress_node_id_T_31 | _route_buffer_io_enq_bits_flow_egress_node_id_T_32 | _route_buffer_io_enq_bits_flow_egress_node_id_T_33 | _route_buffer_io_enq_bits_flow_egress_node_id_T_34 | _route_buffer_io_enq_bits_flow_egress_node_id_T_35 | _route_buffer_io_enq_bits_flow_egress_node_id_T_36 | _route_buffer_io_enq_bits_flow_egress_node_id_T_37 | _route_buffer_io_enq_bits_flow_egress_node_id_T_38 | _route_buffer_io_enq_bits_flow_egress_node_id_T_39 | _route_buffer_io_enq_bits_flow_egress_node_id_T_40 | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_id_T_42 | _route_buffer_io_enq_bits_flow_egress_node_id_T_43}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_424 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN_1),	// @[IngressUnit.scala:62:24, :64:53, :65:26]
    .io_enq_bits_vc_sel_3_0 (_T_51 & io_in_bits_egress_id == 6'h31),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_2_0 (_T_51 & io_in_bits_egress_id == 6'h30),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_51 & io_in_bits_egress_id == 6'h2F),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
