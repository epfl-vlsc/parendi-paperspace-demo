...
module TLAToNoC(
  ...
  Queue_911 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id = (_q_io_deq_bits_address[31:30] == 2'h0 ? 6'h2C : 6'h0) | (_q_io_deq_bits_address[31:30] == 2'h2 ? 6'h2F : 6'h0) | (_q_io_deq_bits_address[31:30] == 2'h1 ? 6'h32 : 6'h0);	// @[Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17]
endmodule
