...
module IngressUnit_69(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_23 = io_in_bits_egress_id == 6'h3;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_24 = io_in_bits_egress_id == 6'h17;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_25 = io_in_bits_egress_id == 6'h29;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_26 = io_in_bits_egress_id == 6'h27;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_27 = io_in_bits_egress_id == 6'h23;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_28 = io_in_bits_egress_id == 6'h2B;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_29 = io_in_bits_egress_id == 6'h15;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_30 = io_in_bits_egress_id == 6'h5;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_31 = io_in_bits_egress_id == 6'hD;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_32 = io_in_bits_egress_id == 6'h1D;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_33 = io_in_bits_egress_id == 6'h7;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_34 = io_in_bits_egress_id == 6'h13;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_35 = io_in_bits_egress_id == 6'h21;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_36 = io_in_bits_egress_id == 6'h1B;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_37 = io_in_bits_egress_id == 6'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_38 = io_in_bits_egress_id == 6'h9;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_39 = io_in_bits_egress_id == 6'h11;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_40 = io_in_bits_egress_id == 6'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_41 = io_in_bits_egress_id == 6'h1F;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_42 = io_in_bits_egress_id == 6'h19;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_43 = io_in_bits_egress_id == 6'h25;	// @[IngressUnit.scala:30:72]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_34 = _route_buffer_io_enq_bits_flow_egress_node_id_T_34 ? 4'h9 : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [3:0]  _route_buffer_io_enq_bits_flow_egress_node_T_36 = _route_buffer_io_enq_bits_flow_egress_node_id_T_36 ? 4'hD : 4'h0;	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_T_37 = _route_buffer_io_enq_bits_flow_egress_node_id_T_37 ? 3'h5 : 3'h0;	// @[IngressUnit.scala:30:72, :51:44, Mux.scala:27:73]
  wire [3:0]  _GEN = {1'h0, {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_22}} | {2'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_23}} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_24 ? 4'hB : 4'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_29 ? 4'hA : 4'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire [4:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T_25 ? 5'h14 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_26 ? 5'h13 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_27 ? 5'h11 : 5'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_28 ? 5'h15 : 5'h0) | {_route_buffer_io_enq_bits_flow_egress_node_id_T_35, _GEN[3] | _route_buffer_io_enq_bits_flow_egress_node_id_T_32 | _route_buffer_io_enq_bits_flow_egress_node_T_34[3] | _route_buffer_io_enq_bits_flow_egress_node_T_36[3] | _route_buffer_io_enq_bits_flow_egress_node_id_T_39 | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_id_T_42, _GEN[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_31 | _route_buffer_io_enq_bits_flow_egress_node_id_T_32 | _route_buffer_io_enq_bits_flow_egress_node_T_36[2] | _route_buffer_io_enq_bits_flow_egress_node_T_37[2] | _route_buffer_io_enq_bits_flow_egress_node_id_T_38 | _route_buffer_io_enq_bits_flow_egress_node_id_T_41 | _route_buffer_io_enq_bits_flow_egress_node_id_T_42, _GEN[1] | _route_buffer_io_enq_bits_flow_egress_node_id_T_30 | _route_buffer_io_enq_bits_flow_egress_node_id_T_31 | _route_buffer_io_enq_bits_flow_egress_node_id_T_32 | _route_buffer_io_enq_bits_flow_egress_node_id_T_33 | _route_buffer_io_enq_bits_flow_egress_node_id_T_41, _GEN[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_33 | _route_buffer_io_enq_bits_flow_egress_node_T_34[0] | _route_buffer_io_enq_bits_flow_egress_node_T_36[0] | _route_buffer_io_enq_bits_flow_egress_node_T_37[0] | _route_buffer_io_enq_bits_flow_egress_node_id_T_41} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_43 ? 5'h12 : 5'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  ...
  wire        _GEN_0 = _T_51 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
