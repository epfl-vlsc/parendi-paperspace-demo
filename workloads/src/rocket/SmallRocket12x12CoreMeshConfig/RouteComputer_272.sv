...
module RouteComputer_272(
  ...
  wire [2:0] _decoded_T_110 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [2:0] _decoded_T_114 =
    {io_req_2_bits_flow_egress_node_id[0],
     ~(io_req_2_bits_flow_egress_node[7]),
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [2:0] _decoded_T_120 =
    {io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_122 =
    {~(io_req_2_bits_flow_egress_node[7]), io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [2:0] _decoded_T_124 =
    {io_req_2_bits_flow_egress_node_id[0],
     ~(io_req_2_bits_flow_egress_node[7]),
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  wire [1:0] _decoded_T_126 =
    {io_req_2_bits_flow_egress_node[7], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_110, &_decoded_T_114, &_decoded_T_118, &_decoded_T_122};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_112, &_decoded_T_116, &_decoded_T_120, &_decoded_T_126};	// Cat.scala:33:92, pla.scala:98:74, :114:39
