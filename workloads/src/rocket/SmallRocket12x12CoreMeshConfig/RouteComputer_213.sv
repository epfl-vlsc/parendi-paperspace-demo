...
module RouteComputer_213(
  ...
  wire [1:0] _decoded_T_232 =
    {~(io_req_4_bits_flow_egress_node[6]), io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [1:0] _decoded_T_236 =
    {io_req_4_bits_flow_egress_node[6], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
