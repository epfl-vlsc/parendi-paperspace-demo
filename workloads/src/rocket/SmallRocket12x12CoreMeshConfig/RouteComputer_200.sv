...
module RouteComputer_200(
  ...
  wire [2:0] _decoded_T_136 =
    {_GEN[0], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_110,
      ...
      &_decoded_T_118,
      &_decoded_T_132,
      &_decoded_T_134};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_110,
      ...
      &_decoded_T_124,
      &_decoded_T_128,
      &_decoded_T_130};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_114, &_decoded_T_120, &_decoded_T_126, &_decoded_T_136};	// Cat.scala:33:92, pla.scala:98:74, :114:39
