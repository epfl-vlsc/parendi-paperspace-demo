...
module TLDToNoC(
  ...
  wire [7:0]  _GEN_0 =
    ...
    | (_q_io_deq_bits_source[9:2] == 8'h4A ? 8'h85 : 8'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
  wire [8:0]  _GEN_1 =
    {1'h0,
    ...
    | (_q_io_deq_bits_source[9:2] == 8'h7 ? 9'h10B : 9'h0);	// Edges.scala:221:14, :229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
  ...
  assign io_flit_bits_egress_id =
    ...
    | (_q_io_deq_bits_source[9:2] == 8'h0 ? 9'h119 : 9'h0);	// Edges.scala:229:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
