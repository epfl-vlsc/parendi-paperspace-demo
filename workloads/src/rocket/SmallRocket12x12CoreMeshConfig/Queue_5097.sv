...
module Queue_5097(
  ...
  wire [124:0] _ram_ext_R0_data;	// Decoupled.scala:273:95
  reg          maybe_full;	// Decoupled.scala:276:27
  wire         _io_deq_valid_output = io_enq_valid | maybe_full;	// Decoupled.scala:276:27, :302:16, :314:{24,39}
  wire         do_enq =
    ~(~maybe_full & io_deq_ready) & _io_enq_ready_output & io_enq_valid;	// Decoupled.scala:276:27, :278:28, :280:27, :303:16, :315:17, :318:{26,35}, :323:{24,39}
  ...
  assign io_deq_bits_size = maybe_full ? _ram_ext_R0_data[9:6] : io_enq_bits_size;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
  assign io_deq_bits_source = maybe_full ? _ram_ext_R0_data[19:10] : io_enq_bits_source;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
  assign io_deq_bits_address = maybe_full ? _ram_ext_R0_data[51:20] : io_enq_bits_address;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
  assign io_deq_bits_mask = maybe_full ? _ram_ext_R0_data[59:52] : io_enq_bits_mask;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[123:60] : io_enq_bits_data;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
  assign io_deq_bits_corrupt = maybe_full ? _ram_ext_R0_data[124] : io_enq_bits_corrupt;	// Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19
endmodule
