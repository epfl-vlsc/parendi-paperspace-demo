...
module TLBuffer_14(
  ...
  Queue_5556 x1_a_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_5557 bundleIn_0_d_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_5558 bundleIn_0_b_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_5559 x1_c_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_5545 x1_e_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
