...
module SinkC(
  ...
  output [9:0]  io_resp_bits_source,
  ...
  wire [9:0]  _c_io_deq_bits_source;	// Decoupled.scala:375:21
  ...
  Queue_5547 c (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_5548 io_bs_adr_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
