...
module RouteComputer_179(
  ...
  wire [1:0] _decoded_T_185 =
    {~(io_req_3_bits_flow_egress_node[5]), io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45
  ...
  wire [1:0] _decoded_T_189 =
    {io_req_3_bits_flow_egress_node[5], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
