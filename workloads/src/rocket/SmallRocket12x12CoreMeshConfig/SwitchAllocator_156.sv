...
module SwitchAllocator_156(
  ...
  SwitchArbiter_646 arbs_0 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_646 arbs_1 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_646 arbs_2 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
