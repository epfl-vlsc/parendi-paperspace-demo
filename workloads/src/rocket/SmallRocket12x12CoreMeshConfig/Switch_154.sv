...
module Switch_154(
  ...
  assign io_out_3_0_bits_flow_ingress_node =
    ...
    | (io_sel_3_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_3_0_bits_flow_egress_node =
    ...
    | (io_sel_3_0_3_0 ? io_in_3_0_bits_flit_flow_egress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_2_0_bits_flow_ingress_node =
    ...
    | (io_sel_2_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_2_0_bits_flow_egress_node =
    ...
    | (io_sel_2_0_3_0 ? io_in_3_0_bits_flit_flow_egress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_1_0_bits_flow_ingress_node =
    ...
    | (io_sel_1_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_1_0_bits_flow_egress_node =
    ...
    | (io_sel_1_0_3_0 ? io_in_3_0_bits_flit_flow_egress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_0_0_bits_flow_ingress_node =
    ...
    | (io_sel_0_0_3_0 ? io_in_3_0_bits_flit_flow_ingress_node : 9'h0);	// Mux.scala:27:73
  ...
  assign io_out_0_0_bits_flow_egress_node =
    ...
    | (io_sel_0_0_3_0 ? io_in_3_0_bits_flit_flow_egress_node : 9'h0);	// Mux.scala:27:73
