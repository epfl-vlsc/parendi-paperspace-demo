...
module IngressUnit_408(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T =
    io_in_bits_egress_id == 9'h11A;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 =
    io_in_bits_egress_id == 9'h11D;	// IngressUnit.scala:30:72
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 =
    io_in_bits_egress_id == 9'h120;	// IngressUnit.scala:30:72
  wire [7:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE =
    (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 8'h8D : 8'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 8'h8F : 8'h0)
    | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 8'h8E : 8'h0);	// IngressUnit.scala:30:72, Mux.scala:27:73
  wire        at_dest =
    {_route_buffer_io_enq_bits_flow_egress_node_WIRE[7],
     _route_buffer_io_enq_bits_flow_egress_node_WIRE[3:0]} == 5'h18;	// IngressUnit.scala:41:50, :55:59, Mux.scala:27:73
  wire        _T_13 =
