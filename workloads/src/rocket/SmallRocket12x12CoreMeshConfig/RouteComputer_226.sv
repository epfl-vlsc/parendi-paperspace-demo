...
module RouteComputer_226(
  ...
  wire [2:0] _decoded_T_317 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[2], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_319 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[4], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_323 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[2], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_325 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[4], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_327 =
    {io_req_4_bits_flow_egress_node_id[0],
     _GEN_0[0],
     io_req_4_bits_flow_egress_node[6],
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_329 =
    {_GEN_0[2], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_331 =
    {_GEN_0[4], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_339 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[2], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_341 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[4], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_343 =
    {_GEN_0[0], io_req_4_bits_flow_egress_node[6], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_4_vc_sel_1_1 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_325,
      &_decoded_T_339,
      &_decoded_T_341};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_4_vc_sel_1_3 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_331,
      &_decoded_T_335,
      &_decoded_T_337};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_321, &_decoded_T_327, &_decoded_T_333, &_decoded_T_343};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_4_4 =
    &{~(io_req_2_bits_flow_egress_node[0]), io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45, :98:74
