...
module RouteComputer_261(
  ...
  wire [2:0] _decoded_T_220 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[0], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_222 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[2], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_224 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[3], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_226 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[2],
     io_req_4_bits_flow_egress_node[5],
     io_req_4_bits_flow_egress_node[6],
     io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_228 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_230 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[3], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_236 =
    {_GEN[0], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_238 =
    {_GEN[3], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_240 =
    {io_req_4_bits_flow_egress_node[3],
  ...
  wire [1:0] _decoded_T_246 = {_GEN[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_248 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[0], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_250 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_252 =
    {io_req_4_bits_flow_egress_node[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_254 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[3],
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_226, &_decoded_T_234, &_decoded_T_242, &_decoded_T_256};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_2_2 =
    |{io_req_2_bits_flow_egress_node_id[1], &_decoded_T_111, &_decoded_T_115};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_3_4 =
    &{~(io_req_0_bits_flow_egress_node[1]), io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, RouteComputer.scala:74:27, pla.scala:78:21, :90:45, :98:74
  ...
  assign io_resp_0_vc_sel_2_4 =
    |{io_req_0_bits_flow_egress_node_id[1],
      &_decoded_T_1,
      &{io_req_0_bits_flow_egress_node[1], io_req_0_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
endmodule
