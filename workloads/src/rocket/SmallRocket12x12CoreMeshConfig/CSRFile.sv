...
module CSRFile(
  ...
  wire [7:0]  _GEN_11 =
    ((&{io_rw_addr[2],
        ...
        io_rw_addr[11]})
       ? io_hartid
       : 8'h0) | _io_rw_rdata_T_14[7:0];	// Cat.scala:33:92, Mux.scala:27:73, pla.scala:78:21, :90:45, :91:29, :98:74
  wire [2:0]  _GEN_12 =
  ...
  assign _io_rw_rdata_WIRE =
    ...
    | {32'h0,
       ...
       ((&{io_rw_addr[2],
          ...
          ? {4'h0, io_interrupts_meip, 3'h0}
          : 8'h0) | _io_rw_rdata_T_14[15:8] | _io_rw_rdata_T_111[15:8]
         | _io_rw_rdata_T_112[15:8] | _io_rw_rdata_T_113[15:8] | _io_rw_rdata_T_114[15:8]
         | _io_rw_rdata_T_115[15:8] | _io_rw_rdata_T_116[15:8] | _io_rw_rdata_T_117[15:8]
         | _io_rw_rdata_T_118[15:8],
       _GEN_11[7:3] | _io_rw_rdata_T_111[7:3] | _io_rw_rdata_T_112[7:3]
         | _io_rw_rdata_T_113[7:3] | _io_rw_rdata_T_114[7:3] | _io_rw_rdata_T_115[7:3]
         | _io_rw_rdata_T_116[7:3] | _io_rw_rdata_T_117[7:3] | _io_rw_rdata_T_118[7:3],
       _GEN_12[2:1],
       _GEN_12[0]
         | (&{decoded_decoded_invInputs[0],
              io_rw_addr[1],
