...
module Router_144(
  ...
  wire        _output_unit_1_to_145_io_credit_available_0;	// Router.scala:122:13
  ...
  wire        _output_unit_1_to_145_io_channel_status_0_occupied;	// Router.scala:122:13
  ...
  wire        _input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_1;	// Router.scala:112:13
  wire        _input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_2;	// Router.scala:112:13
  wire        _input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_3;	// Router.scala:112:13
  wire        _input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_4;	// Router.scala:112:13
  ...
  wire [1:0]  fires_count =
    ...
    + {1'h0, _vc_allocator_io_req_1_ready & _input_unit_1_from_156_io_vcalloc_req_valid};	// Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :131:30, :137:31
  ...
  InputUnit_144 input_unit_0_from_0 (	// Router.scala:112:13
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_out_credit_available_1_0
      (_output_unit_1_to_145_io_credit_available_0),	// Router.scala:122:13
  ...
  InputUnit_145 input_unit_1_from_156 (	// Router.scala:112:13
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_vcalloc_req_bits_vc_sel_0_1
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_1),
    .io_vcalloc_req_bits_vc_sel_0_2
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_2),
    .io_vcalloc_req_bits_vc_sel_0_3
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_3),
    .io_vcalloc_req_bits_vc_sel_0_4
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_4),
  ...
  OutputUnit_141 output_unit_0_to_0 (	// Router.scala:122:13
    .clock                                   (clock),
    .reset                                   (reset),
  ...
  OutputUnit output_unit_1_to_145 (	// Router.scala:122:13
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_credit_available_0
      (_output_unit_1_to_145_io_credit_available_0),
    ...
    .io_channel_status_0_occupied
      (_output_unit_1_to_145_io_channel_status_0_occupied),
    .io_channel_status_1_occupied
  ...
  Switch_144 switch (	// Router.scala:129:24
    .clock                                    (clock),
    .reset                                    (reset),
  ...
  SwitchAllocator_144 switch_allocator (	// Router.scala:130:34
    .clock                      (clock),
    .reset                      (reset),
  ...
  RotatingSingleVCAllocator_144 vc_allocator (	// Router.scala:131:30
    .clock                          (clock),
    .reset                          (reset),
    .io_req_1_valid                 (_input_unit_1_from_156_io_vcalloc_req_valid),	// Router.scala:112:13
    .io_req_1_bits_vc_sel_0_1
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_1),	// Router.scala:112:13
    .io_req_1_bits_vc_sel_0_2
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_2),	// Router.scala:112:13
    .io_req_1_bits_vc_sel_0_3
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_3),	// Router.scala:112:13
    .io_req_1_bits_vc_sel_0_4
      (_input_unit_1_from_156_io_vcalloc_req_bits_vc_sel_0_4),	// Router.scala:112:13
    ...
    .io_channel_status_1_0_occupied (_output_unit_1_to_145_io_channel_status_0_occupied),	// Router.scala:122:13
