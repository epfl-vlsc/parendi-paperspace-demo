...
module Repeater_1(
  ...
  reg  [9:0]  saved_source;	// Repeater.scala:20:18
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM_0[19:10];	// Repeater.scala:19:21, :20:18
        saved_address = {_RANDOM_0[31:20], _RANDOM_1[13:0]};	// Repeater.scala:19:21, :20:18
