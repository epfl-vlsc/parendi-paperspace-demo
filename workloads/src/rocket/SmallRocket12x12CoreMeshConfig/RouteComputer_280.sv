...
module RouteComputer_280(
  ...
  wire [3:0] _decoded_T_252 =
    {_GEN[0],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_254 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_256 =
    {_GEN[0], _GEN[1], _GEN[2], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_258 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[0],
     _GEN[1],
     _GEN[2],
  ...
  wire [5:0] _decoded_T_282 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_284 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[3],
     io_req_2_bits_flow_egress_node[4],
     _GEN[3],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_286 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[3],
     io_req_2_bits_flow_egress_node[4],
  ...
  wire [5:0] _decoded_T_342 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_344 =
    {_GEN[0], io_req_2_bits_flow_egress_node[7], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_346 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[0],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_348 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_312,
      &_decoded_T_324,
      &_decoded_T_348};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_114,
      ...
      &_decoded_T_334,
      &_decoded_T_340};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_156, &_decoded_T_204, &_decoded_T_346};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_156, &_decoded_T_204, &_decoded_T_346};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_156, &_decoded_T_204, &_decoded_T_252, &_decoded_T_344};	// Cat.scala:33:92, pla.scala:98:74, :114:39
