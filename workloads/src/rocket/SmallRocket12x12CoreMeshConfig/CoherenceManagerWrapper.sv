...
module CoherenceManagerWrapper(
  ...
  input  [9:0]  auto_coherent_jbar_in_a_bits_source,
  ...
  input  [9:0]  auto_coherent_jbar_in_c_bits_source,
  ...
  input  [13:0] auto_l2_ctl_in_a_bits_source,
  ...
  output [9:0]  auto_coherent_jbar_in_b_bits_source,
  ...
  output [9:0]  auto_coherent_jbar_in_d_bits_source,
  ...
  output [13:0] auto_l2_ctl_in_d_bits_source,
  ...
  wire [9:0]  _InclusiveCache_inner_TLBuffer_auto_out_a_bits_source;	// Parameters.scala:56:69
  ...
  wire [9:0]  _InclusiveCache_inner_TLBuffer_auto_out_c_bits_source;	// Parameters.scala:56:69
  ...
  wire [9:0]  _l2_auto_in_b_bits_source;	// Configs.scala:76:24
  ...
  wire [9:0]  _l2_auto_in_d_bits_source;	// Configs.scala:76:24
