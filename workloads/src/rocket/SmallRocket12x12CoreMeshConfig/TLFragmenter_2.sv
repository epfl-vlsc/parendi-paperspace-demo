...
module TLFragmenter_2(
  ...
  wire [9:0]  _repeater_io_deq_bits_source;	// Fragmenter.scala:264:30
  ...
  wire [5:0]  _GEN =
    ...
    & {1'h1, ~(auto_out_d_bits_source[2:0]), _dsizeOH1_T_1[2:1]};	// Cat.scala:33:92, Fragmenter.scala:194:41, OneHot.scala:64:12, package.scala:233:{35,47,49}, :235:{46,71,76}
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[13:4];	// Fragmenter.scala:228:47
  ...
  assign auto_out_a_bits_address =
    ...
    | {11'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}
