...
module SwitchAllocator_145(
  ...
  SwitchArbiter_586 arbs_0 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_586 arbs_1 (	// SwitchAllocator.scala:83:45
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_req_2_0_ready =
    ...
    & _arbs_1_io_in_2_valid_T_4;	// Decoupled.scala:51:35, SwitchAllocator.scala:83:45, :95:37, :99:30
  assign io_req_1_0_ready =
    _arbs_0_io_in_1_ready & _arbs_0_io_in_1_valid_T_4 | _arbs_1_io_in_1_ready
    & _arbs_1_io_in_1_valid_T_4;	// Decoupled.scala:51:35, SwitchAllocator.scala:83:45, :95:37, :99:30
  assign io_req_0_0_ready =
    _arbs_0_io_in_0_ready & _arbs_0_io_in_0_valid_T_4 | _arbs_1_io_in_0_ready
    & _arbs_1_io_in_0_valid_T_4;	// Decoupled.scala:51:35, SwitchAllocator.scala:83:45, :95:37, :99:30
