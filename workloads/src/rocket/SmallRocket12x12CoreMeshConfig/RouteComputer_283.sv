...
module RouteComputer_283(
  ...
  wire [2:0] _decoded_T_114 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[1], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [5:0] _decoded_T_160 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[1],
     _GEN[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_162 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  wire [2:0] _decoded_T_166 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[1], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_214 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_216 =
    {_GEN[0], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_218 =
    {_GEN[1], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_220 =
    {_GEN[2],
     _GEN[3],
     _GEN[4],
     _GEN[6],
  ...
  wire [5:0] _decoded_T_264 =
    {io_req_2_bits_flow_egress_node[0],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_266 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_268 = {_GEN[0], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_270 = {_GEN[1], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_272 =
    {_GEN[2], _GEN[3], _GEN[4], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_274 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[0], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_276 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[1], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_278 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[2],
     _GEN[3],
     _GEN[4],
  ...
  wire [5:0] _decoded_T_314 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_316 =
    {io_req_2_bits_flow_egress_node[2],
     _GEN[4],
     io_req_2_bits_flow_egress_node[5],
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_318 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     _GEN[4],
     io_req_2_bits_flow_egress_node[5],
  ...
  wire [7:0] _decoded_T_342 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [4:0] _decoded_T_344 =
    {_GEN[2],
     io_req_2_bits_flow_egress_node[3],
     _GEN[4],
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_346 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[2],
     io_req_2_bits_flow_egress_node[3],
     _GEN[4],
  ...
  wire [7:0] _decoded_T_362 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_364 =
    {io_req_2_bits_flow_egress_node[0],
     io_req_2_bits_flow_egress_node[1],
     _GEN[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [5:0] _decoded_T_366 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[0],
     io_req_2_bits_flow_egress_node[1],
     _GEN[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_368 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_370 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  assign io_resp_2_vc_sel_2_1 =
    |{&_decoded_T_112,
      &_decoded_T_114,
      &_decoded_T_116,
      &_decoded_T_122,
      ...
      &_decoded_T_334,
      &_decoded_T_346,
      &_decoded_T_370};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_356,
      &_decoded_T_358,
      &_decoded_T_362};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_352,
      &_decoded_T_354,
      &_decoded_T_360};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_4 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_354,
      &_decoded_T_360};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_1 = |{&_decoded_T_160, &_decoded_T_212, &_decoded_T_366};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_2 = |{&_decoded_T_160, &_decoded_T_212, &_decoded_T_366};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_160, &_decoded_T_212, &_decoded_T_264, &_decoded_T_364};	// Cat.scala:33:92, pla.scala:98:74, :114:39
