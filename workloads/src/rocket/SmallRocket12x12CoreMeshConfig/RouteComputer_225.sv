...
module RouteComputer_225(
  ...
  wire [4:0] _GEN = ~(io_req_4_bits_flow_egress_node[6:2]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [2:0] _decoded_T_222 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[4], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_226 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[2], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_228 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[4], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_230 =
    {io_req_4_bits_flow_egress_node_id[0],
     _GEN[0],
     io_req_4_bits_flow_egress_node[6],
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_232 =
    {_GEN[2], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_234 =
    {_GEN[4], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_242 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[2], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_244 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN[4], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_246 =
    {_GEN[0], io_req_4_bits_flow_egress_node[6], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_248 =
    {io_req_4_bits_flow_egress_node_id[0],
     _GEN[0],
     io_req_4_bits_flow_egress_node[6],
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_224, &_decoded_T_230, &_decoded_T_236, &_decoded_T_246};	// Cat.scala:33:92, pla.scala:98:74, :114:39
