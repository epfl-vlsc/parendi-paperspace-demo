...
module RouteComputer_284(
  ...
  wire [4:0] _decoded_T_260 =
    {io_req_2_bits_flow_egress_node[2],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [5:0] _decoded_T_262 =
    {_GEN[0], _GEN[1], _GEN[2], _GEN[3], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [6:0] _decoded_T_264 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[0],
     _GEN[1],
     _GEN[2],
  ...
  wire [6:0] _decoded_T_348 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_350 =
    {_GEN[0], _GEN[1], io_req_2_bits_flow_egress_node[7], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_356 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_358 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[3],
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_360 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[3],
     io_req_2_bits_flow_egress_node[7],
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_338,
      &_decoded_T_342,
      &_decoded_T_354};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_336,
      &_decoded_T_348,
      &_decoded_T_352};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_334,
      &_decoded_T_346,
      &_decoded_T_350};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_160, &_decoded_T_210, &_decoded_T_260, &_decoded_T_358};	// Cat.scala:33:92, pla.scala:98:74, :114:39
