...
module RouteComputer_202(
  ...
  wire [2:0] _GEN_0 = ~(io_req_4_bits_flow_egress_node[4:2]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [3:0] _decoded_T_321 =
    {io_req_4_bits_flow_egress_node_id[0],
     _GEN_0[0],
     io_req_4_bits_flow_egress_node[4],
     io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_323 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[1], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_329 =
    {_GEN_0[1], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_339 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[1], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_343 =
    {_GEN_0[0], io_req_4_bits_flow_egress_node[4], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
