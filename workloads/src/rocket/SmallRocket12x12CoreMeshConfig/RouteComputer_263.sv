...
module RouteComputer_263(
  ...
  wire [2:0] _decoded_T_181 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_183 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[3], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_185 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[3],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_187 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_189 =
  ...
  wire [2:0] _decoded_T_191 =
    {_GEN_0[3], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_193 =
    {io_req_3_bits_flow_egress_node[3],
     io_req_3_bits_src_virt_id[0],
     io_req_3_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_195 =
    {io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
     io_req_3_bits_src_virt_id[0],
  ...
  wire [1:0] _decoded_T_199 = {_GEN_0[3], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_203 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[3], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_205 =
    {io_req_3_bits_flow_egress_node[3], io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_207 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[3],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_209 =
    {io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
     io_req_3_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_211 =
    {io_req_3_bits_flow_egress_node_id[0],
     io_req_3_bits_flow_egress_node[2],
     io_req_3_bits_flow_egress_node[5],
     io_req_3_bits_flow_egress_node[6],
  ...
  assign io_resp_3_vc_sel_1_1 =
    |{&_decoded_T_173,
      ...
      &_decoded_T_201,
      &_decoded_T_203,
      &_decoded_T_207};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_1_3 =
    |{&_decoded_T_173,
      ...
      &_decoded_T_197,
      &_decoded_T_199,
      &_decoded_T_205};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_3_vc_sel_0_3 =
    |{&_decoded_T_179, &_decoded_T_187, &_decoded_T_195, &_decoded_T_209};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_3_vc_sel_0_4 =
    |{&_decoded_T_179, &_decoded_T_187, &_decoded_T_195, &_decoded_T_209};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_3_2 =
    |{io_req_2_bits_flow_egress_node_id[1], &_decoded_T_118, &_decoded_T_121};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_3_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_62, &_decoded_T_65};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_3_3 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_62, &_decoded_T_65};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_1_vc_sel_3_4 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_62, io_req_1_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_3_2 =
    |{io_req_0_bits_flow_egress_node_id[1], &_decoded_T_1, &_decoded_T_7};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_3_4 =
    |{io_req_0_bits_flow_egress_node_id[1],
      ...
      &{io_req_0_bits_flow_egress_node[0],
        ...
        io_req_0_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  assign io_resp_0_vc_sel_2_4 =
    |{&{_GEN[0], io_req_0_bits_src_virt_id[2]}, &{_GEN[1], io_req_0_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
endmodule
