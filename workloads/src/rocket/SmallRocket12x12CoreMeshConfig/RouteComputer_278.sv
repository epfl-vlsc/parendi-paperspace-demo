...
module RouteComputer_278(
  ...
  wire [3:0] _decoded_T_128 =
    {io_req_2_bits_flow_egress_node[1],
     ...
     io_req_2_bits_src_virt_id[0],
     io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [1:0] _decoded_T_130 = {_GEN[0], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_134 =
    {io_req_2_bits_flow_egress_node[1], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_140 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[7],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  assign io_resp_2_vc_sel_2_1 = |{&_decoded_T_112, &_decoded_T_118, &_decoded_T_132};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_2_2 = |{&_decoded_T_112, &_decoded_T_118, &_decoded_T_132};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112, &_decoded_T_118, &_decoded_T_124, &_decoded_T_130};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_2_4 =
    |{&_decoded_T_112, &_decoded_T_118, &_decoded_T_124, &_decoded_T_130};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_1 = |{&_decoded_T_114, &_decoded_T_120, &_decoded_T_136};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_2 = |{&_decoded_T_114, &_decoded_T_120, &_decoded_T_136};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_114, &_decoded_T_120, &_decoded_T_126, &_decoded_T_134};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_116, &_decoded_T_122, &_decoded_T_128, &_decoded_T_138};	// Cat.scala:33:92, pla.scala:98:74, :114:39
