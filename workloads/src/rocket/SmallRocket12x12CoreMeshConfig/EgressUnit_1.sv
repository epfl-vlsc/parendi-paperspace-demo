...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 9'h8D & _q_io_enq_bits_ingress_id_T_7
          ? 9'h1A8
          : 9'h0)
       | (io_in_0_bits_flow_ingress_node == 9'h8F & _q_io_enq_bits_ingress_id_T_7
            ? 9'h1AA
            : 9'h0)
       | (io_in_0_bits_flow_ingress_node == 9'h8E & _q_io_enq_bits_ingress_id_T_7
            ? 9'h1AC
