...
module Queue_5551(
  ...
  input  [140:0] io_enq_bits_data_clients,
  input  [3:0]   io_enq_bits_data_tag,
  input          io_deq_ready,
  output         io_enq_ready,
                 io_deq_valid,
  ...
  output [140:0] io_deq_bits_data_clients,
  output [3:0]   io_deq_bits_data_tag
);

  wire [157:0] _ram_ext_R0_data;	// Decoupled.scala:273:95
  ...
  ram_combMem_27 ram_ext (	// Decoupled.scala:273:95
    ...
    .W0_data
      ({io_enq_bits_data_tag,
        ...
        io_enq_bits_way,
        io_enq_bits_set}),	// Decoupled.scala:273:95
    .R0_data (_ram_ext_R0_data)
  );
  assign io_enq_ready = ~maybe_full;	// Decoupled.scala:276:27, :303:19
  assign io_deq_valid = maybe_full;	// Decoupled.scala:276:27
  assign io_deq_bits_set = _ram_ext_R0_data[6:0];	// Decoupled.scala:273:95
  assign io_deq_bits_way = _ram_ext_R0_data[9:7];	// Decoupled.scala:273:95
  ...
  assign io_deq_bits_data_clients = _ram_ext_R0_data[153:13];	// Decoupled.scala:273:95
  assign io_deq_bits_data_tag = _ram_ext_R0_data[157:154];	// Decoupled.scala:273:95
endmodule
