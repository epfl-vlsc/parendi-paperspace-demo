...
module RouteComputer_238(
  ...
  wire [3:0] _GEN_0 = ~(io_req_4_bits_flow_egress_node[6:3]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [1:0] _decoded_T_337 = {_GEN_0[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
