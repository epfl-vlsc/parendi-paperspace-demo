...
module ClockSinkDomain_142(
  ...
  input  [8:0]  auto_buffer_in_flit_0_bits_flow_ingress_node,
  input  [1:0]  auto_buffer_in_flit_0_bits_flow_ingress_node_id,
  input  [8:0]  auto_buffer_in_flit_0_bits_flow_egress_node,
  ...
  input  [8:0]  auto_routers_ingress_nodes_in_1_flit_bits_egress_id,
  ...
  output [8:0]  auto_routers_source_nodes_out_flit_0_bits_flow_ingress_node,
  output [1:0]  auto_routers_source_nodes_out_flit_0_bits_flow_ingress_node_id,
  output [8:0]  auto_routers_source_nodes_out_flit_0_bits_flow_egress_node,
