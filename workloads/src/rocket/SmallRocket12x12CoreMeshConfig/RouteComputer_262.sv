...
module RouteComputer_262(
  ...
  wire [3:0] _GEN_0 = ~(io_req_4_bits_flow_egress_node[5:2]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [2:0] _decoded_T_321 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[3], io_req_4_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_327 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[3], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_335 =
    {_GEN_0[3], io_req_4_bits_src_virt_id[0], io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_337 =
    {io_req_4_bits_flow_egress_node[3],
     io_req_4_bits_src_virt_id[0],
     io_req_4_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:90:45
  wire [4:0] _decoded_T_339 =
    {io_req_4_bits_flow_egress_node[2],
     io_req_4_bits_flow_egress_node[5],
     io_req_4_bits_flow_egress_node[6],
     io_req_4_bits_src_virt_id[0],
  ...
  wire [1:0] _decoded_T_343 = {_GEN_0[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_347 =
    {io_req_4_bits_flow_egress_node_id[0], _GEN_0[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [1:0] _decoded_T_349 =
    {io_req_4_bits_flow_egress_node[3], io_req_4_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [2:0] _decoded_T_351 =
    {io_req_4_bits_flow_egress_node_id[0],
     io_req_4_bits_flow_egress_node[3],
  ...
  assign io_resp_4_vc_sel_1_1 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_345,
      &_decoded_T_347,
      &_decoded_T_351};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_4_vc_sel_1_3 =
    |{&_decoded_T_317,
      ...
      &_decoded_T_341,
      &_decoded_T_343,
      &_decoded_T_349};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_4_vc_sel_0_3 =
    |{&_decoded_T_323, &_decoded_T_331, &_decoded_T_339, &_decoded_T_353};	// Cat.scala:33:92, pla.scala:98:74, :114:39
