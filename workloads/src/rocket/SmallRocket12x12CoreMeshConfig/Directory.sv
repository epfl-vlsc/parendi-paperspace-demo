...
module Directory(
  ...
  input  [140:0] io_write_bits_data_clients,
  ...
  output [140:0] io_result_bits_clients,
  ...
  wire [147:0]  _WIRE_7;	// Directory.scala:99:44
  wire [147:0]  _WIRE_6;	// Directory.scala:99:44
  wire [147:0]  _WIRE_5;	// Directory.scala:99:44
  wire [147:0]  _WIRE_4;	// Directory.scala:99:44
  wire [147:0]  _WIRE_3;	// Directory.scala:99:44
  wire [147:0]  _WIRE_2;	// Directory.scala:99:44
  wire [147:0]  _WIRE_1;	// Directory.scala:99:44
  wire [147:0]  _WIRE_0;	// Directory.scala:99:44
  ...
  wire [140:0]  _write_io_deq_bits_data_clients;	// Decoupled.scala:375:21
  wire [3:0]    _write_io_deq_bits_data_tag;	// Decoupled.scala:375:21
  wire [1183:0] _cc_dir_RW0_rdata;	// DescribedSRAM.scala:17:26
  reg  [7:0]    wipeCount;	// Directory.scala:79:26
  reg           wipeOff;	// Directory.scala:80:24
  assign cc_dir_MPORT_en =
    ~io_read_valid & (~(wipeCount[7]) & ~wipeOff | _write_io_deq_valid);	// Decoupled.scala:375:21, Directory.scala:79:26, :80:24, :81:27, :85:{9,22}, :86:23, :90:{24,37}, :96:14
  ...
  assign _WIRE_0 =
    wipeCount[7]
      ...
      : 148'h0;	// Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}
  assign _WIRE_1 =
    wipeCount[7]
      ? {_write_io_deq_bits_data_dirty,
         _write_io_deq_bits_data_state,
  ...
  wire [9:0]    victimLFSR =
    {_victimLFSR_prng_io_out_9,
     ...
     _victimLFSR_prng_io_out_5,
     _victimLFSR_prng_io_out_4,
     _victimLFSR_prng_io_out_3,
     _victimLFSR_prng_io_out_2,
     _victimLFSR_prng_io_out_1,
     _victimLFSR_prng_io_out_0};	// Directory.scala:115:63, PRNG.scala:91:22
  wire [2:0]    _GEN =
    {_victimLFSR_prng_io_out_9, _victimLFSR_prng_io_out_8, _victimLFSR_prng_io_out_7};	// Directory.scala:117:43, PRNG.scala:91:22
  ...
  wire [7:0]    victimWayOH =
    ...
    & {1'h1,
       ...
       ~_victimLTE_T_3,
       ~(|_GEN_0),
       ~(|_GEN)};	// Directory.scala:117:43, :119:{31,55,57,70}, PRNG.scala:91:22
  ...
  wire          _hits_T_6 =
    _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[146:145]))
    & (~setQuash | (|_write_io_deq_bits_way));	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_13 =
    _cc_dir_RW0_rdata[151:148] == tag & (|(_cc_dir_RW0_rdata[294:293]))
    & (~setQuash | _write_io_deq_bits_way != 3'h1);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_20 =
    _cc_dir_RW0_rdata[299:296] == tag & (|(_cc_dir_RW0_rdata[442:441]))
    & (~setQuash | _write_io_deq_bits_way != 3'h2);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_27 =
    _cc_dir_RW0_rdata[447:444] == tag & (|(_cc_dir_RW0_rdata[590:589]))
    & (~setQuash | _write_io_deq_bits_way != 3'h3);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_34 =
    _cc_dir_RW0_rdata[595:592] == tag & (|(_cc_dir_RW0_rdata[738:737]))
    & (~setQuash | _write_io_deq_bits_way != 3'h4);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_41 =
    _cc_dir_RW0_rdata[743:740] == tag & (|(_cc_dir_RW0_rdata[886:885]))
    & (~setQuash | _write_io_deq_bits_way != 3'h5);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_48 =
    _cc_dir_RW0_rdata[891:888] == tag & (|(_cc_dir_RW0_rdata[1034:1033]))
    & (~setQuash | _write_io_deq_bits_way != 3'h6);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire          _hits_T_55 =
    _cc_dir_RW0_rdata[1039:1036] == tag & (|(_cc_dir_RW0_rdata[1182:1181]))
    & (~setQuash | _write_io_deq_bits_way != 3'h7);	// Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16
  wire [7:0]    hits =
    {_hits_T_55,
     _hits_T_48,
     _hits_T_41,
     ...
     _hits_T_20,
     _hits_T_13,
     _hits_T_6};	// Cat.scala:33:92, Directory.scala:131:42
  ...
  wire [2:0]    _GEN_2 =
    {_hits_T_55, _hits_T_48, _hits_T_41} | {_hits_T_27, _hits_T_20, _hits_T_13};	// Directory.scala:131:42, OneHot.scala:30:18, :31:18, :32:28
          ...
          & ~(~ren1
              | ({_victimLTE_T_7,
                 ...
                 & {~_victimLTE_T_6,
                    ...
                    ~_victimLTE_T_3,
                    ~(|_GEN_0),
                    ~(|_GEN)}) == 6'h0)) begin	// Cat.scala:33:92, Directory.scala:103:21, :117:43, :119:57, :121:11, :122:{10,17,39,54}, PRNG.scala:91:22
          ...
          & ~(~ren1
              ...
              + {1'h0,
                 {1'h0, {1'h0, victimWayOH[4]} + {1'h0, victimWayOH[5]}}
                   + {1'h0,
                      {1'h0, victimWayOH[6]} + {1'h0, victimWayOH[7]}}} == 4'h1)) begin	// Bitwise.scala:51:90, :53:100, Directory.scala:103:21, :119:55, :121:11, :123:{10,17,42}
  ...
  cc_dir cc_dir (	// DescribedSRAM.scala:17:26
    ...
    .RW0_wmask
      ({cc_dir_MPORT_mask_7,
        ...
        cc_dir_MPORT_mask_2,
        cc_dir_MPORT_mask_1,
        cc_dir_MPORT_mask_0}),	// DescribedSRAM.scala:17:26, Directory.scala:100:65
    .RW0_rdata (_cc_dir_RW0_rdata)
  );
  Queue_5551 write (	// Decoupled.scala:375:21
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty =
    (|hits)
      ? _hits_T_6 & _cc_dir_RW0_rdata[147] | _hits_T_13 & _cc_dir_RW0_rdata[295]
        | _hits_T_20 & _cc_dir_RW0_rdata[443] | _hits_T_27 & _cc_dir_RW0_rdata[591]
        | _hits_T_34 & _cc_dir_RW0_rdata[739] | _hits_T_41 & _cc_dir_RW0_rdata[887]
        | _hits_T_48 & _cc_dir_RW0_rdata[1035] | _hits_T_55 & _cc_dir_RW0_rdata[1183]
      : _view__T_69
          ? _write_io_deq_bits_data_dirty
          : victimWayOH[0] & _cc_dir_RW0_rdata[147] | victimWayOH[1]
            & _cc_dir_RW0_rdata[295] | victimWayOH[2] & _cc_dir_RW0_rdata[443]
            | victimWayOH[3] & _cc_dir_RW0_rdata[591] | victimWayOH[4]
            & _cc_dir_RW0_rdata[739] | victimWayOH[5] & _cc_dir_RW0_rdata[887]
            | victimWayOH[6] & _cc_dir_RW0_rdata[1035] | victimWayOH[7]
            & _cc_dir_RW0_rdata[1183];	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_state =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[146:145] : 2'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[294:293] : 2'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[442:441] : 2'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[590:589] : 2'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[738:737] : 2'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[886:885] : 2'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[1034:1033] : 2'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[1182:1181] : 2'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_state
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[146:145] : 2'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[294:293] : 2'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[442:441] : 2'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[590:589] : 2'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[738:737] : 2'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[886:885] : 2'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[1034:1033] : 2'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[1182:1181] : 2'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_clients =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[144:4] : 141'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[292:152] : 141'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[440:300] : 141'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[588:448] : 141'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[736:596] : 141'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[884:744] : 141'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[1032:892] : 141'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[1180:1040] : 141'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_clients
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[144:4] : 141'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[292:152] : 141'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[440:300] : 141'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[588:448] : 141'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[736:596] : 141'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[884:744] : 141'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[1032:892] : 141'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[1180:1040] : 141'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_tag =
    (|hits)
      ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0)
        | (_hits_T_13 ? _cc_dir_RW0_rdata[151:148] : 4'h0)
        | (_hits_T_20 ? _cc_dir_RW0_rdata[299:296] : 4'h0)
        | (_hits_T_27 ? _cc_dir_RW0_rdata[447:444] : 4'h0)
        | (_hits_T_34 ? _cc_dir_RW0_rdata[595:592] : 4'h0)
        | (_hits_T_41 ? _cc_dir_RW0_rdata[743:740] : 4'h0)
        | (_hits_T_48 ? _cc_dir_RW0_rdata[891:888] : 4'h0)
        | (_hits_T_55 ? _cc_dir_RW0_rdata[1039:1036] : 4'h0)
      : _view__T_69
          ? _write_io_deq_bits_data_tag
          : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0)
            | (victimWayOH[1] ? _cc_dir_RW0_rdata[151:148] : 4'h0)
            | (victimWayOH[2] ? _cc_dir_RW0_rdata[299:296] : 4'h0)
            | (victimWayOH[3] ? _cc_dir_RW0_rdata[447:444] : 4'h0)
            | (victimWayOH[4] ? _cc_dir_RW0_rdata[595:592] : 4'h0)
            | (victimWayOH[5] ? _cc_dir_RW0_rdata[743:740] : 4'h0)
            | (victimWayOH[6] ? _cc_dir_RW0_rdata[891:888] : 4'h0)
            | (victimWayOH[7] ? _cc_dir_RW0_rdata[1039:1036] : 4'h0);	// Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73
  assign io_result_bits_hit =
    (|hits) | _io_result_bits_way_T_7 & (|_write_io_deq_bits_data_state);	// Cat.scala:33:92, Decoupled.scala:375:21, Directory.scala:133:18, :137:{29,42,54,75}
  assign io_result_bits_way =
    (|hits)
      ? {|{_hits_T_55, _hits_T_48, _hits_T_41, _hits_T_34},
         |(_GEN_2[2:1]),
         _GEN_2[2] | _GEN_2[0]}
      : _io_result_bits_way_T_7 ? _write_io_deq_bits_way : victimWay;	// Cat.scala:33:92, Decoupled.scala:375:21, Directory.scala:131:42, :133:18, :137:42, :138:{28,53}, OneHot.scala:30:18, :31:18, :32:{14,28}
