...
module RouteComputer_251(
  ...
  wire [1:0] _GEN_0 = ~(io_req_3_bits_flow_egress_node[6:5]);	// RouteComputer.scala:74:27, pla.scala:78:21
  ...
  wire [2:0] _decoded_T_175 =
    {io_req_3_bits_flow_egress_node_id[0], _GEN_0[1], io_req_3_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
