...
module RouteComputer_268(
  ...
  wire [2:0] _decoded_T_112 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[2], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_114 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[3], io_req_2_bits_src_virt_id[0]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_122 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[3], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_130 =
    {_GEN[3], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_144 =
    {io_req_2_bits_flow_egress_node_id[0], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_116, &_decoded_T_124, &_decoded_T_132, &_decoded_T_146};	// Cat.scala:33:92, pla.scala:98:74, :114:39
