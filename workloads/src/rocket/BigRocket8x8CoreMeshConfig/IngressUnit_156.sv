...
module IngressUnit_156(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 8'h7A;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 8'h7D;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 8'h80;	// @[IngressUnit.scala:30:72]
  wire [5:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 6'h3D : 6'h0) | {6{_route_buffer_io_enq_bits_flow_egress_node_id_T_1}} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 6'h3E : 6'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 6'h34;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (7'h34),
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 8'h69),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 8'h68),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
