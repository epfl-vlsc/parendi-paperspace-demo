...
module RouteComputer_95(
  ...
  wire [1:0] _GEN_0 = ~(io_req_3_bits_flow_egress_node[4:3]);	// @[RouteComputer.scala:74:27, pla.scala:78:21]
  ...
  wire [3:0] _decoded_T_177 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[3], io_req_3_bits_flow_egress_node[4], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [3:0] _decoded_T_183 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[3], io_req_3_bits_flow_egress_node[4], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [3:0] _decoded_T_189 = {io_req_3_bits_flow_egress_node[3], io_req_3_bits_flow_egress_node[4], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [2:0] _decoded_T_199 = {io_req_3_bits_flow_egress_node[3], io_req_3_bits_flow_egress_node[4], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [3:0] _decoded_T_201 = {io_req_3_bits_flow_egress_node_id[0], io_req_3_bits_flow_egress_node[3], io_req_3_bits_flow_egress_node[4], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
