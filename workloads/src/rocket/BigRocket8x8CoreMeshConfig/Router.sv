...
module Router(
  ...
  wire [2:0]  fires_count = {1'h0, {1'h0, _vc_allocator_io_req_0_ready & _input_unit_0_from_64_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_1_ready & _ingress_unit_1_from_0_io_vcalloc_req_valid}} + {1'h0, {1'h0, _vc_allocator_io_req_2_ready & _ingress_unit_2_from_1_io_vcalloc_req_valid} + {1'h0, _vc_allocator_io_req_3_ready & _ingress_unit_3_from_2_io_vcalloc_req_valid}};	// @[Bitwise.scala:51:90, Decoupled.scala:51:35, Router.scala:112:13, :116:13, :131:30, :137:31, :176:14]
  ...
  InputUnit input_unit_0_from_64 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
