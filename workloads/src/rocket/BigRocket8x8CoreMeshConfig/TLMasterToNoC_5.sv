...
module TLMasterToNoC_5(
  ...
  TLAToNoC a (	// @[Tilelink.scala:221:17]
    ...
    .io_protocol_bits_source  (io_tilelink_a_bits_source | 8'hDC),	// @[Tilelink.scala:227:58]
  ...
  TLCToNoC c (	// @[Tilelink.scala:223:17]
    ...
    .io_protocol_bits_source  (io_tilelink_c_bits_source | 8'hDC),	// @[Tilelink.scala:227:58, :231:58]
