...
module InputUnit_193(
  ...
  wire [9:0]  _vcalloc_filter_T_20 = vcalloc_vals_4 & ~(mask[4]) ? 10'h10 : {vcalloc_vals_4, 9'h0};	// @[InputUnit.scala:235:14, :250:21, :253:{87,89}, :266:32, Mux.scala:47:70]
  ...
  wire        _salloc_arb_io_in_4_valid_T_2 = states_4_g == 3'h3 & (|({states_4_vc_sel_3_0, states_4_vc_sel_2_0, states_4_vc_sel_1_0} & {io_out_credit_available_3_0, io_out_credit_available_2_0, io_out_credit_available_1_0})) & _input_buffer_io_deq_4_valid;	// @[InputUnit.scala:181:28, :192:19, :210:20, :304:{40,47,73,81}, :305:{22,50}]
  ...
  wire        _GEN_0 = _route_arbiter_io_out_valid & _route_arbiter_io_out_bits_src_virt_id == 3'h4;	// @[InputUnit.scala:187:29, :205:60, :210:20, :239:31, :244:{17,25}, :245:26]
  ...
  always @(posedge clock) begin
    if (reset | _salloc_arb_io_in_4_ready & _salloc_arb_io_in_4_valid_T_2 & _input_buffer_io_deq_4_bits_tail)	// @[InputUnit.scala:181:28, :285:32, :296:26, :305:50, :309:{22,35}, :310:13, :395:23, :396:24]
    ...
    else if (_T_31 & vcalloc_sel[4] | vcalloc_vals_4 & vcalloc_sel[4] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:239:31, :254:58, :266:32, :270:{51,76,82}, :285:32, :287:29, :289:21, Mux.scala:29:36]
      ...
      if (io_in_flit_0_bits_flow_egress_node == 9'hC1)	// @[InputUnit.scala:209:57]
        states_4_g <= 3'h2;	// @[InputUnit.scala:192:19, :210:26]
    ...
    if (_GEN) begin	// @[InputUnit.scala:287:29]
      ...
      states_4_vc_sel_3_0 <= ~_GEN_0 & (_T ? io_in_flit_0_bits_flow_egress_node_id == 2'h2 & _GEN_1 | ~_GEN_1 & states_4_vc_sel_3_0 : states_4_vc_sel_3_0);	// @[InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26]
      states_4_vc_sel_2_0 <= ~_GEN_0 & (_T ? io_in_flit_0_bits_flow_egress_node_id == 2'h1 & _GEN_1 | ~_GEN_1 & states_4_vc_sel_2_0 : states_4_vc_sel_2_0);	// @[InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26]
      states_4_vc_sel_1_0 <= ~_GEN_0 & (_T ? io_in_flit_0_bits_flow_egress_node_id == 2'h0 & _GEN_1 | ~_GEN_1 & states_4_vc_sel_1_0 : states_4_vc_sel_1_0);	// @[Bitwise.scala:51:90, InputUnit.scala:192:19, :205:{32,60}, :210:20, :211:45, :213:{19,63}, :214:44, :239:31, :244:25, :245:26]
    end
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[InputUnit.scala:207:13]
      ...
      if (_route_arbiter_io_out_valid & ~reset & _GEN_4[_route_arbiter_io_out_bits_src_virt_id] != 3'h1) begin	// @[InputUnit.scala:187:29, :208:27, :210:26, :241:{11,25}]
  ...
  InputBuffer_193 input_buffer (	// @[InputUnit.scala:181:28]
    .clock                         (clock),
    .reset                         (reset),
