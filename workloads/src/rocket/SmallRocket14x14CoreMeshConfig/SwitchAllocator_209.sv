...
module SwitchAllocator_209(
  ...
  SwitchArbiter_859 arbs_0 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_859 arbs_1 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_859 arbs_2 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
