...
module SwitchAllocator_210(
  ...
  SwitchArbiter_864 arbs_0 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_864 arbs_1 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_864 arbs_2 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
