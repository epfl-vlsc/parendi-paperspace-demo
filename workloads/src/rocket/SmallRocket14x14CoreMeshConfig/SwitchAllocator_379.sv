...
module SwitchAllocator_379(
  ...
  SwitchArbiter_1974 arbs_0 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_1974 arbs_1 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_1974 arbs_2 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  SwitchArbiter_1974 arbs_3 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
