...
module TLSlaveToNoC_1(
  input         clock,
                ...
                io_tilelink_a_ready,
                io_tilelink_b_valid,
  input  [1:0]  io_tilelink_b_bits_param,
  input  [3:0]  io_tilelink_b_bits_size,
  input  [9:0]  io_tilelink_b_bits_source,
  input  [31:0] io_tilelink_b_bits_address,
  input         io_tilelink_c_ready,
                io_tilelink_d_valid,
  input  [2:0]  io_tilelink_d_bits_opcode,
  input  [1:0]  io_tilelink_d_bits_param,
  input  [3:0]  io_tilelink_d_bits_size,
  input  [9:0]  io_tilelink_d_bits_source,
  ...
  output        io_tilelink_a_bits_corrupt,
                io_tilelink_b_ready,
                io_tilelink_c_valid,
  output [2:0]  io_tilelink_c_bits_opcode,
                io_tilelink_c_bits_param,
  output [3:0]  io_tilelink_c_bits_size,
  output [9:0]  io_tilelink_c_bits_source,
  output [31:0] io_tilelink_c_bits_address,
  output [63:0] io_tilelink_c_bits_data,
  output        io_tilelink_c_bits_corrupt,
                io_tilelink_d_ready,
                io_tilelink_e_valid,
  output [2:0]  io_tilelink_e_bits_sink,
  output        io_flits_a_ready,
                io_flits_b_valid,
                io_flits_b_bits_head,
                io_flits_b_bits_tail,
  output [72:0] io_flits_b_bits_payload,
  output [8:0]  io_flits_b_bits_egress_id,
  output        io_flits_c_ready,
                io_flits_d_valid,
                io_flits_d_bits_head,
                io_flits_d_bits_tail,
  output [72:0] io_flits_d_bits_payload,
  output [8:0]  io_flits_d_bits_egress_id
);
  ...
  TLCFromNoC_1 c (	// @[Tilelink.scala:266:17]
    .clock                    (clock),
    .reset                    (reset),
    ...
    .io_flit_bits_payload     (io_flits_c_bits_payload[64:0]),	// @[Tilelink.scala:279:14]
  ...
  TLEFromNoC_1 e (	// @[Tilelink.scala:268:17]
    .clock                 (clock),
    .reset                 (reset),
    .io_flit_valid         (io_flits_e_valid),
    .io_flit_bits_head     (io_flits_e_bits_head),
    .io_flit_bits_tail     (io_flits_e_bits_tail),
    .io_flit_bits_payload  (io_flits_e_bits_payload[2:0]),	// @[Tilelink.scala:281:14]
