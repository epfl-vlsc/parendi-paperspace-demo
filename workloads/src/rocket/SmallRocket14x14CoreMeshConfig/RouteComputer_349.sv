...
module RouteComputer_349(
  ...
  wire [6:0] _GEN_0 = ~(io_req_3_bits_flow_egress_node[7:1]);	// @[RouteComputer.scala:74:27, pla.scala:78:21]
  wire [2:0] _decoded_T_173 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[6], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [3:0] _decoded_T_177 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[7], io_req_3_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_179 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[3], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_181 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[6], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_183 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[7], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  ...
  wire [2:0] _decoded_T_187 = {_GEN_0[6], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_189 = {_GEN_0[0], io_req_3_bits_flow_egress_node[7], io_req_3_bits_src_virt_id[0], io_req_3_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [1:0] _decoded_T_191 = {_GEN_0[3], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [1:0] _decoded_T_193 = {_GEN_0[6], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_195 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[3], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_197 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[6], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [2:0] _decoded_T_199 = {_GEN_0[0], io_req_3_bits_flow_egress_node[7], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
  wire [3:0] _decoded_T_201 = {io_req_3_bits_flow_egress_node_id[0], _GEN_0[0], io_req_3_bits_flow_egress_node[7], io_req_3_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29]
