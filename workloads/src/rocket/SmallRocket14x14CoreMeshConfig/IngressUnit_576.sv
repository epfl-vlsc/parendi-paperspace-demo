...
module IngressUnit_576(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T = io_in_bits_egress_id == 9'h182;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 9'h185;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 9'h188;	// @[IngressUnit.scala:30:72]
  wire [7:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 8'hC1 : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 8'hC3 : 8'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 8'hC2 : 8'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[7:6], _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 4'hC;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
  ...
  Queue_5 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (9'hC0),
  ...
  Queue_6 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_13 & io_in_bits_egress_id == 9'h181),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_13 & io_in_bits_egress_id == 9'h180),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
