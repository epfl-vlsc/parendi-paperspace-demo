...
module InputBuffer(
  ...
  wire            _tails_T_15 = io_enq_0_bits_virt_channel_id == 3'h0;	// @[InputUnit.scala:103:45, Mux.scala:29:36]
  ...
  wire            _tails_T_19 = io_enq_0_bits_virt_channel_id == 3'h4;	// @[Mux.scala:27:73, :29:36]
  ...
  wire [7:0][3:0] _GEN = {{tails_0}, {tails_0}, {tails_0}, {tails_4}, {tails_3}, {tails_2}, {tails_1}, {tails_0}};	// @[InputUnit.scala:87:24]
  wire [3:0]      mem_MPORT_addr = _GEN[io_enq_0_bits_virt_channel_id];
  ...
  wire [4:0]      to_q_oh_enc = can_to_q_0 ? 5'h1 : can_to_q_1 ? 5'h2 : can_to_q_2 ? 5'h4 : can_to_q_3 ? 5'h8 : {can_to_q_4, 4'h0};	// @[InputUnit.scala:86:32, :117:70, Mux.scala:47:70]
  wire            _T_11 = can_to_q_0 | can_to_q_1 | can_to_q_2 | can_to_q_3 | can_to_q_4;	// @[InputUnit.scala:117:70, package.scala:73:59]
  wire [3:0]      head = (to_q_oh_enc[0] ? heads_0 : 4'h0) | (to_q_oh_enc[1] ? heads_1 : 4'h0) | (to_q_oh_enc[2] ? heads_2 : 4'h0) | (to_q_oh_enc[3] ? heads_3 : 4'h0) | (to_q_oh_enc[4] ? heads_4 : 4'h0);	// @[InputUnit.scala:86:{24,32}, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  ...
  wire            _tails_T_14 = mem_MPORT_addr == ({1'h0, {1'h0, {2{_tails_T_16}}} | {3{_tails_T_17}}} | (_tails_T_18 ? 4'hB : 4'h0) | {4{_tails_T_19}});	// @[InputUnit.scala:86:32, :104:14, Mux.scala:27:73, :29:36]
  wire [3:0]      _tails_WIRE_2 = {_tails_T_18, _tails_T_17, 2'h0} | (_tails_T_19 ? 4'hC : 4'h0);	// @[InputUnit.scala:86:32, Mux.scala:27:73, :29:36]
  wire [3:0]      _tails_T_30 = mem_MPORT_addr + 4'h1;	// @[InputUnit.scala:106:14, Mux.scala:47:70]
  ...
  wire            _heads_T_9 = head == ({1'h0, {1'h0, {2{to_q_oh_enc[1]}}} | {3{to_q_oh_enc[2]}}} | (to_q_oh_enc[3] ? 4'hB : 4'h0) | {4{to_q_oh_enc[4]}});	// @[InputUnit.scala:86:32, :123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [3:0]      _heads_WIRE_2 = {to_q_oh_enc[3:2], 2'h0} | (to_q_oh_enc[4] ? 4'hC : 4'h0);	// @[InputUnit.scala:86:32, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [3:0]      _heads_T_20 = head + 4'h1;	// @[InputUnit.scala:125:16, Mux.scala:27:73, :47:70]
  always @(posedge clock) begin
    if (reset) begin
      heads_0 <= 4'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_1 <= 4'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_2 <= 4'h4;	// @[InputUnit.scala:86:{24,32}]
      heads_3 <= 4'h8;	// @[InputUnit.scala:86:{24,32}]
      heads_4 <= 4'hC;	// @[InputUnit.scala:86:{24,32}]
      tails_0 <= 4'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_1 <= 4'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_2 <= 4'h4;	// @[InputUnit.scala:86:32, :87:24]
      tails_3 <= 4'h8;	// @[InputUnit.scala:86:32, :87:24]
      tails_4 <= 4'hC;	// @[InputUnit.scala:86:32, :87:24]
    end
    else begin
      if (_T_11 & to_q == 3'h0) begin	// @[Cat.scala:33:92, InputUnit.scala:86:24, :103:45, :120:27, :122:21, package.scala:73:59]
      ...
      if (_T_11 & to_q == 3'h4) begin	// @[Cat.scala:33:92, InputUnit.scala:86:24, :120:27, :122:21, Mux.scala:27:73, package.scala:73:59]
        if (_heads_T_9)	// @[InputUnit.scala:123:16]
      ...
      if (mem_MPORT_en & io_enq_0_bits_virt_channel_id == 3'h4) begin	// @[InputUnit.scala:87:24, :100:{27,44}, :103:45, Mux.scala:27:73]
        if (_tails_T_14)	// @[InputUnit.scala:104:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        heads_0 = _RANDOM_0[3:0];	// @[InputUnit.scala:86:24]
        heads_1 = _RANDOM_0[7:4];	// @[InputUnit.scala:86:24]
        heads_2 = _RANDOM_0[11:8];	// @[InputUnit.scala:86:24]
        heads_3 = _RANDOM_0[15:12];	// @[InputUnit.scala:86:24]
        heads_4 = _RANDOM_0[19:16];	// @[InputUnit.scala:86:24]
        tails_0 = _RANDOM_0[23:20];	// @[InputUnit.scala:86:24, :87:24]
        tails_1 = _RANDOM_0[27:24];	// @[InputUnit.scala:86:24, :87:24]
        tails_2 = _RANDOM_0[31:28];	// @[InputUnit.scala:86:24, :87:24]
        tails_3 = _RANDOM_1[3:0];	// @[InputUnit.scala:87:24]
        tails_4 = _RANDOM_1[7:4];	// @[InputUnit.scala:87:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue qs_4 (	// @[InputUnit.scala:90:49]
    .clock               (clock),
    .reset               (reset),
    .io_enq_valid        (_GEN_4 | ~mem_MPORT_en & _T_2 & io_enq_0_bits_virt_channel_id == 3'h4),	// @[InputUnit.scala:91:31, :100:{27,44}, :107:{34,50}, :109:46, :120:27, :127:29, :128:32, Mux.scala:27:73]
