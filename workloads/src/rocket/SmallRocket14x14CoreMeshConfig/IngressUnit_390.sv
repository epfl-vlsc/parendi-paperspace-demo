...
module IngressUnit_390(
  ...
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[7:6], _route_buffer_io_enq_bits_flow_egress_node_WIRE[1:0]} == 4'hA;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
