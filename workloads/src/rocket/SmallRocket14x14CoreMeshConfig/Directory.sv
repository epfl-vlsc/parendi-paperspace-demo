...
module Directory(
  ...
  input  [192:0] io_write_bits_data_clients,
  ...
  output [192:0] io_result_bits_clients,
  ...
  wire [199:0]  _WIRE_7;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_6;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_5;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_4;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_3;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_2;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_1;	// @[Directory.scala:99:44]
  wire [199:0]  _WIRE_0;	// @[Directory.scala:99:44]
  ...
  wire [192:0]  _write_io_deq_bits_data_clients;	// @[Decoupled.scala:375:21]
  wire [3:0]    _write_io_deq_bits_data_tag;	// @[Decoupled.scala:375:21]
  wire [1599:0] _cc_dir_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  assign _WIRE_0 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_1 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_2 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_3 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_4 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_5 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_6 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_7 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 200'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  ...
  wire          _hits_T_6 = _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[198:197])) & (~setQuash | (|_write_io_deq_bits_way));	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_13 = _cc_dir_RW0_rdata[203:200] == tag & (|(_cc_dir_RW0_rdata[398:397])) & (~setQuash | _write_io_deq_bits_way != 3'h1);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_20 = _cc_dir_RW0_rdata[403:400] == tag & (|(_cc_dir_RW0_rdata[598:597])) & (~setQuash | _write_io_deq_bits_way != 3'h2);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_27 = _cc_dir_RW0_rdata[603:600] == tag & (|(_cc_dir_RW0_rdata[798:797])) & (~setQuash | _write_io_deq_bits_way != 3'h3);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_34 = _cc_dir_RW0_rdata[803:800] == tag & (|(_cc_dir_RW0_rdata[998:997])) & (~setQuash | _write_io_deq_bits_way != 3'h4);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_41 = _cc_dir_RW0_rdata[1003:1000] == tag & (|(_cc_dir_RW0_rdata[1198:1197])) & (~setQuash | _write_io_deq_bits_way != 3'h5);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_48 = _cc_dir_RW0_rdata[1203:1200] == tag & (|(_cc_dir_RW0_rdata[1398:1397])) & (~setQuash | _write_io_deq_bits_way != 3'h6);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire          _hits_T_55 = _cc_dir_RW0_rdata[1403:1400] == tag & (|(_cc_dir_RW0_rdata[1598:1597])) & (~setQuash | _write_io_deq_bits_way != 3'h7);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  ...
  Queue_7515 write (	// @[Decoupled.scala:375:21]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty = (|hits) ? _hits_T_6 & _cc_dir_RW0_rdata[199] | _hits_T_13 & _cc_dir_RW0_rdata[399] | _hits_T_20 & _cc_dir_RW0_rdata[599] | _hits_T_27 & _cc_dir_RW0_rdata[799] | _hits_T_34 & _cc_dir_RW0_rdata[999] | _hits_T_41 & _cc_dir_RW0_rdata[1199] | _hits_T_48 & _cc_dir_RW0_rdata[1399] | _hits_T_55 & _cc_dir_RW0_rdata[1599] : _view__T_69 ? _write_io_deq_bits_data_dirty : victimWayOH[0] & _cc_dir_RW0_rdata[199] | victimWayOH[1] & _cc_dir_RW0_rdata[399] | victimWayOH[2] & _cc_dir_RW0_rdata[599] | victimWayOH[3] & _cc_dir_RW0_rdata[799] | victimWayOH[4] & _cc_dir_RW0_rdata[999] | victimWayOH[5] & _cc_dir_RW0_rdata[1199] | victimWayOH[6] & _cc_dir_RW0_rdata[1399] | victimWayOH[7] & _cc_dir_RW0_rdata[1599];	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_state = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[198:197] : 2'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[398:397] : 2'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[598:597] : 2'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[798:797] : 2'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[998:997] : 2'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[1198:1197] : 2'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[1398:1397] : 2'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[1598:1597] : 2'h0) : _view__T_69 ? _write_io_deq_bits_data_state : (victimWayOH[0] ? _cc_dir_RW0_rdata[198:197] : 2'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[398:397] : 2'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[598:597] : 2'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[798:797] : 2'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[998:997] : 2'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[1198:1197] : 2'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[1398:1397] : 2'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[1598:1597] : 2'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_clients = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[196:4] : 193'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[396:204] : 193'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[596:404] : 193'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[796:604] : 193'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[996:804] : 193'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[1196:1004] : 193'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[1396:1204] : 193'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[1596:1404] : 193'h0) : _view__T_69 ? _write_io_deq_bits_data_clients : (victimWayOH[0] ? _cc_dir_RW0_rdata[196:4] : 193'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[396:204] : 193'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[596:404] : 193'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[796:604] : 193'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[996:804] : 193'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[1196:1004] : 193'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[1396:1204] : 193'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[1596:1404] : 193'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_tag = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[203:200] : 4'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[403:400] : 4'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[603:600] : 4'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[803:800] : 4'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[1003:1000] : 4'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[1203:1200] : 4'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[1403:1400] : 4'h0) : _view__T_69 ? _write_io_deq_bits_data_tag : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[203:200] : 4'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[403:400] : 4'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[603:600] : 4'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[803:800] : 4'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[1003:1000] : 4'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[1203:1200] : 4'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[1403:1400] : 4'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
