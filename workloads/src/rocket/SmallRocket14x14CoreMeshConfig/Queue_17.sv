...
module Queue_17(
  ...
  input  [9:0]  io_enq_bits_ingress_id,
  input         io_deq_ready,
  output        io_enq_ready,
                io_deq_valid,
                io_deq_bits_head,
  ...
  wire [1:0]  ptr_diff = enq_ptr_value - deq_ptr_value;	// @[Counter.scala:61:40, Decoupled.scala:326:32]
  ...
  ram_combMem_9 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_ingress_id, io_enq_bits_payload, io_enq_bits_tail, io_enq_bits_head}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_head = empty ? io_enq_bits_head : _ram_ext_R0_data[0];	// @[Decoupled.scala:273:95, :278:25, :310:17, :315:17, :316:19]
  assign io_deq_bits_tail = empty ? io_enq_bits_tail : _ram_ext_R0_data[1];	// @[Decoupled.scala:273:95, :278:25, :310:17, :315:17, :316:19]
  assign io_deq_bits_payload = empty ? io_enq_bits_payload : _ram_ext_R0_data[74:2];	// @[Decoupled.scala:273:95, :278:25, :310:17, :315:17, :316:19]
  assign io_count = ptr_match ? {2{maybe_full}} : deq_ptr_value > enq_ptr_value ? ptr_diff - 2'h1 : ptr_diff;	// @[Counter.scala:61:40, Decoupled.scala:276:27, :277:33, :326:32, :331:20, :333:10, :334:{10,25,57}]
endmodule
