...
module IngressUnit_207(
  ...
  wire        at_dest = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[6], _route_buffer_io_enq_bits_flow_egress_node_WIRE[4:0]} == 6'h25;	// @[IngressUnit.scala:41:50, :55:59, Mux.scala:27:73]
