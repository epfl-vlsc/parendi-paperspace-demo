...
module IngressUnit(
  ...
  wire [5:0]  _GEN = {_route_buffer_io_enq_bits_flow_egress_node_WIRE[6], _route_buffer_io_enq_bits_flow_egress_node_WIRE[4:0]};	// @[IngressUnit.scala:41:50, Mux.scala:27:73]
