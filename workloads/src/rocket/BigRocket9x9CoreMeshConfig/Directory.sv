...
module Directory(
  ...
  input  [77:0] io_write_bits_data_clients,
  ...
  output [77:0] io_result_bits_clients,
  ...
  wire [84:0]  _WIRE_7;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_6;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_5;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_4;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_3;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_2;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_1;	// @[Directory.scala:99:44]
  wire [84:0]  _WIRE_0;	// @[Directory.scala:99:44]
  ...
  wire [77:0]  _write_io_deq_bits_data_clients;	// @[Decoupled.scala:375:21]
  wire [3:0]   _write_io_deq_bits_data_tag;	// @[Decoupled.scala:375:21]
  wire [679:0] _cc_dir_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  assign _WIRE_0 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_1 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_2 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_3 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_4 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_5 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_6 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  assign _WIRE_7 = wipeCount[7] ? {_write_io_deq_bits_data_dirty, _write_io_deq_bits_data_state, _write_io_deq_bits_data_clients, _write_io_deq_bits_data_tag} : 85'h0;	// @[Decoupled.scala:375:21, Directory.scala:79:26, :81:27, :99:{44,71}]
  ...
  wire         _hits_T_6 = _cc_dir_RW0_rdata[3:0] == tag & (|(_cc_dir_RW0_rdata[83:82])) & (~setQuash | (|_write_io_deq_bits_way));	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_13 = _cc_dir_RW0_rdata[88:85] == tag & (|(_cc_dir_RW0_rdata[168:167])) & (~setQuash | _write_io_deq_bits_way != 3'h1);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_20 = _cc_dir_RW0_rdata[173:170] == tag & (|(_cc_dir_RW0_rdata[253:252])) & (~setQuash | _write_io_deq_bits_way != 3'h2);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_27 = _cc_dir_RW0_rdata[258:255] == tag & (|(_cc_dir_RW0_rdata[338:337])) & (~setQuash | _write_io_deq_bits_way != 3'h3);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_34 = _cc_dir_RW0_rdata[343:340] == tag & (|(_cc_dir_RW0_rdata[423:422])) & (~setQuash | _write_io_deq_bits_way != 3'h4);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_41 = _cc_dir_RW0_rdata[428:425] == tag & (|(_cc_dir_RW0_rdata[508:507])) & (~setQuash | _write_io_deq_bits_way != 3'h5);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_48 = _cc_dir_RW0_rdata[513:510] == tag & (|(_cc_dir_RW0_rdata[593:592])) & (~setQuash | _write_io_deq_bits_way != 3'h6);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  wire         _hits_T_55 = _cc_dir_RW0_rdata[598:595] == tag & (|(_cc_dir_RW0_rdata[678:677])) & (~setQuash | _write_io_deq_bits_way != 3'h7);	// @[Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:125:31, :129:40, :131:{11,30,42,46,56,63}, Reg.scala:19:16]
  ...
  Queue_3160 write (	// @[Decoupled.scala:375:21]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_result_bits_dirty = (|hits) ? _hits_T_6 & _cc_dir_RW0_rdata[84] | _hits_T_13 & _cc_dir_RW0_rdata[169] | _hits_T_20 & _cc_dir_RW0_rdata[254] | _hits_T_27 & _cc_dir_RW0_rdata[339] | _hits_T_34 & _cc_dir_RW0_rdata[424] | _hits_T_41 & _cc_dir_RW0_rdata[509] | _hits_T_48 & _cc_dir_RW0_rdata[594] | _hits_T_55 & _cc_dir_RW0_rdata[679] : _view__T_69 ? _write_io_deq_bits_data_dirty : victimWayOH[0] & _cc_dir_RW0_rdata[84] | victimWayOH[1] & _cc_dir_RW0_rdata[169] | victimWayOH[2] & _cc_dir_RW0_rdata[254] | victimWayOH[3] & _cc_dir_RW0_rdata[339] | victimWayOH[4] & _cc_dir_RW0_rdata[424] | victimWayOH[5] & _cc_dir_RW0_rdata[509] | victimWayOH[6] & _cc_dir_RW0_rdata[594] | victimWayOH[7] & _cc_dir_RW0_rdata[679];	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_state = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[83:82] : 2'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[168:167] : 2'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[253:252] : 2'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[338:337] : 2'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[423:422] : 2'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[508:507] : 2'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[593:592] : 2'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[678:677] : 2'h0) : _view__T_69 ? _write_io_deq_bits_data_state : (victimWayOH[0] ? _cc_dir_RW0_rdata[83:82] : 2'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[168:167] : 2'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[253:252] : 2'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[338:337] : 2'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[423:422] : 2'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[508:507] : 2'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[593:592] : 2'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[678:677] : 2'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:{30,42}, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_clients = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[81:4] : 78'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[166:89] : 78'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[251:174] : 78'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[336:259] : 78'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[421:344] : 78'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[506:429] : 78'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[591:514] : 78'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[676:599] : 78'h0) : _view__T_69 ? _write_io_deq_bits_data_clients : (victimWayOH[0] ? _cc_dir_RW0_rdata[81:4] : 78'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[166:89] : 78'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[251:174] : 78'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[336:259] : 78'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[421:344] : 78'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[506:429] : 78'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[591:514] : 78'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[676:599] : 78'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
  assign io_result_bits_tag = (|hits) ? (_hits_T_6 ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (_hits_T_13 ? _cc_dir_RW0_rdata[88:85] : 4'h0) | (_hits_T_20 ? _cc_dir_RW0_rdata[173:170] : 4'h0) | (_hits_T_27 ? _cc_dir_RW0_rdata[258:255] : 4'h0) | (_hits_T_34 ? _cc_dir_RW0_rdata[343:340] : 4'h0) | (_hits_T_41 ? _cc_dir_RW0_rdata[428:425] : 4'h0) | (_hits_T_48 ? _cc_dir_RW0_rdata[513:510] : 4'h0) | (_hits_T_55 ? _cc_dir_RW0_rdata[598:595] : 4'h0) : _view__T_69 ? _write_io_deq_bits_data_tag : (victimWayOH[0] ? _cc_dir_RW0_rdata[3:0] : 4'h0) | (victimWayOH[1] ? _cc_dir_RW0_rdata[88:85] : 4'h0) | (victimWayOH[2] ? _cc_dir_RW0_rdata[173:170] : 4'h0) | (victimWayOH[3] ? _cc_dir_RW0_rdata[258:255] : 4'h0) | (victimWayOH[4] ? _cc_dir_RW0_rdata[343:340] : 4'h0) | (victimWayOH[5] ? _cc_dir_RW0_rdata[428:425] : 4'h0) | (victimWayOH[6] ? _cc_dir_RW0_rdata[513:510] : 4'h0) | (victimWayOH[7] ? _cc_dir_RW0_rdata[598:595] : 4'h0);	// @[Bitwise.scala:53:100, Cat.scala:33:92, Decoupled.scala:375:21, DescribedSRAM.scala:17:26, Directory.scala:119:55, :129:40, :131:42, :133:18, :136:{67,95,105}, Mux.scala:27:73]
