...
module RouteComputer_135(
  ...
  wire [3:0] _decoded_T_59 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[1], io_req_1_bits_flow_egress_node[2], io_req_1_bits_src_virt_id[0]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [3:0] _decoded_T_65 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[1], io_req_1_bits_flow_egress_node[2], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [3:0] _decoded_T_71 = {io_req_1_bits_flow_egress_node[1], io_req_1_bits_flow_egress_node[2], io_req_1_bits_src_virt_id[0], io_req_1_bits_src_virt_id[1]};	// @[Cat.scala:33:92, pla.scala:90:45]
  ...
  wire [2:0] _decoded_T_81 = {io_req_1_bits_flow_egress_node[1], io_req_1_bits_flow_egress_node[2], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
  wire [3:0] _decoded_T_83 = {io_req_1_bits_flow_egress_node_id[0], io_req_1_bits_flow_egress_node[1], io_req_1_bits_flow_egress_node[2], io_req_1_bits_src_virt_id[2]};	// @[Cat.scala:33:92, pla.scala:90:45]
