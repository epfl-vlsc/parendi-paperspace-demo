...
module SimTLMemGen_1(
  ...
  input  [1:0]  io_tl_0_a_bits_source,
  ...
  output [1:0]  io_tl_0_d_bits_source,
  ...
  wire [1:0]  _fragmenter_auto_in_d_bits_source;	// @[Fragmenter.scala:335:34]
  ...
  wire [7:0]  _fragmenter_auto_out_a_bits_source;	// @[Fragmenter.scala:335:34]
  ...
  wire [7:0]  _srams_auto_in_d_bits_source;	// @[HarnessExtMem.scala:186:15]
