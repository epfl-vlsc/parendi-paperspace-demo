...
module DigitalTop(
  ...
  wire [25:0] _subsystem_sbus_auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_address;	// @[SystemBus.scala:24:26]
  ...
  ClockSinkDomain bootROMDomainWrapper (	// @[BootROM.scala:72:42]
  ...
  ClockSinkDomain_1 prci_ctrl_domain (	// @[HasChipyardPRCI.scala:37:36]
