...
module RouteComputer_157(
  ...
  wire [3:0] _decoded_T_262 =
    {_GEN[2], _GEN[4], io_req_2_bits_flow_egress_node[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [5:0] _decoded_T_276 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_278 =
    {io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  wire [3:0] _decoded_T_280 =
    {io_req_2_bits_flow_egress_node_id[0],
     io_req_2_bits_flow_egress_node[2],
     io_req_2_bits_flow_egress_node[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:90:45
  ...
  assign io_resp_2_vc_sel_1_1 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_260,
      &_decoded_T_266,
      &_decoded_T_276};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_118,
      ...
      &_decoded_T_264,
      &_decoded_T_268,
      &_decoded_T_274};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_144, &_decoded_T_178, &_decoded_T_212, &_decoded_T_278};	// Cat.scala:33:92, pla.scala:98:74, :114:39
