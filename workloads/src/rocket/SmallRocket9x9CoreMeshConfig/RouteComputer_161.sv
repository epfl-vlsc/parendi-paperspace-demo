...
module RouteComputer_161(
  ...
  wire [3:0]  _decoded_T_74 =
    {_GEN[0], _GEN[3], io_req_0_bits_src_virt_id[0], io_req_0_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0]  _decoded_T_120 =
    {_GEN[0], io_req_0_bits_flow_egress_node[1], _GEN[4], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0]  _decoded_T_124 =
    {io_req_0_bits_flow_egress_node[2], _GEN[5], _GEN[6], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0]  _decoded_T_136 =
    {_GEN[0], _GEN[1], io_req_0_bits_flow_egress_node[4], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0]  _decoded_T_152 =
    {_GEN[0], _GEN[2], io_req_0_bits_flow_egress_node[5], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0]  _decoded_T_154 =
    {_GEN[1], _GEN[2], io_req_0_bits_flow_egress_node[5], io_req_0_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_4 =
    |{&_decoded_T_292, &_decoded_T_298, &{_GEN_0[20], io_req_2_bits_src_virt_id[2]}};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
  ...
  assign io_resp_1_vc_sel_0_2 =
    |{io_req_1_bits_flow_egress_node_id[1], &_decoded_T_238, &_decoded_T_241};	// Cat.scala:33:92, pla.scala:90:45, :98:74, :114:39
  ...
  assign io_resp_0_vc_sel_1_1 =
    |{&_decoded_T_10,
      ...
      &_decoded_T_174,
      &_decoded_T_178,
      &_decoded_T_186};	// Cat.scala:33:92, pla.scala:98:74, :114:39
