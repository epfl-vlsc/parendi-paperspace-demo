...
module RouteComputer_158(
  ...
  wire [3:0] _decoded_T_176 =
    {_GEN[2], _GEN[5], io_req_2_bits_src_virt_id[0], io_req_2_bits_src_virt_id[1]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_228 =
    {_GEN[0], _GEN[1], io_req_2_bits_flow_egress_node[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [2:0] _decoded_T_236 =
    {_GEN[1], io_req_2_bits_flow_egress_node[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_238 =
    {io_req_2_bits_flow_egress_node_id[0],
     _GEN[1],
     io_req_2_bits_flow_egress_node[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_1 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_238,
      &_decoded_T_242,
      &_decoded_T_262};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_236,
      &_decoded_T_240,
      &_decoded_T_260};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_1_3 =
    |{&_decoded_T_116,
      ...
      &_decoded_T_252,
      &_decoded_T_256,
      &_decoded_T_264};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_142, &_decoded_T_174, &_decoded_T_206, &_decoded_T_268};	// Cat.scala:33:92, pla.scala:98:74, :114:39
