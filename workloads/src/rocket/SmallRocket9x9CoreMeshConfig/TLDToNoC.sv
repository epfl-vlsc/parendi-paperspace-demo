...
module TLDToNoC(
     ...
     {1'h0,
      {1'h0,
       {1'h0,
        {1'h0,
         {1'h0,
          {1'h0, _q_io_deq_bits_source[8:2] == 7'h4D}
            | {2{_q_io_deq_bits_source[8:2] == 7'h4C}}}
           | (_q_io_deq_bits_source[8:2] == 7'h4B ? 3'h5 : 3'h0)
           | {3{_q_io_deq_bits_source[8:2] == 7'h4A}}}
          | (_q_io_deq_bits_source[8:2] == 7'h49 ? 4'h9 : 4'h0)
          | (_q_io_deq_bits_source[8:2] == 7'h48 ? 4'hB : 4'h0)
          | (_q_io_deq_bits_source[8:2] == 7'h47 ? 4'hD : 4'h0)
          | {4{_q_io_deq_bits_source[8:2] == 7'h46}}}
         | (_q_io_deq_bits_source[8:2] == 7'h45 ? 5'h11 : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h44 ? 5'h13 : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h43 ? 5'h15 : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h42 ? 5'h17 : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h41 ? 5'h19 : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h40 ? 5'h1B : 5'h0)
         | (_q_io_deq_bits_source[8:2] == 7'h3F ? 5'h1D : 5'h0)
         | {5{_q_io_deq_bits_source[8:2] == 7'h3E}}}
        | (_q_io_deq_bits_source[8:2] == 7'h3D ? 6'h21 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h3C ? 6'h23 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h3B ? 6'h25 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h3A ? 6'h27 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h39 ? 6'h29 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h38 ? 6'h2B : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h37 ? 6'h2D : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h36 ? 6'h2F : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h35 ? 6'h31 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h34 ? 6'h33 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h33 ? 6'h35 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h32 ? 6'h37 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h31 ? 6'h39 : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h30 ? 6'h3B : 6'h0)
        | (_q_io_deq_bits_source[8:2] == 7'h2F ? 6'h3D : 6'h0)
        | {6{_q_io_deq_bits_source[8:2] == 7'h2E}}}
       | (_q_io_deq_bits_source[8:2] == 7'h2D ? 7'h41 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h2C ? 7'h43 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h2B ? 7'h45 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h2A ? 7'h47 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h29 ? 7'h49 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h28 ? 7'h4B : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h27 ? 7'h4D : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h26 ? 7'h4F : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h25 ? 7'h51 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h24 ? 7'h53 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h23 ? 7'h55 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h22 ? 7'h57 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h21 ? 7'h59 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h20 ? 7'h5B : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1F ? 7'h5D : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1E ? 7'h5F : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1D ? 7'h61 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1C ? 7'h63 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1B ? 7'h65 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h1A ? 7'h67 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h19 ? 7'h69 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h18 ? 7'h6B : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h17 ? 7'h6D : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h16 ? 7'h6F : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h15 ? 7'h71 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h14 ? 7'h73 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h13 ? 7'h75 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h12 ? 7'h77 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h11 ? 7'h79 : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'h10 ? 7'h7B : 7'h0)
       | (_q_io_deq_bits_source[8:2] == 7'hF ? 7'h7D : 7'h0)
       | {7{_q_io_deq_bits_source[8:2] == 7'hE}}}
    | (_q_io_deq_bits_source[8:2] == 7'hD ? 8'h81 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'hC ? 8'h83 : 8'h0);	// Edges.scala:221:14, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
  ...
  assign io_flit_bits_egress_id =
    _GEN_0 | (_q_io_deq_bits_source[8:2] == 7'hB ? 8'h85 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'hA ? 8'h87 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h9 ? 8'h89 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h8 ? 8'h8B : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h7 ? 8'h8D : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h6 ? 8'h8F : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h5 ? 8'h91 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h4 ? 8'h93 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h3 ? 8'h95 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h2 ? 8'h97 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h1 ? 8'h99 : 8'h0)
    | (_q_io_deq_bits_source[8:2] == 7'h0 ? 8'h9B : 8'h0);	// Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17
endmodule
