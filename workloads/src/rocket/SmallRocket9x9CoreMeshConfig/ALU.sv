...
module ALU(
  ...
  wire        slt =
    io_in1[63] == io_in2[63]
      ...
      : io_fn[1] ? io_in2[63] : io_in1[63];	// ALU.scala:112:35, :141:36, :145:{8,15,24,34,56}, :146:8
  ...
  wire [63:0] shin =
    _shout_T | _shout_T_1
      ...
      : {io_in1[0],
         ...
         _T_7[29],
         _T_7[30],
         _T_7[31]};	// ALU.scala:155:24, :157:34, :159:{17,24,41,50}, Bitwise.scala:108:{21,39,46}, Cat.scala:33:92
  wire [64:0] _shout_r_T_5 =
    $signed($signed({io_fn[3] & shin[63], shin})
            >>> {59'h0, io_in2[5] & io_dw, io_in2[4:0]});	// ALU.scala:110:29, :156:{29,33,60}, :159:17, :160:{41,47,70}, Cat.scala:33:92
      ...
      : {63'h0, io_fn > 4'hB & slt} | (io_fn == 4'h4 | _logic_T_4 ? in1_xor_in2 : 64'h0)
        ...
        | (io_fn == 4'h1
             ? {_shout_r_T_5[0],
                ...
                _shout_r_T_5[62],
                _shout_r_T_5[63]}
             : 64'h0);	// ALU.scala:111:30, :140:28, :141:36, :145:8, :159:{24,50}, :160:{70,79}, :162:{18,41}, :163:{18,25}, :172:{18,25,42,51}, :173:{18,41,50,75}, :175:{42,50,58}, :180:{16,23,40,49}, Bitwise.scala:108:{21,31,39,46}
