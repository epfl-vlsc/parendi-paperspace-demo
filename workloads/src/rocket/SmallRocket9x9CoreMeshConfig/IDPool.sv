      ...
      if (io_alloc_ready | io_free_valid) begin	// IDPool.scala:33:24
        ...
        valid <=
          ...
          & ~({1'h0,
              ...
              & io_alloc_ready) | io_free_valid;	// Bitwise.scala:51:90, :53:100, IDPool.scala:18:23, :20:23, :29:{28,32,35,55,64}, :30:17
      end
                         ...
                         : bitmap[1]
                             ...
                             : bitmap[2]
                                 ...
                                 : bitmap[3]
                                     ...
                                     : bitmap[4]
                                         ? 3'h4
                                         : bitmap[5] ? 3'h5 : {2'h3, ~(bitmap[6])})) begin	// Bitwise.scala:53:100, IDPool.scala:18:23, :19:23, :20:23, :51:36, :52:{14,22}, Mux.scala:47:70
