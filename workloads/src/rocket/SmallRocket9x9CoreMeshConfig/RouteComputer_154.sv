...
module RouteComputer_154(
  ...
  wire [3:0] _decoded_T_162 =
    {_GEN[0], io_req_2_bits_flow_egress_node[3], _GEN[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [4:0] _decoded_T_168 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[6],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [2:0] _decoded_T_170 =
    {_GEN[3], io_req_2_bits_flow_egress_node[6], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_2_3 =
    |{&_decoded_T_112,
      ...
      &_decoded_T_154,
      &_decoded_T_166,
      &_decoded_T_178};	// Cat.scala:33:92, pla.scala:98:74, :114:39
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_122, &_decoded_T_136, &_decoded_T_150, &_decoded_T_174};	// Cat.scala:33:92, pla.scala:98:74, :114:39
