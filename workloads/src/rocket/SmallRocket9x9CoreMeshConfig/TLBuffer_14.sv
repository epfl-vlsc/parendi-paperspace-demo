...
module TLBuffer_14(
  ...
  Queue_3165 x1_a_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_3166 bundleIn_0_d_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_3167 bundleIn_0_b_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_3168 x1_c_q (	// Decoupled.scala:375:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_3154 x1_e_q (	// Decoupled.scala:375:21
    .clock            (clock),
    .reset            (reset),
