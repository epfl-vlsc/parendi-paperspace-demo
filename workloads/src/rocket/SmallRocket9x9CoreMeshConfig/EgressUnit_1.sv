...
module EgressUnit_1(
  ...
  Queue_17 q (	// EgressUnit.scala:22:17
    ...
    .io_enq_bits_ingress_id
      ((io_in_0_bits_flow_ingress_node == 8'h4E & _q_io_enq_bits_ingress_id_T_7
          ? 8'hEB
          : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 8'h50 & _q_io_enq_bits_ingress_id_T_7
            ? 8'hED
            : 8'h0)
       | (io_in_0_bits_flow_ingress_node == 8'h4F & _q_io_enq_bits_ingress_id_T_7
            ? 8'hEF
