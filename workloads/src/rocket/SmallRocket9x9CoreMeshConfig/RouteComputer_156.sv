...
module RouteComputer_156(
  ...
  wire [3:0] _decoded_T_214 =
    {io_req_2_bits_flow_egress_node[0], _GEN[1], _GEN[4], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [5:0] _decoded_T_224 =
    {io_req_2_bits_flow_egress_node_id[0],
     ...
     _GEN[4],
     io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_226 =
    {_GEN[0], io_req_2_bits_flow_egress_node[2], _GEN[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  wire [3:0] _decoded_T_228 =
    {io_req_2_bits_flow_egress_node[2], _GEN[4], _GEN[5], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  wire [3:0] _decoded_T_234 =
    {_GEN[0], _GEN[2], io_req_2_bits_flow_egress_node[3], io_req_2_bits_src_virt_id[2]};	// Cat.scala:33:92, pla.scala:78:21, :90:45, :91:29
  ...
  assign io_resp_2_vc_sel_0_3 =
    |{&_decoded_T_142, &_decoded_T_176, &_decoded_T_208, &_decoded_T_270};	// Cat.scala:33:92, pla.scala:98:74, :114:39
