...
module SinkA(
  ...
  wire [40:0] freeOH =
    {~(_freeOH_T_15 | {_freeOH_T_15[7:0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// Edges.scala:230:28, SinkA.scala:59:{16,25,33,39}, package.scala:245:{43,48,53}
  ...
  wire [5:0]  freeIdx =
    {|(freeOH[40:32]),
     ...
     |(_GEN_1[6:3]),
     |(_GEN_2[2:1]),
     _GEN_2[2] | _GEN_2[0]};	// Cat.scala:33:92, OneHot.scala:30:18, :31:18, :32:{14,28}, SinkA.scala:59:39
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      lists <=
        (lists
         | (_T_3 & ~(io_a_bits_opcode[2]) & ~req_block & ~buf_block
              ? freeOH[39:0]
              : 40'h0)) & ~(_T_9 & io_pb_pop_bits_last ? _lists_clr_T[39:0] : 40'h0);	// Decoupled.scala:51:35, Edges.scala:92:{28,37}, OneHot.scala:64:{12,27}, SinkA.scala:52:22, :54:27, :55:27, :56:{19,32,34}, :59:39, :70:25, :71:27, :78:{14,28}, :79:27, :81:{51,66,78}, :108:{24,48}, :109:15
  ...
  ListBuffer putbuffer (	// SinkA.scala:51:25
    ...
    .reset                     (reset),
    .io_push_valid
      (io_a_valid & ~(io_a_bits_opcode[2]) & ~req_block & ~set_block),	// Edges.scala:92:{28,37}, SinkA.scala:70:25, :72:36, :78:{14,42}, :80:63
  ...
  assign io_req_bits_tag = io_a_bits_address[16:13];	// Cat.scala:33:92, Parameters.scala:214:22, :215:19
  ...
  assign io_req_bits_set = io_a_bits_address[12:6];	// Cat.scala:33:92, Parameters.scala:214:22, :216:28
